...
var filesToCache = [
    ...
    './manifest.json',
    './dist/index.min.js',
    './src/config/engine/render/shader/shader_libs.json',
    './src/config/engine/render/shader/shaders.json',
    './src/config/engine/no_worker/pipeline/loop_pipelines.json',
    './src/config/engine/no_worker/pipeline/init_pipelines.json',
    './src/config/engine/no_worker/job/loop_jobs.json',
    './src/config/engine/no_worker/job/init_jobs.json',
    './src/config/engine/setting.json',
    './src/config/editor/setting.json',
    './src/config/engine/no_worker/setting/setting.json',
