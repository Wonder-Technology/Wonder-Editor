...
import { setNear, setFar, createCameraController, setAspect, setFovy } from "../../adaptor/CameraAdaptor";
import { translate } from "./TransformOper";
export var createCamera = function () {
    var camera = createGameObject(), cameraController = createCameraController();
...
//# sourceMappingURL=CameraOper.js.map