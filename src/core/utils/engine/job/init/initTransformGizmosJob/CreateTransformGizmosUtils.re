    ...
    transformGizmoData:
      Some({
        ...
        scaleGizmoData: {
          ...
          dragStartXAxisNormalizedVec: None,
          dragStartYAxisNormalizedVec: None,
          dragStartZAxisNormalizedVec: None,
          dragStartScaleWholeGizmoInvertLocalToWorldMatrixTypeArray: None,
        },
      }),
  },
};