...
Wonder_jest.describe("test remove fly camera controller", (function (param) {
        ...
        return Wonder_jest.describe("if is run", (function (param) {
                      ...
                      return Wonder_jest.test("unbind flyCameraController event for game view", (function (param) {
                                    ...
                                    var cameraController = GameObjectComponentEngineService$WonderEditor.unsafeGetFlyCameraControllerComponent(__x, StateEngineService$WonderEditor.unsafeGetState(/* () */0));
                                    StateLogicService$WonderEditor.getAndSetEngineState((function (param) {
                                            return FlyCameraEngineService$WonderEditor.bindFlyCameraControllerEventForGameView(cameraController, param);
                                          }));
                                    ...
                                    return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](FlyCameraEngineService$WonderEditor.isBindFlyCameraControllerEventForGameView(cameraController, engineState)), false);
                                  }));
                    }));
      }));
