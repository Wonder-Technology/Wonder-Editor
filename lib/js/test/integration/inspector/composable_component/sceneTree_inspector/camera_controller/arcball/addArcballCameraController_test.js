...
Wonder_jest.describe("test add arcballCameraController", (function (param) {
        ...
        return Wonder_jest.describe("if is run", (function (param) {
                      ...
                      Wonder_jest.describe("if gameObject has basicCameraView and basicCameraView is active ", (function (param) {
                              return Wonder_jest.test("bind arcballCameraController event for game view", (function (param) {
                                            ...
                                            return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](ArcballCameraEngineService$WonderEditor.isBindArcballCameraControllerEventForGameView(currentArcballCameraController, engineState$1)), true);
                                          }));
                            }));
                      return Wonder_jest.describe("else", (function (param) {
                                    return Wonder_jest.test("not bind event for game view", (function (param) {
                                                  ...
                                                  return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](ArcballCameraEngineService$WonderEditor.isBindArcballCameraControllerEventForGameView(GameObjectComponentEngineService$WonderEditor.unsafeGetArcballCameraControllerComponent(currentSceneTreeNode, engineState), engineState)), false);
                                                }));
                                  }));
                    }));
      }));
