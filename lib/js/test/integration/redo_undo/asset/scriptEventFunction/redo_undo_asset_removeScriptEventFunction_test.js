...
Wonder_jest.describe("redo_undo: asset remove script event function", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateOnceRemoveScriptEventFunction = function (param) {
          MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */1](/* () */0);
          var addedScriptEventFunctionNodeId1 = MainEditorAssetIdTool$WonderEditor.getNewAssetId(undefined, /* () */0);
          MainEditorAssetHeaderOperateNodeTool$WonderEditor.addScriptEventFunction(undefined, undefined, /* () */0);
          return MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeScriptEventFunctionNode(undefined, undefined, addedScriptEventFunctionNodeId1, /* () */0);
        };
        beforeEach((function () {
        ...
        Wonder_jest.describe("test undo operate", (function (param) {
                return Wonder_jest.describe("test undo one step", (function (param) {
                              return Wonder_jest.test("step which from first to zero", (function (param) {
                                            _simulateOnceRemoveScriptEventFunction(/* () */0);
