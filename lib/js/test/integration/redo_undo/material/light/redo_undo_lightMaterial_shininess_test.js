...
Wonder_jest.describe("redo_undo: lightMaterial shininess", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _changeShininess = function (value) {
          GameObjectTool$WonderEditor.getCurrentSceneTreeNodeLightMaterial(/* () */0);
          MainEditorLightMaterialForGameObjectTool$WonderEditor.changeShininess(undefined, value, /* () */0);
          return MainEditorLightMaterialForGameObjectTool$WonderEditor.blurShininess(undefined, undefined, undefined, value, /* () */0);
        };
