...
Wonder_jest.describe("redo_undo: add geometry component", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateAddSpecificComponent = function (param) {
          return MainEditorInspectorAddComponentTool$WonderEditor.addGeometryComponent(undefined, undefined, undefined, /* () */0);
        };
