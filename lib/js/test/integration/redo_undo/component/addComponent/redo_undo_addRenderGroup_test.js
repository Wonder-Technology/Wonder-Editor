...
Wonder_jest.describe("redo_undo: add renderGroup component", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateAddSpecificComponent = function (param) {
          return MainEditorInspectorAddComponentTool$WonderEditor.addRenderGroupComponent(undefined, undefined, undefined, /* () */0);
        };
