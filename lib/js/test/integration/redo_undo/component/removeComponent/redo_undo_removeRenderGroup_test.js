...
Wonder_jest.describe("redo_undo: remove renderGroup component", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateRemoveSpecificComponent = function (param) {
          return MainEditorInspectorRemoveComponentTool$WonderEditor.removeRenderGroupComponent(undefined, undefined, undefined, /* () */0);
        };
