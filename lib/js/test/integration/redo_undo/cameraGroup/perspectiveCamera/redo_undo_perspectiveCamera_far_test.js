...
Wonder_jest.describe("redo_undo: perspectiveCamera far", (function (param) {
        ...
        var _changeFar = function (value) {
          return MainEditorCameraProjectionTool$WonderEditor.changeFarAndBlur(GameObjectTool$WonderEditor.getCurrentSceneTreeNodePerspectiveCamera(/* () */0), value, undefined, undefined, /* () */0);
        };
        var _simulateTwiceChangeFar = function (param) {
          _changeFar(10.112);
