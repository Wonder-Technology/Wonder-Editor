...
var ArrayTool$WonderEditor = require("../../../tool/ArrayTool.js");
...
var RotationGizmosTool$WonderEditor = require("../tool/RotationGizmosTool.js");
...
var DataScaleGizmoSceneViewEditorService$WonderEditor = require("../../../../src/service/state/editor/view/sceneView/transform/scale/DataScaleGizmoSceneViewEditorService.js");
var SelectScaleGizmoSceneViewEditorService$WonderEditor = require("../../../../src/service/state/editor/view/sceneView/transform/scale/SelectScaleGizmoSceneViewEditorService.js");
...
var SelectRotationGizmoSceneViewEditorService$WonderEditor = require("../../../../src/service/state/editor/view/sceneView/transform/rotation/SelectRotationGizmoSceneViewEditorService.js");
...
Wonder_jest.describe("init transform gizmos job", (function (param) {
        ...
        Wonder_jest.describe("create transform gizmos", (function (param) {
                ...
                Wonder_jest.describe("create translation gizmos", (function (param) {
                        beforeEach((function () {
                                return _prepareState(sandbox);
                              }));
                        Wonder_jest.describe("create three axis gizmos", (function (param) {
                                ...
                                Wonder_jest.describe("test each axis gizmo", (function (param) {
                                        return Wonder_jest.describe("test y axis gizmo", (function (param) {
                                ...
                                Wonder_jest.describe("test axis gizmo color", (function (param) {
                                ...
                                return Wonder_jest.describe("test axis gizmos->draw order", (function (param) {
                                              return Wonder_jest.describe("should draw z->y->x axis gizmo", (function (param) {
                        ...
                        return Wonder_jest.describe("create three plane gizmos", (function (param) {
                                      ...
                                      Wonder_jest.describe("test each plane gizmo", (function (param) {
                                              return Wonder_jest.describe("test xy plane gizmo", (function (param) {
                                      ...
                                      Wonder_jest.describe("test plane gizmo color", (function (param) {
                                      ...
                                      return Wonder_jest.describe("test plane gizmos->draw order", (function (param) {
                ...
                Wonder_jest.describe("create rotation gizmos", (function (param) {
                        beforeEach((function () {
                                return _prepareState(sandbox);
                              }));
                        return Wonder_jest.describe("create three circle gizmos", (function (param) {
                                      ...
                                      Wonder_jest.describe("test each circle gizmo", (function (param) {
                                              return Wonder_jest.describe("test xy circle gizmo", (function (param) {
                                      ...
                                      Wonder_jest.describe("test circle gizmo color", (function (param) {
                ...
                return Wonder_jest.describe("create scale gizmos", (function (param) {
                              beforeEach((function () {
                                      return _prepareState(sandbox);
                                    }));
                              Wonder_jest.describe("create three axis gizmos", (function (param) {
                              ...
                              return Wonder_jest.describe("create center box gizmo", (function (param) {
                                            ...
                                            return Wonder_jest.describe("test center box gizmos->draw order", (function (param) {
                                                          return Wonder_jest.test("should draw after axis gizmo", (function (param) {
                                                                        var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                        var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
        ...
        Wonder_jest.describe("test move translation plane gizmos", (function (param) {
                var _prepareState = function (sandbox) {
                ...
                return Wonder_jest.describe("move based on the camera pos in the local coordinate system of the current scene tree node", (function (param) {
        ...
        return Wonder_jest.describe("bind event", (function (param) {
                      ...
                      Wonder_jest.describe("bind point drag start event", (function (param) {
                              Wonder_jest.describe("test translation gizmo", (function (param) {
                                      ...
                                      Wonder_jest.describe("if mouse button isn't left button", (function (param) {
                                      ...
                                      Wonder_jest.describe("else if translation gizmo isn't render, not select gizmo", (function (param) {
                                              return Wonder_jest.describe("if not has current scene tree node", (function (param) {
                                      ...
                                      return Wonder_jest.describe("else", (function (param) {
                                                    ...
                                                    Wonder_jest.describe("if point down any axis, select that axis", (function (param) {
                                                            return Wonder_jest.describe("test point down x axis", (function (param) {
                                                                          return Wonder_jest.describe("should mark x axis selected", (function (param) {
                                                    ...
                                                    return Wonder_jest.describe("fix bug", (function (param) {
                                                                  return Wonder_jest.describe("\"select translation gizmo\" should intersect \"with mesh\" instead of \"with aabb\"", (function (param) {
                                                                                var prepareGameObject = function (sandbox) {
                              ...
                              Wonder_jest.describe("test rotation gizmo", (function (param) {
                                      ...
                                      Wonder_jest.describe("if circle gizmo is unused, not select it", (function (param) {
                                      ...
                                      Wonder_jest.describe("else if point down the not visible part of the circle gizmo, not select it", (function (param) {
                                      ...
                                      Wonder_jest.describe("else if point down any circle gizmo, select it", (function (param) {
                                              return Wonder_jest.describe("test point down xy circle gizmo", (function (param) {
                                                            Wonder_jest.describe("if point down", (function (param) {
                              ...
                              return Wonder_jest.describe("test scale gizmo", (function (param) {
                                            ...
                                            Wonder_jest.describe("else if scale gizmo isn't render, not select gizmo", (function (param) {
                                                    return Wonder_jest.describe("if not has current scene tree node", (function (param) {
                      ...
                      return Wonder_jest.describe("bind point drag over event", (function (param) {
                                    Wonder_jest.describe("test translation gizmo", (function (param) {
                                            Wonder_jest.test("if mouse button isn't left button, not affect gizmo", (function (param) {
                                                    ...
                                                    InitPickingJobTool$WonderEditor.triggerPicking(undefined, sandbox, 250, 100, /* () */0);
                                                    EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 260, 100, /* () */0);
                                                    EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(2, sandbox, 270, 100, /* () */0);
                                            ...
                                            Wonder_jest.describe("else", (function (param) {
                                                    return Wonder_jest.describe("affect gizmo", (function (param) {
                                                                  var _prepare = function (sandbox, prepareGameObjectFunc) {
                                                                    var gameObject1 = Curry._1(prepareGameObjectFunc, sandbox);
                                                                    InitPickingJobTool$WonderEditor.triggerPicking(undefined, sandbox, 250, 100, /* () */0);
                                                                    return gameObject1;
                                                                  };
                                                                  Wonder_jest.describe("test affect plane gizmos", (function (param) {
                                                                          return Wonder_jest.describe("test affect xy plane gizmo", (function (param) {
                                                                                        return Wonder_jest.describe("should move current scene tree node along the xy plane", (function (param) {
                                                                                                      return Wonder_jest.describe("test current scene tree node not rotate", (function (param) {
                                                                                                                    var prepareGameObject = function (sandbox) {
                                                                                                                      return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 200, 0, 0, /* tuple */[
                                                                                                                                  0.1,
                                                                                                                                  0.1,
                                                                  ...
                                                                  return Wonder_jest.describe("test affect axis gizmos", (function (param) {
                                                                                Wonder_jest.describe("test affect x axis", (function (param) {
                                                                                        Wonder_jest.describe("should move current scene tree node along the x axis", (function (param) {
                                                                                                Wonder_jest.describe("test current scene tree node not rotate", (function (param) {
                                                                                                        var prepareGameObject = function (sandbox) {
                                                                                                          return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 200, 0, 0, /* tuple */[
                                                                                                                      0,
                                                                                                                      0,
                                                                                                        ...
                                                                                                        Wonder_jest.test("\n            pick gameObject;\n            select x axis;\n            mouse move (10px, 20px);\n\n            gameObject should move (10px, 0px);\n            ", (function (param) {
                                                                                                                _prepare(sandbox, prepareGameObject);
                                                                                                                EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 260, 100, /* () */0);
                                                                                                                EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 270, 120, /* () */0);
                                                                                                                return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodePosition(/* () */0)), /* tuple */[
                                                                                                                            0.173,
                                                                                                                            0,
                                                                                                                            0
                                                                                                ...
                                                                                                return Wonder_jest.describe("test current scene tree node rotate", (function (param) {
                                                                                                              var prepareGameObject = function (sandbox) {
                                                                                                                return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 400, 0, 0, /* tuple */[
                                                                                                                            0,
                                                                                                                            16.180339813232422,
                                                                                                              ...
                                                                                                              return Wonder_jest.test("\n            pick gameObject;\n            select x axis;\n            mouse move (10px, 0px);\n\n            gameObject should move along +x axis;\n            ", (function (param) {
                                                                                                                            ...
                                                                                                                            EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 285, 165, /* () */0);
                                                                                                                            return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodePosition(/* () */0)), /* tuple */[
                                                                                                                                        0.22,
                                                                                                                                        0.089,
                                                                                                                                        -0.238
                                                                                        ...
                                                                                        return Wonder_jest.describe("should move translation whole gizmo along the x axis", (function (param) {
                                                                                                      var prepareGameObject = function (sandbox) {
                                                                                                        return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 200, 0, 0, /* tuple */[
                                                                                                                    0,
                                                                                                                    0,
                                                                                ...
                                                                                return Wonder_jest.describe("test current scene tree node has parent", (function (param) {
                                                                                              ...
                                                                                              return Wonder_jest.test("\n            create parent gameObject p1;\n            set p1->local position to (1.0, 0.0, 0.0);\n            set p1->local eulerAngles to (12.0, 22.0, 0.0);\n            add child gameObject c1;\n            set c1->local position to (-1.0, 0.0, 0.0);\n            set c1->local eulerAngles to (0.0, 23.0, 22.0);\n            pick c1;\n            select axis;\n            mouse move (10px, 0px);\n\n            c1 should move along axis in world coordinate system;\n            ", (function (param) {
                                                                                                            ...
                                                                                                            EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 280, 90, /* () */0);
                                                                                                            return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodePosition(/* () */0)), /* tuple */[
                                                                                                                        0.344,
                                                                                                                        -0.265,
                                                                                                                        0.707
                                            ...
                                            return Wonder_jest.describe("test refresh inspector", (function (param) {
                                                          var _prepare = function (sandbox) {
                                    ...
                                    Wonder_jest.describe("test rotation gizmo", (function (param) {
                                            ...
                                            Wonder_jest.describe("affect gizmo", (function (param) {
                                                    return Wonder_jest.describe("test affect circle gizmos", (function (param) {
                                                                  Wonder_jest.describe("test affect xy circle", (function (param) {
                                                                          Wonder_jest.describe("should rotate current scene tree node along the local z axis(compute the angle based on the point projected mouse to xy plane of the circle)", (function (param) {
                                                                          ...
                                                                          return Wonder_jest.describe("should rotate translation whole gizmo along the local z axis", (function (param) {
                                                                  ...
                                                                  Wonder_jest.describe("test affect xy+xz circle", (function (param) {
                                                                          return Wonder_jest.describe("should rotate current scene tree node along the local z and y axis", (function (param) {
                                                                                        return Wonder_jest.test("\n            pick gameObject;\n            select xy circle;\n            mouse move (30px, 0px);\n            select xz circle;\n            mouse move (0px, -20px);\n\n            gameObject should rotate;\n            ", (function (param) {
                                                                                                      _prepare(undefined, sandbox, /* () */0);
                                                                                                      EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 226, 172, /* () */0);
                                                                                                      EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 256, 172, /* () */0);
                                                                                                      EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 216, 218, /* () */0);
                                                                                                      EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 216, 198, /* () */0);
                                                                                                      return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeEulerAngles(/* () */0)), /* tuple */[
                                                                                                                  -0,
                                                                                                                  9.5,
                                                                                                                  -33.9
                                                                  ...
                                                                  return Wonder_jest.describe("fix bug", (function (param) {
                                                                                return Wonder_jest.describe("test camera is look at the negative plane of the circle", (function (param) {
                                                                                              return Wonder_jest.describe("test xy circle", (function (param) {
                                                                                                            return Wonder_jest.test("\n            pick gameObject;\n            select xy circle;\n            mouse move (30px, 0px);\n\n            gameObject should rotate;\n            ", (function (param) {
                                                                                                                          _prepare(/* tuple */[
                                                                                                                                -0.11191991716623306,
                                                                                                                                14.925893783569336,
                                                                                                                          ...
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 243, 172, /* () */0);
                                                                                                                          return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeEulerAngles(/* () */0)), /* tuple */[
                                                                                                                                      0,
                                                                                                                                      0,
                                                                                                                                      32.1
                                            ...
                                            return Wonder_jest.describe("test refresh inspector", (function (param) {
                                                          Wonder_jest.describe("if select any circle gizmo", (function (param) {
                                                          ...
                                                          return Wonder_jest.test("else, not refresh inspector", (function (param) {
                                                                        ...
                                                                        EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 20, 0, /* () */0);
                                                                        return Sinon.toCalledWith(/* array */[[
                                                                                      AppStore$WonderEditor.UpdateAction,
                                                                                      /* Update */[/* array */[/* Inspector */2]]
                                                                                    ]], Wonder_jest.Expect[/* not__ */24](Wonder_jest.Expect[/* expect */0](dispatchFuncStub)));
                                    ...
                                    return Wonder_jest.describe("test scale gizmo", (function (param) {
                                                  ...
                                                  Wonder_jest.describe("else", (function (param) {
                                                          return Wonder_jest.describe("affect gizmo", (function (param) {
                                                                        ...
                                                                        Wonder_jest.describe("test affect center box gizmos", (function (param) {
                                                                                return Wonder_jest.describe("should scale the same value for x,y,z together", (function (param) {
                                                                                              var prepareGameObject = function (sandbox) {
                                                                                                return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 200, 0, 0, /* tuple */[
                                                                                                            0.0,
                                                                                                            2.0,
                                                                                              ...
                                                                                              return Wonder_jest.describe("based on mouse location in view", (function (param) {
                                                                                                            Wonder_jest.test("if mouse move up, scale bigger", (function (param) {
                                                                                                                    _prepare(sandbox, prepareGameObject);
                                                                                                                    EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 100, /* () */0);
                                                                                                                    EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 250, 80, /* () */0);
                                                                                                                    return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeLocalScale(/* () */0)), /* tuple */[
                                                                                                                                1.5,
                                                                                                                                1.5,
                                                                                                                                1.5
                                                                                                            ...
                                                                                                            Wonder_jest.test("if mouse move down, scale smaller", (function (param) {
                                                                                                                    _prepare(sandbox, prepareGameObject);
                                                                                                                    EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 100, /* () */0);
                                                                                                                    EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 250, 120, /* () */0);
                                                                                                                    return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeLocalScale(/* () */0)), /* tuple */[
                                                                                                                                0.5,
                                                                                                                                0.5,
                                                                                                                                0.5
                                                                                                            ...
                                                                                                            return Wonder_jest.test("should avoid scale to 0", (function (param) {
                                                                                                                          _prepare(sandbox, prepareGameObject);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 100, /* () */0);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 210, 100, /* () */0);
                                                                        ...
                                                                        return Wonder_jest.describe("test affect axis gizmos", (function (param) {
                                                                                      return Wonder_jest.describe("test affect y axis", (function (param) {
                                                                                                    return Wonder_jest.describe("should scale current scene tree node in the y axis", (function (param) {
                                                                                                                  var prepareGameObject = function (sandbox) {
                                                                                                                    return InitTransformGizmosJobTool$WonderEditor.prepareOneGameObject(InitPickingJobTool$WonderEditor.createCube, sandbox, 500, 200, 0, 0, /* tuple */[
                                                                                                                                0,
                                                                                                                                0,
                                                                                                                  ...
                                                                                                                  Wonder_jest.test("\n            pick gameObject;\n            select y axis;\n            mouse move (0px, -5px);\n\n            gameObject should scale bigger in the y axis;\n            ", (function (param) {
                                                                                                                          ...
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 250, 85, /* () */0);
                                                                                                                          return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeLocalScale(/* () */0)), /* tuple */[
                                                                                                                                      1,
                                                                                                                                      1.5,
                                                                                                                                      1
                                                                                                                  ...
                                                                                                                  Wonder_jest.test("\n            pick gameObject;\n            select y axis;\n            mouse move (10px, -5px);\n\n            gameObject should scale to the same value as mouse move (0px, -5px);\n            ", (function (param) {
                                                                                                                          _prepare(sandbox, prepareGameObject);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 90, /* () */0);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 260, 85, /* () */0);
                                                                                                                          return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeLocalScale(/* () */0)), /* tuple */[
                                                                                                                                      1,
                                                                                                                                      1.5,
                                                                                                                                      1
                                                                                                                  ...
                                                                                                                  Wonder_jest.test("\n            pick gameObject;\n            select y axis;\n            mouse move (0px, +5px);\n\n            gameObject should scale smaller in the y axis;\n            ", (function (param) {
                                                                                                                          _prepare(sandbox, prepareGameObject);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 90, /* () */0);
                                                                                                                          EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 250, 95, /* () */0);
                                                                                                                          return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](InitTransformGizmosJobTool$WonderEditor.getCurrentSceneTreeNodeLocalScale(/* () */0)), /* tuple */[
                                                                                                                                      1,
                                                                                                                                      0.5,
                                                                                                                                      1
                                                                                                                  ...
                                                                                                                  return Wonder_jest.test("\n            pick gameObject;\n            select y axis;\n            mouse move to the position of the whole scale gizmo;\n\n            gameObject should scale to 0.001 in the y axis;\n            ", (function (param) {
                                                                                                                                _prepare(sandbox, prepareGameObject);
                                                                                                                                EventTransformGizmosTool$WonderEditor.triggerMouseDown(undefined, sandbox, 250, 90, /* () */0);
                                                                                                                                EventTransformGizmosTool$WonderEditor.triggerFirstMouseDragOverEvent(undefined, sandbox, 250, 100, /* () */0);
                                                                                                                                var partial_arg = StateLogicService$WonderEditor.getEditorState(SceneTreeEditorService$WonderEditor.unsafeGetCurrentSceneTreeNode);
                                                                                                                                return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](Vector3Service$WonderEditor.truncate(3, StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                                                                                                                                                          return TransformGameObjectEngineService$WonderEditor.getLocalScale(partial_arg, param);
                                                                                                                                                        })))), /* tuple */[
