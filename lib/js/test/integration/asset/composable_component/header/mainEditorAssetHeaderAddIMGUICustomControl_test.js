...
var IMGUICustomControlNodeNameAssetService$WonderEditor = require("../../../../../src/service/record/editor/asset/IMGUICustomControlNodeNameAssetService.js");
...
Wonder_jest.describe("MainEditorAssetHeader->add imgui custom control", (function (param) {
        ...
        return Wonder_jest.describe("test name", (function (param) {
                      return Wonder_jest.describe("name should be unique in imgui custom control assets", (function (param) {
                                    return Wonder_jest.test("test add imgui custom control asset in different folders", (function (param) {
                                                  var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                  MainEditorAssetTreeTool$WonderEditor.Select[/* selectFolderNode */1](Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData), undefined, /* () */0);
                                                  MainEditorAssetHeaderOperateNodeTool$WonderEditor.addIMGUICustomControl(undefined, undefined, /* () */0);
                                                  ...
                                                  return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEditorState((function (param) {
                                                                        return IMGUICustomControlNodeAssetEditorService$WonderEditor.getNodeName(addedNodeId, param);
                                                                      }))), MainEditorAssetNameTool$WonderEditor.buildUniqueName(IMGUICustomControlNodeNameAssetService$WonderEditor.getNewName(/* () */0)));
                                                }));
                                  }));
                    }));
      }));
