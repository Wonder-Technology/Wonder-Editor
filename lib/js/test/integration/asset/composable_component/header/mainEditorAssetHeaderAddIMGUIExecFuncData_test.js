...
var IMGUIExecFuncDataNodeNameAssetService$WonderEditor = require("../../../../../src/service/record/editor/asset/IMGUIExecFuncDataNodeNameAssetService.js");
...
Wonder_jest.describe("MainEditorAssetHeader->add imgui exec func data", (function (param) {
        ...
        return Wonder_jest.describe("test name", (function (param) {
                      return Wonder_jest.describe("name should be unique in imgui exec func data assets", (function (param) {
                                    return Wonder_jest.test("test add imgui exec func data asset in different folders", (function (param) {
                                                  var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                  MainEditorAssetTreeTool$WonderEditor.Select[/* selectFolderNode */1](Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData), undefined, /* () */0);
                                                  MainEditorAssetHeaderOperateNodeTool$WonderEditor.addIMGUIExecFuncData(undefined, undefined, /* () */0);
                                                  ...
                                                  return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEditorState((function (param) {
                                                                        return IMGUIExecFuncDataNodeAssetEditorService$WonderEditor.getNodeName(addedNodeId, param);
                                                                      }))), MainEditorAssetNameTool$WonderEditor.buildUniqueName(IMGUIExecFuncDataNodeNameAssetService$WonderEditor.getNewName(/* () */0)));
                                                }));
                                  }));
                    }));
      }));
