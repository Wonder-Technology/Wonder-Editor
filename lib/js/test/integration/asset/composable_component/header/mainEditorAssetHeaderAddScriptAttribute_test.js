...
Wonder_jest.describe("MainEditorAssetHeader->add script attribute", (function (param) {
        ...
        return Wonder_jest.describe("test name", (function (param) {
                      return Wonder_jest.describe("name should be unique in script attribute assets", (function (param) {
                                    return Wonder_jest.test("test add script attributes in different folders", (function (param) {
                                                  var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                  MainEditorAssetTreeTool$WonderEditor.Select[/* selectFolderNode */1](Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */8][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData), undefined, /* () */0);
                                                  MainEditorAssetHeaderOperateNodeTool$WonderEditor.addScriptAttribute(undefined, undefined, /* () */0);
                                                  ...
                                                  MainEditorAssetHeaderOperateNodeTool$WonderEditor.addScriptAttribute(undefined, undefined, /* () */0);
                                                  return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](ScriptAttributeNodeAssetService$WonderEditor.getNodeName(StateLogicService$WonderEditor.getEditorState((function (param) {
                                                                            return OperateTreeAssetEditorService$WonderEditor.unsafeFindNodeById(addedNodeId, param);
                                                                          })))), MainEditorAssetNameTool$WonderEditor.buildUniqueName(ScriptAttributeNodeNameAssetService$WonderEditor.getNewAttributeName(/* () */0)));
                                                }));
                                  }));
                    }));
      }));
