...
Wonder_jest.describe("MainEditorAssetHeader->remove script event function", (function (param) {
        ...
        Wonder_jest.describe("\n        select script event function;\n        click remove-button;\n            ", (function (param) {
                return Wonder_jest.test("should remove it from assetTreeRoot", (function (param) {
                              var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* ScriptEventFunction */4][/* buildOneScriptEventFunctionAssetTree */0], /* () */0);
                              MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeScriptEventFunctionNode(undefined, undefined, Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* ScriptEventFunction */4][/* getFirstScriptEventFunctionNodeId */2], assetTreeData), /* () */0);
        ...
        return Wonder_jest.describe("should remove from script components", (function (param) {
                      ...
                      return Wonder_jest.test("test", (function (param) {
                                    ...
                                    MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeScriptEventFunctionNode(undefined, undefined, addedNodeId, /* () */0);
