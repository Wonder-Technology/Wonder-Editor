...
function addGeometryInCamera() {
  var cameraComponentCount = ComponentDomTool$WonderEditor.getCameraComponentCount(/* () */0);
  var meshCategoryDomIndex = ComponentDomTool$WonderEditor.getMeshCategoryDomIndex(/* () */0);
  var geometryTypeDomIndex = ComponentDomTool$WonderEditor.getGeometryTypeDomIndex(/* () */0);
  return OperateComponentEventTool$WonderEditor.addComponentIntoCurrentGameObject(cameraComponentCount, meshCategoryDomIndex, geometryTypeDomIndex);
}
