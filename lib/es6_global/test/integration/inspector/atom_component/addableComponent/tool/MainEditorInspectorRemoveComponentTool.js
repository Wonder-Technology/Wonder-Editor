...
function removeDirectionLightComponent($staropt$star, $staropt$star$1, $staropt$star$2, _) {
...
function removeCameraGroupComponent($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  var gameObject = $staropt$star$2 !== undefined ? $staropt$star$2 : GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0);
  return _removeComponent(/* tuple */[
...
function removeGeometryComponent($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  var gameObject = $staropt$star$2 !== undefined ? $staropt$star$2 : GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0);
  return _removeComponent(/* tuple */[
...
function removeRenderGroupComponent($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  var gameObject = $staropt$star$2 !== undefined ? $staropt$star$2 : GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0);
  return _removeComponent(/* tuple */[
...
function removeArcballCameraControllerComponent($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  var gameObject = $staropt$star$2 !== undefined ? $staropt$star$2 : GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0);
  return _removeComponent(/* tuple */[
