...
describe("AddableComponent add component", (function (param) {
        ...
        describe("test gameObject add component workflow", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test add light component", (function (param) {
                        ...
                        describe("should re-init all light material components in the scene", (function (param) {
                                describe("test add direction light component", (function (param) {
                ...
                describe("test add cameraGroup component", (function (param) {
                        describe("test snapshot", (function (param) {
        ...
        describe("test camera add component", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test add geometry component", (function (param) {
                        describe("test snapshot", (function (param) {
                ...
                describe("test add renderGroup component", (function (param) {
                        describe("test snapshot", (function (param) {
                ...
                describe("test add arcballCamera component", (function (param) {
                        describe("test snapshot", (function (param) {
        ...
        describe("deal with specific case", (function (param) {
                ...
                describe("test InspectorAddComponentUtils addComponentByType function", (function (param) {
                        return Wonder_jest.test("test add unaddable component should throw error", (function (param) {
                                      ...
                                      InspectorAddComponentUtils$WonderEditor.addComponentByType(/* SourceInstance */6, GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0), /* tuple */[
                ...
                describe("test InspectorHasComponentUtils isHasSpecificComponentByType", (function (param) {
                        return Wonder_jest.test("test has sourceInstance component, should throw error", (function (param) {
                                      ...
                                      StateLogicService$WonderEditor.getStateToGetData((function (param) {
                                              return InspectorHasComponentUtils$WonderEditor.isHasSpecificComponentByType(/* SourceInstance */6, partial_arg, param);
                                            }));
                                      return ConsoleTool$WonderEditor.judgeError("inspectorComponentType", errorStub);
                                    }));
                      }));
