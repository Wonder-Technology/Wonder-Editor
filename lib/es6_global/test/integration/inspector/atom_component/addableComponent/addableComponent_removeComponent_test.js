...
describe("AddableComponent remove component", (function (param) {
        ...
        describe("test remove directionLight gameObject component", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test remove light component", (function (param) {
                        ...
                        describe("should re-init all light material components in the scene", (function (param) {
                                describe("test remove direction light component", (function (param) {
        ...
        describe("test remove box gameObject component", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test remove geometry component", (function (param) {
                        describe("test snapshot", (function (param) {
                        ...
                        describe("test logic", (function (param) {
                                ...
                                return Wonder_jest.test("test click remove geometry component, current gameObject shouldn't has it", (function (param) {
                                              MainEditorInspectorRemoveComponentTool$WonderEditor.removeGeometryComponent(undefined, undefined, undefined, /* () */0);
                                              var partial_arg = GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0);
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                                                                    return GameObjectComponentEngineService$WonderEditor.hasGeometryComponent(partial_arg, param);
                ...
                describe("test remove renderGroup component", (function (param) {
                        describe("test snapshot", (function (param) {
                        ...
                        describe("test logic", (function (param) {
                                ...
                                describe("test click remove renderGroup component", (function (param) {
        ...
        describe("test remove camera gameObject component", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test remove arcballCamera component", (function (param) {
                        beforeEach((function (param) {
        ...
        describe("deal with specific case", (function (param) {
                ...
                describe("test InspectorRemoveComponentUtils removeComponentByType function", (function (param) {
