...
describe("MainEditorInspector", (function () {
        ...
        describe("test should update", (function () {
                ...
                return Wonder_jest.test("else, should not update", (function () {
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](MainEditorInspector$WonderEditor.shouldUpdate(OldNewSelfTool$WonderEditor.buildNewSelf(/* record */[/* updateTypeArr : array */[/* SceneTree */4]]))), false);
                            }));
              }));
