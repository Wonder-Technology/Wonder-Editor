...
describe("MainEditorInspector", (function (param) {
        ...
        describe("change source to show it's inspector", (function (param) {
                ...
                describe("else set currentSelectSource is SceneTree", (function (param) {
                        beforeEach((function (param) {
                ...
                describe("else set currentSelectSource is Asset", (function (param) {
                        beforeEach((function (param) {
                                return StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
