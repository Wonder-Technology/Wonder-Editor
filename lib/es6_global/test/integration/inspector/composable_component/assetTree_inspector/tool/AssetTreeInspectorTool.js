...
function renameAssetTextureNode($staropt$star, $staropt$star$1, nodeId, name, _) {
...
function renameAssetMaterialNode($staropt$star, $staropt$star$1, nodeId, name, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  return _renameAssetNode(/* tuple */[
              store,
...
function renameAssetFolderNode($staropt$star, $staropt$star$1, nodeId, name, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  return _renameAssetNode(/* tuple */[
              store,
...
function reducer($staropt$star, $staropt$star$1, nodeId, nodeType, action, state, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
