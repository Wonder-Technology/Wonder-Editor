...
function _getTriggerRenameInput(domChildren) {
  ...
  var texArticle = ArrayService$WonderEditor.unsafeGetNth(0, array);
  var array$1 = texArticle.children;
  var div = ArrayService$WonderEditor.unsafeGetNth(0, array$1);
  var array$2 = div.children;
  var renameDiv = ArrayService$WonderEditor.unsafeGetNth(2, array$2);
  var array$3 = renameDiv.children;
  var renameArticle = ArrayService$WonderEditor.unsafeGetNth(0, array$3);
  var array$4 = renameArticle.children;
  return ArrayService$WonderEditor.unsafeGetNth(1, array$4);
}
...
function triggerChangeWrapEvent(index, value, domChildren) {
  var article = ArrayService$WonderEditor.unsafeGetNth(0, domChildren);
  var array = article.children;
  var textureArticle = ArrayService$WonderEditor.unsafeGetNth(0, array);
  var array$1 = textureArticle.children;
  var div = ArrayService$WonderEditor.unsafeGetNth(0, array$1);
  var array$2 = div.children;
  var selectDiv = ArrayService$WonderEditor.unsafeGetNth(index, array$2);
  var array$3 = selectDiv.children;
  var selectArticle = ArrayService$WonderEditor.unsafeGetNth(0, array$3);
  var array$4 = selectArticle.children;
  var select = ArrayService$WonderEditor.unsafeGetNth(1, array$4);
