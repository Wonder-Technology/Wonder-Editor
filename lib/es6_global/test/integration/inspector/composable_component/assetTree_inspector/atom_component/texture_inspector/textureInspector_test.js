...
describe("texture inspector", (function () {
        ...
        describe("prepare currentSelectSource", (function () {
                ...
                describe("test texture inspector->show default value", (function () {
                ...
                describe("test texture rename", (function () {
                        describe("test rename to specific name", (function () {
                                return Wonder_jest.test("test snapshot", (function () {
                                              var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* buildOneTextureAssetTree */0], /* () */0);
                                              AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetTextureNode */1](undefined, undefined, Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* getFirstTextureNodeId */2], assetTreeData), "newTextureName", /* () */0);
                ...
                describe("test texture change wrap", (function () {
                        describe("test set wrapS to Repeat", (function () {
                                var _prepareAndExec = function () {
                                  ...
                                  TextureInspectorTool$WonderEditor.changeWrapS(MainEditorAssetNodeTool$WonderEditor.getTextureComponentFromNodeId(Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* getFirstTextureNodeId */2], assetTreeData)), wrapRepeatType);
                                  return /* tuple */[
                                ...
                                Wonder_jest.test("set wrapS", (function () {
                ...
                describe("test texture change filter", (function () {
                        describe("test set MagFilter", (function () {
                                var _prepareAndExec = function () {
                                  var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* buildOneTextureAssetTree */0], /* () */0);
                                  var filterNearestType = TextureInspectorTool$WonderEditor.getFilterNearestType(/* () */0);
                                  var nodeId = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* getFirstTextureNodeId */2], assetTreeData);
                                  TextureInspectorTool$WonderEditor.changeMagFilter(MainEditorAssetTextureNodeTool$WonderEditor.getTextureComponent(nodeId, StateEditorService$WonderEditor.getState(/* () */0)), filterNearestType);
                                  return /* tuple */[
                                          MainEditorAssetNodeTool$WonderEditor.getTextureComponentFromNodeId(nodeId),
                                          filterNearestType
                                        ];
                                };
                                Wonder_jest.test("set magFilter", (function () {
                                        var match = _prepareAndExec(/* () */0);
                                        var textureComponent = match[0];
                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                        ...
                        describe("test set MinFilter to Nearest_mipmap_linear", (function () {
                                var _prepareAndExec = function () {
                                  ...
                                  var nodeId = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* getFirstTextureNodeId */2], assetTreeData);
                                  TextureInspectorTool$WonderEditor.changeMinFilter(MainEditorAssetNodeTool$WonderEditor.getTextureComponentFromNodeId(Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */2][/* getFirstTextureNodeId */2], assetTreeData)), filterLinearMipmapLinearType);
                                  return /* tuple */[
                                          MainEditorAssetNodeTool$WonderEditor.getTextureComponentFromNodeId(nodeId),
                                ...
                                Wonder_jest.test("set minFilter", (function () {
                                        var match = _prepareAndExec(/* () */0);
                                        var textureComponent = match[0];
                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
