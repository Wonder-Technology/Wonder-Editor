        ...
        describe("prepare currentSelectSource", (function () {
                ...
                describe("test texture rename", (function () {
                        ...
                        return Wonder_jest.test("if rename to the existed name in the same dir, should fail", (function (param) {
                                      ...
                                      AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetTextureNode */1](undefined, undefined, firstTextureNodeId, newName, /* () */0);
                                      var texture2OldName = MainEditorAssetTextureNodeTool$WonderEditor.getTextureName(secondTextureNodeId, undefined, undefined, /* () */0);
                                      AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetTextureNode */1](undefined, undefined, secondTextureNodeId, newName, /* () */0);
