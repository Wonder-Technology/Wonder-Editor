        ...
        describe("prepare currentSelectSource", (function () {
                ...
                describe("test rename folder node", (function () {
                        Wonder_jest.test("test rename to specific name", (function (param) {
                                ...
                                AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, nodeId, "mickeyFolder", /* () */0);
                        ...
                        describe("test the root folder can't be rename", (function () {
                                return Wonder_jest.test("the root treeNode->rename-input->disabled should be true", (function (param) {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](AssetTreeInspectorTool$WonderEditor.Rename[/* isFolderNameDisabled */5](nodeId)), true);
                                            }));
                              }));
                        describe("test rename asset tree children node", (function () {
                                describe("if node has ext name", (function () {
                                        ...
                                        return Wonder_jest.test("if rename success, the newName should include ext name", (function (param) {
                                                      var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */5][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                      var nodeId = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */5][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData);
                                                      AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, nodeId, "folder.aaa", /* () */0);
                                                      MainEditorAssetTreeTool$WonderEditor.Select[/* selectFolderNode */1](nodeId, undefined, /* () */0);
