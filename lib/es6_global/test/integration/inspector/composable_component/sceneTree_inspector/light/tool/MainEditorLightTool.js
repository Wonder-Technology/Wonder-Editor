...
function trigerChangeLightTypeEvent(value, domChildren) {
  var selectDiv = ArrayService$WonderEditor.getNth(0, domChildren);
...
function _getComponentInputByIndex(index, domChildren) {
  var div = ArrayService$WonderEditor.getNth(index, domChildren);
  var array = div.children;
  var article = ArrayService$WonderEditor.getNth(0, array);
  var array$1 = article.children;
  var inputArticle = ArrayService$WonderEditor.getNth(0, array$1);
