...
describe("MainEditorLight component", (function () {
        ...
        describe("test set currentSceneTreeNode", (function () {
                                ...
                                describe("test change direction light to be point light", (function () {
                                        return Wonder_jest.test("test\n               glsl->DIRECTION_LIGHTS_COUNT should - 1;\n               glsl->POINT_LIGHTS_COUNT should + 1;", (function () {
                                                      ...
                                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                      ...
                                                                      GLSLToolEngine$WonderEditor.contain(GLSLToolEngine$WonderEditor.getVsSource(editGlShaderSource), "#define POINT_LIGHTS_COUNT 1"),
                                                                      GLSLToolEngine$WonderEditor.contain(GLSLToolEngine$WonderEditor.getFsSource(runGlShaderSource), "#define POINT_LIGHTS_COUNT 1")
                                                                    ]), /* tuple */[
                                                                  true,
                                                                  true,
                                                                  true,
                ...
                describe("deal with specific caase", (function () {
                        return Wonder_jest.test("test getLightTypeByGameObject should throw error when gameObject haven't light ", (function () {
                                      return Wonder_jest.Expect[/* toThrowMessageRe */21]((/getLightTypeByGameObject/img), Wonder_jest.Expect[/* expect */0]((function () {
