                                ...
                                describe("test engine ", (function () {
                                        ...
                                        return Wonder_jest.testPromise("test upload texture;\n               drag texture to set gameObject material texture;", (function () {
                                                      ...
                                                      return MainEditorAssetTool$WonderEditor.fileLoad(TestTool$WonderEditor.getDispatch(/* () */0), BaseEventTool$WonderEditor.buildFileEvent(undefined, undefined, undefined, undefined, /* () */0)).then((function () {
                                                                    ...
                                                                    var engineStateToGetData = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                    var mapId = BasicMaterialEngineService$WonderEditor.unsafeGetBasicMaterialMap(GameObjectComponentEngineService$WonderEditor.unsafeGetBasicMaterialComponent(currentGameObject, engineStateToGetData), engineStateToGetData);
                ...
                describe("test set remove texture", (function () {
                        ...
                        describe("test logic", (function () {
                                var _getGameObjectMaterialMap = function (engineState, gameObject) {
                                  return BasicMaterialEngineService$WonderEditor.getBasicMaterialMap(GameObjectComponentEngineService$WonderEditor.unsafeGetBasicMaterialComponent(gameObject, engineState), engineState);
                                };
