...
describe("MainEditorGeometry component", (function (param) {
        ...
        describe("test set currentSceneTreeNode", (function (param) {
                describe("test change geometry", (function (param) {
                        describe("test snapshot", (function (param) {
                                describe("test show select geometry group widget", (function (param) {
                                        var _addNoTexCoordGeometryWDBGameObject = function (param) {
                                          ...
                                          MainEditorAssetWDBNodeTool$WonderEditor.addWDBNode(match[1], match[4], undefined, /* () */0);
                ...
                describe("test load asset wdb", (function (param) {
                        ...
                        Wonder_jest.testPromise("test select geometry group widget should show all geometry", (function (param) {
                        ...
                        return Wonder_jest.testPromise("test set new geometry should set into engineState", (function (param) {
                                      MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */0](/* () */0);
        ...
        describe("test select geometry group->show order", (function (param) {
