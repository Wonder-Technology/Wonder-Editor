...
function blurNear(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
...
function changeNearAndBlur(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  MainEditorCameraProjection$WonderEditor.Method[/* changeNear */1](cameraProjection, value);
  return blurNear(cameraProjection, value, store, dispatchFunc, /* () */0);
}
...
function blurFar(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
...
function changeFarAndBlur(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  MainEditorCameraProjection$WonderEditor.Method[/* changeFar */3](cameraProjection, value);
  return blurFar(cameraProjection, value, store, dispatchFunc, /* () */0);
}
...
function blurFovy(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
...
function changeFovyAndBlur(cameraProjection, value, $staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  MainEditorCameraProjection$WonderEditor.Method[/* changeFovy */5](cameraProjection, value);
  return blurFovy(cameraProjection, value, store, dispatchFunc, /* () */0);
}
