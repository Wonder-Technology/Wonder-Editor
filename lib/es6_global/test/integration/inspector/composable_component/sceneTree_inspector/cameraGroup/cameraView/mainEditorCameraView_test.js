...
describe("MainEditor CameraView", (function (param) {
        ...
        describe("test set currentSceneTreeNode to be camera", (function (param) {
                ...
                describe("test set current camera", (function (param) {
                        describe("test snapshot", (function (param) {
                                ...
                                return Wonder_jest.test("test set unactive camera to be currentCamera, the currentCamera->cameraView checkBox defaultChecked should == true and disabled should == true", (function (param) {
                                              MainEditorCameraViewTool$WonderEditor.setCurrentCamera(GameObjectTool$WonderEditor.getCurrentGameObjectBasicCameraView(/* () */0), Caml_option.some(MainEditorCameraViewTool$WonderEditor.buildEvent(true)), undefined, undefined, /* () */0);
                                              return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildCameraView(TestTool$WonderEditor.buildEmptyAppState(/* () */0)));
                                            }));
                              }));
