...
describe("MainEditorTransform scale", (function () {
        ...
        describe("deal with specific case", (function () {
                ...
                describe("the scale value in engineState can't be 0", (function () {
                        return Wonder_jest.test("if input 0, set origin value to engineState instead of 0", (function (param) {
                                      GameObjectTool$WonderEditor.getCurrentSceneTreeNodeTransform(/* () */0);
                                      var state = FloatInputTool$WonderEditor.buildState(undefined, "1.0", "0.", undefined, /* () */0);
                                      var reasonStateUpdate = ReactTool$WonderEditor.getUpdateState(FloatInputTool$WonderEditor.reducer(undefined, undefined, false, /* Blur */1, state, /* () */0));
                                      return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](reasonStateUpdate[/* inputValue */0]), "1.0");
                                    }));
                      }));
                return /* () */0;
              }));
