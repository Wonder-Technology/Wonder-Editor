...
describe("MainEditorTransform rotation", (function (param) {
        ...
        describe("test change rotation value", (function (param) {
                beforeEach((function (param) {
                ...
                describe("test change localEulerAngle x", (function (param) {
