...
function prepareMouseEvent(sandbox, viewWidth, viewHeight, offsetLeft, offsetTop, $staropt$star, _) {
...
function getCurrentSceneTreeNodePosition() {
  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
  var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
