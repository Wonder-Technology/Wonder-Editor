...
describe("test init camera controller job", (function () {
        ...
        describe("test bind for game view", (function () {
                var _setArballCameraControllerGameObjectToCurrentSceneTreeNode = function () {
                ...
                var _judgeShouldRemoveLocalEulerAngleData = function () {
                ...
                describe("if current scene tree node has arcballCameraController component", (function () {
                        ...
                        describe("trigger refresh_inspector event", (function () {
                                Wonder_jest.test("test bind point drag event", (function () {
                                        ...
                                        _prepareAndExec(/* tuple */[
                                              ...
                                              20
                                                ...
                                                EventTool$WonderEditor.triggerDomEvent("mousedown", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(pageX, pageY, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                                                EventTool$WonderEditor.triggerDomEvent("mousemove", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(pageX, pageY, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                                ...
                                return Wonder_jest.test("test bind point scale event", (function () {
                                              var dispatchFuncStub = ReactTool$WonderEditor.createDispatchFuncStub(sandbox);
                                              _prepareMouseEvent(sandbox, /* () */0);
                                              _prepareAndExec(/* tuple */[
                                                    60,
                                                    20
                                                      ...
                                                      MainEditorTransformTool$WonderEditor.setLocalEulerAngleData(/* () */0);
                                                      EventTool$WonderEditor.triggerDomEvent("mousedown", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(pageX, pageY, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                                                      EventTool$WonderEditor.triggerDomEvent("mousewheel", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(pageX, pageY, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                                                      return EventTool$WonderEditor.restore(/* () */0);
                                                    }));
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                              _judgeShouldRemoveLocalEulerAngleData(/* () */0),
                ...
                describe("test bind keydown event", (function () {
                        ...
                        describe("if current scene tree node has arcballCameraController component", (function () {
                                var _prepareAndExec = function (param) {
                                  ...
                                  EventTool$WonderEditor.triggerDomEvent("keydown", EventTool$WonderEditor.getKeyboardEventBindedDom(/* () */0), KeyboardEventTool$WonderEditor.buildKeyboardEvent(undefined, undefined, undefined, undefined, undefined, /* () */0));
                                  return EventTool$WonderEditor.restore(/* () */0);
                                };
                                return Wonder_jest.test("trigger refresh_inspector event", (function () {
                                              var dispatchFuncStub = ReactTool$WonderEditor.createDispatchFuncStub(sandbox);
