...
describe("set outline data job", (function () {
        ...
        Wonder_jest.test("gl context->stencil should be true", (function () {
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](ViewToolEngine$WonderEditor.unsafeGetContext(StateEngineService$WonderEditor.unsafeGetState(/* () */0))), /* record */[
                            /* alpha */true,
                            /* depth */true,
                            /* stencil */true,
                            /* antialias */true,
        ...
        describe("set outline data", (function () {
                describe("if current scene tree node exist", (function () {
                        Wonder_jest.test("set outline color", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData(JobDataEngineService$WonderEditor.getOutlineColor)), SetOutlineDataJobTool$WonderEditor.getOutlineColor(/* () */0));
                              }));
                        return Wonder_jest.test("set current scene tree node and its children to be gameObjects need drawOutline", (function () {
                                      StateLogicService$WonderEditor.getAndSetEngineState(MainUtils$WonderEditor._handleEngineState);
                                      ...
                                      StateLogicService$WonderEditor.getAndSetEngineState(DirectorToolEngine$WonderEditor.runWithDefaultTime);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData(SetOutlineDataJobTool$WonderEditor.getGameObjectsNeedDrawOutline)), /* array */[
                                                  firstCube,
                                                  secondCube
                                                ]);
                                    }));
                ...
                describe("else", (function () {
                        return Wonder_jest.test("set gameObjects need drawOutline to be empty", (function () {
                                      StateLogicService$WonderEditor.getAndSetEngineState(MainUtils$WonderEditor._handleEngineState);
                                      GameObjectTool$WonderEditor.setCurrentSceneTreeNode(StateLogicService$WonderEditor.getEngineStateToGetData(MainEditorSceneTool$WonderEditor.getFirstCube));
                                      StateLogicService$WonderEditor.getAndSetEngineState(DirectorToolEngine$WonderEditor.runWithDefaultTime);
