                        ...
                        describe("test components", (function () {
                                describe("add custom geometry component", (function () {
                                        return Wonder_jest.test("test vertices, indices", (function (param) {
                                                      ...
                                                      var indices = GeometryEngineService$WonderEditor.getGeometryIndices16(geometry, engineState);
        ...
        describe("add gameObjects to scene", (function () {
                describe("add one camera", (function () {
                        ...
                        return Wonder_jest.test("move camera", (function (param) {
                                      ...
                                      return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](TransformAPI$Wonderjs.getTransformLocalPosition(transform, engineState)), /* tuple */[
                                                  0,
                                                  0,
                                                  4
                                                ]);
