                ...
                describe("add cube", (function () {
                        describe("test components", (function () {
                                Wonder_jest.test("add material component", (function () {
                                        ...
                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectComponentEngineService$WonderEditor.hasLightMaterialComponent(cube, engineState)), true);
                                      }));
                                Wonder_jest.test("add meshRenderer component", (function () {
                                        var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                        var cube = MainEditorSceneTool$WonderEditor.getCubeInDefaultScene(engineState);
                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectComponentEngineService$WonderEditor.hasMeshRendererComponent(cube, engineState)), true);
                                      }));
                                describe("test geometry component", (function () {
                                        return Wonder_jest.test("add geometry component", (function () {
                                                      var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                      var cube = MainEditorSceneTool$WonderEditor.getCubeInDefaultScene(engineState);
                                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectComponentEngineService$WonderEditor.hasGeometryComponent(cube, engineState)), true);
                                                    }));
                                      }));
                                return /* () */0;
                              }));
