...
describe("test reallocate cpu memory job", (function () {
        ...
        describe("test redo-undo after reallocate", (function () {
                ...
                var _judge = function (uploadedWDBNodeId) {
                  ...
                  return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](GeometryEngineService$WonderEditor.getGeometryVertices(__x$1, engineState)), match[0]));
                };
                beforeAll((function () {
