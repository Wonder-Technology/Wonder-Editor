...
describe("update camera job", (function () {
        ...
        describe("update all arcballCameraControllers", (function () {
                return Wonder_jest.test("update undirty ones", (function (param) {
                              _prepareState(/* () */0);
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */25][/* <> */6], Wonder_jest.Expect[/* expect */0](StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
