...
describe("prepare render game view job", (function (param) {
        ...
        describe("test current camera", (function (param) {
                describe("if scene has active camera", (function (param) {
                        return Wonder_jest.test("active it", (function (param) {
                                      PrepareRenderViewJobTool$WonderEditor.prepare(_prepareState);
                                      StateLogicService$WonderEditor.getAndSetEngineState(DirectorToolEngine$WonderEditor.runWithDefaultTime);
                                      var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](OptionService$Wonderjs.unsafeGet(BasicCameraViewEngineService$WonderEditor.getActiveBasicCameraView(engineState))), PrepareRenderViewJobTool$WonderEditor.getSceneActivedBasicCameraView(engineState));
                                    }));
                      }));
                describe("else", (function (param) {
                        return Wonder_jest.test("unactive all cameras", (function (param) {
                                      ...
                                      StateLogicService$WonderEditor.getAndSetEngineState(DirectorToolEngine$WonderEditor.runWithDefaultTime);
                                      var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicCameraViewEngineService$WonderEditor.getActiveBasicCameraView(engineState)), undefined);
                                    }));
                      }));
                return /* () */0;
              }));
        ...
        describe("shouldn't render grid plane", (function (param) {
                var _prepareState = function (param) {
                ...
                return Wonder_jest.test("test not draw", (function (param) {
                              ...
                              StateLogicService$WonderEditor.getAndSetEngineState(DirectorToolEngine$WonderEditor.runWithDefaultTime);
                              return Sinon.toCalled(Wonder_jest.Expect[/* noT_ */22](Wonder_jest.Expect[/* expect */0](Sinon.withOneArg(2, drawElements))));
                            }));
              }));
        return /* () */0;
      }));
