...
describe("init event job", (function () {
        ...
        var _prepareMouseEvent = function (sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, _) {
          ...
          MouseEventTool$WonderEditor.prepareWithState(sandbox, StateEngineService$WonderEditor.unsafeGetState(/* () */0), offsetLeft, offsetTop, Js_primitive.some(offsetParent), undefined, /* () */0);
