...
describe("init event job", (function (param) {
        ...
        var _prepareMouseEvent = function (sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, param) {
          ...
          MouseEventTool$WonderEditor.prepareWithState(sandbox, StateEngineService$WonderEditor.unsafeGetState(/* () */0), offsetLeft, offsetTop, Caml_option.some(offsetParent), undefined, /* () */0);
        ...
        describe("bind dom event", (function (param) {
                describe("bind mouse event", (function (param) {
                        describe("bind contextmenu event", (function (param) {
                        ...
                        describe("bind mousedown event", (function (param) {
                                var _prepareAndExec = function (pageX, pageY, target) {
                                  ...
                                  EventTool$WonderEditor.triggerDomEvent("mousedown", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(pageX, pageY, undefined, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(target), /* () */0));
                                  EventTool$WonderEditor.restore(/* () */0);
                                  return /* tuple */[
                                          valueX,
                                          valueY
                                ...
                                describe("test set eventTarget to Other", (function (param) {
                                        ...
                                        describe("test loopBody", (function (param) {
                                                return Wonder_jest.test("if not run, not loopBody", (function (param) {
                                                              _prepareMouseEvent(sandbox, undefined, undefined, undefined, /* () */0);
                                ...
                                describe("test trigger in scene view", (function (param) {
                                        describe("test loopBody", (function (param) {
                                                Wonder_jest.test("if not run, loopBody", (function (param) {
                                                        _prepareMouseEvent(sandbox, undefined, undefined, undefined, /* () */0);
                                                        ControllerTool$WonderEditor.setIsRun(false);
                                        ...
                                        describe("test locationInView", (function (param) {
                                ...
                                describe("test trigger in game view", (function (param) {
                                        describe("test loopBody", (function (param) {
                        ...
                        describe("bind mousemove event", (function (param) {
                                ...
                                describe("test eventTarget is scene view", (function (param) {
                                        describe("test locationInView", (function (param) {
                                                describe("test view has no offsetParent", (function (param) {
                                ...
                                describe("test eventTarget is game view", (function (param) {
                                        describe("test locationInView", (function (param) {
                                                describe("test view has no offsetParent", (function (param) {
                                                        Wonder_jest.test("test trigger in scene view", (function (param) {
                                                                _prepareMouseEvent(sandbox, 1, 2, undefined, /* () */0);
                        ...
                        describe("bind mousedrag event", (function (param) {
                                describe("test eventTarget is game view", (function (param) {
                                        describe("test locationInView", (function (param) {
                                                describe("test view has no offsetParent", (function (param) {
                                                        return Wonder_jest.test("test trigger in scene view", (function (param) {
                                                                      _prepareMouseEvent(sandbox, 1, 2, undefined, /* () */0);
                                                                      var param$1 = /* tuple */[
                                                                        60,
                                                                        20
                                                                      ...
                                                                      EventTool$WonderEditor.triggerDomEvent("mousedown", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(param$1[0], param$1[1], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                                                                      EventTool$WonderEditor.triggerDomEvent("mousemove", EventTool$WonderEditor.getBody(/* () */0), MouseEventTool$WonderEditor.buildMouseEvent(param$2[0], param$2[1], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0));
                ...
                describe("bind keyboard event", (function (param) {
                        describe("bind keyup event", (function (param) {
                                ...
                                Wonder_jest.test("if is stop, loopBody", (function (param) {
                                ...
                                describe("test eventTarget is other", (function (param) {
                                        describe("do nothing", (function (param) {
                                                describe("test loopBody", (function (param) {
                                ...
                                describe("test eventTarget is game view", (function (param) {
                                        ...
                                        Wonder_jest.test("trigger keyup event", (function (param) {
                                                _prepareKeyboardEvent(sandbox, /* () */0);
                                        ...
                                        describe("trigger refresh_inspector event", (function (param) {
                                                return Wonder_jest.test("defer 0 ms to exec", (function (param) {
        ...
        describe("bind dom event to trigger point event", (function (param) {
                describe("bind mouse event to trigger point event", (function (param) {
                        ...
                        describe("test eventTarget is scene view", (function (param) {
                                describe("test loopBody", (function (param) {
                                        return Wonder_jest.test("if is stop, loopBody", (function (param) {
                                                      _prepareMouseEvent(sandbox, undefined, undefined, undefined, /* () */0);
                                                      ControllerTool$WonderEditor.setIsRun(false);
                                                      _prepareAndExec(EventEditorService$WonderEditor.getPointScaleEventName(/* () */0), /* tuple */[
                                                            10,
                        ...
                        describe("test eventTarget is game view", (function (param) {
                                describe("test loopBody", (function (param) {
                                        return Wonder_jest.test("if is stop, noT_ loopBody", (function (param) {
                                                      _prepareMouseEvent(sandbox, undefined, undefined, undefined, /* () */0);
                                                      ControllerTool$WonderEditor.setIsRun(false);
                                                      _prepareAndExec(EventEditorService$WonderEditor.getPointScaleEventName(/* () */0), /* tuple */[
                                                            60,
                                ...
                                Wonder_jest.test("trigger engine point event", (function (param) {
                                        _prepareMouseEvent(sandbox, undefined, undefined, undefined, /* () */0);
