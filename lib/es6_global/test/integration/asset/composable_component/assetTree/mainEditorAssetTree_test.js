...
describe("MainEditorAssetTree", (function (param) {
        ...
        describe("test set currentNode and currentNodeParent", (function (param) {
                describe("click assetTree node", (function (param) {
                        return Wonder_jest.test("currentNodeId and currentNodeParentId should be same", (function (param) {
        ...
        describe("test drag assetTreeNode to assetTreeNode", (function (param) {
                describe("test has children case", (function (param) {
                        describe("have first layer children", (function (param) {
                        ...
                        describe("have second layer children", (function (param) {
                                Wonder_jest.test("no drag", (function (param) {
        ...
        describe("test drag assetChildrenNode to assetTreeNode", (function (param) {
                Wonder_jest.test("test no drag", (function (param) {
                        Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* ThreeLayer */1][/* buildFourFolderAssetTree */0], /* () */0);
                        return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildAssetComponent(/* () */0));
                      }));
                Wonder_jest.test("test drag folder into it's parent's brother folder", (function (param) {
                        var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* ThreeLayer */1][/* buildFourFolderAssetTree */0], /* () */0);
        ...
        describe("test asse tree node->isShowChildren", (function (param) {
                ...
                describe("test drag treeNode to target treeNode", (function (param) {
                ...
                describe("test add treeNode to target treeNode", (function (param) {
        ...
        describe("test show order", (function (param) {
                beforeEach((function (param) {
