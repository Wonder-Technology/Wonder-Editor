...
describe("MainEditorAssetTree", (function () {
        ...
        describe("test show order", (function () {
                ...
                return Wonder_jest.test("sort the same layer folder by firstname alphabetically", (function (param) {
                              ...
                              AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, addedFolderNodeId2, "BFolder", /* () */0);
                              AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, addedFolderNodeId3, "ZFolder", /* () */0);
                              AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, addedFolderNodeId4, "AFolder", /* () */0);
                              return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildAssetTree(/* () */0));
                            }));
              }));
        describe("fix bug", (function () {
                describe("fix show children arrow", (function () {
