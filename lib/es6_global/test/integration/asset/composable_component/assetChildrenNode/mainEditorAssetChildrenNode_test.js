...
describe("MainEditorAssetChildrenNode", (function (param) {
        ...
        describe("test set current node", (function (param) {
                Wonder_jest.test("click texture file to be current node", (function (param) {
                ...
                describe("test click folder", (function (param) {
                        describe("test single click", (function (param) {
                                Wonder_jest.testPromise("test set folder to be current node", (function (param) {
                        ...
                        return Wonder_jest.testPromise("double click folder, set folder to be currentAssetNodeParent and currentNode(are the same)", (function (param) {
                                      Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                      var fakeDom = Curry._1(EventListenerTool$WonderEditor.stubGetElementByIdReturnFakeDom, Curry._1(EventListenerTool$WonderEditor.buildFakeDom, /* () */0));
                                      BuildComponentTool$WonderEditor.buildAssetChildrenNode(10, /* () */0);
                                      if (!class_tables$2[0]) {
        ...
        describe("test asse tree node->isShowChildren", (function (param) {
                describe("test double click folder", (function (param) {
