        ...
        describe("test set current node", (function () {
                Wonder_jest.test("click texture file to be current node", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                    ...
                                    MainEditorAssetNodeTool$WonderEditor.OperateTwoLayer[/* getFirstTextureNodeId */13](assetTreeDomRecord),
                                    /* Texture */2
                                  ]);
                      }));
                Wonder_jest.test("click json file to be current node", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                    ...
                                    MainEditorAssetNodeTool$WonderEditor.OperateTwoLayer[/* getFirstJsonNodeId */15](assetTreeDomRecord),
                                    /* Json */1
                                  ]);
                      }));
                                        ...
                                        return new Promise((function (resolve, _) {
                                                      return Curry._2(Timeout$WonderEditor.$$setTimeout, (function () {
                                                                    ...
                                                                    return resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                                    ...
                                                                                    MainEditorAssetNodeTool$WonderEditor.OperateTwoLayer[/* getSecondFolderNodeId */12](assetTreeDomRecord),
                                                                                    /* Folder */0
                                                                                  ]));
                                                                  }), 20);
                                                    }));
