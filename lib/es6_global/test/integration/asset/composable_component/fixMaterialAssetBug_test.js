...
describe("fix material asset bug", (function (param) {
        ...
        describe("fix bug", (function (param) {
                describe("fix change material type bug", (function (param) {
                        ...
                        describe("fix change gameObject->material->type bug", (function (param) {
                                describe("\n        add material m1;\n        select sceneTree->gameObject g1;\n        g1 change material to m1;\n        change g1->material->type to basicMaterial;\n        ", (function (param) {
                                        return Wonder_jest.test("m1->type should be basicMaterial", (function (param) {
                                                      ...
                                                      MainEditorMaterialTool$WonderEditor.changeMaterial(GameObjectTool$WonderEditor.getCurrentGameObjectLightMaterial(/* () */0), /* LightMaterial */1, match[/* materialComponent */2], /* LightMaterial */1, addedMaterialNodeId, gameObject, undefined, undefined, /* () */0);
                                                      MainEditorBasicMaterialTool$WonderEditor.changeMaterialTypeToBeBasicMaterial(undefined, undefined, /* () */0);
                                                      var match$1 = MaterialNodeMapAssetEditorService$WonderEditor.unsafeGetResult(addedMaterialNodeId, StateEditorService$WonderEditor.getState(/* () */0));
                                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](match$1[/* type_ */1]), /* BasicMaterial */0);
                                                    }));
                                      }));
                                describe("\n        add material m1;\n        select sceneTree->gameObject g1;\n        g1 change material to m1;\n        select sceneTree->gameObject g2;\n        g2 change material to m1;\n        change g1->material->type to basicMaterial;\n        change g1->material->type to lightMaterial;\n        ", (function (param) {
                                        return Wonder_jest.test("m1->type and g2->material->type should be lightMaterial", (function (param) {
                                                      ...
                                                      var match$2 = MaterialNodeMapAssetEditorService$WonderEditor.unsafeGetResult(match[2], StateEditorService$WonderEditor.getState(/* () */0));
                                                      var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                        ...
                        describe("fix change MaterialInspector->type bug", (function (param) {
                                ...
                                describe("fix name", (function (param) {
                                        beforeEach((function (param) {
                                                MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */0](/* () */0);
                                                return /* () */0;
                                              }));
                ...
                describe("\n        add material m1;\n        upload texture t1;\n        drag t1 to m1->diffuseMap;\n        remove t1 by remove texture asset;\n        ", (function (param) {
                        ...
                        return Wonder_jest.testPromise("m1->materialInspector->diffuseMap should be none", (function (param) {
                                      MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */0](/* () */0);
                                      var addedMaterialNodeId = MainEditorAssetIdTool$WonderEditor.getNewAssetId(undefined, /* () */0);
                                      MainEditorAssetHeaderOperateNodeTool$WonderEditor.addMaterial(undefined, undefined, /* () */0);
