        ...
        describe("\n        add material m1;\n        select sceneTree->gameObject g1;\n        g1 change material to m1;\n        remove m1;\n        ", (function () {
                ...
                describe("g1 should use default light material", (function () {
                        ...
                        return Wonder_jest.test("g1's material component shouldn't be m1", (function (param) {
                                      ...
                                      return Wonder_jest.Expect[/* toEqual */12](materialComponent, Wonder_jest.Expect[/* not__ */24](Wonder_jest.Expect[/* expect */0](GameObjectComponentEngineService$WonderEditor.unsafeGetLightMaterialComponent(gameObject1, engineState$1))));
                                    }));
                      }));
                return /* () */0;
              }));
