...
describe("MainEditorAssetHeader->load glb", (function (param) {
        ...
        describe("test load glb", (function (param) {
                beforeEach((function (param) {
                ...
                return Wonder_jest.testPromise("convert glb to wdb and load", (function (param) {
