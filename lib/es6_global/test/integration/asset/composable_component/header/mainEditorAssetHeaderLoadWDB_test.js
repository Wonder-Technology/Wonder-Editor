        ...
        describe("test load wdb", (function () {
                ...
                describe("extract assets from loaded wdb asset", (function () {
                        ...
                        describe("if wdb has no material", (function () {
                                ...
                                return Wonder_jest.testPromise("should has no extracted assets", undefined, (function (param) {
                        ...
                        describe("extract material assets", (function () {
                                describe("test asset tree", (function () {
                                        ...
                                        return Wonder_jest.testPromise("material asset should has unique name", undefined, (function (param) {
                                                      Curry._1(EventListenerTool$WonderEditor.stubGetElementByIdReturnFakeDom, Curry._1(EventListenerTool$WonderEditor.buildFakeDom, /* () */0));
                                ...
                                describe("test wdb asset->wdb gameObject->material", (function () {
                                        Wonder_jest.testPromise("wdb gameObject should use extraced material asset->materialComponent", undefined, (function (param) {
                                                return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                              var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                              var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                        ...
                                        return Wonder_jest.testPromise("if already has equaled material asset, wdb gameObject should use it", undefined, (function (param) {
                                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId1) {
                                                                    return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId2) {
                                                                                  var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                        ...
                        describe("extract texture assets", (function () {
                                ...
                                describe("test wdb asset->wdb gameObject->texture", (function () {
                                        Wonder_jest.testPromise("wdb gameObject should use extraced texture asset->textureComponent", undefined, (function (param) {
                                                return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                              var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                              var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                              var boxTexturedMeshGameObject = LoadWDBTool$WonderEditor.getBoxTexturedMeshGameObjectFromAssetNode(uploadedWDBNodeId, /* tuple */[
                                                              ...
                                                              return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](MainEditorAssetTextureNodeTool$WonderEditor.hasTextureComponent(diffuseMap, editorState)), true));
                                                            }));
                                              }));
                                        return Wonder_jest.testPromise("if already has equaled texture asset, wdb gameObject should use it", undefined, (function (param) {
                                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId1) {
                                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                    var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                    var boxTexturedMeshGameObject1 = LoadWDBTool$WonderEditor.getBoxTexturedMeshGameObjectFromAssetNode(uploadedWDBNodeId1, /* tuple */[
                                                                    ...
                                                                    return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId2) {
                                                                                  ...
                                                                                  return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                                                      ...
                                                                                                      ImmutableSparseMapService$WonderCommonlib.length(ImageDataMapAssetEditorService$WonderEditor.getValidValues(editorState))
                                                                                                    ]), /* tuple */[
                                                                                                  true,
                                                                                                  1,
                                                                                                  1
