...
describe("MainEditorAssetHeader->remove wdb", (function (param) {
        ...
        describe("drag wdb asset into scene;\n              select wdb to be currentNode;\n              click remove-button;\n              ", (function (param) {
                describe("test cloned gameObjects of the wdb asset", (function (param) {
                        Wonder_jest.testPromise("cloned gameObjects shouldn't be removed", (function (param) {
                        ...
                        describe("cloned gameObjects->geometrys should be disposed", (function (param) {
                                ...
                                Wonder_jest.testPromise("test engine", (function (param) {
                                ...
                                return Wonder_jest.testPromise("test snapshot", (function (param) {
                                              return _prepare((function (clonedGameObjectsWhoHasGeometryWhenCloned, engineState) {
                ...
                describe("dispose wdb asset gameObject", (function (param) {
                        Wonder_jest.testPromise("it's geometry should be disposed", (function (param) {
                        ...
                        describe("it's material should be removed", (function (param) {
                                return Wonder_jest.testPromise("the material asset related with the material component should exist", (function (param) {
                                              MainEditorSceneTool$WonderEditor.createDefaultSceneAndNotInit(sandbox);
                                              return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                            MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](uploadedWDBNodeId, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
                                                            MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeWDBNode(undefined, undefined, uploadedWDBNodeId, /* () */0);
                        ...
                        return Wonder_jest.testPromise("it should be disposed", (function (param) {
                                      MainEditorSceneTool$WonderEditor.createDefaultSceneAndNotInit(sandbox);
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                    MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](uploadedWDBNodeId, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
                                                    var editorState = StateEditorService$WonderEditor.getState(/* () */0);
        ...
        describe("fix bug", (function (param) {
                describe("the default geometry with wdb asset should be remove instead of dispose when remove wdb asset", (function (param) {
                ...
                describe("test with import package", (function (param) {
