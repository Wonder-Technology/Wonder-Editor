        ...
        describe("test remove tree node", (function () {
                ...
                describe("else", (function () {
                        ...
                        describe("test select file", (function () {
                                                ...
                                                describe("should remove it from engineState", (function () {
                                                        ...
                                                        describe("should remove it from scene->materials", (function () {
                                                                describe("test remove lightMaterial->diffuseMap", (function () {
                                                                        ...
                                                                        Wonder_jest.test("test one gameObject use one material", (function () {
                                                                                var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Texture */1][/* buildOneTextureAssetTree */0], /* () */0);
                                                                                _drag(assetTreeData);
                                                                        ...
                                                                        describe("test two gameObjects use one material", (function () {
                                                                                return Wonder_jest.test("test gameObjects are in scene", (function () {
                                ...
                                describe("test removed asset node, the id should be added into removedAssetIdArray", (function () {
                                        describe("test remove first folder", (function () {
                                                ...
                                                Wonder_jest.test("test add a new folder, use the removed id", (function () {
                                                        var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                        var removedFolderNodeId = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData);
                                                        MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeFolderNode(undefined, undefined, removedFolderNodeId, /* () */0);
                                                ...
                                                return Wonder_jest.test("test add two new folders, use the removed id and generate one new id", (function () {
                                                              var assetTreeData = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                                                              var removedFolderNodeId = Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* getFirstFolderNodeId */3], assetTreeData);
                                                              MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeFolderNode(undefined, undefined, removedFolderNodeId, /* () */0);
                                                              MainEditorAssetHeaderOperateNodeTool$WonderEditor.addFolder(undefined, undefined, /* () */0);
