                ...
                describe("test logic", (function () {
                        ...
                        describe("test should add into nodeMap", (function () {
                                describe("test imageNodeMap", (function () {
                                        Wonder_jest.testPromise("add image base64 to imageNodeMap", undefined, (function (param) {
                                                MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */1](/* () */0);
                                        ...
                                        return Wonder_jest.testPromise("test show texture image, get it base64 from imageNodeMap", undefined, (function (param) {
                                                      MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* buildEmptyAssetTree */1](/* () */0);
