...
describe("MainEditorAssetHeader->load texture", (function (param) {
        ...
        describe("test load texture", (function (param) {
                beforeEach((function (param) {
                ...
                return Wonder_jest.testPromise("set source name", (function (param) {
