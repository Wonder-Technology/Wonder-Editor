...
describe("MainEditorAssetHeader", (function () {
        ...
        beforeEach((function () {
                ...
                MainEditorSceneTool$WonderEditor.initStateAndGl(sandbox, undefined, /* () */0);
                ...
                describe("test snapshot", (function () {
                        describe("if not select specific treeNode", (function () {
                                return Wonder_jest.testPromise("load file should add into root node children", (function () {
                                              MainEditorAssetTool$WonderEditor.buildTwoLayerAssetTreeRoot(/* () */0);
                                              return MainEditorAssetHeader$WonderEditor.Method[/* _fileLoad */4](TestTool$WonderEditor.getDispatch(/* () */0), BaseEventTool$WonderEditor.buildFileEvent(undefined, undefined, undefined, undefined, /* () */0)).then((function () {
                        ...
                        describe("test should add into nodeMap", (function () {
                                describe("test imageBase64Map", (function () {
                                        Wonder_jest.testPromise("add image base64 to imageBase64Map", (function () {
                                                ...
                                                return MainEditorAssetHeader$WonderEditor.Method[/* _fileLoad */4](TestTool$WonderEditor.getDispatch(/* () */0), BaseEventTool$WonderEditor.buildFileEvent(undefined, imgBase64, undefined, undefined, /* () */0)).then((function () {
                                        ...
                                        return Wonder_jest.testPromise("test show texture image, get it base64 from imageBase64Map", (function () {
                                                      MainEditorAssetTool$WonderEditor.buildTwoLayerAssetTreeRoot(/* () */0);
                                                      return MainEditorAssetHeader$WonderEditor.Method[/* _fileLoad */4](TestTool$WonderEditor.getDispatch(/* () */0), BaseEventTool$WonderEditor.buildFileEvent(undefined, "newImgBase64", undefined, undefined, /* () */0)).then((function () {
                                                                    return Promise.resolve(ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildAssetComponent(/* () */0)));
                                                                  }));
                                                    }));
                                      }));
                                ...
                                describe("test jsonNodeMap", (function () {
                                        return Wonder_jest.testPromise("add json string to jsonNodeMap", (function () {
                                                      ...
                                                      return MainEditorAssetHeader$WonderEditor.Method[/* _fileLoad */4](TestTool$WonderEditor.getDispatch(/* () */0), BaseEventTool$WonderEditor.buildFileEvent(undefined, undefined, jsonName, "I'm the result", /* () */0)).then((function () {
