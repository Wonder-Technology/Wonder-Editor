...
describe("MainEditorAssetHeader->add folder", (function (param) {
        ...
        describe("if not select specific treeNode, add folder into root treeNode", (function (param) {
                describe("should add folder into root treeNode", (function (param) {
        ...
        describe("else", (function (param) {
                describe("add folder into specific treeNode", (function (param) {
        ...
        describe("test name", (function (param) {
                Wonder_jest.test("test add the same name folder, the name should add postfix", (function (param) {
                        Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* buildOneFolderAssetTree */0], /* () */0);
                        MainEditorAssetHeaderOperateNodeTool$WonderEditor.addFolder(undefined, undefined, /* () */0);
                        MainEditorAssetHeaderOperateNodeTool$WonderEditor.addFolder(undefined, undefined, /* () */0);
                        MainEditorAssetHeaderOperateNodeTool$WonderEditor.addFolder(undefined, undefined, /* () */0);
