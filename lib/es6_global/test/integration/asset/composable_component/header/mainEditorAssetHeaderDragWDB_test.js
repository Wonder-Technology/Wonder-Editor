        ...
        describe("test drag wdb to scene tree", (function () {
                describe("test wdb has direction and point light gameObjects", (function () {
                        ...
                        describe("should init cloned gameObjects", (function () {
                                return Wonder_jest.testPromise("glsl->direction,point light count should + 1", (function () {
                                              return _test(sandbox, (function (shaderSourceCountBeforeDrag, _, glShaderSource) {
                        ...
                        describe("should reinit origin gameObjects in scene", (function () {
                                return Wonder_jest.testPromise("glsl->direction,point light count should + 1", (function () {
                                              return _test(sandbox, (function (shaderSourceCountBeforeDrag, _, glShaderSource) {
                        ...
                        Wonder_jest.testPromise("should reinit cloned gameObjects", (function () {
                                return _test(sandbox, (function (shaderSourceCountBeforeDrag, shaderSourceCountAfterDrag, _) {
                        ...
                        return Wonder_jest.testPromise("should clear shader cache", (function () {
                                      return _test(sandbox, (function (_, _$1, _$2) {
                        ...
                        describe("check light count before drag", (function () {
                                describe("if light count will exceed max count after drag, warn", (function () {
                                        ...
                                        describe("test direction light", (function () {
                                                Wonder_jest.testPromise("test not exceed", (function () {
                                                ...
                                                return Wonder_jest.testPromise("test exceed", (function () {
                                                              return _test((function (editorState, engineState) {
                                                                            var match = PrimitiveEngineService$WonderEditor.createDirectionLight(editorState, engineState);
                                                                            var match$1 = PrimitiveEngineService$WonderEditor.createDirectionLight(match[0], match[1]);
                ...
                describe("test drag wdb to gameObject", (function () {
                        return Wonder_jest.testPromise("should add to target sceneTree node's children", (function () {
                                      ...
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(directionPointLightsAndCubeWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                    MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](uploadedWDBNodeId, MainEditorSceneTool$WonderEditor.getFirstCube(engineState), undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
