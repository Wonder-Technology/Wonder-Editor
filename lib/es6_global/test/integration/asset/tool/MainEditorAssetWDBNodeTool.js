...
function getWDBGameObject(nodeId, editorState) {
  return SparseMapService$WonderCommonlib.unsafeGet(nodeId, WDBNodeMapAssetEditorService$WonderEditor.getWDBNodeMap(editorState))[/* wdbGameObject */2];
}

var getAllWDBGameObjects = GeometryAssetLogicService$WonderEditor.getAllWDBGameObjects;

function addWDBNode(gameObject, $staropt$star, $staropt$star$1, param) {
  ...
  var __x = WDBNodeMapAssetEditorService$WonderEditor.buildWDBNodeResult(name, undefined, gameObject);
