...
function loadOneTexture($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
  ...
  return Curry._3(AssetHeaderFileLoadEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0], /* tuple */[
                store,
                dispatchFunc
              ], Zip$WonderBsJszip.create, BaseEventTool$WonderEditor.buildOneTextureFileEvent(imgName, imgSrc, /* () */0)).then((function () {
                return Promise.resolve(uploadedTextureNodeId);
              }));
}

function loadOneWDB(arrayBuffer, $staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  ...
  return Curry._3(AssetHeaderFileLoadEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0], /* tuple */[
                store,
                dispatchFunc
              ], Zip$WonderBsJszip.create, BaseEventTool$WonderEditor.buildWDBFileEvent(fileName, arrayBuffer)).then((function () {
                return Promise.resolve(uploadedWDBNodeId);
              }));
}

function loadOneGLB(arrayBuffer, $staropt$star, $staropt$star$1, $staropt$star$2, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  ...
  return Curry._3(AssetHeaderFileLoadEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0], /* tuple */[
                store,
                dispatchFunc
              ], Zip$WonderBsJszip.create, BaseEventTool$WonderEditor.buildGLBFileEvent(fileName, arrayBuffer)).then((function () {
                return Promise.resolve(uploadedWDBNodeId);
              }));
}

function loadOneGLTFZip(_, createJsZipFunc, $staropt$star, $staropt$star$1, $staropt$star$2, _$1) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  ...
  return Curry._3(AssetHeaderFileLoadEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0], /* tuple */[
                store,
                dispatchFunc
              ], createJsZipFunc, BaseEventTool$WonderEditor.buildGLTFZipFileEvent(fileName)).then((function () {
                return Promise.resolve(uploadedWDBNodeId);
              }));
}
