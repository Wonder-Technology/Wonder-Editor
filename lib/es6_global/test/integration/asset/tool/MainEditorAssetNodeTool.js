...
function getAddedFirstFolderNodeDomIndexForAssetTree(assetTreeDomRecord) {
  return assetTreeDomRecord[/* firstLayer */1][/* folderDomIndexArr */1].length + 1 | 0;
}

function getAddedSecondNodeDomIndex(assetTreeDomRecord) {
  return assetTreeDomRecord[/* firstLayer */1][/* length */0] + 2 | 0;
}

function getAddedFirstNodeDomIndex(assetTreeDomRecord) {
  return assetTreeDomRecord[/* firstLayer */1][/* length */0] + 1 | 0;
}

function getFirstFolderDomIndexForAssetChildren(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* firstLayer */1][/* folderDomIndexArr */1]) - 1 | 0;
}

function getFirstFolderDomIndexForAssetTree(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* firstLayer */1][/* folderDomIndexArr */1]);
}

function getSecondFolderDomIndexForAssetChildren(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* firstLayer */1][/* folderDomIndexArr */1]) - 1 | 0;
}

function getSecondFolderDomIndexForAssetTree(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* firstLayer */1][/* folderDomIndexArr */1]);
}

function getFirstTextureDomIndex(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* firstLayer */1][/* textureData */3][/* domIndexArr */0]) - 1 | 0;
}

function getSecondTextureDomIndex(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* firstLayer */1][/* textureData */3][/* domIndexArr */0]) - 1 | 0;
}

function getFirstJsonDomIndex(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* firstLayer */1][/* jsonDomIndexArr */2]) - 1 | 0;
}

function getRootFolderNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* treeNodeIdData */2][/* folderNodeIdArr */0]);
}

function getFirstFolderNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* treeNodeIdData */2][/* folderNodeIdArr */0]);
}

function getSecondFolderNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(2, assetTreeDomRecord[/* treeNodeIdData */2][/* folderNodeIdArr */0]);
}

function getFirstTextureNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* treeNodeIdData */2][/* textureNodeIdArr */2]);
}

function getSecondTextureNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* treeNodeIdData */2][/* textureNodeIdArr */2]);
}

function getFirstJsonNodeId(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* treeNodeIdData */2][/* jsonNodeIdArr */1]);
}
...
function getSecondLayserFirstFolderDomIndexForAssetTree(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* secondLayer */2][/* folderDomIndexArr */2]);
}

function getSecondLayserFirstFolderDomIndexForAssetChildren(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* secondLayer */2][/* folderDomIndexArr */2]) - 1 | 0;
}

function getSecondLayserSecondFolderDomIndexForAssetTree(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetNth(1, assetTreeDomRecord[/* secondLayer */2][/* folderDomIndexArr */2]);
}

function getSecondLayserSecondTextureDomIndex(assetTreeDomRecord) {
  return ArrayService$WonderEditor.unsafeGetFirst(assetTreeDomRecord[/* secondLayer */2][/* textureData */4][/* domIndexArr */0]) - 1 | 0;
}
