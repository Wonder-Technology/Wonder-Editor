...
describe("relate asset", (function (param) {
        ...
        describe("test isLightMaterialDataEqual", (function (param) {
                describe("test judge name is equal", (function (param) {
        ...
        describe("test _isImageNodeDataEqual", (function (param) {
                describe("test judge name is equal", (function (param) {
                        Wonder_jest.test("if sourceName and targetName are all default name, return true", (function (param) {
