...
describe("test arcball cameraController event", (function (param) {
        ...
        describe("test bind for scene view", (function (param) {
                describe("test bind point down event", (function (param) {
                ...
                describe("test bind keydown event", (function (param) {
                        describe("test set target", (function (param) {
                                var _prepareMouseEvent = function (sandbox, param) {
        ...
        describe("test bind for game view", (function (param) {
                describe("test bind point down event", (function (param) {
                        var _test = function (sandbox, param, judgeFunc) {
                          return _testPointDownEvent(sandbox, /* tuple */[
                                      param[0],
