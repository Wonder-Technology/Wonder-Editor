...
describe("test arcball cameraController event", (function () {
        ...
        var _testKeydownEvent = function (sandbox, param, param$1) {
          ...
          var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
          return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](ArcballCameraEngineService$WonderEditor.unsafeGetArcballCameraControllerTarget(match[0], engineState)), Curry._2(param$1[0], /* tuple */[
                          match$2[0],
                          match$2[1]
                        ], /* tuple */[
                          match$1[0],
        ...
        describe("test bind for scene view", (function () {
                describe("test bind point drag start event", (function () {
                ...
                describe("test bind keydown event", (function () {
                        ...
                        Wonder_jest.test("if is combined key, not prevent default", (function (param) {
                                _prepareMouseEventForTestKeyboardEvent(sandbox, ArcballCameraControllerLogicService$WonderEditor.bindArcballCameraControllerEventForSceneView, /* () */0);
                        ...
                        describe("else", (function () {
                                describe("if key affect arcballCameraController", (function () {
                                        Wonder_jest.test("prevent default", (function (param) {
                                                _prepareMouseEventForTestKeyboardEvent(sandbox, ArcballCameraControllerLogicService$WonderEditor.bindArcballCameraControllerEventForSceneView, /* () */0);
                                                var preventDefaultFunc = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                        ...
                                        describe("loop when stop", (function () {
                                                Wonder_jest.test("if key is a, loop when stop", (function (param) {
                                                        _prepareMouseEventForTestKeyboardEvent(sandbox, ArcballCameraControllerLogicService$WonderEditor.bindArcballCameraControllerEventForSceneView, /* () */0);
                                                        _execKeydownEvent(10, 20, 65, undefined, undefined, /* () */0);
                                                        var gl = FakeGlToolEngine$WonderEditor.getEngineStateGl(/* () */0);
                                                        return Sinon.toCalled(Wonder_jest.Expect[/* expect */0](gl.clearColor));
                                                      }));
                                                return Wonder_jest.test("if key is e, not loop", (function (param) {
                                                              _prepareMouseEventForTestKeyboardEvent(sandbox, ArcballCameraControllerLogicService$WonderEditor.bindArcballCameraControllerEventForSceneView, /* () */0);
                                                              _execKeydownEvent(10, 20, 69, undefined, undefined, /* () */0);
                                                              var gl = FakeGlToolEngine$WonderEditor.getEngineStateGl(/* () */0);
        ...
        describe("test bind for game view", (function () {
                describe("test bind point drag start event", (function () {
                        ...
                        describe("if eventTarget is game view", (function () {
