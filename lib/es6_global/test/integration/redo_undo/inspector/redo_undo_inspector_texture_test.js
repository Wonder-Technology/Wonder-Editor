        ...
        describe("test change wrapS", (function () {
                ...
                describe("test undo operate", (function () {
                        ...
                        return Wonder_jest.test("should mark texture->isNeedUpdate to true after undo", (function (param) {
                                      ...
                                      RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.getIsNeedUpdate(textureComponent, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), /* NeedUpdate */1);
                                    }));
                      }));
