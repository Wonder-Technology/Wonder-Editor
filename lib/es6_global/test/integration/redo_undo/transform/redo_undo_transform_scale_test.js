...
describe("redo_undo: transform scale", (function () {
        ...
        var _simulateTwiceChangeScale = function () {
          ...
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return TransformEventTool$WonderEditor.triggerChangeScaleX(firstValue, param);
                }));
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return TransformEventTool$WonderEditor.triggerBlurScaleX(firstValue, param);
                }));
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return TransformEventTool$WonderEditor.triggerChangeScaleY(secondValue, param);
                }));
          return BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                        return TransformEventTool$WonderEditor.triggerBlurScaleY(secondValue, param);
                      }));
        };
