...
function _triggerClickUndo(domChildren) {
  var operateHistoryDiv = ArrayService$WonderEditor.getNth(0, domChildren);
  var array = operateHistoryDiv.children;
  var undoDiv = ArrayService$WonderEditor.getNth(0, array);
...
function _triggerClickRedo(domChildren) {
  var operateHistoryDiv = ArrayService$WonderEditor.getNth(0, domChildren);
  var array = operateHistoryDiv.children;
  var redoDiv = ArrayService$WonderEditor.getNth(1, array);
