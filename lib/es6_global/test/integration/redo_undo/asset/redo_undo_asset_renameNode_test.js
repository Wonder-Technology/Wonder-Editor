...
describe("redo_undo: asset rename node", (function () {
        ...
        var _simulateTwiceChangeName = function (param) {
          ...
          AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, nodeId, name1, /* () */0);
          AssetTreeInspectorTool$WonderEditor.Rename[/* renameAssetFolderNode */4](undefined, undefined, nodeId, name2, /* () */0);
          return /* tuple */[
                  nodeId,
                  /* tuple */[
                    name1,
