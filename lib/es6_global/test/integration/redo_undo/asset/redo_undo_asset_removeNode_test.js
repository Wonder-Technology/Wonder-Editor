...
describe("redo_undo: asset remove node", (function (param) {
        ...
        var _simulateTwiceRemoveFolder = function (param) {
          ...
          return MainEditorAssetHeaderOperateNodeTool$WonderEditor.removeFolderNode(undefined, undefined, Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* Folder */3][/* TwoLayer */0][/* getSecondFolderNodeId */4], assetTreeData), /* () */0);
        };
