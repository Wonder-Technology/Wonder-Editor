...
describe("redo_undo: controller isRun", (function (param) {
        ...
        describe("undo to the state before run", (function (param) {
                ...
                describe("test redo to the state after run", (function (param) {
