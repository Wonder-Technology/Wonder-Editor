...
describe("redo_undo: controller workflow", (function () {
        ...
        Wonder_jest.test("init default scene", (function () {
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateLogicService$WonderEditor.getEditEngineState(/* () */0)).length), 6);
              }));
        Wonder_jest.test("add two gameObject", (function () {
                _addGameObjectWithCount(2);
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateLogicService$WonderEditor.getEditEngineState(/* () */0)).length), 8);
              }));
        Wonder_jest.test("undo one step", (function () {
                _addGameObjectWithCount(2);
                StateHistoryToolEditor$WonderEditor.undo(/* () */0);
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateLogicService$WonderEditor.getEditEngineState(/* () */0)).length), 7);
              }));
        Wonder_jest.test("click run button(which store all stack), add three gameObject", (function () {
                ...
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateLogicService$WonderEditor.getEditEngineState(/* () */0)).length), 10);
              }));
        Wonder_jest.test("undo one step", (function () {
                _addGameObjectWithCount(2);
                StateHistoryToolEditor$WonderEditor.undo(/* () */0);
                ...
                _addGameObjectWithCount(3);
                StateHistoryToolEditor$WonderEditor.undo(/* () */0);
                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateLogicService$WonderEditor.getEditEngineState(/* () */0)).length), 9);
              }));
