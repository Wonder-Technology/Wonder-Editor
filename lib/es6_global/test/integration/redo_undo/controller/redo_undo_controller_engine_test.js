        ...
        describe("test undo operate", (function () {
                ...
                describe("test transform", (function () {
                        ...
                        return Wonder_jest.test("test undo one step which from second to first", (function () {
                                      ...
                                      StateHistoryToolEditor$WonderEditor.undo(/* () */0);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](TransformEngineService$WonderEditor.getLocalPosition(GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0))), /* tuple */[
                                                  155,
                                                  0,
                                                  0
                                                ]);
