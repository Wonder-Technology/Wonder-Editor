...
describe("redo_undo: test stack", (function () {
        ...
        describe("limit stack to max size", (function () {
                ...
                Wonder_jest.test("should only store max size stacks to undo stack", (function () {
                        _addGameObjectWithCount(3);
                        RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                        RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                        RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0)).length), 1);
                      }));
                Wonder_jest.test("not affect redo operation", (function () {
                        _addGameObjectWithCount(3);
                        RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                        RedoUndoTool$WonderEditor.undoHistoryState(undefined, undefined, undefined, undefined, /* () */0);
                ...
                describe("test controller", (function () {
                        ...
                        describe("test stop", (function () {
                                return Wonder_jest.test("can undo to stack stored when play which is exceed max stack size", (function () {
