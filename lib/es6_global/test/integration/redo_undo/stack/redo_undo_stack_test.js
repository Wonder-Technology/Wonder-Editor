...
describe("redo_undo: test stack", (function (param) {
        ...
        describe("limit stack to max size", (function (param) {
                beforeEach((function (param) {
                        return StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
                                      return SettingTool$WonderEditor.setMaxStackSize(2, param);
                                    }));
                      }));
                Wonder_jest.test("should only store max size stacks to undo stack", (function (param) {
                ...
                describe("test controller", (function (param) {
                        beforeEach((function (param) {
