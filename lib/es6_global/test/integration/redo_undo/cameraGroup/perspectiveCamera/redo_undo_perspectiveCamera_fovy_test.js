...
describe("redo_undo: perspectiveCamera fovy", (function (param) {
        ...
        var _changeFovy = function (value) {
          return MainEditorCameraProjectionTool$WonderEditor.changeFovyAndBlur(GameObjectTool$WonderEditor.getCurrentGameObjectPerspectiveCamera(/* () */0), value, undefined, undefined, /* () */0);
        };
