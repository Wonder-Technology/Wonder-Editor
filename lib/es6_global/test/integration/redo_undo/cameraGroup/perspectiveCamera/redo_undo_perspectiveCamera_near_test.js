...
describe("redo_undo: perspectiveCamera near", (function (param) {
        ...
        var _changeNear = function (value) {
          return MainEditorCameraProjectionTool$WonderEditor.changeNearAndBlur(GameObjectTool$WonderEditor.getCurrentGameObjectPerspectiveCamera(/* () */0), value, undefined, undefined, /* () */0);
        };
