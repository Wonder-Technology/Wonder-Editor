...
describe("redo_undo: perspectiveCamera far", (function (param) {
        ...
        var _changeFar = function (value) {
          return MainEditorCameraProjectionTool$WonderEditor.changeFarAndBlur(GameObjectTool$WonderEditor.getCurrentGameObjectPerspectiveCamera(/* () */0), value, undefined, undefined, /* () */0);
        };
