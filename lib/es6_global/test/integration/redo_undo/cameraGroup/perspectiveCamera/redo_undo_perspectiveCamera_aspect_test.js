...
describe("redo_undo: perspectiveCamera aspect", (function () {
        ...
        var _changeAspect = function (value) {
          var aspectDomIndex = MainEditorCameraProjectionTool$WonderEditor.getAspectDomIndex(/* () */0);
          return MainEditorCameraProjectionTool$WonderEditor.triggerPerspectiveCameraChangeAndBlurEvent(aspectDomIndex, value);
        };
        var _simulateTwiceChangeAspect = function () {
          _changeAspect(10.112);
          return _changeAspect(123.12);
        };
