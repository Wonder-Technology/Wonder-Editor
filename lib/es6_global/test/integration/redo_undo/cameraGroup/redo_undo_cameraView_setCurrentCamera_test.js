...
describe("redo_undo: cameraView set currentCamera", (function (param) {
        ...
        var _simulateSetFirstCameraBeCurrentCamera = function (param) {
          ...
          return MainEditorCameraViewTool$WonderEditor.setCurrentCamera(GameObjectTool$WonderEditor.getCurrentGameObjectBasicCameraView(/* () */0), undefined, undefined, undefined, /* () */0);
        };
