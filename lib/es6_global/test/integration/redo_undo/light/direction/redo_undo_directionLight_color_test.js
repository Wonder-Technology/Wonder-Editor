...
describe("redo_undo: directionLight color", (function () {
        ...
        var _changeColor = function (color) {
          ...
          PickColorEventTool$WonderEditor.triggerChangeDirectionLightColor(currentGameObjectDirectionLightComponent, color);
