...
describe("redo_undo: pointLight quadratic", (function () {
        ...
        var _changeQuadratic = function (value) {
          ...
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return MainEditorLightTool$WonderEditor.triggerLightComponentChangeEvent(quadraticDomIndex, value, param);
                }));
          return BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                        return MainEditorLightTool$WonderEditor.triggerLightComponentBlurEvent(quadraticDomIndex, value, param);
                      }));
        };
        var _simulateTwiceChangeQuadratic = function () {
          MainEditorLightTool$WonderEditor.setLightTypeToBePointLight(/* () */0);
          _changeQuadratic(10.1);
          return _changeQuadratic(12.12);
        };
