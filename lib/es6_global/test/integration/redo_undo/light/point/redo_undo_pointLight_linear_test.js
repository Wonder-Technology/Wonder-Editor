...
describe("redo_undo: pointLight linear", (function () {
        ...
        var _changeLinear = function (value) {
          ...
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return MainEditorLightTool$WonderEditor.triggerLightComponentChangeEvent(linearDomIndex, value, param);
                }));
          return BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                        return MainEditorLightTool$WonderEditor.triggerLightComponentBlurEvent(linearDomIndex, value, param);
                      }));
        };
        var _simulateTwiceChangeLinear = function () {
          MainEditorLightTool$WonderEditor.setLightTypeToBePointLight(/* () */0);
          _changeLinear(10.1);
          return _changeLinear(12.12);
        };
