...
describe("redo_undo: pointLight color", (function () {
        ...
        var _changeColor = function (color) {
          var component = BuildComponentTool$WonderEditor.buildPointLight(GameObjectTool$WonderEditor.getCurrentGameObjectPointLightComponent(/* () */0));
          ...
          PickColorEventTool$WonderEditor.triggerChangePointLightColor(currentGameObjectPointLightComponent, color);
