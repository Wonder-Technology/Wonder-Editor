...
describe("redo_undo: pointLight constant", (function () {
        ...
        var _changeConstant = function (value) {
          ...
          BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                  return MainEditorLightTool$WonderEditor.triggerLightComponentChangeEvent(constantDomIndex, value, param);
                }));
          return BaseEventTool$WonderEditor.triggerComponentEvent(component, (function (param) {
                        return MainEditorLightTool$WonderEditor.triggerLightComponentBlurEvent(constantDomIndex, value, param);
                      }));
        };
        var _simulateTwiceChangeConstant = function () {
          MainEditorLightTool$WonderEditor.setLightTypeToBePointLight(/* () */0);
          _changeConstant(10.1);
          return _changeConstant(12.12);
        };
