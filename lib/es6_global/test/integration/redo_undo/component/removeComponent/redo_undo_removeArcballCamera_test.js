...
describe("redo_undo: remove cameraGroup component", (function () {
        ...
        var _simulateRemoveSpecificComponent = function () {
          return OperateComponentEventTool$WonderEditor.removeComponentFromCurrentGameObject(SceneTreeNodeDomTool$WonderEditor.OperateDefaultScene[/* getArcballCameraComponentFromCamera */11](/* () */0));
        };
