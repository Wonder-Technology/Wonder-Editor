...
describe("redo_undo: remove cameraGroup component", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateRemoveSpecificComponent = function (param) {
          return MainEditorInspectorRemoveComponentTool$WonderEditor.removeArcballCameraControllerComponent(undefined, undefined, undefined, /* () */0);
        };
