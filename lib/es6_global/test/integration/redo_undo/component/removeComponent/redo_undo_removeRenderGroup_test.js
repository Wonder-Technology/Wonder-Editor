...
describe("redo_undo: remove renderGroup component", (function () {
        ...
        var _simulateRemoveSpecificComponent = function () {
          return OperateComponentEventTool$WonderEditor.removeComponentFromCurrentGameObject(SceneTreeNodeDomTool$WonderEditor.OperateDefaultScene[/* getRenderGroupComponentFromBox */6](/* () */0));
        };
