...
describe("redo_undo: sceneTree", (function () {
        ...
        var _simulateTwiceDragEvent = function () {
          MainEditorSceneTreeTool$WonderEditor.Drag[/* dragGameObjectIntoGameObject */2](MainEditorSceneTool$WonderEditor.getSecondCube(StateEngineService$WonderEditor.unsafeGetState(/* () */0)), MainEditorSceneTool$WonderEditor.getSceneFirstCamera(/* () */0), undefined, undefined, /* () */0);
          return MainEditorSceneTreeTool$WonderEditor.Drag[/* dragGameObjectIntoGameObject */2](MainEditorSceneTool$WonderEditor.getFirstCube(StateEngineService$WonderEditor.unsafeGetState(/* () */0)), MainEditorSceneTool$WonderEditor.getSceneFirstCamera(/* () */0), undefined, undefined, /* () */0);
        };
