...
describe("redo_undo: sceneTree", (function (param) {
        var sandbox = Sinon.getSandboxDefaultVal(/* () */0);
        var _simulateTwiceDragEvent = function (param) {
          MainEditorSceneTreeTool$WonderEditor.Drag[/* dragGameObjectIntoGameObject */2](MainEditorSceneTool$WonderEditor.getSecondBox(StateEngineService$WonderEditor.unsafeGetState(/* () */0)), MainEditorSceneTool$WonderEditor.getSceneFirstCamera(/* () */0), undefined, undefined, /* () */0);
          return MainEditorSceneTreeTool$WonderEditor.Drag[/* dragGameObjectIntoGameObject */2](MainEditorSceneTool$WonderEditor.getFirstBox(StateEngineService$WonderEditor.unsafeGetState(/* () */0)), MainEditorSceneTool$WonderEditor.getSceneFirstCamera(/* () */0), undefined, undefined, /* () */0);
        };
