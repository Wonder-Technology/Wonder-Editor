...
describe("test console unread count", (function () {
        ...
        describe("should show unread count in bottom header", (function () {
                beforeEach((function () {
                        BuildComponentTool$WonderEditor.buildBottom(undefined, undefined, /* () */0);
                        return /* () */0;
                      }));
                Wonder_jest.test("if console one message, unread count should + 1", (function () {
