...
describe("header load scene wdb", (function () {
        ...
        describe("test load scene wdb", (function () {
                ...
                describe("test imgui", (function () {
                        describe("test engineState", (function () {
                                describe("if scene wdb's imgui exist", (function () {
                                        return Wonder_jest.testPromise("should save scene wdb's imgui func and customData to editorState", undefined, (function (param) {
                                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                                                    ...
                                                                    return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                                    ...
                                                                                    StringTool$WonderEditor.removeNewLinesAndSpaces("function(param,apiJsObj,engineState){\n        var label = apiJsObj.label;\n        return label(/*tuple*/[100,30,300,200], \"imgui\", 0, engineState);\n                               }"),
                                                                                    null
                                                                                  ]));
                                                                  }));
                                                    }));
                                ...
                                describe("else", (function () {
                                        return Wonder_jest.testPromise("should remove scene wdb's imgui func and customData from editorState", undefined, (function (param) {
                                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                                                    return LoadSceneWDBTool$WonderEditor.loadSceneWDB(boxTexturedWDBArrayBuffer[0], undefined, "BoxTextured", /* () */0).then((function (param) {
                                                                                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                                  return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                ...
                describe("test bind arcball event", (function () {
                        return Wonder_jest.testPromise("should not bind scene wdb->arcball cameraControllers(instead bind editCamera->arcball cameraController)", undefined, (function (param) {
                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
