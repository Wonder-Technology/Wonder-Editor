...
describe("header load scene wdb", (function (param) {
        ...
        describe("test load scene wdb", (function (param) {
                beforeEach((function (param) {
                ...
                Wonder_jest.testPromise("should clear current scene tree node", (function (param) {
                ...
                describe("test load no light scene wdb to scene which has light", (function (param) {
                        ...
                        Wonder_jest.testPromise("new scene->box->glsl should has no light count", (function (param) {
                        ...
                        return Wonder_jest.testPromise("if add light material and init after load, its glsl should has no light count", (function (param) {
                                      return _prepare((function (shaderSourceCountBeforeLoadSceneWDB, glShaderSource) {
                ...
                describe("test imgui", (function (param) {
                        describe("test engineState", (function (param) {
                                describe("if scene wdb's imgui exist", (function (param) {
                                        return Wonder_jest.testPromise("should save scene wdb's imgui func and customData to editorState", (function (param) {
                                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                ...
                                describe("else", (function (param) {
                                        return Wonder_jest.testPromise("should remove scene wdb's imgui func and customData from editorState", (function (param) {
                                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                                                    return LoadSceneWDBTool$WonderEditor.loadSceneWDB(boxTexturedWDBArrayBuffer[0], undefined, "BoxTextured", /* () */0).then((function (param) {
                                                                                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                                  return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                ...
                describe("test bind arcball event", (function (param) {
                        return Wonder_jest.testPromise("should not bind scene wdb->arcball cameraControllers(instead bind editCamera->arcball cameraController)", (function (param) {
                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                ...
                Wonder_jest.test("if load no wdb, return", (function (param) {
                        return Wonder_jest.Expect[/* toThrow */18](Wonder_jest.Expect[/* noT_ */22](Wonder_jest.Expect[/* expect */0]((function (param) {
                ...
                describe("set wdb->actived camera to editorState", (function (param) {
                        Wonder_jest.testPromise("test wdb has one", (function (param) {
                                return LoadSceneWDBTool$WonderEditor.loadSceneWDB(sceneWDBArrayBuffer[0], undefined, "Scene", /* () */0).then((function (param) {
                                              var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                        ...
                        return Wonder_jest.testPromise("test wdb not has one", (function (param) {
                                      return LoadSceneWDBTool$WonderEditor.loadSceneWDB(boxTexturedWDBArrayBuffer[0], undefined, "BoxTextured", /* () */0).then((function (param) {
                                                    var editorState = StateEditorService$WonderEditor.getState(/* () */0);
