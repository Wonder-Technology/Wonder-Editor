...
describe("header import package", (function () {
        ...
        describe("dispose assets", (function () {
                describe("dispose wdb assets", (function () {
                        beforeEach((function () {
                        ...
                        describe("dispose geometry assets", (function () {
                                Wonder_jest.testPromise("\n          1.load CubeTextured wdb asset w1;\n          2.drag w1 to scene tree to be gameObject g1;\n          3.export;\n          4.import;\n\n\n          g1->geometry->select geometry group widget should have only one wdb geometry and be using it\n          ", (function () {
                                        ...
                                        return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                      ...
                                                      return ImportPackageTool$WonderEditor.testImportPackage((function () {
                                                                    ...
                                                                    GameObjectTool$WonderEditor.setCurrentSceneTreeNode(LoadWDBTool$WonderEditor.getCubeTexturedMeshGameObject(engineState));
                                ...
                                return Wonder_jest.testPromise("should dispose geometry engine data", (function () {
                        ...
                        describe("dispose wdb gameObjects", (function () {
                                var wdbArrayBuffer = /* record */[/* contents */1];
                                var generateWDB = function () {
                                ...
                                return Wonder_jest.testPromise("should dispose gameObject engine data", (function () {
                ...
                describe("dispose material assets", (function () {
                        beforeEach((function () {
        ...
        describe("reallocate", (function () {
                describe("reallocate geometry", (function () {
                        beforeEach((function () {
                        ...
                        return Wonder_jest.testPromise("if geometry-buffer-use percent >= 10%, reallocate geometry to new buffer", (function () {
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
        ...
        describe("test import scene wdb", (function () {
                beforeEach((function () {
                ...
                Wonder_jest.testPromise("should reset scene gameObject", (function () {
                ...
                describe("relate scene gameObjects and material assets", (function () {
                        Wonder_jest.testPromise("if scene gameObject use material asset, should still use it after import", (function () {
                        ...
                        Wonder_jest.testPromise("if scene gameObject use default material, should still use it after import", (function () {
                        ...
                        describe("fix bug", (function () {
                                Wonder_jest.testPromise("test change default material to material asset after import", (function () {
                                        var addedMaterialNodeId = MainEditorAssetIdTool$WonderEditor.getNewAssetId(undefined, /* () */0);
                                        MainEditorAssetHeaderOperateNodeTool$WonderEditor.addMaterial(undefined, undefined, /* () */0);
                                        var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                        var gameObject = MainEditorSceneTool$WonderEditor.getFirstCube(engineState);
                                ...
                                describe("test with material and texture assets", (function () {
                                        var _prepareFakeCanvas = function () {
        ...
        describe("test geometry", (function () {
                ...
                describe("test with wdb assets", (function () {
                        beforeEach((function () {
                                ImportPackageTool$WonderEditor.prepareFakeCanvas(sandbox);
                                return /* () */0;
                              }));
                        describe("relate wdb asset gameObjects with default geometrys", (function () {
                                ...
                                Wonder_jest.testPromise("\n               1.load cube wdb asset w1(with default cube geometry);\n               2.export;\n               3.import;\n               4.drag w1 to scene tree to be gameObject g1;\n\n\n               g1->geometry->select geometry group widget should only have default geometrys and be using default cube geometry\n               ", (function () {
                                        return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                                      return ImportPackageTool$WonderEditor.testImportPackage((function () {
                                                                    var wdbNodeId = ArrayService$WonderEditor.unsafeGetFirst(ImportPackageTool$WonderEditor.getImportedWDBAssetNodeId(/* () */0));
                                                                    MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](wdbNodeId, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
                                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                    GameObjectTool$WonderEditor.setCurrentSceneTreeNode(MainEditorSceneTool$WonderEditor.getFirstCube(engineState));
                                                                    MainEditorSceneTreeTool$WonderEditor.Select[/* selectGameObject */0](undefined, undefined, GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0), /* () */0);
                                                                    var component = BuildComponentTool$WonderEditor.buildGeometry(GameObjectTool$WonderEditor.getCurrentGameObjectGeometry(/* () */0), undefined, undefined, undefined, true, /* () */0);
                                ...
                                describe("\n                  1.load cube wdb asset w1(with default cube geometry);\n                  1.load cube wdb asset w2(with default cube geometry);\n                  2.export;\n                  3.import;\n                  4.drag w1 to scene tree to be gameObject g1;\n                  5.drag w2 to scene tree to be gameObject g2;\n                  ", (function () {
                                          ...
                                          return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                                        return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                                                      return ImportPackageTool$WonderEditor.testImportPackage((function () {
                                                                                    ...
                                                                                    MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](wdbNodeId1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
                                                                                    MainEditorSceneTreeTool$WonderEditor.Drag[/* dragWDBAssetToSceneTree */1](wdbNodeId2, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
                                                                                    return Curry._1(testFunc, /* () */0);
                                                                                  }), undefined, undefined, undefined, undefined, /* () */0);
                                                                    }));
                                                      }));
                                        };
                                        Wonder_jest.testPromise("g1->geometry->select geometry group widget should only have default geometrys and be using default cube geometry", (function () {
                                        ...
                                        return Wonder_jest.testPromise("g2->geometry->select geometry group widget should only have default geometrys and be using default cube geometry", (function () {
                                                      return _prepare((function () {
                                                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
        ...
        describe("test import assets", (function () {
                describe("test import material assets", (function () {
                        beforeEach((function () {
                                MainEditorSceneTool$WonderEditor.createDefaultScene(sandbox, MainEditorSceneTool$WonderEditor.setFirstCubeToBeCurrentSceneTreeNode);
                                return Curry._1(EventListenerTool$WonderEditor.stubGetElementByIdReturnFakeDom, Curry._1(EventListenerTool$WonderEditor.buildFakeDom, /* () */0));
                              }));
                        Wonder_jest.testPromise("should add material assets to asset tree", (function () {
                                MainEditorAssetHeaderOperateNodeTool$WonderEditor.addMaterial(undefined, undefined, /* () */0);
                                MainEditorAssetHeaderOperateNodeTool$WonderEditor.addMaterial(undefined, undefined, /* () */0);
                                return ImportPackageTool$WonderEditor.testImportPackage((function () {
                ...
                describe("test import texture assets", (function () {
                        beforeEach((function () {
                        ...
                        Wonder_jest.testPromise("should add texture assets to asset tree", (function () {
                                return MainEditorAssetUploadTool$WonderEditor.loadOneTexture(undefined, undefined, "loadImg.png", "newImgBase64", /* () */0).then((function () {
                                              return ImportPackageTool$WonderEditor.testImportPackage((function () {
                                                            return Promise.resolve(ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildAssetChildrenNode(undefined, /* () */0)));
                                                          }), undefined, undefined, undefined, undefined, /* () */0);
                                            }));
                              }));
                        describe("should keep texture data not change", (function () {
                                ...
                                Wonder_jest.testPromise("test format", (function () {
                                ...
                                Wonder_jest.testPromise("test type_", (function () {
                                ...
                                return Wonder_jest.testPromise("test flipY", (function () {
                ...
                describe("test import wdb assets", (function () {
                        beforeEach((function () {
                                MainEditorSceneTool$WonderEditor.initStateWithJob(sandbox, NoWorkerJobConfigToolEngine$WonderEditor.buildNoWorkerJobConfig(undefined, undefined, undefined, undefined, undefined, /* () */0), undefined, false, undefined, /* () */0);
                        ...
                        describe("relate wdb asset gameObjects and material assets", (function () {
                                return Wonder_jest.testPromise("test", (function () {
                                              return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                            ...
                                                            return ImportPackageTool$WonderEditor.testImportPackage((function () {
                                                                          var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                          var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                          var __x = LoadWDBTool$WonderEditor.getCubeTexturedMeshGameObject(engineState);
                                                                          var material = GameObjectComponentEngineService$WonderEditor.unsafeGetLightMaterialComponent(__x, engineState);
                                                                          return Promise.resolve(Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                                                              MainEditorAssetMaterialNodeTool$WonderEditor.hasMaterialComponent(material, LoadWDBTool$WonderEditor.getCubeTexturedMeshGameObjectMaterialType(/* () */0), editorState),
        ...
        describe("shouldn't warn exceed max count when c1(current scene(before import package)->total light count) + c2(scene wdb->total light count) is exceed but c2 is not exceed", (function () {
                beforeEach((function () {
                        MainEditorSceneTool$WonderEditor.initStateWithJob(sandbox, NoWorkerJobConfigToolEngine$WonderEditor.buildNoWorkerJobConfig(undefined, undefined, "\n                   [\n                       {\n                           \"name\": \"default\",\n                           \"jobs\": [\n                               {\n                                   \"name\": \"dispose\"\n                               }\n                           ]\n                       }\n                   ]\n               ", undefined, undefined, /* () */0), undefined, false, undefined, /* () */0);
                        MainEditorSceneTool$WonderEditor.prepareScene(sandbox);
                ...
                return Wonder_jest.testPromise("test", (function () {
                              ...
                              StateEngineService$WonderEditor.setState(engineState$1);
                              return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(directionPointLightsAndCubeWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                            return ImportPackageTool$WonderEditor.testImportPackage((function () {
        ...
        describe("fix bug", (function () {
                ...
                Wonder_jest.testPromise("\n            1.import package p1(error);\n            2.import package p2;\n\n            should import p2 success\n            ", (function () {
                        ...
                        ConsoleTool$WonderEditor.notShowMessage(/* () */0);
                        return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                      var cubeTexturedWPKArrayBuffer = ExportPackageTool$WonderEditor.exportWPK(/* () */0);
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(stoveWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function () {
                                                    ...
                                                    MainEditorSceneTool$WonderEditor.prepareScene(sandbox);
                                                    ConsoleTool$WonderEditor.notShowMessage(/* () */0);
                                                    return ImportPackageTool$WonderEditor.testImportPackageWithoutExport((function () {
                                                                  ...
                                                                  return ImportPackageTool$WonderEditor.testImportPackageWithoutExport((function () {
                                                                              ...
                                                                              }), cubeTexturedWPKArrayBuffer, undefined, undefined, undefined, /* () */0);
                                                                }), cubeTextuedAndStoveWPKArrayBuffer, undefined, undefined, undefined, /* () */0);
                                                  }));
                                    }));
                      }));
                describe("test use extracted assets from wdb assets to scene gameObject before export package", (function () {
                        ...
                        Wonder_jest.testPromise("\n          add gameObject g1 to scene tree;\n          add material asset m1;\n          load CubeTextured wdb asset w1;\n          drag w1 to scene tree to be gameObject g2;\n          drag w1->extracted texture t1 to be m1->diffuseMap;\n          set g1->material to be m1;\n          export;\n          import;\n\n          g1->material should be m1;\n          g1->material->diffuseMap should be t1;\n          ", (function () {
                                ...
                                return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                              ...
                                              var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                              var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                              var cubeTexturedMeshDiffuseMap = LoadWDBTool$WonderEditor.unsafeGetCubeTexturedMeshDiffuseMap(engineState);
                                              var cubeTexturedMeshDiffuseMapName = BasicSourceTextureEngineService$WonderEditor.unsafeGetBasicSourceTextureName(cubeTexturedMeshDiffuseMap, engineState);
                        ...
                        return Wonder_jest.testPromise("\n          add gameObject g1 to scene tree;\n          load texture asset t1;\n          load CubeTextured wdb asset w1;\n          drag w1 to scene tree to be gameObject g2;\n          drag t1 to be w1->extracted material m1->diffuseMap;\n          set g1->material to be m1;\n          export;\n          import;\n\n          g1->material should be m1;\n          g1->material->diffuseMap should be t1;\n          ", (function () {
                                      ...
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneTexture(undefined, undefined, imgName1, undefined, /* () */0).then((function (uploadedTextureNodeId1) {
                                                    return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(cubeTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
                                                                  ...
                                                                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                                                  var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                                                  var wdbMaterial = LoadWDBTool$WonderEditor.unsafeGetCubeTexturedMeshLightMaterial(engineState);
