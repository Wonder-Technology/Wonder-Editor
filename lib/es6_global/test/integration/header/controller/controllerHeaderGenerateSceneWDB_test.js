...
describe("controller header generate scene wdb", (function () {
        ...
        describe("fix bind arcballCameraController event bug: package should bind event if any basicCameraView is active", (function () {
                ...
                var _generateSceneWDB = function ($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, param) {
                  ...
                  var generateWDBFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : GenerateSceneGraphEngineService$WonderEditor.generateWDB;
                  var imageUint8ArrayMap = $staropt$star$2 !== undefined ? Caml_option.valFromOption($staropt$star$2) : Uint8ArrayAssetEditorService$WonderEditor.buildImageUint8ArrayMap(StateEditorService$WonderEditor.getState(/* () */0));
                ...
                describe("test stop", (function () {
                        Wonder_jest.testPromise("test bind", undefined, (function (param) {
                                return _test((function (param) {
