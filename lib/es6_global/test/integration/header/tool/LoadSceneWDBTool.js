...
function handleSceneWDB(wdbArrayBuffer) {
  return Most.tap((function (param) {
                return StateLogicService$WonderEditor.refreshEngineState(GameObjectEngineService$WonderEditor.initAllGameObjects(param[0], ShaderEngineService$WonderEditor.clearInitShaderCache(StateEngineService$WonderEditor.unsafeGetState(/* () */0))));
