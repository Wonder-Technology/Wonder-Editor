...
describe("header publish local", (function () {
        ...
        describe("download zip", (function () {
                var _prepare = function (judgeFunc, buildFakeFetch, $staropt$star, param) {
                  ...
                  Curry._1(MainEditorAssetTreeTool$WonderEditor.BuildAssetTree[/* All */6][/* ThreeLayer */0][/* buildFolderAndTextureAndMaterialAssetTree */0], /* () */0);
                  var fakeFetchFunc = Curry._1(buildFakeFetch, /* () */0);
                  var obj = HeaderTool$WonderEditor.buildPublishFakeJsZipCreateFunc(sandbox[0]);
                  return HeaderPublishLocalUtils$WonderEditor.Publish[/* publishZip */2](/* tuple */[
                                "WonderLocal",
                                useWorker
                              ], (function (param) {
                                  return obj;
