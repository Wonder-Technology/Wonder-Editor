...
describe("header publish local", (function (param) {
        ...
        describe("download zip", (function (param) {
                ...
                describe("test default", (function (param) {
                        var _buildFakeFetch = function (sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, $staropt$star$8, $staropt$star$9, $staropt$star$10, $staropt$star$11, param) {
                        ...
                        Wonder_jest.testPromise("export index.html", (function (param) {
                                return _testText(0, "index.html");
                              }));
                        Wonder_jest.testPromise("export wd.min.js", (function (param) {
                                return _testText(1, "wd.min.js");
                              }));
                        describe("export res data", (function (param) {
                                Wonder_jest.testPromise("export logo", (function (param) {
                                        return _testText(2, "res/loading/logo.png");
                                      }));
                                return Wonder_jest.testPromise("export ico", (function (param) {
                                              return _testText(3, "res/loading/favicon.ico");
                                            }));
                              }));
                        describe("export config data", (function (param) {
                                Wonder_jest.testPromise("export setting", (function (param) {
                                        return _testText(4, "config/setting.json");
                                      }));
                                Wonder_jest.testPromise("export init jobs", (function (param) {
                                        return _testText(5, "config/no_worker/job/init_jobs.json");
                                      }));
                                Wonder_jest.testPromise("export loop jobs", (function (param) {
                                        return _testText(6, "config/no_worker/job/loop_jobs.json");
                                      }));
                                Wonder_jest.testPromise("export init pipelines", (function (param) {
                                        return _testText(7, "config/no_worker/pipeline/init_pipelines.json");
                                      }));
                                Wonder_jest.testPromise("export loop pipelines", (function (param) {
                                        return _testText(8, "config/no_worker/pipeline/loop_pipelines.json");
                                      }));
                                Wonder_jest.testPromise("export no worker setting", (function (param) {
                                        return _testText(9, "config/no_worker/setting/setting.json");
                                      }));
                                Wonder_jest.testPromise("export shader libs", (function (param) {
                                        return _testText(10, "config/render/shader/shader_libs.json");
                                      }));
                                return Wonder_jest.testPromise("export shaders", (function (param) {
                                              return _testText(11, "config/render/shader/shaders.json");
                                            }));
                              }));
                        return Wonder_jest.testPromise("export Scene.wdb", (function (param) {
                                      return _prepare((function (fetchCount, file) {
                ...
                describe("test useWorker", (function (param) {
                        var _testText = function (callCount, targetText) {
                          return _prepare((function (fetchCount, file) {
                                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](OptionService$WonderEditor.unsafeGet(Js_list.hd(Sinon.getArgs(Sinon.getCall(callCount, file))))), targetText);
                                      }), (function (eta) {
                        ...
                        Wonder_jest.testPromise("export wd.render.worker.js", (function (param) {
                                return _testText(2, "wd.render.worker.js");
                              }));
                        Wonder_jest.testPromise("export setting", (function (param) {
                                return _testText(5, "config/setting.json");
                              }));
                        return Wonder_jest.testPromise("export worker setting", (function (param) {
