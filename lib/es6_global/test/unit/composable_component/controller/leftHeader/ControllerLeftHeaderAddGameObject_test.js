...
describe("controller leftHeader add gameObject", (function () {
        ...
        describe("test add cube", (function () {
                Wonder_jest.test("test add one cube", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](HierarchyGameObjectEngineService$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0)).length), 5);
                      }));
                Wonder_jest.test("test add two cubees", (function () {
                        MainEditorLeftHeaderTool$WonderEditor.addCube(undefined, undefined, /* () */0);
                        MainEditorLeftHeaderTool$WonderEditor.addCube(undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](HierarchyGameObjectEngineService$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0)).length), 6);
                      }));
                Wonder_jest.test("the added cube's geometry's name should be Wonder-Default-Cube", (function () {
                        var addedCubeUid = GameObjectTool$WonderEditor.getNewGameObject(undefined, /* () */0);
                        var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                        MainEditorLeftHeaderTool$WonderEditor.addCube(undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GeometryEngineService$WonderEditor.unsafeGetGeometryName(GameObjectComponentEngineService$WonderEditor.unsafeGetGeometryComponent(addedCubeUid, engineState), engineState)), "Wonder-Default-Cube");
                      }));
        ...
        describe("test add emptyGameObject", (function () {
                Wonder_jest.test("test add one emptyGameObject", (function () {
                ...
                describe("test scene tree snanpshot", (function () {
                        return Wonder_jest.test("test add one emptyGameObject", (function () {
                                      MainEditorLeftHeaderTool$WonderEditor.addEmptyGameObject(undefined, undefined, /* () */0);
                                      return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildSceneTree(TestTool$WonderEditor.buildEmptyAppState(/* () */0)));
                                    }));
                      }));
        ...
        describe("test add sphere", (function () {
                Wonder_jest.test("test add one sphere", (function () {
                        MainEditorLeftHeaderTool$WonderEditor.addSphere(undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](HierarchyGameObjectEngineService$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0)).length), 5);
                      }));
                Wonder_jest.test("test add two spheres", (function () {
                        MainEditorLeftHeaderTool$WonderEditor.addSphere(undefined, undefined, /* () */0);
                        MainEditorLeftHeaderTool$WonderEditor.addSphere(undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](HierarchyGameObjectEngineService$WonderEditor.getChildren(MainEditorSceneTool$WonderEditor.unsafeGetScene(/* () */0), StateEngineService$WonderEditor.unsafeGetState(/* () */0)).length), 6);
                      }));
                Wonder_jest.test("the added sphere's geometry's name should be Wonder-Default-Sphere", (function () {
                        var addedSphereUid = GameObjectTool$WonderEditor.getNewGameObject(undefined, /* () */0);
                        var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                        MainEditorLeftHeaderTool$WonderEditor.addSphere(undefined, undefined, /* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GeometryEngineService$WonderEditor.unsafeGetGeometryName(GameObjectComponentEngineService$WonderEditor.unsafeGetGeometryComponent(addedSphereUid, engineState), engineState)), "Wonder-Default-Sphere");
                      }));
                describe("test scene tree snapshot", (function () {
                        return Wonder_jest.test("test add one sphere", (function () {
                                      MainEditorLeftHeaderTool$WonderEditor.addSphere(undefined, undefined, /* () */0);
                                      return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildSceneTree(TestTool$WonderEditor.buildEmptyAppState(/* () */0)));
                                    }));
                      }));
