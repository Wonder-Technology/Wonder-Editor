                ...
                describe("test has two cameras with arcballCameraController component", (function () {
                        ...
                        describe("test click run and change current camera", (function () {
                                ...
                                return Wonder_jest.test("active source camera->basicCameraView", (function (param) {
                                              ...
                                              var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                              return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](GameViewEditorService$WonderEditor.getActivedBasicCameraView(editorState)), GameObjectComponentEngineService$WonderEditor.unsafeGetArcballCameraControllerComponent(match[0], engineState));
                                            }));
                              }));
                        return /* () */0;
                      }));
