...
describe("controller inspector point light", (function () {
        ...
        describe("test set value into engineState", (function () {
                ...
                return Wonder_jest.test("test change intensity", (function (param) {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](FloatService$WonderEditor.truncateFloatValue(PointLightEngineService$WonderEditor.getPointLightIntensity(currentGameObjectPointLightComponent, StateEngineService$WonderEditor.unsafeGetState(/* () */0)), 5)), 10.1);
                            }));
              }));
        return /* () */0;
      }));
