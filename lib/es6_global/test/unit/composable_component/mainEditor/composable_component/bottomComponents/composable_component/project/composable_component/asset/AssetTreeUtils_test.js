...
describe("AssetTreeUtils", (function (param) {
        ...
        describe("isTreeNodeRelationError", (function (param) {
                beforeEach((function (param) {
                ...
                Wonder_jest.test("if source and target node is the same node, return true", (function (param) {
                ...
                describe("else", (function (param) {
                        Wonder_jest.test("if source node is target node's parent, return true", (function (param) {
                        ...
                        describe("else", (function (param) {
                                Wonder_jest.test("if target node is source node's parent, return true", (function (param) {
                                        var match = MainEditorAssetTreeTool$WonderEditor._increaseIndex(StateEditorService$WonderEditor.getState(/* () */0));
                                        var rootId = match[0];
                                        var match$1 = MainEditorAssetTreeTool$WonderEditor._increaseIndex(match[1]);
                                        var id1 = match$1[0];
                                ...
                                return Wonder_jest.test("else if target node's children has the node which has the same name with source node, return true", (function (param) {
                                              var match = MainEditorAssetTreeTool$WonderEditor._increaseIndex(StateEditorService$WonderEditor.getState(/* () */0));
                                              var rootId = match[0];
                                              var match$1 = MainEditorAssetTreeTool$WonderEditor._increaseIndex(match[1]);
                                              var id1 = match$1[0];
