...
describe("MainEditorConsole", (function () {
        ...
        describe("test stub console", (function () {
                ...
                Wonder_jest.test("console.log should add the message into content", (function () {
                ...
                Wonder_jest.test("console.info should add the message into content", (function () {
                        var partial_arg = "message";
                        StateLogicService$WonderEditor.getEditorState((function (param) {
                ...
                Wonder_jest.test("console.warn should add the message into content", (function () {
                        var partial_arg = "message";
                        StateLogicService$WonderEditor.getEditorState((function (param) {
                ...
                Wonder_jest.test("console.debug should add the message into content", (function () {
                        var partial_arg = "";
                ...
                Wonder_jest.test("console.error should add the message into content", (function () {
                        var partial_arg = "message";
                        StateLogicService$WonderEditor.getEditorState((function (param) {
                ...
                return Wonder_jest.test("console.trace should invoke Error.captureStackTrace", (function () {
