...
describe("MainEditorConsole", (function (param) {
        ...
        describe("test stub console", (function (param) {
                beforeEach((function (param) {
                ...
                return Wonder_jest.test("console.trace should invoke Error.captureStackTrace", (function (param) {
