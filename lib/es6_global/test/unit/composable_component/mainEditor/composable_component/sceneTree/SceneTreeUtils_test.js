...
describe("SceneTreeUtils", (function (param) {
        ...
        describe("isGameObjectRelationError", (function (param) {
                beforeEach((function (param) {
                ...
                Wonder_jest.test("if draged and target gameObject is the same one, return true ", (function (param) {
                ...
                describe("else", (function (param) {
                        Wonder_jest.test("if draged gameObject is target gameObject's parent, return true", (function (param) {
                        ...
                        describe("else", (function (param) {
                                return Wonder_jest.test("if target gameObject is draged gameObject's parent, return true", (function (param) {
                                              var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                                              var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                              var match = GameObjectToolEngine$WonderEditor.createGameObject(engineState);
                                              var gameObject1 = match[1];
