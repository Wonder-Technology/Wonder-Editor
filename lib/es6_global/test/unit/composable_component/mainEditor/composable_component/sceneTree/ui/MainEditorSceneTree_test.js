...
describe("MainEditorSceneTree", (function (param) {
        ...
        describe("get sceneTree from engine", (function (param) {
                describe("test should update", (function (param) {
                ...
                describe("test simple scene graph data which haven't children case", (function (param) {
                        beforeEach((function (param) {
                        ...
                        return Wonder_jest.test("drag treeNode into target treeNode", (function (param) {
                ...
                describe("set current gameObject", (function (param) {
                        beforeEach((function (param) {
                                return MainEditorSceneTool$WonderEditor.createDefaultScene(sandbox, (function (param) {
                                              return /* () */0;
                                            }));
                              }));
                        return Wonder_jest.test("click treeNode to set it to be currentSceneTreeNode", (function (param) {
                ...
                describe("deal with the specific case", (function (param) {
                        ...
                        describe("if drag treeNode into it's second layer chidlren", (function (param) {
