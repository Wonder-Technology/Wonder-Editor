...
import * as SceneViewEditorService$WonderEditor from "../../../../src/service/state/editor/sceneView/SceneViewEditorService.js";
...
describe("test mainEditor->resize", (function () {
        ...
        describe("resizeCanvasAndViewPort", (function () {
                describe("set canvas size", (function () {
                        return Wonder_jest.test("canvan's width and height should == parent's width and height", (function () {
                                      _prepareState(/* () */0);
                ...
                describe("set viewport", (function () {
                        return Wonder_jest.test("canvas's viewport should == canvas parent's width and height", (function () {
                                      _prepareState(/* () */0);
                                      var match = IMGUITool$WonderEditor.stubCanvasParentAndCanvas(sandbox);
                                      var parentDom = match[0];
                                      _resize(sandbox);
                ...
                describe("update view rect", (function () {
                        return Wonder_jest.test("update scene view and game view rect", (function () {
                                      _prepareState(/* () */0);
                                      var match = IMGUITool$WonderEditor.stubCanvasParentAndCanvas(sandbox);
                                      var parentDom = match[0];
                ...
                describe("update all cameraProjections by new aspect", (function () {
                        ...
                        return Wonder_jest.test("test resize twice(the first resize is to mark all cameraProjections not dirty)", (function () {
                                      ...
                                      var pMatrix = PerspectiveCameraProjectionToolEngine$WonderEditor.buildPerspective(60, 100 / 200, 0.1, 1000);
