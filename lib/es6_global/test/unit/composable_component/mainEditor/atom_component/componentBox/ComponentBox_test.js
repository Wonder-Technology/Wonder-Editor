...
describe("componentBox", (function (param) {
        ...
        describe("test component arguments", (function (param) {
        ...
        describe("test show component workflow", (function (param) {
                describe("test click triangle once to hide the common type component", (function (param) {
