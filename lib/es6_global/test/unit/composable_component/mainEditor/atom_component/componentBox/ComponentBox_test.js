...
import * as ComponentBox$WonderEditor from "../../../../../../src/core/composable_component/mainEditor/atom_component/componentBox/ui/ComponentBox.js";
...
describe("componentBox", (function () {
        ...
        describe("test show component workflow", (function () {
                var _triggerClickTransformTriangle = function (domChildren) {
                  var inspector = ArrayService$WonderEditor.getNth(0, domChildren);
                  var array = inspector.children;
                  var transformArcticle = ArrayService$WonderEditor.getNth(1, array);
                  var array$1 = transformArcticle.children;
                  var headerDiv = ArrayService$WonderEditor.getNth(0, array$1);
