...
describe("test mainEditor->bind event", (function (param) {
        ...
        describe("bind refresh_inspector event", (function (param) {
                return Wonder_jest.test("should dispatch", (function (param) {
                              _prepareState(/* () */0);
                              var dispatchFunc = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                              MainEditor$WonderEditor.Method[/* bindRefreshInspectorEvent */5](dispatchFunc);
