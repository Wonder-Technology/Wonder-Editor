...
describe("controller sceneTree", (function (param) {
        ...
        describe("test set parent in engine", (function (param) {
                ...
                return Wonder_jest.test("drag treeNode into target treeNode, set draged gameObject's parent to be target gameObject", (function (param) {
