...
describe("controller sceneTree", (function () {
        ...
        describe("test set parent in engine", (function () {
                ...
                return Wonder_jest.test("drag treeNode into target treeNode, set draged gameObject's parent to be target gameObject", (function () {
                              var targetRunGameObject = MainEditorSceneTool$WonderEditor.getBoxByIndex(0, StateLogicService$WonderEditor.getRunEngineState(/* () */0));
                              var dragedRunGameObject = MainEditorSceneTool$WonderEditor.getBoxByIndex(1, StateLogicService$WonderEditor.getRunEngineState(/* () */0));
                              var targetEditGameObject = MainEditorSceneTool$WonderEditor.getBoxByIndex(0, StateLogicService$WonderEditor.getEditEngineState(/* () */0));
                              var dragedEditGameObject = MainEditorSceneTool$WonderEditor.getBoxByIndex(1, StateLogicService$WonderEditor.getEditEngineState(/* () */0));
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              GameObjectUtils$WonderEditor.getParent(dragedRunGameObject, StateLogicService$WonderEditor.getRunEngineState(/* () */0)),
                                              GameObjectUtils$WonderEditor.getParent(dragedEditGameObject, StateLogicService$WonderEditor.getEditEngineState(/* () */0))
                                            ]), /* tuple */[
                                          targetRunGameObject,
                                          targetEditGameObject
                                        ]);
                            }));
              }));
        return /* () */0;
