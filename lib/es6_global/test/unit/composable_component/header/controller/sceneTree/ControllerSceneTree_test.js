...
describe("controller sceneTree", (function () {
        ...
        describe("test set parent in engine", (function () {
                ...
                return Wonder_jest.test("drag treeNode into target treeNode, set dragged gameObject's parent to be target gameObject", (function () {
                              ...
                              MainEditorSceneTreeTool$WonderEditor.Drag[/* dragGameObjectIntoGameObject */2](draggedGameObject, targetGameObject, undefined, undefined, /* () */0);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectUtils$WonderEditor.getParent(draggedGameObject, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), targetGameObject);
                            }));
              }));
        return /* () */0;
      }));
