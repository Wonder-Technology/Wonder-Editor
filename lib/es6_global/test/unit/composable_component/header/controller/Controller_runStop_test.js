...
describe("controller run and stop", (function (param) {
        ...
        describe("test run", (function (param) {
                ...
                describe("bind game view active camera->arcball camera controller event", (function (param) {
        ...
        describe("test stop", (function (param) {
                describe("stop current loop", (function (param) {
                        ...
                        describe("cancelAnimationFrame should called with current loopId", (function (param) {
                ...
                describe("unbind game view active camera->arcball camera controller event", (function (param) {
                        return Wonder_jest.test("test", (function (param) {
                                      Curry._1(ControllerTool$WonderEditor.stubRequestAnimationFrame, Sinon.createEmptyStubWithJsObjSandbox(sandbox));
