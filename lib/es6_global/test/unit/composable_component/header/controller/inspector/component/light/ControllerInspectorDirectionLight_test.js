        ...
        describe("test set value into edit and run engineState", (function () {
                Wonder_jest.test("test change color", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        Color$WonderEditor.getHexString(DirectionLightEngineService$WonderEditor.getDirectionLightColor(DiffComponentTool$WonderEditor.getEditEngineComponent(/* DirectionLight */6, currentGameObjectDirectionLightComponent), StateLogicService$WonderEditor.getEditEngineState(/* () */0))),
                ...
                return Wonder_jest.test("test change intensity", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              _getDirectionLightIntensity(DiffComponentTool$WonderEditor.getEditEngineComponent(/* DirectionLight */6, currentGameObjectDirectionLightComponent), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
