        ...
        describe("test set value into edit and run engineState", (function () {
                Wonder_jest.test("test change color", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        Color$WonderEditor.getHexString(PointLightEngineService$WonderEditor.getPointLightColor(DiffComponentTool$WonderEditor.getEditEngineComponent(/* PointLight */6, currentGameObjectPointLightComponent), StateLogicService$WonderEditor.getEditEngineState(/* () */0))),
                ...
                return Wonder_jest.test("test change intensity", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              _getPointLightIntensity(DiffComponentTool$WonderEditor.getEditEngineComponent(/* PointLight */6, currentGameObjectPointLightComponent), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
