...
describe("controller inspector transform", (function () {
        ...
        describe("test set transform in ee and re engine state", (function () {
                Wonder_jest.test("current gameObject's tranform position should set into engine", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        TransformEngineService$WonderEditor.getLocalPosition(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Transform */1, currentGameObjectTransform), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                                        TransformEngineService$WonderEditor.getLocalPosition(currentGameObjectTransform, StateLogicService$WonderEditor.getRunEngineState(/* () */0))
                                      ]), /* tuple */[
                                    /* tuple */[
                                      155,
                                      0,
                ...
                Wonder_jest.test("current gameObject's tranform scale should set into engine", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        TransformUtils$WonderEditor.truncateTransformValue(TransformEngineService$WonderEditor.getLocalEulerAngles(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Transform */1, currentGameObjectTransform), StateLogicService$WonderEditor.getEditEngineState(/* () */0))),
                                        TransformUtils$WonderEditor.truncateTransformValue(TransformEngineService$WonderEditor.getLocalEulerAngles(currentGameObjectTransform, StateLogicService$WonderEditor.getRunEngineState(/* () */0)))
                                      ]), /* tuple */[
                                    /* tuple */[
                                      19,
                                      0,
                ...
                return Wonder_jest.test("current gameObject's tranform scale should set into engine", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              TransformEngineService$WonderEditor.getLocalScale(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Transform */1, currentGameObjectTransform), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                                              TransformEngineService$WonderEditor.getLocalScale(currentGameObjectTransform, StateLogicService$WonderEditor.getRunEngineState(/* () */0))
                                            ]), /* tuple */[
                                          /* tuple */[
                                            15,
                                            1,
