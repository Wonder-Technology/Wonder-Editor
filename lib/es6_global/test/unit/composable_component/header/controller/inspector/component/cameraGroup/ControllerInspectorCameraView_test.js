...
describe("controller inspector cameraView", (function (param) {
        ...
        describe("test camera bind arcballCameraController event", (function (param) {
                describe("test has two cameras with arcballCameraController component", (function (param) {
                        beforeEach((function (param) {
                        ...
                        Wonder_jest.test("test click run, the current camera arcballCameraController should bind event, the other camera shouldn't bind event", (function (param) {
                        ...
                        Wonder_jest.test("test click stop, the two camera arcballCameraController shouldn't bind event", (function (param) {
                                var match = MainEditorInspectorAddComponentTool$WonderEditor.buildTwoAddedArcballCameraControllerCamera(sandbox);
                                ControllerTool$WonderEditor.run(/* () */0);
                        ...
                        describe("test click run and change current camera", (function (param) {
