                ...
                describe("test set value into edit and run engineState", (function () {
                        describe("test change arcballCameraController distance", (function () {
                                ...
                                return Wonder_jest.test("test change distance should set into engine", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                              _getArcballCameraDistance(DiffComponentTool$WonderEditor.getEditEngineComponent(/* ArcballCameraController */9, currentGameObjectArcballCamera), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                        ...
                        describe("test change arcballCameraController minDistance", (function () {
                                ...
                                return Wonder_jest.test("test change minDistance should set into engine", (function () {
                                              ...
                                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                                              _getArcballCameraMinDistance(DiffComponentTool$WonderEditor.getEditEngineComponent(/* ArcballCameraController */9, currentGameObjectArcballCamera), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
