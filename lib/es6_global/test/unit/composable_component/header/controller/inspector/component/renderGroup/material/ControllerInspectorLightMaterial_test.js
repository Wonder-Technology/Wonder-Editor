...
describe("controller inspector light material", (function () {
        ...
        describe("test set value into edit and run engineState", (function () {
                ...
                return Wonder_jest.test("test change shininess", (function () {
                              ...
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              _getLightMaterialShininessValue(DiffComponentTool$WonderEditor.getEditEngineComponent(/* LightMaterial */4, currentGameObjectMaterial), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
