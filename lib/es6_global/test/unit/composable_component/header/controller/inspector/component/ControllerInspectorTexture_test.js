...
describe("controller inspector texture", (function () {
        ...
        describe("test set value into engineState", (function () {
                Wonder_jest.test("test rename texture", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.unsafeGetBasicSourceTextureName(textureIndex, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), newName);
                      }));
                Wonder_jest.test("test change wrapS", (function () {
                        ...
                        var textureIndex = MainEditorAssetNodeTool$WonderEditor.getTextureIndexFromCurrentNodeId(/* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.getWrapS(textureIndex, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), wrapRepeatType);
                      }));
                Wonder_jest.test("test change wrapT", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.getWrapT(textureIndex, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), wrapMirroredRepeatType);
                      }));
                Wonder_jest.test("test change magFilter", (function () {
                        ...
                        var textureIndex = TextureInspectorTool$WonderEditor.getTextureIndexFromCurrentNodeData(/* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.getMagFilter(textureIndex, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), filterLinearMipmapLinearType);
                      }));
                return Wonder_jest.test("test change minFilter", (function () {
                              ...
                              var textureIndex = TextureInspectorTool$WonderEditor.getTextureIndexFromCurrentNodeData(/* () */0);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](BasicSourceTextureEngineService$WonderEditor.getMinFilter(textureIndex, StateEngineService$WonderEditor.unsafeGetState(/* () */0))), filterNearestMipmapLinearType);
                            }));
              }));
        return /* () */0;
      }));
