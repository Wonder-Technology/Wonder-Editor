        ...
        describe("test set value into edit and run engineState", (function () {
                Wonder_jest.test("test rename texture", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        BasicSourceTextureEngineService$WonderEditor.unsafeGetBasicSourceTextureName(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Texture */10, textureIndex), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                ...
                Wonder_jest.test("test change wrapS", (function () {
                        ...
                        var textureIndex = MainEditorAssetNodeTool$WonderEditor.getTextureIndexFromCurrentNodeId(/* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        BasicSourceTextureEngineService$WonderEditor.getWrapS(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Texture */10, textureIndex), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                ...
                Wonder_jest.test("test change wrapT", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        BasicSourceTextureEngineService$WonderEditor.getWrapT(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Texture */10, textureIndex), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                ...
                Wonder_jest.test("test change magFilter", (function () {
                        ...
                        var textureIndex = TextureInspectorTool$WonderEditor.getTextureIndexFromCurrentNodeData(/* () */0);
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                        BasicSourceTextureEngineService$WonderEditor.getMagFilter(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Texture */10, textureIndex), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
                ...
                return Wonder_jest.test("test change minFilter", (function () {
                              ...
                              var textureIndex = TextureInspectorTool$WonderEditor.getTextureIndexFromCurrentNodeData(/* () */0);
                              return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](/* tuple */[
                                              BasicSourceTextureEngineService$WonderEditor.getMinFilter(DiffComponentTool$WonderEditor.getEditEngineComponent(/* Texture */10, textureIndex), StateLogicService$WonderEditor.getEditEngineState(/* () */0)),
