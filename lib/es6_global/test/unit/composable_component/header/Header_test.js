                ...
                describe("test Controls", (function () {
                        describe("test modal content", (function () {
                                var _test = function (setOSFunc) {
                                  ...
                                  return ReactTestTool$WonderEditor.createSnapshotAndMatch(BuildComponentTool$WonderEditor.buildUI(HeaderTool$WonderEditor.buildFileComponent(HeaderTool$WonderEditor.buildState(undefined, undefined, true, undefined, undefined, undefined, undefined, /* () */0), Sinon.createEmptyStubWithJsObjSandbox(sandbox), undefined, undefined, /* () */0)));
                                };
                                Wonder_jest.test("if os is mac, should show command hot keys", (function () {
                                        return _test(DetectOSTool$WonderEditor.setOSToBeMac);
                                      }));
                                return Wonder_jest.test("else, shouldn't show command hot keys", (function () {
