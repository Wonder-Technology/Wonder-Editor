...
describe("reactTestRenderer", (function () {
        Jest.test("create returns ReactTestInstance", (function () {
                var component = ReactTestRenderer.create(ReasonReact.element(/* None */0, /* None */0, NumberInput$WonderEditor.make(/* None */0, /* None */0, /* array */[])));
        ...
        Jest.test("numberInput component has defaultValue", (function () {
                var component = ReactTestRenderer.create(ReasonReact.element(/* None */0, /* None */0, NumberInput$WonderEditor.make(/* Some */["12.2"], /* None */0, /* array */[])));
                var json = component.toJSON();
                return Jest.ExpectJs[/* toMatchSnapshot */16](Jest.ExpectJs[/* expect */0](json));
              }));
        Jest.test("numberInput component has label", (function () {
                var component = ReactTestRenderer.create(ReasonReact.element(/* None */0, /* None */0, NumberInput$WonderEditor.make(/* None */0, /* Some */["xyz"], /* array */[])));
                var json = component.toJSON();
                return Jest.ExpectJs[/* toMatchSnapshot */16](Jest.ExpectJs[/* expect */0](json));
              }));
        return Jest.test("numberInput component has defaultValue and label", (function () {
                      var component = ReactTestRenderer.create(ReasonReact.element(/* None */0, /* None */0, NumberInput$WonderEditor.make(/* Some */["22"], /* Some */["xyz"], /* array */[])));
                      var json = component.toJSON();
                      return Jest.ExpectJs[/* toMatchSnapshot */16](Jest.ExpectJs[/* expect */0](json));
                    }));
      }));
