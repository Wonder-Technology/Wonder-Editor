...
function getSimpleSceneTree(param) {
  return /* array */[/* record */[
            /* name */"root",
            /* uid */0,
            /* isShowChildren */true,
...
function getTwoLayerSceneTree(param) {
  return /* array */[/* record */[
            /* name */"root",
            /* uid */0,
            /* isShowChildren */true,
...
function getThreeLayerSceneTree(param) {
  return /* array */[/* record */[
            /* name */"root",
            /* uid */0,
            /* isShowChildren */true,
...
function dragWDBAssetToSceneTree(wdbNodeId, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, param) {
  ...
  var dragImg = $staropt$star$5 !== undefined ? Caml_option.valFromOption($staropt$star$5) : document.createElement("img");
  var $$event = $staropt$star$6 !== undefined ? Caml_option.valFromOption($staropt$star$6) : BaseEventTool$WonderEditor.buildDragEvent();
  DragEventUtils$WonderEditor.handleDragStart(wdbNodeId, widget, dragImg, effectEffectAllowd, $$event);
  var param$1 = SparseMapService$WonderCommonlib.unsafeGet(wdbNodeId, WDBNodeMapAssetEditorService$WonderEditor.getWDBNodeMap(StateEditorService$WonderEditor.getState(/* () */0)));
...
function dragGameObjectIntoGameObject(sourceGameObject, targetGameObject, $staropt$star, $staropt$star$1, param) {
