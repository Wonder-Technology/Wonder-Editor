...
describe("WDBNodeAssetEditorService", (function () {
        ...
        describe("isWDBAssetFile", (function () {
                ...
                describe("test current drag source contain asset widget", (function () {
                        Wonder_jest.test("if current drag source contain texture node, return false", (function () {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](WDBNodeAssetEditorService$WonderEditor.isWDBAssetFile(/* () */0)), false);
                              }));
                        return Wonder_jest.test("if current drag source contain wdb node, return true", (function () {
                                      ...
                                      StateEditorService$WonderEditor.setState(editorState$1);
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](WDBNodeAssetEditorService$WonderEditor.isWDBAssetFile(/* () */0)), true);
                                    }));
                      }));
                return /* () */0;
              }));
