        ...
        describe("checkGameObjectRelation", (function () {
                ...
                describe("else", (function () {
                        Wonder_jest.test("if dragged gameObject is target gameObject's parent, return fail", (function (param) {
                                ...
                                return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](Result$WonderEditor.RelationResult[/* isSuccess */2](CheckSceneTreeLogicService$WonderEditor.checkGameObjectRelation(gameObject2, gameObject1, /* tuple */[
                                                        editorState,
                                                        engineState$1
                                                      ]))), false);
                              }));
                        describe("else", (function () {
                                return Wonder_jest.test("if target gameObject is dragged gameObject's parent, return fail", (function (param) {
                                              ...
                                              var gameObject2 = match$1[1];
                                              var engineState$1 = HierarchyGameObjectEngineService$WonderEditor.addChild(gameObject1, gameObject2, match$1[0]);
                                              return Curry._2(Wonder_jest.Expect[/* Operators */25][/* = */5], Wonder_jest.Expect[/* expect */0](Result$WonderEditor.RelationResult[/* isSuccess */2](CheckSceneTreeLogicService$WonderEditor.checkGameObjectRelation(gameObject1, gameObject2, /* tuple */[
                                                                      editorState,
                                                                      engineState$1
                                                                    ]))), false);
                                            }));
