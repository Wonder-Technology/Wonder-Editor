...
describe("engine: mainEditor inspector", (function () {
        ...
        describe("test current gameObject", (function () {
                Wonder_jest.test("if not set currentGameObject, there hasn't currentGameObject", (function () {
                        ...
                        return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectTool$WonderEditor.hasCurrentGameObject(/* () */0)), /* false */0);
                      }));
                describe("else can get currentGameObject", (function () {
                        beforeEach((function () {
                                ...
                                return GameObjectTool$WonderEditor.setCurrentGameObject(2);
                              }));
                        Wonder_jest.test("the hasCurrentGameObject should == true", (function () {
                                return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectTool$WonderEditor.hasCurrentGameObject(/* () */0)), /* true */1);
                              }));
                        return Wonder_jest.test("the currentGameObject should == the set one", (function () {
                                      return Curry._2(Wonder_jest.Expect[/* Operators */23][/* = */5], Wonder_jest.Expect[/* expect */0](GameObjectTool$WonderEditor.unsafeGetCurrentGameObject(/* () */0)), 2);
                                    }));
                      }));
                return /* () */0;
              }));
