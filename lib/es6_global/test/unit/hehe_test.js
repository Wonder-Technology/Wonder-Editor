...
describe("test hehe", (function () {
        ...
        Jest.test("test pass one string to empty stub", (function () {
        ...
        describe("test extended sinon matcher for jest", (function () {
                Jest.test("test toCalledWith", (function () {
                        ...
                        return Sinon$WonderEditor.toCalledWith(/* :: */[
                                  ...
                                  ], Jest.Expect[/* expect */0](Sinon$WonderEditor.getCall(stub, 1)));
                      }));
                ...
                Jest.test("test toCalledOnce", (function () {
                        ...
                        var func = obj.func1;
                        Curry._2(func, 1, 2);
                        return Sinon$WonderEditor.toCalledOnce(Jest.Expect[/* expect */0](stub1));
                      }));
                ...
                return Jest.test("test toCalledCount", (function () {
                              var obj = {
                                func1: (function (x, y) {
                                    return x + y | 0;
                                  }),
