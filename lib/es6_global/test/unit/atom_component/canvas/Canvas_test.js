...
describe("Canvas", (function (param) {
        ...
        describe("test drag wdb", (function (param) {
                ...
                describe("test drag wdb to scene", (function (param) {
                        return Wonder_jest.testPromise("if current sceneTree node is None, add to scene", (function (param) {
                ...
                describe("test drag wdb to gameObject", (function (param) {
                        return Wonder_jest.testPromise("should add to current sceneTree node's children", (function (param) {
                                      return MainEditorAssetUploadTool$WonderEditor.loadOneWDB(boxTexturedWDBArrayBuffer[0], undefined, undefined, undefined, /* () */0).then((function (uploadedWDBNodeId) {
