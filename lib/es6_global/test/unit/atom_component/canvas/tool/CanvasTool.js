...
function dragWDBAsset(wdbNodeId, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, param) {
  ...
  var dragImg = $staropt$star$4 !== undefined ? Caml_option.valFromOption($staropt$star$4) : document.createElement("img");
  var $$event = $staropt$star$5 !== undefined ? Caml_option.valFromOption($staropt$star$5) : BaseEventTool$WonderEditor.buildDragEvent();
