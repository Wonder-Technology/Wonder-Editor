...
describe("Swicth", (function () {
        ...
        describe("test workflow", (function () {
                describe("test initial:is close", (function () {
                        ...
                        return Wonder_jest.test("click button should execute onOpen func", (function () {
                ...
                describe("test initial:is open", (function () {
                        Wonder_jest.test("show openText", (function () {
                                return ReactTestTool$WonderEditor.createSnapshotAndMatch(buildSwitch(true));
                              }));
                        return Wonder_jest.test("click button should execute onClose func", (function () {
                                      var onCloseFunc = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
                                      var onOpenFunc = Sinon.createEmptyStubWithJsObjSandbox(sandbox);
