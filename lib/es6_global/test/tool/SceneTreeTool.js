...
function buildTwoCameraSceneGraphToEngine(sandbox) {
  ...
  var defaultLightMaterial = MaterialDataAssetEditorService$WonderEditor.unsafeGetDefaultLightMaterial(editorState$1);
...
function _buildThreeLayerSceneGraph(componentData, editorState, engineState) {
  ...
  return /* tuple */[
          match$3[0],
          GameObjectUtils$WonderEditor.addChild(scene, box3, GameObjectUtils$WonderEditor.addChild(scene, box2, GameObjectUtils$WonderEditor.addChild(box1, box4, GameObjectUtils$WonderEditor.addChild(scene, box1, match$3[1])))),
          /* tuple */[
            scene,
            /* tuple */[
              box1,
