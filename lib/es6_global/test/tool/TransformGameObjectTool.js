...
function setLocalRotation(gameObject, localRotation, engineState) {
  return TransformEngineService$WonderEditor.setLocalRotation(GameObjectComponentEngineService$WonderEditor.unsafeGetTransformComponent(gameObject, engineState), localRotation, engineState);
}
