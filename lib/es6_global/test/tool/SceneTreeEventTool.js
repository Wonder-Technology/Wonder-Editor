...
function triggerClickEvent(treeNodeIndex, domChildren) {
  ...
  var treeNodeUl = ArrayService$WonderEditor.unsafeGetNth(treeNodeIndex, array);
...
function _getTriggerDragParentDiv(index, domChildren) {
  var dragTreeArticle = ArrayService$WonderEditor.unsafeGetNth(0, domChildren);
  var array = dragTreeArticle.children;
  var treeNodeUl = ArrayService$WonderEditor.unsafeGetNth(index, array);
  var array$1 = treeNodeUl.children;
  var treeNodeLi = ArrayService$WonderEditor.unsafeGetNth(0, array$1);
  var array$2 = treeNodeLi.children;
  return ArrayService$WonderEditor.unsafeGetNth(0, array$2);
}
...
function _getTriggerDragChildrenDiv(parentIndex, childrenIndex, domChildren) {
  ...
  var treeNodeLi = ArrayService$WonderEditor.unsafeGetNth(0, array$2);
  var array$3 = treeNodeLi.children;
  return ArrayService$WonderEditor.unsafeGetNth(0, array$3);
}
...
function triggerDragEnterDiv(index, domChildren) {
  var dragTreeArticle = ArrayService$WonderEditor.unsafeGetNth(0, domChildren);
  var array = dragTreeArticle.children;
  var div = ArrayService$WonderEditor.unsafeGetNth(index, array);
  return BaseEventTool$WonderEditor.triggerDragEnterEvent(div, BaseEventTool$WonderEditor.buildDragEvent(/* () */0));
}
