...
function initWithJobConfigWithoutBuildFakeDom(sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, param) {
  var isDebug = $staropt$star !== undefined ? $staropt$star : "true";
  ...
  var state = NoWorkerJobConfigToolEngine$WonderEditor.create(noWorkerJobRecord, SettingToolEngine$WonderEditor.createStateAndSetToStateData(isDebug, Caml_option.some(canvasId), context, useHardwareInstance, buffer, undefined, /* () */0));
  if (isInitJob) {
...
function createAndSetEngineState(sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, param) {
  ...
  StateEngineService$WonderEditor.setState(initWithJobConfigWithoutBuildFakeDom(sandbox, undefined, undefined, context, undefined, buffer, noWorkerJobRecord, undefined, isInitJob, /* () */0));
  return /* () */0;
}
