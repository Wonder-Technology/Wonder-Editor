...
function buildFakeGl(sandbox, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, $staropt$star$8, $staropt$star$9, $staropt$star$10, $staropt$star$11, $staropt$star$12, $staropt$star$13, $staropt$star$14, $staropt$star$15, $staropt$star$16, $staropt$star$17, $staropt$star$18, $staropt$star$19, $staropt$star$20, $staropt$star$21, $staropt$star$22, $staropt$star$23, $staropt$star$24, $staropt$star$25, $staropt$star$26, $staropt$star$27, $staropt$star$28, $staropt$star$29, $staropt$star$30, $staropt$star$31, $staropt$star$32, $staropt$star$33, $staropt$star$34, $staropt$star$35, $staropt$star$36, $staropt$star$37, $staropt$star$38, $staropt$star$39, $staropt$star$40, $staropt$star$41, $staropt$star$42, $staropt$star$43, $staropt$star$44, $staropt$star$45, $staropt$star$46, $staropt$star$47, $staropt$star$48, $staropt$star$49, $staropt$star$50, $staropt$star$51, $staropt$star$52, $staropt$star$53, $staropt$star$54, $staropt$star$55, $staropt$star$56, $staropt$star$57, $staropt$star$58, $staropt$star$59, $staropt$star$60, $staropt$star$61, $staropt$star$62, $staropt$star$63, $staropt$star$64, $staropt$star$65, $staropt$star$66, $staropt$star$67, $staropt$star$68, $staropt$star$69, $staropt$star$70, $staropt$star$71, $staropt$star$72, $staropt$star$73, $staropt$star$74, $staropt$star$75, $staropt$star$76, $staropt$star$77, $staropt$star$78, $staropt$star$79, $staropt$star$80, $staropt$star$81, $staropt$star$82, $staropt$star$83, $staropt$star$84, $staropt$star$85, $staropt$star$86, $staropt$star$87, $staropt$star$88, $staropt$star$89, $staropt$star$90, $staropt$star$91, $staropt$star$92, $staropt$star$93, $staropt$star$94, $staropt$star$95, $staropt$star$96, $staropt$star$97, $staropt$star$98, $staropt$star$99, $staropt$star$100, $staropt$star$101, $staropt$star$102, $staropt$star$103, $staropt$star$104, $staropt$star$105, $staropt$star$106, $staropt$star$107, $staropt$star$108, $staropt$star$109, $staropt$star$110, $staropt$star$111, param) {
  ...
  var deleteShader = $staropt$star$86 !== undefined ? Caml_option.valFromOption($staropt$star$86) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var deleteBuffer = $staropt$star$87 !== undefined ? Caml_option.valFromOption($staropt$star$87) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var getAttribLocation = $staropt$star$88 !== undefined ? Caml_option.valFromOption($staropt$star$88) : Sinon.returns(0, Curry._1(Sinon.createEmptyStub, sandbox[0]));
  var getUniformLocation = $staropt$star$89 !== undefined ? Caml_option.valFromOption($staropt$star$89) : Sinon.returns(0, Curry._1(Sinon.createEmptyStub, sandbox[0]));
  var bindBuffer = $staropt$star$90 !== undefined ? Caml_option.valFromOption($staropt$star$90) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var resetBuffer = $staropt$star$91 !== undefined ? Caml_option.valFromOption($staropt$star$91) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var createBuffer = $staropt$star$92 !== undefined ? Caml_option.valFromOption($staropt$star$92) : Sinon.returns(0, Curry._1(Sinon.createEmptyStub, sandbox[0]));
  var bufferData = $staropt$star$93 !== undefined ? Caml_option.valFromOption($staropt$star$93) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var bufferSubData = $staropt$star$94 !== undefined ? Caml_option.valFromOption($staropt$star$94) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var vertexAttribPointer = $staropt$star$95 !== undefined ? Caml_option.valFromOption($staropt$star$95) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var enableVertexAttribArray = $staropt$star$96 !== undefined ? Caml_option.valFromOption($staropt$star$96) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var uniformMatrix3fv = $staropt$star$97 !== undefined ? Caml_option.valFromOption($staropt$star$97) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var uniformMatrix4fv = $staropt$star$98 !== undefined ? Caml_option.valFromOption($staropt$star$98) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var uniform1i = $staropt$star$99 !== undefined ? Caml_option.valFromOption($staropt$star$99) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var uniform1f = $staropt$star$100 !== undefined ? Caml_option.valFromOption($staropt$star$100) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var uniform3f = $staropt$star$101 !== undefined ? Caml_option.valFromOption($staropt$star$101) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var drawElements = $staropt$star$102 !== undefined ? Caml_option.valFromOption($staropt$star$102) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var drawArray = $staropt$star$103 !== undefined ? Caml_option.valFromOption($staropt$star$103) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var viewport = $staropt$star$104 !== undefined ? Caml_option.valFromOption($staropt$star$104) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var scissor = $staropt$star$105 !== undefined ? Caml_option.valFromOption($staropt$star$105) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var clearColor = $staropt$star$106 !== undefined ? Caml_option.valFromOption($staropt$star$106) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var clear = $staropt$star$107 !== undefined ? Caml_option.valFromOption($staropt$star$107) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var colorMask = $staropt$star$108 !== undefined ? Caml_option.valFromOption($staropt$star$108) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var depthMask = $staropt$star$109 !== undefined ? Caml_option.valFromOption($staropt$star$109) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var useProgram = $staropt$star$110 !== undefined ? Caml_option.valFromOption($staropt$star$110) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  var disableVertexAttribArray = $staropt$star$111 !== undefined ? Caml_option.valFromOption($staropt$star$111) : Curry._1(Sinon.createEmptyStub, sandbox[0]);
  return {
