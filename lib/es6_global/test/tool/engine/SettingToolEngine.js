...
function setMemory(state, $staropt$star, _) {
  ...
  var init = state[/* settingRecord */1];
  var init$1 = OperateSettingService$Wonderjs.unsafeGetMemory(state[/* settingRecord */1]);
  newrecord[/* settingRecord */1] = /* record */[
...
function setBufferSize(state, $staropt$star, _) {
  ...
  var newrecord = Caml_array.caml_array_dup(state);
  var init = state[/* settingRecord */1];
  var init$1 = BufferSettingService$Wonderjs.unsafeGetBuffer(state[/* settingRecord */1]);
  newrecord[/* settingRecord */1] = /* record */[
    /* canvasId */init[/* canvasId */0],
...
function unsafeGetGPU(state) {
  return OperateSettingService$Wonderjs.unsafeGetGPU(state[/* settingRecord */1]);
}
