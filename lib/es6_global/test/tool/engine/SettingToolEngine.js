...
function buildBufferConfigStr($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, $staropt$star$8, $staropt$star$9, $staropt$star$10, $staropt$star$11, $staropt$star$12, _) {
  ...
  var textureCountPerMaterial = $staropt$star$8 !== undefined ? $staropt$star$8 : 3;
  var basicSourceTextureCount = $staropt$star$9 !== undefined ? $staropt$star$9 : 50;
  var arrayBufferViewSourceTextureCount = $staropt$star$10 !== undefined ? $staropt$star$10 : 50;
...
function setBufferSize(state, $staropt$star, _) {
  ...
  newrecord[/* settingRecord */0] = /* record */[
    ...
    /* buffer *//* record */[
      ...
      /* textureCountPerMaterial */init$1[/* textureCountPerMaterial */7],
      /* basicSourceTextureCount */init$1[/* basicSourceTextureCount */8],
      /* arrayBufferViewSourceTextureCount */init$1[/* arrayBufferViewSourceTextureCount */9],
