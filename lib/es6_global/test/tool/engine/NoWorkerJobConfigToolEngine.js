...
function create(param, state) {
  ...
  newrecord[/* noWorkerJobRecord */3] = /* record */[
...
function getSetting(state) {
  return OperateNoWorkerJobService$Wonderjs.getSetting(state[/* noWorkerJobRecord */3]);
}

function getInitJobs(state) {
  return OperateNoWorkerJobService$Wonderjs.getInitJobs(state[/* noWorkerJobRecord */3]);
}

function getLoopPipelines(state) {
  return OperateNoWorkerJobService$Wonderjs.getLoopPipelines(state[/* noWorkerJobRecord */3]);
}

function getLoopJobs(state) {
  return OperateNoWorkerJobService$Wonderjs.getLoopJobs(state[/* noWorkerJobRecord */3]);
}

function getInitPipelines(state) {
  return OperateNoWorkerJobService$Wonderjs.getInitPipelines(state[/* noWorkerJobRecord */3]);
}
