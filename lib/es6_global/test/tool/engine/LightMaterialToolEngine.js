...
function getNewLightMaterial($staropt$star, _) {
  ...
  return ComponentToolEngine$WonderEditor.generateIndex(geometryRecord[/* index */0], geometryRecord[/* disposedIndexArray */14])[0];
}
