...
function buildConsole($staropt$star, $staropt$star$1, _) {
...
function buildBottom($staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
...
function buildBottomHeader($staropt$star, $staropt$star$1, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
...
function buildGeometry(geometryComponent, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
...
function buildMaterial($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
...
function buildMaterialMap($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
  var store = $staropt$star !== undefined ? $staropt$star : TestTool$WonderEditor.buildEmptyAppState(/* () */0);
  var dispatchFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : TestTool$WonderEditor.getDispatch(/* () */0);
  var isShowTextureGroup = $staropt$star$2 !== undefined ? $staropt$star$2 : false;
  var materialComponent = $staropt$star$3 !== undefined ? $staropt$star$3 : GameObjectTool$WonderEditor.getCurrentGameObjectMaterial(/* () */0);
  return ReactTestRenderer.create(ReasonReact.element(undefined, undefined, MainEditorMaterialMap$WonderEditor.make(store, dispatchFunc, materialComponent, "Diffuse map", LightMaterialEngineService$WonderEditor.getLightMaterialDiffuseMap, MainEditorLightMaterial$WonderEditor.Method[/* onDrop */3], MainEditorLightMaterial$WonderEditor.Method[/* removeTexture */4], isShowTextureGroup, /* array */[])));
}
...
function buildAssetChildrenNode($staropt$star, _) {
