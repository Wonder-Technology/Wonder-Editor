...
import * as MainEditorAsset$WonderEditor from "../../src/core/composable_component/mainEditor/composable_component/bottom_components/asset/ui/MainEditorAsset.js";
...
import * as MainEditorConsole$WonderEditor from "../../src/core/composable_component/mainEditor/composable_component/bottom_components/console/ui/MainEditorConsole.js";
...
import * as MainEditorAssetChildrenNode$WonderEditor from "../../src/core/composable_component/mainEditor/composable_component/bottom_components/asset/composable_component/assetChildrenNode/ui/MainEditorAssetChildrenNode.js";
...
function buildConsole() {
  return ReactTestRenderer.create(ReasonReact.element(undefined, undefined, MainEditorConsole$WonderEditor.make(true, /* array */[])));
}
...
function buildGeometry(store, geometryComponent) {
  return ReactTestRenderer.create(ReasonReact.element(undefined, undefined, MainEditorGeometry$WonderEditor.make(store, TestTool$WonderEditor.getDispatch(/* () */0), GameObjectTool$WonderEditor.unsafeGetCurrentSceneTreeNode(/* () */0), geometryComponent, /* array */[])));
}
...
function buildAssetComponent() {
  return ReactTestRenderer.create(ReasonReact.element(undefined, undefined, MainEditorAsset$WonderEditor.make(TestTool$WonderEditor.buildEmptyAppState(/* () */0), TestTool$WonderEditor.getDispatch(/* () */0), true, /* array */[])));
}
