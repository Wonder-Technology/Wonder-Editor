...
function buildTwoJsonFileEvent($staropt$star, $staropt$star$1, _) {
  var jsonName = $staropt$star !== undefined ? $staropt$star : "loadJson";
  var jsonResult = $staropt$star$1 !== undefined ? $staropt$star$1 : "loadJson string result";
  return {
          target: {
            files: {
              "0": {
