...
function generateWDB(buildWDBGameObjectFunc) {
  ...
  LoadTool$WonderEditor.buildFakeTextEncoder();
  var match$3 = HeaderExportSceneWDBUtils$WonderEditor.generateWDB(match$1[0], Uint8ArrayAssetEditorService$WonderEditor.buildImageUint8ArrayMap(match$2[0]), GenerateSceneGraphEngineService$WonderEditor.generateWDB, match$2[1]);
...
function generateDirectionPointLightsAndCubeWDB() {
