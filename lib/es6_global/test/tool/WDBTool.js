...
function _createStateTuple() {
  var sandbox = Sinon$1.sandbox.create();
  MainEditorSceneTool$WonderEditor.initStateWithJob(/* record */[/* contents */sandbox], NoWorkerJobConfigToolEngine$WonderEditor.buildNoWorkerEmptyJobConfig(/* () */0), undefined, false, undefined, /* () */0);
  ...
  var engineState$1 = FakeGlToolEngine$WonderEditor.setFakeGl(FakeGlToolEngine$WonderEditor.buildFakeGl(/* record */[/* contents */sandbox], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0), engineState);
  return /* tuple */[
          editorState,
          engineState$1
        ];
...
function _buildFakeCanvas(sandbox, base64, _) {
...
function generateWDB(buildWDBGameObjectFunc) {
  ...
  LoadTool$WonderEditor.buildFakeTextEncoder();
  var match$3 = HeaderExportSceneWDBUtils$WonderEditor.generateWDB(match$1[0], GenerateSceneGraphEngineService$WonderEditor.generateWDB, /* tuple */[
        match$2[0],
        match$2[1]
      ]);
...
function buildSource($staropt$star, $staropt$star$1, $staropt$star$2, _) {
...
function generateDirectionPointLightsAndBoxWDB() {
  return generateWDB((function (editorState, engineState) {
                ...
                var engineState$1 = GameObjectUtils$WonderEditor.addChild(rootGameObject, match$4[2], GameObjectUtils$WonderEditor.addChild(rootGameObject, match$3[2], GameObjectUtils$WonderEditor.addChild(rootGameObject, match$2[2], match$5[0])));
                return /* tuple */[
                        rootGameObject,
                        /* tuple */[
                          match$4[0],
...
function generateSceneWDB() {
  return generateWDB((function (editorState, engineState) {
                var engineState$1 = ManageIMGUIEngineService$WonderEditor.setIMGUIFunc(null, (function (_, apiJsObj, engineState) {
                ...
                var match = GeometryEngineService$WonderEditor.createBoxGeometry(engineState$1);
                var match$1 = LightMaterialEngineService$WonderEditor.create(match[0]);
                var match$2 = PrimitiveEngineService$WonderEditor.createCube(/* tuple */[
                      match[1],
                      match$1[1]
                ...
                var match$6 = PrimitiveEngineService$WonderEditor.createDirectionLight(match$5[0], match$5[1]);
                var match$7 = GameObjectEngineService$WonderEditor.create(match$6[1]);
                var rootGameObject = match$7[1];
                var engineState$4 = GameObjectUtils$WonderEditor.addChild(rootGameObject, match$6[2], GameObjectUtils$WonderEditor.addChild(rootGameObject, camera, GameObjectUtils$WonderEditor.addChild(rootGameObject, match$2[2], match$7[0])));
                return /* tuple */[
                        rootGameObject,
                        /* tuple */[
                          match$6[0],
...
export {
  ...
  generateWDB ,
  buildSource ,
  generateDirectionPointLightsAndBoxWDB ,
  generateSceneWDB ,
