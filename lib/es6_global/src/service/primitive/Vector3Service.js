...
import * as FloatService$WonderEditor from "../atom/FloatService.js";
import * as ValueService$WonderEditor from "../atom/ValueService.js";
...
function truncate(digit, param) {
  return /* tuple */[
          FloatService$WonderEditor.truncateFloatValue(param[0], digit),
          FloatService$WonderEditor.truncateFloatValue(param[1], digit),
          FloatService$WonderEditor.truncateFloatValue(param[2], digit)
        ];
}
