...
function getComponentTypeMap(editorState) {
  return ComponentTypeMapInspectorService$WonderEditor.getComponentTypeMap(editorState[/* inspectorRecord */7]);
}
...
function clearComponentTypeMap(editorState) {
  return /* record */[
          ...
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.clearComponentTypeMap(editorState[/* inspectorRecord */7]),
...
function addComponentTypeToMap(index, componentType, editorState) {
  return /* record */[
          ...
          /* eventRecord */editorState[/* eventRecord */5],
          /* imguiRecord */editorState[/* imguiRecord */6],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.addComponentTypeToMap(index, componentType, editorState[/* inspectorRecord */7]),
          /* consoleRecord */editorState[/* consoleRecord */8],
          /* transformRecord */editorState[/* transformRecord */9],
          /* pickingRecord */editorState[/* pickingRecord */10],
          /* currentDragSource */editorState[/* currentDragSource */11],
...
function removeComponentTypeToMap(index, componentType, editorState) {
  return /* record */[
          ...
          /* eventRecord */editorState[/* eventRecord */5],
          /* imguiRecord */editorState[/* imguiRecord */6],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.removeComponentTypeToMap(index, componentType, editorState[/* inspectorRecord */7]),
          /* consoleRecord */editorState[/* consoleRecord */8],
          /* transformRecord */editorState[/* transformRecord */9],
          /* pickingRecord */editorState[/* pickingRecord */10],
          /* currentDragSource */editorState[/* currentDragSource */11],
...
function clearComponentType(editorState) {
  return /* record */[
          /* settingRecord */editorState[/* settingRecord */0],
          /* sceneTreeRecord */editorState[/* sceneTreeRecord */1],
          /* assetRecord */editorState[/* assetRecord */2],
          ...
          /* eventRecord */editorState[/* eventRecord */5],
          /* imguiRecord */editorState[/* imguiRecord */6],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.clearComponentType(editorState[/* inspectorRecord */7]),
          /* consoleRecord */editorState[/* consoleRecord */8],
          /* transformRecord */editorState[/* transformRecord */9],
          /* pickingRecord */editorState[/* pickingRecord */10],
          /* currentDragSource */editorState[/* currentDragSource */11],
...
function addSceneGameObjectComponentTypeToMap(sceneGameObject, editorState) {
  return addComponentTypeToMap(sceneGameObject, /* Transform */0, editorState);
}
