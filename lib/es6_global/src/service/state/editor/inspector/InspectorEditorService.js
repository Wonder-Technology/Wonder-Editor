...
function getComponentTypeMap(editorState) {
  return ComponentTypeMapInspectorService$WonderEditor.getComponentTypeMap(editorState[/* inspectorRecord */10]);
}
...
function clearComponentTypeMap(editorState) {
  return /* record */[
          ...
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.clearComponentTypeMap(editorState[/* inspectorRecord */10]),
...
function addComponentTypeToMap(index, componentType, editorState) {
  return /* record */[
          ...
          /* eventRecord */editorState[/* eventRecord */8],
          /* imguiRecord */editorState[/* imguiRecord */9],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.addComponentTypeToMap(index, componentType, editorState[/* inspectorRecord */10]),
          /* consoleRecord */editorState[/* consoleRecord */11],
          /* transformRecord */editorState[/* transformRecord */12],
          /* pickingRecord */editorState[/* pickingRecord */13],
          /* currentDragSource */editorState[/* currentDragSource */14],
...
function removeComponentTypeToMap(index, componentType, editorState) {
  return /* record */[
          ...
          /* eventRecord */editorState[/* eventRecord */8],
          /* imguiRecord */editorState[/* imguiRecord */9],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.removeComponentTypeToMap(index, componentType, editorState[/* inspectorRecord */10]),
          /* consoleRecord */editorState[/* consoleRecord */11],
          /* transformRecord */editorState[/* transformRecord */12],
          /* pickingRecord */editorState[/* pickingRecord */13],
          /* currentDragSource */editorState[/* currentDragSource */14],
...
function clearComponentType(editorState) {
  return /* record */[
          ...
          /* eventRecord */editorState[/* eventRecord */8],
          /* imguiRecord */editorState[/* imguiRecord */9],
          /* inspectorRecord */ComponentTypeMapInspectorService$WonderEditor.clearComponentType(editorState[/* inspectorRecord */10]),
          /* consoleRecord */editorState[/* consoleRecord */11],
          /* transformRecord */editorState[/* transformRecord */12],
          /* pickingRecord */editorState[/* pickingRecord */13],
          /* currentDragSource */editorState[/* currentDragSource */14],
