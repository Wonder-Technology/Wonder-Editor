...
import * as MessageArrayUIService$WonderEditor from "../../../record/editor/ui/MessageArrayUIService.js";

function getMessageArray(editorState) {
  return MessageArrayUIService$WonderEditor.getMessageArray(editorState[/* uiRecord */2]);
}

function setMessageArray(messageArray, editorState) {
  return /* record */[
          /* inspectorCanvasRecord */editorState[/* inspectorCanvasRecord */0],
          /* imgCanvasRecord */editorState[/* imgCanvasRecord */1],
          /* uiRecord */MessageArrayUIService$WonderEditor.setMessageArray(messageArray, editorState[/* uiRecord */2]),
...
function addMessage(message, editorState) {
  return /* record */[
          /* inspectorCanvasRecord */editorState[/* inspectorCanvasRecord */0],
          /* imgCanvasRecord */editorState[/* imgCanvasRecord */1],
          /* uiRecord */MessageArrayUIService$WonderEditor.addMessage(message, editorState[/* uiRecord */2]),
          /* settingRecord */editorState[/* settingRecord */3],
          /* sceneTreeRecord */editorState[/* sceneTreeRecord */4],
          /* assetRecord */editorState[/* assetRecord */5],
          /* sceneViewRecord */editorState[/* sceneViewRecord */6],
...
function removeMessage(message, editorState) {
  return /* record */[
          /* inspectorCanvasRecord */editorState[/* inspectorCanvasRecord */0],
          /* imgCanvasRecord */editorState[/* imgCanvasRecord */1],
          /* uiRecord */MessageArrayUIService$WonderEditor.removeMessage(message, editorState[/* uiRecord */2]),
          /* settingRecord */editorState[/* settingRecord */3],
          /* sceneTreeRecord */editorState[/* sceneTreeRecord */4],
          /* assetRecord */editorState[/* assetRecord */5],
          /* sceneViewRecord */editorState[/* sceneViewRecord */6],
...
/* MessageArrayUIService-WonderEditor Not a pure module */
