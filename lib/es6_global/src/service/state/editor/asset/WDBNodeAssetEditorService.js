...
function findAllWDBNodes(editorState) {
  return IterateTreeAssetEditorService$WonderEditor.filter(editorState, /* array */[], ArrayService$WonderEditor.push, undefined, undefined, (function () {
                return true;
              }), undefined, /* () */0);
}
...
function isWDBAssetFile() {
  ...
  if (widget !== undefined && startNodeId !== undefined && widget === AssetWidgetService$WonderEditor.getWidget(/* () */0)) {
    return OptionService$WonderEditor.eitherWithNoData(WDBNodeAssetService$WonderEditor.isWDBNode, (function () {
                  return false;
