...
function findAllWDBNodes(editorState) {
  return IterateTreeAssetEditorService$WonderEditor.filter(editorState, /* array */[], ArrayService$WonderEditor.push, undefined, undefined, undefined, undefined, (function (node) {
                return true;
