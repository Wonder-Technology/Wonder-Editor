...
function buildWDBNodeResult(name, parentFolderNodeId, wdbGameObject, wdbArrayBuffer) {
  return /* record */[
          /* name */name,
...
function renameWDBNodeResult(name, wdbNodeResult) {
  return /* record */[
          ...
          /* wdbArrayBuffer */wdbNodeResult[/* wdbArrayBuffer */2],
          /* wdbGameObject */wdbNodeResult[/* wdbGameObject */3]
        ];
}
