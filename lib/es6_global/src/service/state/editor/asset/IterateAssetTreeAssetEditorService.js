...
function getChildrenNameAndIdArr(nodeId, nodeType, param) {
  ...
  Contract$WonderLog.requireCheck((function (param) {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("the parent asset node type should be Folder", "not"), (function (param) {
                        ...
                        return Contract$WonderLog.assertTrue(param$1[/* type_ */2] === /* Folder */0);
                      }));
