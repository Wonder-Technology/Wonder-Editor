...
function findMaterialNode(targetMaterialComponent, targetType_, editorState) {
  ...
  return (function (param) {
              return IterateTreeAssetService$WonderEditor.findOne(param, undefined, arg, undefined, undefined, /* () */0);
...
function findNodeParent(targetNode, editorState) {
  return IterateTreeAssetService$WonderEditor.findOne(TreeAssetEditorService$WonderEditor.unsafeGetTree(editorState), undefined, undefined, undefined, (function (node) {
