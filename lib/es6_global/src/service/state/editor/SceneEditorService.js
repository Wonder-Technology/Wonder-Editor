...
function setScene(scene, editorState) {
  return /* record */[/* sceneRecord */RootSceneService$WonderEditor.setScene(scene, editorState[/* sceneRecord */0])];
}
...
function setCurrentGameObject(gameObject, editorState) {
  return /* record */[/* sceneRecord */CurrentGameObjectSceneService$WonderEditor.setCurrentGameObject(gameObject, editorState[/* sceneRecord */0])];
}

function clearCurrentGameObject(editorState) {
  return /* record */[/* sceneRecord */CurrentGameObjectSceneService$WonderEditor.clearCurrentGameObject(editorState[/* sceneRecord */0])];
}
