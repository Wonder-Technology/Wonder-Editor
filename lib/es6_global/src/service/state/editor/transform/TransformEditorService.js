...
function setLocalEulerAngleFieldWhenNotExistInMap(transformComponent, valueInEngineState, valueInMap, setFunc, editorState) {
  if (valueInMap !== undefined) {
    return editorState;
  } else {
    return Curry._3(setFunc, transformComponent, valueInEngineState, editorState);
  }
}
...
function getLocalEulerAngleOrInit(transformComponent, param) {
  ...
  if (exit === 1) {
    ...
    var ey = match$3[1];
    var ex = match$3[0];
    var editorState$1 = setLocalEulerAngleFieldWhenNotExistInMap(transformComponent, ez, match$2, setLocalEulerAngleZ, setLocalEulerAngleFieldWhenNotExistInMap(transformComponent, ey, match$1, setLocalEulerAngleY, setLocalEulerAngleFieldWhenNotExistInMap(transformComponent, ex, match, setLocalEulerAngleX, editorState)));
    return /* tuple */[
