...
function getImageBase64Map(assetState) {
...
function setResult(textureIndex, base64, assetState) {
  return /* record */[
          /* assetTreeRoot */assetState[/* assetTreeRoot */0],
          /* index */assetState[/* index */1],
          /* currentNodeData */assetState[/* currentNodeData */2],
          ...
          /* jsonNodeMap */assetState[/* jsonNodeMap */5],
          /* folderNodeMap */assetState[/* folderNodeMap */6],
          /* imageBase64Map */SparseMapService$WonderEditor.immutableSet(textureIndex, base64, assetState[/* imageBase64Map */7])
        ];
}
