...
function createGridPlaneGameObject(param, color, engineState) {
  ...
  var engineState$1 = GeometryAPI$Wonderjs.setGeometryIndices16(geometry, new Uint16Array(match$2[1]), GeometryAPI$Wonderjs.setGeometryVertices(geometry, new Float32Array(match$2[0]), match$1[0]));
