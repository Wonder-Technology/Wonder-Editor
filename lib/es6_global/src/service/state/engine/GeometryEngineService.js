...
function replaceAllGameObjectGeometryToDefaultGeometry(gameObject, targetGeometry, engineState) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (state, gameObject) {
                return GameObjectComponentEngineService$WonderEditor.addGeometryComponent(gameObject, targetGeometry, GameObjectComponentEngineService$WonderEditor.removeGeometryComponent(gameObject, GameObjectComponentEngineService$WonderEditor.unsafeGetGeometryComponent(gameObject, state), state));
              }), engineState, Log$WonderLog.print(ArrayService$WonderCommonlib.flatten(getAllUniqueGeometrys(gameObject, engineState).map((function (geometryIndex) {
