...
function getAllLightMaterials(gameObject, engineState) {
  var _iterate = function (gameObjectArr, resultArr) {
    return ArrayService$WonderCommonlib.reduceOneParam((function (resultArr, gameObject) {
                  ...
                  return _iterate(unsafeGetGameObjectChildren(gameObject, engineState), match ? ArrayService$Wonderjs.push(GameObjectAPI$Wonderjs.unsafeGetGameObjectLightMaterialComponent(gameObject, engineState), resultArr) : resultArr);
