...
function generateWDBForWPK(sceneGameObject, imageUint8ArrayMap, engineState) {
  return GenerateWDBSystem$Wonderjs.generateWDB(sceneGameObject, OptionService$Wonderjs.unsafeGet((imageUint8ArrayMap == null) ? undefined : Caml_option.some(imageUint8ArrayMap)), /* tuple */[
              /* tuple */[
                ...
                (function (geometry, engineState) {
                    return new Uint16Array(/* array */[IndicesGeometryMainService$Wonderjs.getIndices16(geometry, engineState).length]);
                  }),
                (function (geometry, engineState) {
