...
function isMaxCountByCount(count, engineState) {
  return (CountLightService$Wonderjs.getLightCount(RecordPointLightMainService$Wonderjs.getRecord(engineState)[/* renderLightArr */8]) + count | 0) > BufferPointLightService$Wonderjs.getBufferMaxCount(/* () */0);
}
