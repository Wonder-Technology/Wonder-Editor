...
function isLightMaterialMap(material, texture, engineState) {
...
function reInitAllLightMaterialsAndClearShaderCache(materials, engineState) {
  return ShaderEngineService$WonderEditor.clearShaderCache(LightMaterialAPI$Wonderjs.reInitMaterials(materials, engineState));
}
...
var _reInitMaterials = LightMaterialAPI$Wonderjs.reInitMaterials;
