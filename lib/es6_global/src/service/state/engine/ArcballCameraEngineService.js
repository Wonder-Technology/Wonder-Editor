...
function unbindArcballCameraControllerEventIfHasComponent(gameObject, engineState) {
  var match = GameObjectComponentEngineService$WonderEditor.hasArcballCameraControllerComponent(gameObject, engineState);
  if (match) {
    return ArcballCameraControllerAPI$Wonderjs.unbindArcballCameraControllerEvent(GameObjectComponentEngineService$WonderEditor.getArcballCameraControllerComponent(gameObject, engineState), engineState);
  } else {
    return engineState;
  }
}

function bindArcballCameraControllerEventIfHasComponent(gameObject, engineState) {
  var match = GameObjectComponentEngineService$WonderEditor.hasArcballCameraControllerComponent(gameObject, engineState);
  if (match) {
    return ArcballCameraControllerAPI$Wonderjs.bindArcballCameraControllerEvent(GameObjectComponentEngineService$WonderEditor.getArcballCameraControllerComponent(gameObject, engineState), engineState);
  } else {
    return engineState;
  }
}
...
export {
  ...
  unbindArcballCameraControllerEventIfHasComponent ,
  bindArcballCameraControllerEventIfHasComponent ,
