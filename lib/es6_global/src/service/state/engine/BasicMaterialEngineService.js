...
function setBasicMaterialName(name, material, engineState) {
  return BasicMaterialAPI$Wonderjs.setBasicMaterialName(material, name, engineState);
}
...
var disposeBasicMaterialRemoveTexture = disposeBasicMaterial;
...
export {
  ...
  disposeBasicMaterialRemoveTexture ,
