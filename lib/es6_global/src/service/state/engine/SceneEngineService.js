...
function clearShaderCacheAndReInitAllLightMaterials(engineState) {
  return LightMaterialEngineService$WonderEditor.reInitLightMaterialsAndClearShaderCache(LightMaterialEngineService$WonderEditor.getAllLightMaterials(engineState), engineState);
}

function isNeedReInitAllLightMaterials(gameObjects, engineState) {
...
export {
  ...
  clearShaderCacheAndReInitAllLightMaterials ,
