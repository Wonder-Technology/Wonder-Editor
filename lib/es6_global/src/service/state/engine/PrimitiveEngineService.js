...
function createBox(state) {
  ...
  var state$1 = GameObjectComponentEngineService$WonderEditor.addGeometryComponent(obj, geometry, GameObjectComponentEngineService$WonderEditor.addMeshRendererComponent(obj, match$1[1], GameObjectComponentEngineService$WonderEditor.addMaterialComponent(obj, match[1], GeometryEngineService$WonderEditor.setBoxGeometryConfigData(geometry, {
                    width: 5,
                    height: 5,
                    depth: 5,
