...
function getBasicCameraViewComponent(gameObject, engineState) {
  return GetComponentGameObjectService$Wonderjs.getBasicCameraViewComponent(gameObject, engineState[/* gameObjectRecord */10]);
}
...
function getScriptComponent(gameObject, engineState) {
  return GetComponentGameObjectService$Wonderjs.getScriptComponent(gameObject, engineState[/* gameObjectRecord */10]);
}
...
var disposeLightMaterialComponentRemoveTexture = GameObjectAPI$Wonderjs.disposeGameObjectLightMaterialComponentRemoveTexture;
...
var disposeBasicMaterialComponentRemoveTexture = GameObjectAPI$Wonderjs.disposeGameObjectBasicMaterialComponent;
...
var hasScriptComponent = GameObjectAPI$Wonderjs.hasGameObjectScriptComponent;

var unsafeGetScriptComponent = GameObjectAPI$Wonderjs.unsafeGetGameObjectScriptComponent;

var addScriptComponent = GameObjectAPI$Wonderjs.addGameObjectScriptComponent;

var disposeScriptComponent = GameObjectAPI$Wonderjs.disposeGameObjectScriptComponent;
...
export {
  ...
  disposeLightMaterialComponentRemoveTexture ,
  ...
  disposeBasicMaterialComponentRemoveTexture ,
  ...
  hasScriptComponent ,
  getScriptComponent ,
  unsafeGetScriptComponent ,
  addScriptComponent ,
  disposeScriptComponent ,
