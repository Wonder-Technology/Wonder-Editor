...
function getLocalRotation(gameObject, engineState) {
  return TransformEngineService$WonderEditor.getLocalRotation(GameObjectComponentEngineService$WonderEditor.unsafeGetTransformComponent(gameObject, engineState), engineState);
}

function setLocalRotation(gameObject, rotation, engineState) {
  return TransformEngineService$WonderEditor.setLocalRotation(rotation, GameObjectComponentEngineService$WonderEditor.unsafeGetTransformComponent(gameObject, engineState), engineState);
}
