...
import * as OperateHistoryLogicService$WonderEditor from "./OperateHistoryLogicService.js";

function undo(historyState, currentState) {
  return StateEngineService$WonderEditor.restoreState(currentState, OperateHistoryLogicService$WonderEditor.operateHistory(currentState, historyState[/* engineUndoStack */6], (function () {
                    return /* record */[
...
function redo(historyState, currentState) {
  return StateEngineService$WonderEditor.restoreState(currentState, OperateHistoryLogicService$WonderEditor.operateHistory(currentState, historyState[/* engineRedoStack */5], (function () {
                    return /* record */[
                            /* markRedoUndoStack */historyState[/* markRedoUndoStack */0],
                            /* uiRedoStack */historyState[/* uiRedoStack */1],
                            /* uiUndoStack */historyState[/* uiUndoStack */2],
...
function storeState(currentState, historyState) {
  return /* record */[
          ...
          /* engineUndoStack */Immutable.Stack[/* addFirst */17](StateEngineService$WonderEditor.deepCopyStateForRestore(currentState), historyState[/* engineUndoStack */6])
        ];
}
