...
import * as MainEditorService$WonderEditor       from "../state/editor/MainEditorService.js";
...
function init(editorState) {
  ...
  var scene = match[1];
  var editorState$1 = MainEditorService$WonderEditor.initEditor(scene, editorState);
...
/* MainEditorService-WonderEditor Not a pure module */
