...
function undo(historyState, currentState) {
  return OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* editorUndoStack */4], (function () {
                ...
                newrecord[/* editorRedoStack */3] = Immutable.Stack[/* addFirst */17](currentState, historyState[/* editorRedoStack */3]);
                newrecord[/* editorUndoStack */4] = Immutable.Stack[/* removeFirstOrRaise */19](historyState[/* editorUndoStack */4]);
                return newrecord;
              }));
}
...
function redo(historyState, currentState) {
  return OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* editorRedoStack */3], (function () {
                var newrecord = historyState.slice();
                newrecord[/* editorRedoStack */3] = Immutable.Stack[/* removeFirstOrRaise */19](historyState[/* editorRedoStack */3]);
                newrecord[/* editorUndoStack */4] = Immutable.Stack[/* addFirst */17](currentState, historyState[/* editorUndoStack */4]);
                return newrecord;
              }));
}
...
function storeState(currentState, historyState) {
  var newrecord = historyState.slice();
  newrecord[/* editorRedoStack */3] = Immutable.Stack[/* empty */20](/* () */0);
  newrecord[/* editorUndoStack */4] = Immutable.Stack[/* addFirst */17](currentState, historyState[/* editorUndoStack */4]);
  return newrecord;
}
