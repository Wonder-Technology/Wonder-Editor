...
function undo(historyState, currentState) {
  return RestoreStateEngineService$WonderEditor.restoreState(currentState, OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* engineUndoStack */6], (function () {
                    return /* record */[
...
function redo(historyState, currentState) {
  return RestoreStateEngineService$WonderEditor.restoreState(currentState, OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* engineRedoStack */5], (function () {
                    return /* record */[
                            /* copiedRedoUndoStackRecord */historyState[/* copiedRedoUndoStackRecord */0],
                            /* uiRedoStack */historyState[/* uiRedoStack */1],
                            /* uiUndoStack */historyState[/* uiUndoStack */2],
