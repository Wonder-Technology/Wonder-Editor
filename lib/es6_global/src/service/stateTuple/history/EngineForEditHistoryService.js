...
function undo(historyState, currentState) {
  return StateEngineService$WonderEditor.restoreState(currentState, OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* engineForEditUndoStack */7], (function () {
                    ...
                    newrecord[/* engineForEditRedoStack */6] = Immutable.Stack[/* addFirst */17](currentState, historyState[/* engineForEditRedoStack */6]);
                    newrecord[/* engineForEditUndoStack */7] = Immutable.Stack[/* removeFirstOrRaise */19](historyState[/* engineForEditUndoStack */7]);
                    return newrecord;
                  })));
}
...
function redo(historyState, currentState) {
  return StateEngineService$WonderEditor.restoreState(currentState, OperateStateHistoryService$WonderEditor.operateHistory(currentState, historyState[/* engineForEditRedoStack */6], (function () {
                    var newrecord = historyState.slice();
                    newrecord[/* engineForEditRedoStack */6] = Immutable.Stack[/* removeFirstOrRaise */19](historyState[/* engineForEditRedoStack */6]);
                    newrecord[/* engineForEditUndoStack */7] = Immutable.Stack[/* addFirst */17](currentState, historyState[/* engineForEditUndoStack */7]);
                    return newrecord;
                  })));
}
...
function storeState(currentState, historyState) {
  var newrecord = historyState.slice();
  newrecord[/* engineForEditRedoStack */6] = Immutable.Stack[/* empty */20](/* () */0);
  newrecord[/* engineForEditUndoStack */7] = Immutable.Stack[/* addFirst */17](StateEngineService$WonderEditor.deepCopyForRestore(currentState), historyState[/* engineForEditUndoStack */7]);
  return newrecord;
}
