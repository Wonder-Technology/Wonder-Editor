...
function storeHistoryState(store, param, historyState) {
  return EngineForRunHistoryService$WonderEditor.storeState(param[2], EngineForEditHistoryService$WonderEditor.storeState(param[1], EditorHistoryService$WonderEditor.storeState(param[0], UIHistoryService$WonderEditor.storeUIState(store, historyState))));
}
