...
function storeHistoryState(uiState, editorState, engineState, historyState) {
  return EngineHistoryService$WonderEditor.storeState(engineState, EditorHistoryService$WonderEditor.storeState(editorState, UIHistoryService$WonderEditor.storeUIState(uiState, historyState)));
}
