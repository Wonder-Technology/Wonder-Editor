...
function _scriptEventFunctionNodeFunc(param, parentFolderNode, param$1, nodeId, nodeData) {
  ...
  var match = Result$WonderEditor.RelationResult[/* isSuccess */3](result) && NodeAssetService$WonderEditor.isIdEqual(nodeId, param[0]);
  if (match) {
    var result$1 = Result$WonderEditor.RelationResult[/* handleSuccess */4]((function (param) {
            var match = ScriptEventFunctionNodeNameAssetService$WonderEditor.isTreeScriptEventFunctionNodesHasTargetName(name, tree);
            if (match) {
              return Result$WonderEditor.RelationResult[/* fail */1](LanguageUtils$WonderEditor.getMessageLanguageDataByType("asset-rename-scriptEventFunction", StateLogicService$WonderEditor.getEditorState(LanguageEditorService$WonderEditor.unsafeGetType)));
            } else {
              return Result$WonderEditor.RelationResult[/* success */0](/* () */0);
            }
...
function _scriptAttributeNodeFunc(param, parentFolderNode, param$1, nodeId, nodeData) {
  ...
  if (match) {
    var result$1 = Result$WonderEditor.RelationResult[/* handleSuccess */4]((function (param) {
            var match = ScriptAttributeNodeNameAssetService$WonderEditor.isTreeScriptAttributeNodesHasTargetName(newName, tree);
            if (match) {
              return Result$WonderEditor.RelationResult[/* fail */1](LanguageUtils$WonderEditor.getMessageLanguageDataByType("asset-rename-scriptAttribute", StateLogicService$WonderEditor.getEditorState(LanguageEditorService$WonderEditor.unsafeGetType)));
            } else {
              return Result$WonderEditor.RelationResult[/* success */0](/* () */0);
            }
