...
function _isGeometryVertexDataEqual(geometry1, geometry2, engineState) {
  if (isGeometryPointDataEqual(GeometryEngineService$WonderEditor.unsafeGetGeometryVertices(geometry1, engineState), GeometryEngineService$WonderEditor.unsafeGetGeometryVertices(geometry2, engineState), (function (prim) {
            return prim.length;
          })) && isGeometryPointDataEqual(GeometryEngineService$WonderEditor.unsafeGetGeometryNormals(geometry1, engineState), GeometryEngineService$WonderEditor.unsafeGetGeometryNormals(geometry2, engineState), (function (prim) {
            return prim.length;
          })) && isGeometryPointDataEqual(GeometryEngineService$WonderEditor.unsafeGetGeometryTexCoords(geometry1, engineState), GeometryEngineService$WonderEditor.unsafeGetGeometryTexCoords(geometry2, engineState), (function (prim) {
            return prim.length;
          }))) {
    return isGeometryPointDataEqual(GeometryEngineService$WonderEditor.unsafeGetGeometryIndices16(geometry1, engineState), GeometryEngineService$WonderEditor.unsafeGetGeometryIndices16(geometry2, engineState), (function (prim) {
                  return prim.length;
                }));
  } else {
    return false;
