...
function getAllWDBGameObjects(editorState, engineState) {
  return SparseMapService$WonderEditor.reduceValid((function (allWDBGameObjects, param) {
                return ArrayService$WonderEditor.fastConcat(allWDBGameObjects, GameObjectEngineService$WonderEditor.getAllGameObjects(param[/* wdbGameObject */3], engineState));
