...
function getAllWDBGameObjects(editorState, engineState) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (allWDBGameObjects, wdbNode) {
                return ArrayService$WonderEditor.fastConcat(allWDBGameObjects, GameObjectEngineService$WonderEditor.getAllGameObjects(WDBNodeAssetService$WonderEditor.getWDBGameObject(wdbNode), engineState));
