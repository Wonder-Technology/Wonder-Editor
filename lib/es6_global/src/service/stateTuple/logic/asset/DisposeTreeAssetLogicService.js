...
function _disposeNodeEditorData(node, engineState, editorState) {
  return NodeAssetService$WonderEditor.handleNode(node, (function (_, nodeData) {
...
function _disposeTreeEditorData(engineState, editorState) {
  return IterateTreeAssetService$WonderEditor.fold((function (editorState, _, _$1, _$2) {
                return editorState;
              }), editorState, TreeAssetEditorService$WonderEditor.unsafeGetTree(editorState), undefined, (function (editorState, _, nodeData) {
                return _disposeTextureNodeEditorData(nodeData, editorState);
              }), undefined, (function (editorState, _, nodeData) {
                return _disposeWDBNodeEditorData(nodeData, /* tuple */[
                            editorState,
                            engineState
                          ]);
...
function _disposeTreeEngineData(editorState, engineState) {
  return IterateTreeAssetService$WonderEditor.fold((function (engineState, _, _$1, _$2) {
                return engineState;
              }), engineState, TreeAssetEditorService$WonderEditor.unsafeGetTree(editorState), undefined, (function (engineState, _, nodeData) {
                return _disposeTextureNodeEngineData(nodeData, engineState);
              }), (function (engineState, _, nodeData) {
                return _disposeMaterialNodeEngineData(nodeData, /* tuple */[
                            editorState,
                            engineState
                          ]);
