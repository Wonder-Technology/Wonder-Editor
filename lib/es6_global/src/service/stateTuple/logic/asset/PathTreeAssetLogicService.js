...
function _scriptEventFunctionNodeFunc(targetNodeId, acc, nodeId, param) {
  return _handleLeafNodeFunc(acc, targetNodeId, nodeId, param[/* name */0]);
}

function _scriptAttributeNodeFunc(targetNodeId, acc, nodeId, param) {
  return _handleLeafNodeFunc(acc, targetNodeId, nodeId, param[/* name */0]);
}
...
function _assetBundleNodeFunc(targetNodeId, acc, nodeId, param) {
  return _handleLeafNodeFunc(acc, targetNodeId, nodeId, param[/* name */0]);
}
...
function getNodePath(targetNode, param) {
  ...
  var match = IterateTreeAssetService$WonderEditor.foldWithHandleBeforeAndAfterFoldChildren(/* tuple */[
        ...
        /* array */[]
          ...
          return _scriptEventFunctionNodeFunc(targetNodeId, param, param$1, param$2);
        }), (function (param, param$1, param$2) {
          return _scriptAttributeNodeFunc(targetNodeId, param, param$1, param$2);
        }), (function (param, param$1, param$2) {
          return _wdbNodeFunc(targetNodeId, param, param$1, param$2);
        }), (function (param, param$1, param$2) {
          return _assetBundleNodeFunc(targetNodeId, param, param$1, param$2);
