...
function _removeWDBTreeNode(nodeId, param) {
  ...
  var wdbGameObjects = GameObjectEngineService$WonderEditor.getAllGameObjects(match[/* wdbGameObject */2], engineState);
...
function _checkRemovedTreeNodeAndGetVal(param) {
  ...
  Contract$WonderLog.requireCheck((function (param) {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("removedTreeNode should exist", "not"), (function (param) {
