...
function disposeGeometryForRunEngineState(gameObject, geometryComponent, param) {
  return /* tuple */[
...
var disposeGeometryForEditEngineState = GameObjectComponentEngineService$WonderEditor.disposeGeometryComponent;
...
export {
  ...
  disposeGeometryForEditEngineState ,
  disposeGeometryForRunEngineState ,
