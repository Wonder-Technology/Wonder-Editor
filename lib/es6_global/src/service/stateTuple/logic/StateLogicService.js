...
function handleFuncWithDiff(diffArgumentArrForRun, editEngineState, runEngineState, handleFunc) {
  var match = _getWithDiffHandleFunc(diffArgumentArrForRun, handleFunc);
  return /* tuple */[
          Curry._1(match[0], editEngineState),
          Curry._1(match[1], runEngineState)
        ];
}
