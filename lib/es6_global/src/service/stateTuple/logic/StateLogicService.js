...
function getAndRefreshEngineStateWithDiff(argumentArrayForRun, type_, handleFunc) {
  ...
  var argumentArrayForEdit = ArrayService$WonderCommonlib.reduceOneParam((function (arr, component) {
          return ArrayService$WonderEditor.push(component + diffValue | 0, arr);
        }), /* array */[], argumentArrayForRun);
...
function getAndRefreshEngineStateWithDiffTest(diffArgumentArrForRun, handleFunc) {
  var argumentArrayForRun = diffArgumentArrForRun.reduce((function (arr, param) {
          return param[/* arguments */0].reduce((function (arr, component) {
                        return ArrayService$WonderEditor.push(component, arr);
                      }), arr);
        }), /* array */[]);
  var argumentArrayForEdit = diffArgumentArrForRun.reduce((function (arr, param) {
  ...
  var handleFuncForRun = argumentArrayForRun.reduce((function (handleFunc, component) {
          return Curry._1(handleFunc, component);
        }), handleFunc);
  var handleFuncForEdit = argumentArrayForEdit.reduce((function (handleFunc, component) {
          return Curry._1(handleFunc, component);
        }), handleFunc);
  setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._1(handleFuncForRun, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getRunEngineStateData(/* () */0)))));
  return setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._1(handleFuncForEdit, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getEditEngineStateData(/* () */0)))));
...
export {
  ...
  getAndRefreshEngineStateWithDiffTest ,
  getEditorState ,
