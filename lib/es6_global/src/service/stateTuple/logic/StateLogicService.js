...
import * as EngineStateDataEditorService$WonderEditor from "../../state/data/EngineStateDataEditorService.js";
...
function refreshEditAndRunEngineState(editEngineState, runEngineState) {
  setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, editEngineState));
  return setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, runEngineState));
}

function getAndRefreshEditAndRunEngineState() {
  setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getEditEngineStateData(/* () */0))));
  return setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getRunEngineStateData(/* () */0))));
}

function getAndRefreshEditAndRunEngineStateWithFunc(handleFunc) {
  setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._1(handleFunc, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getEditEngineStateData(/* () */0)))));
  return setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._1(handleFunc, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getRunEngineStateData(/* () */0)))));
}
...
export {
  ...
  refreshEditAndRunEngineState ,
  getAndRefreshEditAndRunEngineState ,
  getAndRefreshEditAndRunEngineStateWithFunc ,
