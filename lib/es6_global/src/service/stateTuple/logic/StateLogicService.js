...
function getAndRefreshEngineStateWithTwoDiff(firstComponent, lastComponent, type_, handleFunc) {
  ...
  setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._3(handleFunc, firstComponent, lastComponent, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getRunEngineStateData(/* () */0)))));
  return setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, Curry._3(handleFunc, firstComponent + diffValue | 0, lastComponent + diffValue | 0, StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getEditEngineStateData(/* () */0)))));
}
...
export {
  ...
  getAndRefreshEngineStateWithTwoDiff ,
  getEditorState                      ,
