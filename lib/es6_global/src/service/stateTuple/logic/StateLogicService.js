...
function getAndRefreshEngineStateWithDiff(componentArrayForRun, type_, handleFunc) {
  ...
  var componentArrayForEdit = componentArrayForRun.reduce((function (arr, component) {
          return ArrayService$WonderEditor.push(component + diffValue | 0, arr);
        }), /* int array */[]);
  var handleFuncForRun = componentArrayForRun.reduce((function (handleFunc, component) {
          return Curry._1(handleFunc, component);
        }), handleFunc);
  var handleFuncForEdit = componentArrayForEdit.reduce((function (handleFunc, component) {
          return Curry._1(handleFunc, component);
        }), handleFunc);
