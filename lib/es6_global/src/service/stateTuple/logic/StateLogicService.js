...
import * as StateAssetService$WonderEditor from "../../state/asset/StateAssetService.js";
...
function getAssetAndEngineStateToGetData(handleFunc) {
  return Curry._1(handleFunc, /* tuple */[
              StateAssetService$WonderEditor.getState(/* () */0),
              StateEngineService$WonderEditor.getStateFromData(EngineStateDataEditorService$WonderEditor.getRunEngineStateData(/* () */0))
            ]);
}

function getAssetState(handleFunc) {
  return Curry._1(handleFunc, StateAssetService$WonderEditor.getState(/* () */0));
}

function getAndSetAssetState(handleFunc) {
  StateAssetService$WonderEditor.setState(Curry._1(handleFunc, StateAssetService$WonderEditor.getState(/* () */0)));
  return /* () */0;
}
...
export {
  ...
  getStateToGetData ,
  getAssetAndEngineStateToGetData ,
  getAssetState ,
  getAndSetAssetState ,
