...
import * as OperateBasicMaterialLogicService$WonderEditor from "./OperateBasicMaterialLogicService.js";
...
function _replaceMaterialAndRefreshEngineState(gameObject, material, setMapFunc) {
  ...
  var match$1 = OperateBasicMaterialLogicService$WonderEditor.createBasicMaterial(match[0], match[1]);
  ...
  var match$2 = StateLogicService$WonderEditor.handleFuncWithDiff(/* array */[/* record */[
          ...
          ], GameObjectComponentEngineService$WonderEditor.addBasicMaterialComponent, setMapFunc !== undefined ? Curry._2(setMapFunc, newMaterial, engineStateTuple) : engineStateTuple));
...
function replaceMaterialComponentToHasMapOne(gameObject, material, mapId) {
  return _replaceMaterialAndRefreshEngineState(gameObject, material, (function (param, param$1) {
                return _setMapToEditAndRunEngineState(mapId, param, param$1);
              }));
}

function replaceMaterialComponentToNoMapOne(gameObject, material) {
  return _replaceMaterialAndRefreshEngineState(gameObject, material, undefined);
}
