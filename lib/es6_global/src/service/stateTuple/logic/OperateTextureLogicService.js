...
function changeTextureMapAndRefreshEngineState(material, textureComponent, setMapFunc, engineState) {
  return StateLogicService$WonderEditor.renderEngineStateAndReturnEngineState(Curry._3(setMapFunc, textureComponent, material, engineState));
}

function _handleMapAndUpdateShaderAndRefreshEngineState(material, param, engineState) {
  return StateLogicService$WonderEditor.renderEngineStateAndReturnEngineState(Curry._2(param[1], /* array */[material], Curry._2(param[0], material, engineState)));
}
