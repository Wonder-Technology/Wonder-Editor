...
function disposeCurrentGameObject(gameObject) {
  StateLogicService$WonderEditor.getAndRefreshEngineStateWithDiff(gameObject, /* GameObject */0, GameObjectEngineService$WonderEditor.disposeGameObjectKeepOrder);
