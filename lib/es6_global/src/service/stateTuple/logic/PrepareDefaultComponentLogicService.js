...
function getDefaultCubeGeometryName(param) {
  return "Wonder-Default-Cube";
}

function getDefaultSphereGeometryName(param) {
...
function getDefaultBasicMaterialName(param) {
  return "Wonder-Default-Basic-Material";
}

function getDefaultLightMaterialName(param) {
...
function buildDefaultMaterialComponents(editorState, engineState) {
  ...
  var engineState$1 = LightMaterialEngineService$WonderEditor.setLightMaterialName("Wonder-Default-Light-Material", lightMaterial, BasicMaterialEngineService$WonderEditor.setBasicMaterialName("Wonder-Default-Basic-Material", basicMaterial, match$1[0]));
