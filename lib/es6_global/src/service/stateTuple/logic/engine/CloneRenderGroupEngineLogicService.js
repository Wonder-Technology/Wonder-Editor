...
function _addRenderGroupIfHasLightMaterial(targetGameObject, newMeshRenderer, param, param$1) {
  var clonedEngineState = param[1];
  ...
  var match = CloneMaterialEngineLogicService$WonderEditor.cloneLightMaterialToOtherEngineState(clonedGameObjectMaterial, param$1[0], clonedEngineState, param$1[1]);
  return /* tuple */[
          RenderGroupEngineService$WonderEditor.buildRenderGroup(newMeshRenderer, match[0]),
