...
function _checkEditAndRunMaterialWithDiff(param, type_, editEngineState, runEngineState) {
...
function createMaterial(editEngineState, runEngineState) {
  ...
  return _checkEditAndRunMaterialWithDiff(/* tuple */[
              match[1],
              match$1[1]
            ], /* Material */2, match[0], match$1[0]);
}
