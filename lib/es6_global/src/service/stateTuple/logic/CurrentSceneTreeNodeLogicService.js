...
function disposeCurrentSceneTreeNode(gameObject) {
  StateLogicService$WonderEditor.getAndRefreshEngineStateWithDiff(/* array */[gameObject], /* GameObject */0, GameObjectEngineService$WonderEditor.disposeGameObjectKeepOrder);
