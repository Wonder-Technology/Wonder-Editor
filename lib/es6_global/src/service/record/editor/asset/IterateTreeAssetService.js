...
function foldWithParentFolderNode(folderNodeFunc, acc, tree, $staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, _) {
  var seqFoldFunc = $staropt$star !== undefined ? $staropt$star : ArrayService$WonderCommonlib.reduceOneParam;
  var textureNodeFunc = $staropt$star$1 !== undefined ? $staropt$star$1 : (function (_, acc, _$1, _$2) {
        return acc;
      });
  var materialNodeFunc = $staropt$star$2 !== undefined ? $staropt$star$2 : (function (_, acc, _$1, _$2) {
        return acc;
      });
  var wdbNodeFunc = $staropt$star$3 !== undefined ? $staropt$star$3 : (function (_, acc, _$1, _$2) {
        return acc;
      });
  var parentFolderNode = $staropt$star$4 !== undefined ? Js_primitive.valFromOption($staropt$star$4) : undefined;
  switch (tree.tag | 0) {
    case 0 : 
    ...
    case 3 : 
        ...
        return UIStateAssetService$WonderEditor.fold(seqFoldFunc, (function (param, param$1) {
                      ...
                      return foldWithParentFolderNode(folderNodeFunc, acc, children, undefined, textureNodeFunc, materialNodeFunc, wdbNodeFunc, Js_primitive.some(parentFolderNode), /* () */0);
                    }), localAccum, children);
