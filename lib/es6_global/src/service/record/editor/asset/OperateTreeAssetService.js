...
function setNodeIsShowChildren(targetNodeId, isShowChildren, tree) {
  ...
  return IterateTreeAssetService$WonderEditor.map(tree, _folderNodeFunc, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
}
...
function findNodeById(targetNodeId, tree) {
  ...
  return IterateTreeAssetService$WonderEditor.findOne(tree, predNodeFunc, predNodeFunc, predNodeFunc, predNodeFunc, predNodeFunc, predNodeFunc, predNodeFunc, /* () */0);
}
...
function insertNode(targetNodeId, newTreeNode, tree) {
  ...
  return IterateTreeAssetService$WonderEditor.cata(tree, undefined, undefined, undefined, undefined, undefined, undefined, _folderNodeFunc, /* () */0);
}
...
function removeNodeById(targetNodeId, tree) {
  ...
  return /* tuple */[
          IterateTreeAssetService$WonderEditor.cata(tree, undefined, undefined, undefined, undefined, undefined, undefined, _folderNodeFunc, /* () */0),
          removedNode
        ];
}
...
function replaceNode(targetNodeId, newTreeNode, tree) {
  ...
  var _scriptEventFunctionNodeFunc = function (nodeId, nodeData) {
    return _nodeFunc(nodeId, nodeData, ScriptEventFunctionNodeAssetService$WonderEditor.buildNodeByNodeData);
  };
  var _scriptAttributeNodeFunc = function (nodeId, nodeData) {
    return _nodeFunc(nodeId, nodeData, ScriptAttributeNodeAssetService$WonderEditor.buildNodeByNodeData);
  };
  ...
  var _assetBundleNodeFunc = function (nodeId, nodeData) {
    return _nodeFunc(nodeId, nodeData, AssetBundleNodeAssetService$WonderEditor.buildNodeByNodeData);
  };
  var _folderNodeFunc = function (nodeId, nodeData, children) {
  ...
  return IterateTreeAssetService$WonderEditor.cata(tree, _textureNodeFunc, _materialNodeFunc, _scriptEventFunctionNodeFunc, _scriptAttributeNodeFunc, _wdbNodeFunc, _assetBundleNodeFunc, _folderNodeFunc, /* () */0);
}
...
function _mergeTreeByFolderNodeName(isNodeEqualByName, tree1, onlyFolderNodeTree) {
  ...
  return IterateTreeAssetService$WonderEditor.fold(_folderNodeFunc, /* tuple */[
              undefined,
              tree1
            ], onlyFolderNodeTree, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* () */0);
}

function _unsafeFindFolderNodeByName(targetFolderNodeName, tree) {
  return OptionService$WonderEditor.unsafeGet(IterateTreeAssetService$WonderEditor.findOne(tree, undefined, undefined, undefined, undefined, undefined, undefined, (function (node) {
...
function addFolderNodesToTreeByPath(path, isNodeEqualByName, tree, index) {
  ...
  var match$1 = _mergeTreeByFolderNodeName(isNodeEqualByName, tree, match[0]);
  return /* tuple */[
          match$1[1],
          match[1],
