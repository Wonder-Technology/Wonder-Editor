...
function insertNode(targetNodeId, newTreeNode, tree) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("new tree node not exist in tree", "exist"), (function () {
...
function findTargetChild(folderNode, targetChild, isNodeEqualFunc) {
  return Js_primitive.undefined_to_opt(FolderNodeAssetService$WonderEditor.getChildrenNodes(folderNode).find((function (child) {
...
function _getFolderPathArr(folderPath) {
  return Contract$WonderLog.ensureCheck((function (pathArr) {
                return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("contain root node", "not"), (function () {
