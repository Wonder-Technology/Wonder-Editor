...
function prepareRenderGameViewJob(_, engineState) {
  ...
  var param = PrepareRenderViewJobUtils$WonderEditor.markIsRenderSceneViewGameObjects(false, editorState, PrepareRenderViewJobUtils$WonderEditor.prepareRenderViewJob(OptionService$WonderEditor.unsafeGet(gameViewRect), _activeGameViewCamera, engineState));
