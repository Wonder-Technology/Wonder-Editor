...
function _fromDomEventAndHandleError(editorState, engineState) {
  return Most.recoverWith((function (e) {
                Console$WonderEditor.throwFatal(e);
                return _fromDomEventAndHandleError(editorState, engineState);
              }), fromDomEvent(editorState, engineState));
}

function initEventForEditorJob(_, engineState) {
  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
  var domEventStreamSubscription = _fromDomEventAndHandleError(editorState, engineState).subscribe({
        next: (function () {
            return /* () */0;
          }),
        error: (function (e) {
