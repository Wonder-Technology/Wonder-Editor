...
function bindDomEventToTriggerPointEvent(editorState, engineState) {
  ...
  if (match) {
    return _bindMouseEventToTriggerSceneViewPointEvent(/* MouseDragDrop */8, SceneViewEventEditorService$WonderEditor.getPointDragDropEventName(/* () */0), /* PointDragDrop */7, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseDragOver */7, SceneViewEventEditorService$WonderEditor.getPointDragOverEventName(/* () */0), /* PointDragOver */6, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseDragStart */6, SceneViewEventEditorService$WonderEditor.getPointDragStartEventName(/* () */0), /* PointDragStart */5, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseMove */4, SceneViewEventEditorService$WonderEditor.getPointMoveEventName(/* () */0), /* PointMove */3, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseWheel */5, SceneViewEventEditorService$WonderEditor.getPointScaleEventName(/* () */0), /* PointScale */4, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseDown */2, SceneViewEventEditorService$WonderEditor.getPointDownEventName(/* () */0), /* PointDown */1, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* MouseUp */3, SceneViewEventEditorService$WonderEditor.getPointUpEventName(/* () */0), /* PointUp */2, _isTriggerSceneViewEvent, _bindMouseEventToTriggerSceneViewPointEvent(/* Click */1, SceneViewEventEditorService$WonderEditor.getPointTapEventName(/* () */0), /* PointTap */0, _isTriggerSceneViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseDragDrop */8, GameViewEventEditorService$WonderEditor.getPointDragDropEventName(/* () */0), /* PointDragDrop */7, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseDragOver */7, GameViewEventEditorService$WonderEditor.getPointDragOverEventName(/* () */0), /* PointDragOver */6, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseDragStart */6, GameViewEventEditorService$WonderEditor.getPointDragStartEventName(/* () */0), /* PointDragStart */5, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseMove */4, GameViewEventEditorService$WonderEditor.getPointMoveEventName(/* () */0), /* PointMove */3, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseWheel */5, GameViewEventEditorService$WonderEditor.getPointScaleEventName(/* () */0), /* PointScale */4, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseDown */2, GameViewEventEditorService$WonderEditor.getPointDownEventName(/* () */0), /* PointDown */1, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* MouseUp */3, GameViewEventEditorService$WonderEditor.getPointUpEventName(/* () */0), /* PointUp */2, _isTriggerGameViewEvent, _bindMouseEventToTriggerGameViewPointEvent(/* Click */1, GameViewEventEditorService$WonderEditor.getPointTapEventName(/* () */0), /* PointTap */0, _isTriggerGameViewEvent, engineState))))))))))))))));
  } else {
