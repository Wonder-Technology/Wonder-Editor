...
function _findInNextFolderNode(param) {
  var nodeNameHierachy = param[0];
  var nextFolderNodeName = ArrayService$WonderEditor.unsafeGetFirst(nodeNameHierachy);
  var nextFolderNode = OptionService$WonderEditor.unsafeGet(Caml_option.undefined_to_opt(FolderNodeAssetService$WonderEditor.getChildrenNodes(param[1]).find((function (childNode) {
  ...
  return Curry._3(param[3], nodeNameHierachy.slice(1), nextFolderNode, param[2]);
}

function _findAssetBundbleNodeData(nodeNameHierachy, folderNode, editorState) {
  ...
  if (match) {
    return _findInNextFolderNode(/* tuple */[
                nodeNameHierachy,
                folderNode,
                editorState,
    ...
    return AssetBundleNodeAssetService$WonderEditor.getNodeData(OptionService$WonderEditor.unsafeGet(Caml_option.undefined_to_opt(FolderNodeAssetService$WonderEditor.getChildrenNodes(folderNode).find((function (childNode) {
...
var Load = /* module */[
  ...
  /* _findInNextFolderNode */_findInNextFolderNode,
