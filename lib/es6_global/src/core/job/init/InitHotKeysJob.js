  ...
  switch (hotKeyAction) {
    case 0 : 
        return (function (param) {
            return Controller$WonderEditor.Method[/* handleChangeCurrentTransformGizmoType */4](dispatch, /* Translation */0);
          });
    case 1 : 
        return (function (param) {
            return Controller$WonderEditor.Method[/* handleChangeCurrentTransformGizmoType */4](dispatch, /* Rotation */1);
          });
    case 2 : 
        return (function (param) {
            return Controller$WonderEditor.Method[/* handleChangeCurrentTransformGizmoType */4](dispatch, /* Scale */2);
          });
    case 3 : 
        return (function (param) {
