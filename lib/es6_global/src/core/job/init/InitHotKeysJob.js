  ...
  switch (hotKeyAction) {
    ...
    case 6 : 
        return (function (param) {
            if (isCurrentSceneTreeNodeSceneChildren) {
              ...
              if (match) {
                Curry._3(MainEditorAssetHeader$WonderEditor.Method[/* removeAssetNode */1], /* tuple */[
                      uiState,
                      dispatch
                    ], /* () */0, /* () */0);
                return /* () */0;
    ...
    case 7 : 
        return (function (param) {
            ...
            if (match !== undefined) {
              return StateLogicService$WonderEditor.refreshEngineState(FocusUtils$WonderEditor.setCameraFocusTargetGameObject(SceneViewEditorService$WonderEditor.unsafeGetEditCamera(editorState), match, 2.5, StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
            } else {
              return /* () */0;
            }
          });
