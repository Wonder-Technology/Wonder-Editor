...
function render(buttonText, param) {
  ...
  return React.createElement("article", {
              className: "wonder-file-input"
                  ...
                  }, DomHelper$WonderEditor.textEl(buttonText)) : null, match ? React.createElement("div", undefined, React.createElement("textarea", {
...
function make(buttonText, onSubmit, $staropt$star, $staropt$star$1, _) {
