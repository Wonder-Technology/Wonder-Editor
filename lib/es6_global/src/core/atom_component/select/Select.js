...
function reducer(onChange, action) {
  ...
  return (function () {
      return ReasonReactUtils$WonderEditor.updateWithSideEffects(/* record */[/* selectedKey */selectedKey], (function () {
...
function render(label, options, param) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-select"
                    ...
                    className: ""
                  }, DomHelper$WonderEditor.textEl(label[0])) : null, React.createElement("select", {
...
function make(label, options, selectedKey, onChange, _) {
  return /* record */[
