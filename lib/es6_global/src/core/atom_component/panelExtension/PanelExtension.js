...
function render(record, name, store, _self) {
  Curry._1(record[/* willRender */4], /* () */0);
  return React.createElement("article", {
              key: "panelExtension"
            }, ParseComponentUtils$WonderEditor.buildSpecificComponents(record[/* render */2], name, store));
}

function make(record, name, store, _children) {
  return /* record */[
