...
function _renderFooter(closeFunc, submitFunc) {
  if (submitFunc !== undefined) {
    ...
    return React.createElement("div", {
                className: "modal-item-footer"
                  ...
                  }, DomHelper$WonderEditor.textEl("OK")));
  }
}
  ...
  return React.createElement("article", {
              className: "wonder-modal"
                  ...
                  className: "modal-item"
                    ...
                    }, content), _renderFooter(closeFunc, param[1])));
}

function make(title, content, closeFunc, submitFunc, _children) {
  return /* record */[
