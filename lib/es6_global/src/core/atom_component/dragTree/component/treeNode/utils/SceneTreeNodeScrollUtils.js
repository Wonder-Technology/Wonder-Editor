...
function _calcXAxisScrollValue(sceneTreeContainerJsObj, sceneTreeNodeDomOffsetLeft, param) {
...
function _calcYAxisScrollValue(sceneTreeContainerJsObj, sceneTreeNodeDomOffsetTop, param) {
