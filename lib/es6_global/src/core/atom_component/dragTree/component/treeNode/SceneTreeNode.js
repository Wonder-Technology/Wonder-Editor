...
function handleDragStart(gameObject, widget, dragImg, effectAllowd, $$event) {
  DragEventBaseUtils$WonderEditor.dragStart(gameObject, widget, dragImg, effectAllowd, $$event);
  return /* DragStart */3;
}
...
function _calcDragPosition($$event, domElement) {
  ...
  if (pageY > ((domOffsetHeight + domOffsetTop | 0) - gapHeight | 0)) {
    return /* DragAfterTarget */3;
  } else if (pageY < (domOffsetTop + gapHeight | 0)) {
...
function _renderDragableText(param, param$1, param$2) {
  ...
  return React.createElement("div", {
              ...
              onDragStart: (function (e) {
                  return Curry._1(send, handleDragStart(gameObject, widget, dragImg, "move", e));
                }),
              onDrop: (function (_e) {
