...
function getContent(param, param$1, param$2) {
  ...
  var dragImg = param$1[3];
  var widget = param$1[2];
  var icon = param$1[1];
  var id = param$1[0];
  var send = param[1];
  return React.createElement("li", undefined, param$1[7] ? React.createElement("div", {
                    className: "item-triangle",
                    onMouseDown: (function ($$event) {
                        DomHelper$WonderEditor.stopPropagation($$event);
                        return Curry._1(send, /* TogggleChildren */Block.__(0, [id]));
                      })
                  }, param$1[6] ? React.createElement("img", {
                  ...
                  className: "draggable-container" + (
                    param$1[8] ? (
                        param$1[9] ? " select-active" : " select-not-active"
                      ) : ""
                  ),
                  draggable: true,
                ...
                }, DomHelper$WonderEditor.textEl(param$1[4])));
}
...
function render(param, param$1, treeChildren, param$2) {
  ...
  return TreeNodeUtils$WonderEditor.buildNotDragableUl(treeChildren, isShowChildren, getContent(/* tuple */[
                  param$2[/* state */1],
                  param$2[/* send */3]
                ], /* tuple */[
                  param[0],
...
function make(id, name, isSelected, isActive, dragImg, widget, icon, onSelect, dragGameObject, dragWDB, isWidget, isShowChildren, isHasChildren, handleRelationError, handleToggleShowTreeChildren, isAssetWDBFile, treeChildren, _) {
