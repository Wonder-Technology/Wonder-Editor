...
function _calcDragPosition($$event, domElement) {
  ...
  var domOffsetTop = domClientRect.top;
  var domOffsetHeight = domClientRect.height;
  var pageY = $$event.pageY;
  if (pageY > ((domOffsetHeight + domOffsetTop | 0) - 4 | 0)) {
    return /* DragAfterTarget */3;
  } else if (pageY < (domOffsetTop + 4 | 0)) {
...
function handleDragEnter(id, param, $$event) {
  var match = DragEventBaseUtils$WonderEditor.checkDragEnter(id, param[0], param[1]);
  var match$1 = match[0] || Curry._1(param[2], /* () */0);
  if (match$1) {
    return /* DragEnter */Block.__(1, [_calcDragPosition($$event, $$event.target)]);
  } else {
    return /* Nothing */0;
  }
}
...
function handleDragOver(id, param, $$event) {
  EventHelper$WonderEditor.preventDefault($$event);
  var match = DragEventBaseUtils$WonderEditor.checkDragEnter(id, param[0], param[1]);
  var isSceneGameObject = StateLogicService$WonderEditor.getEngineStateToGetData(SceneEngineService$WonderEditor.getSceneGameObject) === id;
  var match$1 = match[0] || Curry._1(param[2], /* () */0);
  if (match$1) {
    return /* DragOver */Block.__(2, [isSceneGameObject ? /* DragIntoTarget */2 : _calcDragPosition($$event, $$event.target)]);
  } else {
    return /* Nothing */0;
  }
}

function handleDrop(id, param, dragPosition, $$event) {
  var startId = DragUtils$WonderEditor.getDragedId($$event);
  EventHelper$WonderEditor.preventDefault($$event);
  var match = DragEventBaseUtils$WonderEditor.checkDragDrop(id, startId, param[0], param[1]);
  OptionService$WonderEditor.handleSomeAndIgnore((function (relationResult) {
          return Result$WonderEditor.RelationResult[/* handleError */3]((function (msg) {
                        return ConsoleUtils$WonderEditor.error(msg, StateEditorService$WonderEditor.getState(/* () */0));
                      }), relationResult);
        }), match[1]);
  if (match[0]) {
    return /* DragGameObject */Block.__(3, [
              id,
              startId,
              dragPosition
            ]);
    ...
    if (match$1) {
      var wdbGameObjectUid = WDBNodeAssetService$WonderEditor.getWDBGameObject(OperateTreeAssetEditorService$WonderEditor.unsafeFindNodeById(startId, StateEditorService$WonderEditor.getState(/* () */0)));
      return /* DragWDB */Block.__(4, [
                id,
                wdbGameObjectUid,
                dragPosition
              ]);
...
function _renderDragableText(param, param$1, param$2) {
  ...
  return React.createElement("div", {
              ...
              onDragOver: (function (e) {
                  return Curry._1(send, handleDragOver(id, /* tuple */[
                                  isWidgetFunc,
                                  checkNodeRelationFunc,
                                  isAssetWDBFileFunc
                                ], e));
              ...
              onDragStart: (function (e) {
                  return Curry._1(send, handleDragStart(id, widget, dragImg, "move", e));
                }),
              onDrop: (function (_e) {
...
function make(id, name, isSelected, isActive, dragImg, widget, icon, onSelect, dragGameObject, dragWDB, isWidget, isShowChildren, isHasChildren, checkNodeRelation, handleToggleShowTreeChildren, isAssetWDBFile, treeChildren, _) {
