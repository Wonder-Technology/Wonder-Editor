...
function make(gameObject, name, isSelected, isActive, dragImg, widget, icon, onSelect, dragGameObject, dragWDB, isWidget, isShowChildren, isHasChildren, checkNodeRelation, handleToggleShowTreeChildren, isAssetWDBFile, treeChildren, _children) {
