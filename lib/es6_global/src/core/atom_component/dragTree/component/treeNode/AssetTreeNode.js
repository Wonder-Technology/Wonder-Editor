...
function make(id, name, isSelected, isActive, dragImg, widget, icon, onSelect, onDrop, isWidget, isShowChildren, isHasChildren, handleRelationError, handleToggleShowTreeChildren, treeChildren, _children) {
