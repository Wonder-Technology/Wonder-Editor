  ...
  return React.createElement("article", {
              className: "wonder-drag-tree"
                  ...
                  onDragEnter: (function (_e) {
                      return Curry._1(send, handleDragEnter(rootUid, handleSign, handleRelationError, _e));
                    }),
                  onDragLeave: (function (_e) {
                      return Curry._1(send, handleDragLeave(rootUid, handleSign, handleRelationError, _e));
                    }),
