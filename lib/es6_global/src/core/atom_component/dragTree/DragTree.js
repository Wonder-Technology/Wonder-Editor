  ...
  return React.createElement("article", {
              className: "wonder-drag-tree"
                  ...
                  onDragEnter: (function (_e) {
                      return Curry._1(send, handleDragEnter(rootUid, handleWidgeFunc, handleRelationErrorFunc, _e));
                    }),
                  onDragLeave: (function (_e) {
                      return Curry._1(send, handleDragLeave(rootUid, handleWidgeFunc, handleRelationErrorFunc, _e));
                    }),
                  onDragOver: DragEventUtils$WonderEditor.handleDragOver,
                  onDrop: (function (_e) {
                      return Curry._1(send, handleDrop(rootUid, handleWidgeFunc, handleRelationErrorFunc, _e));
                    })
                }));
}

function make(treeArray, rootUid, onDrop, isWidge, handleRelationError, _) {
  return /* record */[
