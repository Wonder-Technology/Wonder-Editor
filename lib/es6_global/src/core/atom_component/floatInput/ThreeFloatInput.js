...
function render(_, param, param$1, param$2) {
  ...
  var canBeZero = param[2];
  var gameObjectComponent = param[0];
  return React.createElement("article", {
              className: "inspector-item wonder-three-float-input"
            }, React.createElement("div", {
                  className: "item-header"
                }, DomHelper$WonderEditor.textEl(param[1])), React.createElement("div", {
                  className: "item-content"
                          ...
                          }), StringService$WonderEditor.floatToString(state[/* x */0]), "X", Curry._1(param$1[0], gameObjectComponent), (function (value) {
                          ...
                          }), StringService$WonderEditor.floatToString(state[/* y */1]), "Y", Curry._1(param$1[1], gameObjectComponent), (function (value) {
                            return Curry._1(send, /* BlurY */Block.__(1, [value]));
                          }), /* array */[])), ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(canBeZero, (function (value) {
                            return Curry._1(send, /* DragDropZ */Block.__(5, [value]));
                          }), StringService$WonderEditor.floatToString(state[/* z */2]), "Z", Curry._1(param$1[2], gameObjectComponent), (function (value) {
                            return Curry._1(send, /* BlurZ */Block.__(2, [value]));
                          }), /* array */[]))));
}

function make(uiState, dispatchFunc, label, gameObjectComponent, changeXFunc, changeYFunc, changeZFunc, getDataFunc, blurEventFunc, dragDropFunc, canBeZero, _) {
