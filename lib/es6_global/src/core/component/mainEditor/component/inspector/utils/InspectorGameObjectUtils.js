...
function _operateSpecificComponent(gameObject, componentName, engineState) {
  switch (componentName) {
    ...
    case "boxGeometry" : 
        return _getComponent(gameObject, GameObjectComponentEngineService$WonderEditor.hasBoxGeometryComponent, GameObjectComponentEngineService$WonderEditor.getBoxGeometryComponent, engineState);
