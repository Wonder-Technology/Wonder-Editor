...
function onClick(param, type_, currentGameObject) {
  StateLogicService$WonderEditor.getAndRefreshEngineState((function (param) {
          return InspectorComponentUtils$WonderEditor.addComponentByType(type_, currentGameObject, param);
        }));
