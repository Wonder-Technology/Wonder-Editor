...
function getCurrentGameObjectLocalPosition(transformComponent) {
  return StateLogicService$WonderEditor.getEngineState((function (param) {
...
function _setCurrentGameObjectLocalPosition(transformComponent, param) {
  ...
  return StateLogicService$WonderEditor.getAndRefreshEngineState((function (param) {
                return TransformEngineService$WonderEditor.setLocalPosition(transformComponent, partial_arg, param);
              }));
}
...
function make(store, dispatch, transformComponent, _) {
  ...
  var match = truncateTransformValue(StateLogicService$WonderEditor.getEngineState((function (param) {
              return TransformEngineService$WonderEditor.getLocalPosition(transformComponent, param);
            })));
