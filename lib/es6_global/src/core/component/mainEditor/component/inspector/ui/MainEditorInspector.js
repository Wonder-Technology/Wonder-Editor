...
import * as CurrentGameObjectEditorService$WonderEditor from "../../../../../../service/state/editor/CurrentGameObjectEditorService.js";
...
function buildCurrentGameObjectComponent(store, dispatch, allShowComponentConfig) {
  var match = StateLogicService$WonderEditor.getEditorState(CurrentGameObjectEditorService$WonderEditor.getCurrentGameObject);
  if (match) {
    var gameObject = match[0];
    var match$1 = StateLogicService$WonderEditor.getEngineState((function (param) {
