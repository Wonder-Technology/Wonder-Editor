...
function _buildMaterial(store, dispatch, component) {
  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, MainEditorMaterial$WonderEditor.make(store, dispatch, component, /* array */[]));
}
...
function _buildCameraController(_, _$1, _$2) {
  return React.createElement("div", {
              key: DomHelper$WonderEditor.getRandomKey(/* () */0)
...
function buildCurrentGameObjectComponent(store, dispatch, allShowComponentConfig) {
  var match = StateFacade$WonderEditor.getState(MainEditorSceneView$WonderEditor.getCurrentGameObject);
  if (match) {
    var gameObject = match[0];
    var match$1 = StateFacade$WonderEditor.getState((function (param) {
    ...
    return OperateArrayUtils$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, AddableComponent$WonderEditor.make(/* tuple */[
                        store,
                        dispatch
                      ], gameObject, match$1[1], /* array */[])), _buildGameObjectAllShowComponent(match$1[0], store, dispatch));
  } else {
    return /* array */[];
  }
}
...
var Method = /* module */[
  ...
  /* _buildMaterial */_buildMaterial,
  /* _buildSouceInstance */_buildSouceInstance,
  /* _buildCameraController */_buildCameraController,
