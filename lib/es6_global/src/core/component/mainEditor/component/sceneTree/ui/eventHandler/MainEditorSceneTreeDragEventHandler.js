...
function onDrop(param, _, param$1) {
  ...
  if (match !== 0) {
    ...
    Curry._1(dispatch, [
          ...
          /* SetSceneGraph */[/* Some */[SceneTreeUtils$WonderEditor.getDragedSceneGraphData(targetUid, dragedUid, SceneGraphUIService$WonderEditor.unsafeGetSceneGraphDataFromStore(param[0]))]]
        ]);
    return /* () */0;
  }
}
