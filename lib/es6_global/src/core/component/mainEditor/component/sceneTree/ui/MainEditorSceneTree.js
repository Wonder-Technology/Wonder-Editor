...
function render(store, dispatch, _) {
  ...
  return React.createElement("article", {
              ...
              className: "sceneTree-component"
                              ...
                              store,
                              dispatch
                            ], /* () */0), OperateArrayUtils$WonderEditor.getFirst(sceneGraphData)[/* children */2]), StateFacade$WonderEditor.getState(MainEditorSceneView$WonderEditor.unsafeGetScene), Curry._2(onDrop, /* tuple */[
                          store,
                          dispatch
                        ], /* () */0), /* array */[])));
}
...
function make(store, dispatch, _) {
  ...
  newrecord[/* retainedProps */11] = /* record */[
    ...
    /* currentGameObject */StateFacade$WonderEditor.getState(MainEditorSceneView$WonderEditor.getCurrentGameObject)
  ];
  return newrecord;
}
