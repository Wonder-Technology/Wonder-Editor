...
import '../../../../../../../../../src/core/component/mainEditor/component/sceneTree/ui/css/mainEditorSceneTree.css';
...
function render(store, dispatch, _) {
  ...
  return React.createElement("article", {
              ...
              className: "sceneTree-component"
                              ...
                              store,
                              dispatch
                            ], /* () */0), ArrayService$WonderEditor.getFirst(sceneGraphData)[/* children */2]), StateLogicService$WonderEditor.getEditorState(SceneEditorService$WonderEditor.unsafeGetEditScene), Curry._2(onDrop, /* tuple */[
                          store,
                          dispatch
                        ], /* () */0), /* array */[])));
}
