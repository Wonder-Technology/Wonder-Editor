...
function render(store, dispatch, _) {
  ...
  return React.createElement("article", {
              ...
              className: "sceneTree-component"
                              ...
                              store,
                              dispatch
                            ], /* () */0), OperateArrayUtils$WonderEditor.getFirst(sceneGraphData)[/* children */2]), StateFacade$WonderEditor.getState(SceneFacade$WonderEditor.unsafeGetScene), Curry._2(onDrop, /* tuple */[
                          store,
                          dispatch
                        ], /* () */0), /* array */[])));
}
...
function make(store, dispatch, _) {
  ...
  newrecord[/* retainedProps */11] = /* record */[
    ...
    /* currentGameObject */StateFacade$WonderEditor.getState(CurrentGameObjectFacade$WonderEditor.getCurrentGameObject)
  ];
  return newrecord;
}
