...
function isGeometryDataEqualForDefaultGeometry(param, param$1, engineState) {
...
function getGeometryData(geometry, engineState) {
  return /* tuple */[
          ...
          GeometryEngineService$WonderEditor.unsafeGetGeometryNormals(geometry, engineState),
          GeometryEngineService$WonderEditor.unsafeGetGeometryTexCoords(geometry, engineState)
        ];
}
