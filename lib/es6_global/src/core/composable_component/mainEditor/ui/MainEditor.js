...
function bindPickSuccessEvent(dispatchFunc) {
  StateEngineService$WonderEditor.setState(ManageEventEngineService$WonderEditor.onCustomGlobalEvent(EventEditorService$WonderEditor.getPickSuccessEventName(/* () */0), (function ($$event, engineState) {
              StateEngineService$WonderEditor.setState(engineState);
              Curry._1(dispatchFunc, [
                    AppStore$WonderEditor.UpdateAction,
                    /* Update */[/* array */[
...
var Method = /* module */[
  ...
  /* bindPickSuccessEvent */bindPickSuccessEvent,
  /* dragWDB */dragWDB
];
...
function make(store, dispatchFunc, _) {
  return /* record */[
          ...
          /* didMount */(function () {
              ...
              bindPickSuccessEvent(dispatchFunc);
