...
function _setViewportAndRefresh(param, engineState) {
  return DirectorEngineService$WonderEditor.loopBody(0, DeviceManagerEngineService$WonderEditor.setViewport(/* tuple */[
                  0,
                  0,
                  param[0],
                  param[1]
...
function _setViewportAndSendUniformProjectionMatDataAndRefresh(param, engineState) {
  ...
  return DirectorEngineService$WonderEditor.loopBody(0, ManageIMGUIEngineService$WonderEditor.sendUniformProjectionMatData(DeviceManagerEngineService$WonderEditor.unsafeGetGl(engineState), /* tuple */[
                  canvasWidth,
                  canvasHeight
...
function resizeCanvasAndViewPort() {
  ...
  StateLogicService$WonderEditor.setEditEngineState(_setViewportAndSendUniformProjectionMatDataAndRefresh(/* tuple */[
            width,
            height
          ], StateLogicService$WonderEditor.getEditEngineState(/* () */0)));
  return StateLogicService$WonderEditor.setRunEngineState(_setViewportAndRefresh(/* tuple */[
                  width,
                  height
  ...
  return React.createElement("article", {
              ...
              className: "wonder-mainEditor-component"
                  ...
                  className: "top-component"
                    ...
                    }, ReasonReact.element(undefined, undefined, MainEditorInspector$WonderEditor.make(store, dispatchFunc, GameObjectAllComponentParseUtils$WonderEditor.getGameObjectAllComponentConfig(/* () */0), /* array */[]))), React.createElement("div", {
                  ...
                  key: "bottomComponent",
                  className: "bottom-component"
                }, ReasonReact.element(undefined, undefined, MainEditorAsset$WonderEditor.make(store, dispatchFunc, /* array */[]))));
}
