...
function handleFileByType(fileResult) {
  ...
  return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
              (function () {
                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                  var partial_arg = AssetUtils$WonderEditor.addFileIntoTargetTreeNode(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState), newIndex, /* Json */2, AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState));
              ...
              (function () {
                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                  var partial_arg = AssetUtils$WonderEditor.addFileIntoTargetTreeNode(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState), newIndex, /* Image */1, AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState));
                  return StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
                                return AssetEditorService$WonderEditor.setAsseTree(partial_arg, param);
                              }));
                })
