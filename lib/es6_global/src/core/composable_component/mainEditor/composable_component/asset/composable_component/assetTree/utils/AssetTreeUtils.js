...
function onSelect(dispatch, folderId) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          return CurrentSourceEditorService$WonderEditor.setCurrentSource(/* AssetTree */1, AssetEditorService$WonderEditor.setCurrentAssetTreeNode(folderId, AssetEditorService$WonderEditor.setCurrentAssetChildrenNodeParent(folderId, editorState)));
        }));
