...
function removeFolder(dispatch, _) {
  ...
  if (match !== 0) {
    ...
    StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
            var targetTreeNodeId = AssetUtils$WonderEditor.getTargetTreeNodeId(editorState);
            var match = AssetUtils$WonderEditor.removeSpecificTreeNodeFromAssetTree(targetTreeNodeId, AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState));
            return AssetEditorService$WonderEditor.clearCurrentAssetTreeNode(AssetEditorService$WonderEditor.setAsseTree(match[0], FolderArrayUtils$WonderEditor.removeFolderFromFolderArray(targetTreeNodeId, editorState)));
          }));
...
function removeFile(dispatch, _) {
  ...
  var fileId = AssetEditorService$WonderEditor.unsafeGetCurrentAssetFileNode(editorState);
  StateEditorService$WonderEditor.setState(AssetEditorService$WonderEditor.clearCurrentAssetFileNode(AssetEditorService$WonderEditor.setAsseTree(AssetUtils$WonderEditor.removeFileFromTargetTreeNode(AssetEditorService$WonderEditor.unsafeGetCurrentAssetTreeNode(editorState), fileId, FileUtils$WonderEditor.getFileTypeByFileId(fileId, editorState), AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState)), editorState)));
...
function addFolder(dispatch, _) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          ...
          return AssetEditorService$WonderEditor.setAsseTree(AssetUtils$WonderEditor.insertNewTreeNodeToTargetTreeNode(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState$1), AssetUtils$WonderEditor.buildAssetTreeNodeByIndex(nextIndex), AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState$1)), FolderArrayUtils$WonderEditor.addFolderIntoFolderArray(nextIndex, editorState$1));
        }));
  Curry._1(dispatch, AppStore$WonderEditor.ReLoad);
  return /* () */0;
}
...
function handleFile(successFunc, failFunc) {
  var match = StateLogicService$WonderEditor.getEditorState(AssetEditorService$WonderEditor.getCurrentAssetFileNode);
  if (match) {
    return Curry._1(failFunc, match[0]);
  } else {
    return Curry._1(successFunc, /* () */0);
  }
}

function isFileNotBeRemove() {
  return handleFile((function () {
                return true;
              }), (function (fileId) {
                var match = FolderArrayUtils$WonderEditor.isFileBeFolder(fileId, StateEditorService$WonderEditor.getState(/* () */0));
                if (match !== 0) {
                  return true;
                } else {
                  return false;
...
function isFolderNotBeRemove() {
  return handleFile((function () {
                ...
                if (match !== 0) {
                  ...
                  var match$1 = StateLogicService$WonderEditor.getEditorState(AssetUtils$WonderEditor.isTargetIdEqualRootId);
                  if (match$1 !== 0) {
                    return true;
                  } else {
                    return false;
...
var Method = /* module */[
  ...
  /* isFileNotBeRemove */isFileNotBeRemove,
  /* isFolderNotBeRemove */isFolderNotBeRemove
];
  ...
  return React.createElement("article", {
              ...
              className: "tree-header"
                  ...
                  className: "header-item"
                      ...
                      disabled: isFolderNotBeRemove(/* () */0),
                      onClick: (function (param) {
