...
function removeFolder(dispatch, _) {
  ...
  if (match !== 0) {
    ...
    StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
            ...
            return AssetEditorService$WonderEditor.clearCurrentTreeNode(AssetEditorService$WonderEditor.setAsseTree(match[0], FolderArrayUtils$WonderEditor.removeFolderFromFolderArray(targetTreeNodeId, editorState)));
          }));
