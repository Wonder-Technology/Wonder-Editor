...
function isCurrentNodeIdEqualRootId(assetState) {
  ...
  if (match !== undefined) {
    return AssetUtils$WonderEditor.isIdEqual(match[/* currentNodeId */0], AssetTreeRootAssetService$WonderEditor.getRootTreeNodeId(assetState));
  } else {
    return true;
  }
}
...
function addFolder(dispatchFunc, _) {
  StateLogicService$WonderEditor.getAndSetAssetState((function (assetState) {
          ...
          return AssetTreeNodeUtils$WonderEditor.createNodeAndAddToTargetNodeChildren(AssetUtils$WonderEditor.getTargetTreeNodeId(assetState$1), nextIndex, /* Folder */0, AssetTreeNodeUtils$WonderEditor.addFolderIntoNodeMap(nextIndex, assetState$1));
        }));
...
function removeAssetNode(dispatchFunc, _) {
  StateLogicService$WonderEditor.getAndSetAssetState((function (assetState) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-asset-header"
                  ...
                  className: "header-item"
                      ...
                      onClick: (function (param) {
                          return removeAssetNode(dispatchFunc, param);
                        })
