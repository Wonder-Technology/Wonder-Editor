...
function addFolder(dispatchFunc, _) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          ...
          return AssetTreeNodeUtils$WonderEditor.addToCurrentNodeParent(nextIndex, AssetTreeNodeUtils$WonderEditor.addFolderIntoNodeMap(nextIndex, editorState$1));
        }));
...
function render(_, dispatchFunc, _$1) {
