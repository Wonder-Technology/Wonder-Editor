  ...
  if (currentDragSource) {
    ...
    if (match) {
      ...
      if (match$1) {
        ...
        var match$2 = AssetUtils$WonderEditor.removeSpecificTreeNodeFromAssetTree(removedId, AssetTreeRootEditorService$WonderEditor.unsafeGetAssetTreeRoot(editorState));
        StateEditorService$WonderEditor.setState(AssetTreeRootEditorService$WonderEditor.setAssetTreeRoot(AssetUtils$WonderEditor.insertNewTreeNodeToTargetTreeNode(targetId, match$2[1], match$2[0]), editorState));
        return Curry._1(dispatchFunc, AppStore$WonderEditor.ReLoad);
      }
    } else {
