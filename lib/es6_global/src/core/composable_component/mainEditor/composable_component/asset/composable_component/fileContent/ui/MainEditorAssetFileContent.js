...
function showSpecificTreeNodeChildren(store, dispatch, _, assetTreeChildren) {
  return assetTreeChildren.map((function (param) {
                return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FolderBox$WonderEditor.make(store, dispatch, "./public/img/11.jpg", param[/* id */0], param[/* name */1], AssetTreeUtils$WonderEditor.getSign(/* () */0), /* true */1, /* array */[]));
              }));
}
