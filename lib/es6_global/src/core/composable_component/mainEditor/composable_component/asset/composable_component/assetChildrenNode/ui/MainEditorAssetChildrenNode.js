  ...
  return assetTreeNodeChildrenArr.map((function (param) {
                ...
                switch (type_) {
                  case 0 : 
                      ...
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FolderBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/11.jpg", nodeId, type_, match[/* name */0], _isSelected(currentNodeData, nodeId), AssetUtils$WonderEditor.getFlag(/* () */0), debounceTime, (function (param) {
                                        return AssetTreeUtils$WonderEditor.onDrop(dispatchFunc, param);
                                      }), AssetUtils$WonderEditor.handleFlag, AssetUtils$WonderEditor.isTreeNodeRelationError, /* array */[]));
                  case 1 : 
                      ...
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/12.jpg", nodeId, type_, match$1[/* name */0], AssetUtils$WonderEditor.getFlag(/* () */0), _isSelected(currentNodeData, nodeId), /* array */[]));
                  case 2 : 
