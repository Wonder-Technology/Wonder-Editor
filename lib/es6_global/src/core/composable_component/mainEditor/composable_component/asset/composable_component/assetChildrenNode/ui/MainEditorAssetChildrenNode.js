  ...
  return assetTreeNodeChildrenArr.map((function (param) {
                ...
                switch (type_) {
                  case 0 : 
                      ...
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FolderBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/11.jpg", id, type_, match[/* name */0], _isSelected(currentNodeData, id), AssetTreeUtils$WonderEditor.getFlag(/* () */0), debounceTime, (function (param) {
                  ...
                  case 1 : 
                      ...
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/12.jpg", id, type_, match$1[/* name */0], AssetTreeUtils$WonderEditor.getFlag(/* () */0), _isSelected(currentNodeData, id), /* array */[]));
                  case 2 : 
