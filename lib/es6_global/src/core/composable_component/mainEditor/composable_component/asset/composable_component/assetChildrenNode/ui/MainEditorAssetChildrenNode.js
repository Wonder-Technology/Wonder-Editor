...
function showSpecificTreeNodeChildren(store, param, dispatchFunc, assetTreeNodeChildren) {
...
function buildContent(param, dispatchFunc) {
  ...
  return showSpecificTreeNodeChildren(param[0], /* tuple */[
            ...
            ], dispatchFunc, OptionService$WonderEditor.unsafeGet(AssetUtils$WonderEditor.getSpecificTreeNodeById(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState), AssetTreeRootEditorService$WonderEditor.unsafeGetAssetTreeRoot(editorState)))[/* children */1]);
}
...
function render(store, dragImg, dispatchFunc, _) {
