...
function showSpecificTreeNodeChildren(store, dispatch, setNodeParentId, nodeMap, currentNodeId, assetTreeNodeChildren) {
  return assetTreeNodeChildren.map((function (param) {
                ...
                switch (match[/* type_ */1]) {
                  case 0 : 
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FolderBox$WonderEditor.make(store, dispatch, "./public/img/11.jpg", id, name, AssetTreeUtils$WonderEditor.getSign(/* () */0), isIdEqualCurrentNodeId(currentNodeId, id), setNodeParentId, /* array */[]));
                  case 1 : 
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatch, Js_option.getExn(match[/* result */2]), id, name, "assetChildrenNode", isIdEqualCurrentNodeId(currentNodeId, id), /* array */[]));
                  case 2 : 
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatch, "./public/img/12.jpg", id, name, "assetChildrenNode", isIdEqualCurrentNodeId(currentNodeId, id), /* array */[]));
