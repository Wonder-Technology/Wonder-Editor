...
function _isSelected(currentNodeData, nodeId) {
  if (currentNodeData) {
    return AssetUtils$WonderEditor.isIdEqual(nodeId, currentNodeData[0][/* currentNodeId */0]);
  } else {
    return false;
  }
}
...
function showSpecificTreeNodeChildren(param, param$1, assetState, assetTreeNodeChildrenArr) {
  ...
  return assetTreeNodeChildrenArr.map((function (param) {
                ...
                switch (type_) {
                  case 0 : 
                      var match = SparseMapService$WonderCommonlib.unsafeGet(nodeId, FolderNodeMapAssetService$WonderEditor.unsafeGetFolderNodeMap(assetState));
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FolderBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/11.jpg", nodeId, type_, match[/* name */0], _isSelected(currentNodeData, nodeId), AssetTreeUtils$WonderEditor.getFlag(/* () */0), debounceTime, (function (param) {
                                        return AssetTreeUtils$WonderEditor.onDrop(dispatchFunc, param);
                                      }), AssetTreeUtils$WonderEditor.handleFlag, AssetUtils$WonderEditor.isTreeNodeRelationError, /* array */[]));
                  case 1 : 
                      var match$1 = SparseMapService$WonderCommonlib.unsafeGet(nodeId, JsonNodeMapAssetService$WonderEditor.unsafeGetJsonNodeMap(assetState));
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatchFunc, dragImg, "./public/img/12.jpg", nodeId, type_, match$1[/* name */0], AssetTreeUtils$WonderEditor.getFlag(/* () */0), _isSelected(currentNodeData, nodeId), /* array */[]));
                  case 2 : 
                      var match$2 = SparseMapService$WonderCommonlib.unsafeGet(nodeId, TextureNodeMapAssetService$WonderEditor.unsafeGetTextureNodeMap(assetState));
                      var textureId = match$2[/* textureId */0];
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, FileBox$WonderEditor.make(store, dispatchFunc, dragImg, SparseMapService$WonderCommonlib.unsafeGet(textureId, ImageBase64MapAssetService$WonderEditor.unsafeGetImageBase64Map(assetState)), nodeId, type_, StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                                            return BasicSourceTextureEngineService$WonderEditor.unsafeGetBasicSourceTextureName(textureId, param);
                                          })), AssetTreeUtils$WonderEditor.getFlag(/* () */0), _isSelected(currentNodeData, nodeId), /* array */[]));
