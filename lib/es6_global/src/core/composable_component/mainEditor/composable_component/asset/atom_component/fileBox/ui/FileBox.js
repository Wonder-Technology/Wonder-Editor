...
function onSelect(fileId, dispatchFunc, _) {
  StateAssetService$WonderEditor.setState(CurrentNodeIdAssetService$WonderEditor.setCurrentNodeId(fileId, CurrentNodeIdAssetService$WonderEditor.clearCurrentNodeId(StateAssetService$WonderEditor.getState(/* () */0))));
