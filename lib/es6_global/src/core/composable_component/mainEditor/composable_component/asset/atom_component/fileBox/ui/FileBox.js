...
function onSelect(dispatch, fileId, _) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          return CurrentSourceEditorService$WonderEditor.setCurrentSource(/* AssetTree */1, AssetCurrentAssetTreeNodeEditorService$WonderEditor.setCurrentAssetTreeNode(fileId, editorState));
        }));
