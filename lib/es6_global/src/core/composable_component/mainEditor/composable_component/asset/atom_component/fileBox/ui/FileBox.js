...
function render(_, dispatchFunc, attributeTuple, _$1) {
  ...
  return React.createElement("article", {
              ...
              onClick: (function (_event) {
                  ...
                  onDragStart: (function (param) {
                      return DragEventBaseUtils$WonderEditor.dragStart(fileId, sign, dragImg, param);
                    })
...
function make(store, dispatchFunc, attributeTuple, _) {
  return /* record */[
          ...
          /* render */(function (self) {
              return render(store, dispatchFunc, attributeTuple, self);
            }),
