...
function onSelect(fileId, fileType, dispatchFunc, _) {
  StateEditorService$WonderEditor.setState(AssetCurrentNodeDataEditorService$WonderEditor.setCurrentNodeData(/* record */[
  ...
  return React.createElement("article", {
              ...
              onClick: (function (_event) {
                  ...
                  onDragStart: (function (param) {
                      return DragEventBaseUtils$WonderEditor.dragStart(fileId, widge, dragImg, param);
                    })
...
function make(store, dispatchFunc, dragImg, imgSrc, fileId, fileType, fileName, widge, isSelected, _) {
  return /* record */[
