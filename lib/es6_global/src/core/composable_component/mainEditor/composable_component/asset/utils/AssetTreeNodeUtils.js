...
function handleFileByType(fileResult) {
  ...
  return new Promise((function (resolve, _) {
                return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
                            ...
                            (function () {
                                var match = TextureUtils$WonderEditor.createAndInitTexture(StateLogicService$WonderEditor.getEditEngineState(/* () */0), StateLogicService$WonderEditor.getRunEngineState(/* () */0));
