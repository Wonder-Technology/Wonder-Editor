...
function initRootAssetTree(editorState) {
  ...
  if (match) {
    ...
    return /* tuple */[
            ...
            AssetCurrentAssetChildrenNodeParentEditorService$WonderEditor.setCurrentAssetChildrenNodeParent(rootIndex, addFolderIntoNodeMap(rootIndex, editorState))
          ];
  }
}
...
function handleFileByType(fileResult) {
  ...
  var newIndex = AssetIndexEditorService$WonderEditor.getIndex(editorState$1);
  StateEditorService$WonderEditor.setState(AssetNodeMapEditorService$WonderEditor.setResult(newIndex, fileResult, editorState$1));
  return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
              (function () {
                  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                  var partial_arg = AssetUtils$WonderEditor.insertNewTreeNodeToTargetTreeNode(AssetTreeRootEditorService$WonderEditor.getRootTreeNodeId(editorState), AssetNodeEditorService$WonderEditor.buildAssetTreeNodeByIndex(newIndex), AssetTreeRootEditorService$WonderEditor.unsafeGetAssetTreeRoot(editorState));
