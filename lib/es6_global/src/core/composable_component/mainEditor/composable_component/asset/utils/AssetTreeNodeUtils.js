...
function handleFileByType(fileResult) {
  ...
  return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
              (function () {
                  ...
                  var partial_arg = AssetUtils$WonderEditor.insertNewTreeNodeToTargetTreeNode(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState), AssetNodeEditorService$WonderEditor.buildAssetTreeNodeByIndex(newIndex), AssetTreeRootEditorService$WonderEditor.unsafeGetAssetTreeRoot(editorState));
