  ...
  return new Promise((function (resolve, _) {
                return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
                            ...
                            (function () {
                                ...
                                var texture = match[0];
                                var editEngineState = BasicSourceTextureEngineService$WonderEditor.initTexture(texture, match[1]);
                                var runEngineState = BasicSourceTextureEngineService$WonderEditor.initTexture(texture, match[2]);
                                var match$1 = FileNameUtils$WonderEditor.handleFileName(fileResult[/* name */0]);
