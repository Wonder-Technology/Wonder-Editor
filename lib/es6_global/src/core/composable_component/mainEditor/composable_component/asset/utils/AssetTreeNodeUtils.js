                ...
                return _handleSpecificFuncByType(fileResult[/* type_ */1], /* tuple */[
                            ...
                            (function () {
                                ...
                                return Curry._2(Image$WonderEditor.onload, OptionService$WonderEditor.unsafeGet(fileResult[/* result */2]), (function (loadedImg) {
                                              ...
                                              StateEditorService$WonderEditor.setState(createNodeAndAddToCurrentNodeParent(newIndex, AssetNodeMapEditorService$WonderEditor.setResult(newIndex, TextureUtils$WonderEditor.buildTextureNodeResult(/* None */0, texture), editorState)));
                                              return resolve("resolve");
                                            }));
                              })
                          ]);
