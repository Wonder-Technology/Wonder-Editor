...
function addToCurrentNodeParent(newIndex, editorState) {
...
function handleFileByType(fileResult) {
  ...
  StateEditorService$WonderEditor.setState(addToCurrentNodeParent(newIndex, AssetNodeMapEditorService$WonderEditor.setResult(newIndex, fileResult, editorState)));
  return /* () */0;
}
