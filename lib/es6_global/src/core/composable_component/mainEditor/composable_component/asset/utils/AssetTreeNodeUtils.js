  ...
  switch (type_) {
    ...
    default:
      ...
      return Log$WonderLog.fatal((function (param, param$1, param$2) {
                    return Log$WonderLog.buildFatalMessage("getUploadFileType", partial_arg, param, param$1, param$2);
                  }));
  }
}
...
function _handleJsonType(assetState, newIndex, fileResult, resolve, _) {
  StateAssetService$WonderEditor.setState(createNodeAndAddToTargetNodeChildren(AssetUtils$WonderEditor.getTargetTreeNodeId(assetState), newIndex, /* Json */1, JsonNodeMapAssetService$WonderEditor.setResult(newIndex, AssetNodeAssetService$WonderEditor.buildJsonNodeResult(fileResult), assetState)));
