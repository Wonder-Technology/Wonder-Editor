...
function addFolder(dispatch, _) {
  ...
  var partial_arg = AssetUtils$WonderEditor.insertNewTreeNodeToTargetTreeNode(AssetUtils$WonderEditor.getTargetTreeNodeId(editorState), AssetUtils$WonderEditor.buildAssetTreeNodeByIndex(AssetUtils$WonderEditor.increaseIndex(editorState)), AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState));
  StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
              ...
              className: "asset-component"
                  ...
                  className: "asset-tree"
                      ...
                      className: "tree-header"
                        ...
                        }, DomHelper$WonderEditor.textEl("addFolder")), React.createElement("button", undefined, DomHelper$WonderEditor.textEl("remove")), React.createElement("button", undefined, DomHelper$WonderEditor.textEl("upload file"))), StateLogicService$WonderEditor.getEditorState((function (editorState) {
