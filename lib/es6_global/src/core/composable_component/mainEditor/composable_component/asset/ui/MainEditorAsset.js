...
function render(store, dispatch, _) {
  return React.createElement("article", {
              ...
              className: "asset-component"
                ...
                }, ReasonReact.element(/* None */0, /* None */0, MainEditorAssetHeader$WonderEditor.make(store, dispatch, /* array */[])), ReasonReact.element(/* None */0, /* None */0, MainEditorAssetTree$WonderEditor.make(store, dispatch, /* array */[]))));
}
...
function make(store, dispatch, _) {
  ...
  newrecord[/* retainedProps */11] = /* record */[
    ...
    /* currentAssetChildrenNodeParent */StateLogicService$WonderEditor.getEditorState(AssetEditorService$WonderEditor.getCurrentAssetChildrenNodeParent),
    /* nodeMap */StateLogicService$WonderEditor.getEditorState(AssetEditorService$WonderEditor.unsafeGetNodeMap)
  ];
  return newrecord;
}
