...
import * as MainEditorAssetFileContent$WonderEditor from "../composable_component/fileContent/ui/MainEditorAssetFileContent.js";
...
function make(store, dispatch, _) {
  ...
  newrecord[/* retainedProps */11] = /* record */[
    ...
    /* fileMap */StateLogicService$WonderEditor.getEditorState(AssetEditorService$WonderEditor.unsafeGetFileMap)
  ];
  return newrecord;
}
