...
function handleFileToFolder(dispatch, targetTreeNodeId, removedFileId) {
  ...
  if (match !== 0) {
    ...
    var partial_arg = Log$WonderLog.print(AssetUtils$WonderEditor.removeFileAndInsertFile(targetTreeNodeId, removedTreeNodeId, removedFileId, FileUtils$WonderEditor.getFileTypeByFileId(removedFileId, editorState), AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState)));
    StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
