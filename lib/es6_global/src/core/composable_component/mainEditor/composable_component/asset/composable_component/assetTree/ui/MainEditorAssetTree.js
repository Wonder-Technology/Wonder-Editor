                  ...
                  if (match !== 0) {
                    ...
                    if (match$1 !== 0) {
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                    ...
                                    ], AssetTreeUtils$WonderEditor.getAssetTreeSign(/* () */0), /* Some */["./public/img/12.jpg"], /* Some */[_isNotRoot(id)], /* Some */[_iterateAssetTreeArray(onSelect, onDrop, children)], /* array */[]));
                    } else {
                      return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                      id,
                                      nodeResult[/* name */0],
                                      ...
                                      AssetTreeUtils$WonderEditor.handleSign,
                                      AssetUtils$WonderEditor.isTreeNodeRelationError
                                    ], AssetTreeUtils$WonderEditor.getAssetTreeSign(/* () */0), /* Some */["./public/img/12.jpg"], /* Some */[_isNotRoot(id)], /* None */0, /* array */[]));
                    }
                  }
                }), assetTreeArray);
  };
