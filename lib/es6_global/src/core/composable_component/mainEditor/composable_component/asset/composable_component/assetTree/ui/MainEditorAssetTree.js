...
function _isCurrentAssetChildrenNodeParent(id) {
  var match = StateLogicService$WonderEditor.getEditorState(AssetCurrentAssetChildrenNodeParentEditorService$WonderEditor.getCurrentAssetChildrenNodeParent);
  if (match) {
...
function buildAssetTreeNodeArray(onSelect, onDrop, assetTreeRoot) {
...
function render(_, dispatch, _$1) {
  return React.createElement("article", {
              ...
              className: "tree-content"
                    ...
                    return buildAssetTreeNodeArray((function (param) {
