...
function handleFileToFolder(dispatch, targetTreeNodeId, fileId) {
  ...
  if (match !== 0) {
    ...
    var partial_arg = AssetUtils$WonderEditor.addFileIntoTargetTreeNode(targetTreeNodeId, fileId, fileType, AssetUtils$WonderEditor.removeFileFromTargetTreeNode(removedTreeNodeId, fileId, fileType, AssetEditorService$WonderEditor.unsafeGetAssetTree(editorState)));
...
function onDrop(dispatch, param) {
  ...
  if (currentSign === AssetTreeUtils$WonderEditor.getSign(/* () */0)) {
...
function _isCurrentAssetTreeNode(id) {
  var match = StateLogicService$WonderEditor.getEditorState(AssetEditorService$WonderEditor.getCurrentAssetTreeNode);
  if (match) {
...
var Method = /* module */[
  ...
  /* onDrop */onDrop,
  /* _isCurrentAssetTreeNode */_isCurrentAssetTreeNode,
