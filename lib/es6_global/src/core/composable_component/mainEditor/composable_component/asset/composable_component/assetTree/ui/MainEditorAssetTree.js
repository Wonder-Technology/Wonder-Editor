...
function _isActive() {
  ...
  if (match !== undefined) {
    return AssetUtils$WonderEditor.isIdEqual(AssetUtils$WonderEditor.getTargetTreeNodeId(assetState), match[/* currentNodeId */0]);
  } else {
    return false;
  }
}
  ...
  var _iterateAssetTreeArray = function (onSelectFunc, onDropFunc, assetTreeArray) {
    return assetTreeArray.map((function (param) {
                  ...
                  if (type_ !== 0) {
                    ...
                    var match = SparseMapService$WonderCommonlib.unsafeGet(id, FolderNodeMapAssetService$WonderEditor.getFolderNodeMap(StateAssetService$WonderEditor.getState(/* () */0)));
                    return ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, TreeNode$WonderEditor.make(id, match[/* name */0], StateLogicService$WonderEditor.getAssetState(AssetUtils$WonderEditor.getTargetTreeNodeId) === id, _isActive(/* () */0), dragImg, AssetUtils$WonderEditor.getFlag(/* () */0), "./public/img/12.jpg", _isNotRoot(id), Curry._1(onSelectFunc, type_), onDropFunc, AssetUtils$WonderEditor.isFlag, AssetUtils$WonderEditor.isTreeNodeRelationError, _iterateAssetTreeArray(onSelectFunc, onDropFunc, param[/* children */1]), /* array */[]));
                  }
                }));
  };
...
function render(param, dragImg, _) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-asset-assetTree"
                ...
                ], AssetTreeRootAssetService$WonderEditor.unsafeGetAssetTreeRoot(StateAssetService$WonderEditor.getState(/* () */0))));
}
