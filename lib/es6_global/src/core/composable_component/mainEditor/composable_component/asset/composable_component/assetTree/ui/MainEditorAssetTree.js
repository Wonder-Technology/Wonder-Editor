...
function _isSelected(id) {
  var match = StateLogicService$WonderEditor.getEditorState(AssetUtils$WonderEditor.getTargetTreeNodeId) === id;
  if (match) {
    return true;
  } else {
    return false;
...
function _isActive() {
  ...
  if (match) {
    var match$1 = AssetUtils$WonderEditor.isIdEqual(StateLogicService$WonderEditor.getEditorState(AssetUtils$WonderEditor.getTargetTreeNodeId), match[0]);
    if (match$1) {
      return true;
    } else {
      return false;
...
function buildAssetTreeNodeArray(dragImg, param, assetTreeRoot) {
...
function render(_, dragImg, dispatchFunc, _$1) {
  return React.createElement("article", {
              ...
              className: "tree-content"
                    ...
                    return buildAssetTreeNodeArray(dragImg, /* tuple */[
                                (function (param) {
