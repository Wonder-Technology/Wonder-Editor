  ...
  return React.createElement("article", {
              ...
              style: param$2[/* state */1][/* style */0]
                  ...
                  onDragEnter: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragEnter(folderId, isFlag, handleRelationError, _e));
                    }),
                  onDragLeave: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragLeave(folderId, isFlag, handleRelationError, _e));
                    }),
                  ...
                  onDrop: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDrop(folderId, isFlag, handleRelationError, _e));
                    })
...
function make(store, dispatchFunc, dragImg, imgSrc, folderId, fileType, name, isSelected, flag, debounceTime, onDrop, isFlag, handleRelationError, _) {
  return /* record */[
