...
function render(_, _$1, attributeTuple, eventTuple, param) {
  var handleRelationError = eventTuple[2];
  var handleSign = eventTuple[1];
  ...
  return React.createElement("article", {
              ...
              style: param[/* state */4][/* style */0]
                  ...
                  onDragStart: Curry._1(reduce, (function (param) {
                          return DragEventUtils$WonderEditor.handleDragStart(folderId, sign, dragImg, param);
                        })),
...
function make(store, dispatch, attributeTuple, eventTuple, _) {
  ...
  newrecord[/* didMount */4] = (function () {
      var setNodeParentId = eventTuple[3];
      var folderId = attributeTuple[2];
  ...
  newrecord[/* reducer */12] = (function (param, param$1) {
      return reducer(eventTuple, param, param$1);
    });
  return newrecord;
}
