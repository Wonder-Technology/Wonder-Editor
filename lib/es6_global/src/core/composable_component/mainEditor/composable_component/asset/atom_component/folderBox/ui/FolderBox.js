...
function render(_, _$1, attributeTuple, funcTuple, param) {
  var handleRelationError = funcTuple[2];
  var handleSign = funcTuple[1];
  ...
  return React.createElement("article", {
              ...
              style: param[/* state */1][/* style */0]
                  ...
                  onDragEnter: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragEnter(folderId, handleSign, handleRelationError, _e));
                    }),
                  onDragLeave: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragLeave(folderId, handleSign, handleRelationError, _e));
                    }),
                  onDragOver: DragEventUtils$WonderEditor.handleDragOver,
                  onDragStart: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragStart(folderId, sign, dragImg, _e));
                    }),
                  onDrop: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDrop(folderId, handleRelationError, _e));
                    })
...
function make(store, dispatchFunc, attributeTuple, funcTuple, _) {
  return /* record */[
          ...
          /* didMount */(function () {
              var silentSetNodeParentId = funcTuple[4];
              var setNodeParentId = funcTuple[3];
              var folderId = attributeTuple[2];
              var clickStream = Most.fromEvent("mousedown", document.getElementById("folder-" + String(folderId)), Js.true_);
              Most.forEach((function () {
                      Log$WonderLog.print("double click11");
                      return AssetTreeUtils$WonderEditor.onSelect(/* tuple */[
                                  setNodeParentId,
          ...
          /* render */(function (self) {
              return render(store, dispatchFunc, attributeTuple, funcTuple, self);
            }),
