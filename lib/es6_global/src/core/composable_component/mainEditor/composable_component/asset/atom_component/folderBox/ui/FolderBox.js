...
function make(store, dispatchFunc, dragImg, imgSrc, folderId, fileType, name, isSelected, flag, debounceTime, onDrop, handleFlag, handleRelationError, _) {
  return /* record */[
