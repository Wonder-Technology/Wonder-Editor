...
function isTreeNodeRelationError(targetId, removedId, param) {
  ...
  if (match !== 0) {
    ...
    if (match$1 !== 0) {
      ...
      return Log$WonderLog.print(_isTargetTreeNodeBeRemovedParent(OptionService$WonderEditor.unsafeGet(getSpecificTreeNodeById(targetId, AssetTreeRootEditorService$WonderEditor.unsafeGetAssetTreeRoot(editorState))), removedId));
    }
  }
}
