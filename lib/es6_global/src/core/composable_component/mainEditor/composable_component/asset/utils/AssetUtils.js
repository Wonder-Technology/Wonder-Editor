...
function deepRemoveTreeNode(removedTreeNode, nodeMap) {
  var _iterateRemovedTreeNode = function (_, childrenArr, nodeMap) {
    return ArrayService$WonderCommonlib.reduceOneParam((function (nodeMap, param) {
                  var id = param[/* id */0];
                  return _iterateRemovedTreeNode(id, param[/* children */1], Curry._2(DomHelper$WonderEditor.deleteKeyInDict, id, SparseMapService$WonderEditor.copy(nodeMap)));
                }), nodeMap, childrenArr);
  };
  return _iterateRemovedTreeNode(removedTreeNode[/* id */0], removedTreeNode[/* children */1], nodeMap);
}
