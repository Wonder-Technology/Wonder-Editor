...
function getTargetTreeNodeId(editorState) {
  var match = AssetEditorService$WonderEditor.getCurrentAssetTreeNode(editorState);
  if (match) {
    return match[0];
  } else {
...
function initRootAssetTree(editorState) {
  ...
  if (match) {
    ...
    StateLogicService$WonderEditor.getAndSetEditorState((function (param) {
            return FolderArrayUtils$WonderEditor.addFolderIntoFolderArray(rootIndex, param);
          }));
    return /* array */[buildAssetTreeNodeByIndex(rootIndex)];
  }
}
                  ...
                  switch (type_) {
                    case 0 : 
                        throw [
                              ...
                              [
                                "/home/arvin/yangHao/Wonder-Editor/src/core/composable_component/mainEditor/composable_component/asset/utils/AssetUtils.re",
                                141,
                                11
                              ]
                            ];
