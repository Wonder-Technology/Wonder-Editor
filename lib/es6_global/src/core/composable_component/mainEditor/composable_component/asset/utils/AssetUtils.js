    ...
    nodeArr.forEach((function (param) {
            ...
            switch (param[/* type_ */2]) {
              case 0 : 
                  ...
                  StateAssetService$WonderEditor.setState(FolderNodeMapAssetService$WonderEditor.setFolderNodeMap(Curry._2(DomHelper$WonderEditor.deleteKeyInDict, id, SparseMapService$WonderEditor.copy(FolderNodeMapAssetService$WonderEditor.getFolderNodeMap(assetState))), assetState));
                  break;
              case 1 : 
                  var assetState$1 = StateAssetService$WonderEditor.getState(/* () */0);
                  StateAssetService$WonderEditor.setState(JsonNodeMapAssetService$WonderEditor.setJsonNodeMap(Curry._2(DomHelper$WonderEditor.deleteKeyInDict, id, SparseMapService$WonderEditor.copy(JsonNodeMapAssetService$WonderEditor.getJsonNodeMap(assetState$1))), assetState$1));
                  break;
              case 2 : 
                  var assetState$2 = StateAssetService$WonderEditor.getState(/* () */0);
                  StateAssetService$WonderEditor.setState(TextureNodeMapAssetService$WonderEditor.setTextureNodeMap(Curry._2(DomHelper$WonderEditor.deleteKeyInDict, id, SparseMapService$WonderEditor.copy(TextureNodeMapAssetService$WonderEditor.getTextureNodeMap(assetState$2))), assetState$2));
                  break;
