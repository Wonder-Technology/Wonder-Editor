...
function onSelect(dispatch, folderId) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          return AssetEditorService$WonderEditor.clearCurrentFile(CurrentSourceEditorService$WonderEditor.setCurrentSource(/* AssetTree */1, AssetEditorService$WonderEditor.setCurrentTreeNode(folderId, editorState)));
        }));
