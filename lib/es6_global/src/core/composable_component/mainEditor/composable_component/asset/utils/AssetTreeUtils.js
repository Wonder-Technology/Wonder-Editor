...
function onSelect(dispatch, folderId) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          return AssetEditorService$WonderEditor.clearCurrentAssetFileNode(CurrentSourceEditorService$WonderEditor.setCurrentSource(/* AssetTree */1, AssetEditorService$WonderEditor.setCurrentAssetTreeNode(folderId, editorState)));
        }));
