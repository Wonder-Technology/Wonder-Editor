...
function buildSceneTreeArray(param, currentSceneTreeNode, param$1, param$2, sceneGraphArr) {
  ...
  return sceneGraphArr.map((function (param) {
                ...
                var uid = param[/* uid */1];
                return ReasonReact.element(StringService$WonderEditor.intToString(uid), undefined, SceneTreeNode$WonderEditor.make(uid, param[/* name */0], _isSelected(uid, currentSceneTreeNode), true, dragImg, SceneTreeWidgetService$WonderEditor.getWidget(/* () */0), onSelectFunc, dragGameObjectFunc, dragWDBFunc, SceneTreeWidgetService$WonderEditor.isWidget, SceneTreeEditorService$WonderEditor.getIsShowChildern(uid, sceneGameObject, editorState), children.length >= 1, CheckSceneTreeLogicService$WonderEditor.checkGameObjectRelation, (function (param, param$1) {
