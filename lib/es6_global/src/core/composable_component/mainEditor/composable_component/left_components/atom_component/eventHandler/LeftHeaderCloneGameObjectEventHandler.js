...
function handleSelfLogic(param, _, _$1) {
  ...
  var engineState$1 = Result$WonderEditor.Result[/* either */2]((function (targetGameObject) {
          ...
          if (match) {
            var match$1 = MainEditorLightUtils$WonderEditor.isLightExceedMaxCountByType(MainEditorLightUtils$WonderEditor.getLightTypeByGameObject(targetGameObject, engineState), engineState);
            if (match$1[1]) {
              ConsoleUtils$WonderEditor.warn(match$1[0], editorState);
              return engineState;
            } else {
