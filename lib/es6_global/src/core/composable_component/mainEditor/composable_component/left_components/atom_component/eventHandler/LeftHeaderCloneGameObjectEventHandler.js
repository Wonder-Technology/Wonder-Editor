...
function _clone(targetGameObject, editorState, engineState) {
  ...
  return StateLogicService$WonderEditor.renderEngineStateAndReturnEngineState(engineState$3);
}

function _limitMaxLightCountAndClone(targetGameObject, param) {
  var engineState = param[1];
  var editorState = param[0];
  var match = MainEditorLightUtils$WonderEditor.isLightExceedMaxCountByCount(MainEditorLightUtils$WonderEditor.getLightCount(targetGameObject, engineState), engineState);
  if (match[1]) {
...
function handleSelfLogic(param, param$1, param$2) {
  ...
  var engineState$1 = Result$WonderEditor.Result[/* either */2]((function (targetGameObject) {
          return _limitMaxLightCountAndClone(targetGameObject, /* tuple */[
                      editorState,
                      engineState
                    ]);
        }), (function (errorMsg) {
...
var CustomEventHandler = /* module */[
  ...
  /* _clone */_clone,
  /* _limitMaxLightCountAndClone */_limitMaxLightCountAndClone,
