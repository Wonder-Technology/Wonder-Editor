...
function render(reduxTuple, self) {
  var _isCurrentSceneTreeNodeCanBeOperate = StateLogicService$WonderEditor.getStateToGetData(GameObjectLogicService$WonderEditor.isCurrentSceneTreeNodeCanBeOperate);
