...
function render(store, dispatchFunc, param) {
  ...
  var tmp;
  if (match) {
    var match$1 = state[/* currentSelectItem */1] === /* GameObject */1;
  ...
  var match$2 = Js_option.isNone(StateLogicService$WonderEditor.getEditorState(SceneEditorService$WonderEditor.getCurrentSceneTreeNode));
