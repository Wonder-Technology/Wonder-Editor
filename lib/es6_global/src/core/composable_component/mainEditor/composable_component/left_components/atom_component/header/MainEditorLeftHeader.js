...
function _renderAddGameObjectComponent(param, state, send, languageType) {
  var match = state[/* isSelectNav */0];
  return React.createElement("div", {
              ...
              onClick: (function (_e) {
                  ...
                  title: LanguageUtils$WonderEditor.getSceneTreeLanguageDataByType("scene-tree-add", languageType)
...
function _renderRemoveGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeSceneChildren, languageType) {
  return React.createElement("div", {
              className: "sceneTree-header-item",
              title: LanguageUtils$WonderEditor.getSceneTreeLanguageDataByType("scene-tree-remove", languageType),
              onClick: (function (_e) {
...
function _renderCloneGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeSceneChildren, languageType) {
  return React.createElement("div", {
              className: "sceneTree-header-item",
              title: LanguageUtils$WonderEditor.getSceneTreeLanguageDataByType("scene-tree-clone", languageType),
              onClick: (function (_e) {
                  if (isCurrentSceneTreeNodeSceneChildren) {
...
function render(reduxTuple, self) {
  ...
  return React.createElement("article", {
            ...
            }, _renderAddGameObjectComponent(reduxTuple, self[/* state */1], self[/* send */3], languageType), _renderRemoveGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeSceneChildren, languageType), _renderCloneGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeSceneChildren, languageType));
}
