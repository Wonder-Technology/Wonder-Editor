...
function _renderRemoveGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeCanBeOperate) {
  return React.createElement("div", {
              className: "sceneTree-header-item",
              title: "remove",
              onClick: (function () {
            ...
            }, isCurrentSceneTreeNodeCanBeOperate ? React.createElement("div", {
...
function _renderCloneGameObjectComponent(reduxTuple, isCurrentSceneTreeNodeCanBeOperate) {
  return React.createElement("div", {
              className: "sceneTree-header-item",
              title: "clone",
              onClick: (function () {
...
function render(reduxTuple, self) {
  ...
  var _isCurrentSceneTreeNodeCanBeOperate = match !== undefined ? match !== StateLogicService$WonderEditor.getEngineStateToGetData(SceneEngineService$WonderEditor.getSceneGameObject) : false;
  return React.createElement("article", {
              key: "mainEditorScenetreeHeader",
              className: "wonder-left-components-header"
            }, _renderAddGameObjectComponent(reduxTuple, self[/* state */1], self[/* send */3]), _renderRemoveGameObjectComponent(reduxTuple, _isCurrentSceneTreeNodeCanBeOperate), _renderCloneGameObjectComponent(reduxTuple, _isCurrentSceneTreeNodeCanBeOperate));
}
