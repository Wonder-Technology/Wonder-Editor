...
function render(store, dispatchFunc, _self) {
  ...
  var match$1 = StateEditorService$WonderEditor.getStateIsDebug(/* () */0);
  var match$2 = ArrayService$WonderEditor.hasItem(consoleMessageArray);
  return React.createElement("article", {
              key: "console",
              className: "wonder-bottom-console"
            }, React.createElement("article", {
                  className: "wonder-console-component"
                }, match$1 ? _renderHeader(dispatchFunc) : null, React.createElement("div", {
                      className: "console-content"
                    }, match$2 ? showConsoleMsgComponent(consoleMessageArray) : null)));
}
