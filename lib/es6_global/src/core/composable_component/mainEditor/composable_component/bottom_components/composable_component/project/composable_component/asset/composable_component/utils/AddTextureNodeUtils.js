...
function addImageNodeByBase64(base64, fileName, mimeType, editorState) {
  ...
  if (match !== undefined) {
    ...
    return /* tuple */[
            imageNodeId,
            ImageNodeMapAssetEditorService$WonderEditor.setResult(imageNodeId, ImageNodeMapAssetEditorService$WonderEditor.buildImageNodeResult(base64, undefined, fileName, mimeType), match$1[0])
          ];
  }
}
...
function addImageNodeByUint8Array(uint8Array, name, mimeType, editorState) {
  ...
  if (match !== undefined) {
    ...
    return /* tuple */[
            imageNodeId,
            ImageNodeMapAssetEditorService$WonderEditor.setResult(imageNodeId, ImageNodeMapAssetEditorService$WonderEditor.buildImageNodeResult(undefined, Js_primitive.some(uint8Array), name, mimeType), match$1[0])
          ];
  }
}
