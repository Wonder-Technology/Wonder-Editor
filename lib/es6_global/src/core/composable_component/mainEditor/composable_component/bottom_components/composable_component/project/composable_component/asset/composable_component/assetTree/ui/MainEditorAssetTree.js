...
function _isActive(selectedFolderNodeIdInAssetTree, currentNodeId, _) {
...
function buildAssetTreeArray(param, param$1, editorState) {
  ...
  var _build = function (param, allFolderNodes, param$1, param$2, editorState) {
...
function make(uiState, dispatchFunc, dragImg, _) {
  return /* record */[
