...
function _getAssetNode(nodeId, editorState) {
  return OptionService$WonderEditor.unsafeGet(TreeAssetEditorService$WonderEditor.getSpecificTreeNodeById(nodeId, OptionService$WonderEditor.unsafeGet(TreeRootAssetEditorService$WonderEditor.getAssetTreeRoot(editorState))));
}
...
function handleSelfLogic(param, _, param$1) {
  ...
  if (match) {
    ...
    var match$1 = _getAssetNode(sourceNodeId, editorState$1);
