...
function render(param, _self) {
  ...
  var store = param[0];
  var currentComponentType = StoreUtils$WonderEditor.getBottomCurrentComponentType(store);
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(undefined, undefined, MainEditorBottomHeader$WonderEditor.make(store, dispatchFunc, /* array */[])), match ? ReasonReact.element(undefined, undefined, MainEditorProject$WonderEditor.make(store, dispatchFunc, /* array */[])) : null, match$1 ? ReasonReact.element(undefined, undefined, MainEditorConsole$WonderEditor.make(store, dispatchFunc, /* array */[])) : null);
}
