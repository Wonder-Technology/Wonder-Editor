...
function onSelect(fileId, fileType, dispatchFunc, _event) {
...
function make(store, dispatchFunc, effectAllowd, dragImg, imgSrc, fileId, fileType, fileName, widget, isSelected, _children) {
  return /* record */[
