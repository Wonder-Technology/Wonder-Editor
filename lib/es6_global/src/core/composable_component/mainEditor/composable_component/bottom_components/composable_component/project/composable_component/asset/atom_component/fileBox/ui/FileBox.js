...
function onSelect(nodeId, dispatchFunc, _) {
              ...
              onClick: (function (_event) {
                  ...
                  className: "box-image"
                      ...
                      onDragStart: (function (e) {
                          return DragEventBaseUtils$WonderEditor.dragStart(nodeId, widget, dragImg, effectAllowd, e);
                        })
                    })), React.createElement("div", {
                  className: className
...
function make(uiState, dispatchFunc, effectAllowd, dragImg, imgSrc, nodeId, fileName, widget, isSelected, _) {
  return /* record */[
