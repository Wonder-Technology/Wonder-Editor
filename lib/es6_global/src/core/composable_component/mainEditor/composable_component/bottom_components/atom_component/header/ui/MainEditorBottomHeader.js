              ...
              className: "bottom-header"
                  ...
                  className: "bottom-widget-category"
                      ...
                      onClick: (function () {
                        ...
                        }, DomHelper$WonderEditor.textEl("Project"))), React.createElement("div", {
                      className: "category-name" + (
                        match$1 ? " category-active" : ""
                      ),
                      onClick: (function () {
                          ...
                          className: "name-header"
                        }, DomHelper$WonderEditor.textEl("Console")), match$2 ? React.createElement("div", {
                            className: "name-tail"
                          }, DomHelper$WonderEditor.textEl(unreadCount)) : null), React.createElement("span", {
                      className: "category-name"
                    })));
}
