...
function _renderConsole(currentComponentType, dispatchFunc, languageType) {
  ...
  return React.createElement("div", {
              ...
              onClick: (function (_e) {
                ...
                }, DomHelper$WonderEditor.textEl(LanguageUtils$WonderEditor.getAssetLanguageDataByType("bottom-console", languageType))), match$1 ? React.createElement("div", {
                    className: "name-tail"
              ...
              className: "bottom-header"
                  ...
                  className: "bottom-widget-category"
                      ...
                      onClick: (function (_e) {
                          ...
                          className: "name-header"
                        }, DomHelper$WonderEditor.textEl(LanguageUtils$WonderEditor.getAssetLanguageDataByType("bottom-project", languageType)))), _renderConsole(currentComponentType, dispatchFunc, languageType), React.createElement("span", {
                      className: "category-name"
                    })));
}
