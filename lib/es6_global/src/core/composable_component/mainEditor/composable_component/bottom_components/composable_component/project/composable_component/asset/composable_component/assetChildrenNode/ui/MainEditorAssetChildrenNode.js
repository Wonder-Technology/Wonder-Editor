...
function _buildImageDataObjectURLIfNoBase64(editorState) {
  return ArrayService$WonderCommonlib.reduceOneParam((function (editorState, imageDataIndex) {
                return Result$WonderEditor.SameDataResult[/* map */4]((function (param) {
...
function _sortByName(assetTreeChildrenNodeArr, engineState) {
  return assetTreeChildrenNodeArr.sort((function (node1, node2) {
                return SortService$WonderEditor.buildSortByNameFunc(NodeNameAssetLogicService$WonderEditor.getNodeName(node2, engineState), NodeNameAssetLogicService$WonderEditor.getNodeName(node1, engineState));
              }));
}
...
function sortAssetTreeChildrenNode(assetTreeChildrenNodeArr, engineState) {
  ...
  var scriptEventFunctionAssetTreeChildrenNodeArr = assetTreeChildrenNodeArr.filter(ScriptEventFunctionNodeAssetService$WonderEditor.isScriptEventFunctionNode);
  var scriptAttributeAssetTreeChildrenNodeArr = assetTreeChildrenNodeArr.filter(ScriptAttributeNodeAssetService$WonderEditor.isScriptAttributeNode);
  var textureAssetTreeChildrenNodeArr = assetTreeChildrenNodeArr.filter(TextureNodeAssetService$WonderEditor.isTextureNode);
  var assetBundleAssetTreeChildrenNodeArr = assetTreeChildrenNodeArr.filter(AssetBundleNodeAssetService$WonderEditor.isAssetBundleNode);
...
function showSpecificTreeNodeChildren(param, param$1, engineState, editorState) {
  ...
  var result = ArrayService$WonderEditor.traverseSameDataResultAndCollectByApply((function (node) {
          ...
          return NodeAssetService$WonderEditor.handleNode(node, (function (nodeId, param) {
                        ...
                        var imgSrc = ImageDataMapUtils$WonderEditor.getImgSrc(param[/* imageDataIndex */1], editorState);
                        ...
                        var imgSrc = ImageDataMapUtils$WonderEditor.getImgSrc(param[/* imageDataIndex */2], editorState);
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(uiState, dispatchFunc, "move", dragImg, imgSrc, nodeId, fileName, widget, isSelected, /* array */[])));
                      }), (function (nodeId, param) {
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(uiState, dispatchFunc, "move", dragImg, "./public/img/scriptEventFunction.png", nodeId, param[/* name */0], widget, isSelected, /* array */[])));
                      }), (function (nodeId, param) {
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(uiState, dispatchFunc, "move", dragImg, "./public/img/scriptAttribute.png", nodeId, param[/* name */0], widget, isSelected, /* array */[])));
                      }), (function (nodeId, nodeData) {
                        var fileName = WDBNodeAssetService$WonderEditor.getNodeName(nodeData);
                        var imgSrc = ImageDataMapUtils$WonderEditor.getImgSrc(nodeData[/* imageDataIndex */2], editorState);
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(uiState, dispatchFunc, "copyMove", dragImg, imgSrc, nodeId, fileName, widget, isSelected, /* array */[])));
                      }), (function (nodeId, param) {
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(uiState, dispatchFunc, "move", dragImg, "./public/img/assetBundle.png", nodeId, param[/* name */0], widget, isSelected, /* array */[])));
...
function buildCurrentTreeNodeChildrenComponent(param, dragImg, debounceTime) {
  ...
  return ResultUtils$WonderEditor.handleError(Result$WonderEditor.SameDataResult[/* map */4]((function (param) {
