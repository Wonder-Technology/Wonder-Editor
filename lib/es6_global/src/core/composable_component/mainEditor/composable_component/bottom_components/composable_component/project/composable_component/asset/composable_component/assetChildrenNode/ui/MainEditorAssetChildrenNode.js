...
function _build(imageDataIndex, editorState) {
  ...
  return OptionService$WonderEditor.either((function (editorState, _) {
  ...
  var result = ArrayService$WonderEditor.traverseSameDataResultAndCollectByApply((function (node) {
          ...
          return NodeAssetService$WonderEditor.handleNode(node, (function (nodeId, param) {
                        ...
                        return Result$WonderEditor.SameDataResult[/* either */4]((function (imgSrc) {
                                      return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(store, dispatchFunc, "move", dragImg, imgSrc, nodeId, fileName, widget, isSelected, /* array */[])));
                        ...
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(store, dispatchFunc, "move", dragImg, "./public/img/mat.png", nodeId, fileName, widget, isSelected, /* array */[])));
                      }), (function (nodeId, nodeData) {
                        var fileName = WDBNodeAssetService$WonderEditor.getNodeName(nodeData);
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FileBox$WonderEditor.make(store, dispatchFunc, "copyMove", dragImg, "./public/img/wdb.png", nodeId, fileName, widget, isSelected, /* array */[])));
                      }), (function (nodeId, nodeData, _) {
                        var name = FolderNodeAssetService$WonderEditor.getNodeName(nodeData);
                        return Result$WonderEditor.SameDataResult[/* success */0](ReasonReact.element(key, undefined, FolderBox$WonderEditor.make(store, dispatchFunc, dragImg, "move", "./public/img/assetPackage.png", nodeId, name, isSelected, widget, debounceTime, Curry._2(AssetDragNodeToFolderEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0], /* tuple */[
                                                store,
                                                dispatchFunc
