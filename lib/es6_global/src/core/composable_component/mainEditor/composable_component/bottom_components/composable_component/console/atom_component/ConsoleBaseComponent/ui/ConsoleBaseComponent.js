...
function buildTraceComponent(traceString) {
  return traceString.split(" at ").map((function (info, i) {
...
var Method = /* module */[/* buildTraceComponent */buildTraceComponent];
  ...
  return React.createElement("article", {
              className: "console-" + type_
                  ...
                  onClick: (function () {
                    ...
                    }, DomHelper$WonderEditor.textEl(param[0]))), match$1 ? React.createElement("div", {
                    className: "console-trace"
                  }, buildTraceComponent(state[/* traceString */2])) : null);
}

function make(message, traceInfo, type_, imageSrc, _) {
  return /* record */[
