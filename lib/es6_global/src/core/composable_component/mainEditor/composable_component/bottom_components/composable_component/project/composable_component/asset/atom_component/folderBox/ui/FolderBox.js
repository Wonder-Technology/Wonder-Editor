...
function render(param, param$1, param$2, param$3) {
  ...
  var handleRelationError = param$2[1];
  var isWidget = param$2[0];
  var widget = param$1[5];
  var folderId = param$1[3];
...
function make(store, dispatchFunc, dragImg, effectAllowd, imgSrc, folderId, fileType, name, isSelected, widget, debounceTime, onDrop, isWidget, handleRelationError, _children) {
  return /* record */[
