  ...
  return React.createElement("article", {
              ...
              style: param$2[/* state */1][/* style */0]
                  ...
                  onDragStart: (function (_e) {
                      return Curry._1(send, DragEventUtils$WonderEditor.handleDragStart(folderId, /* DragStart */4, widget, dragImg, effectAllowd, _e));
                    }),
                  onDrop: (function (_e) {
...
function make(store, dispatchFunc, dragImg, effectAllowd, imgSrc, folderId, name, isSelected, widget, debounceTime, onDrop, isWidget, checkNodeRelation, _) {
  return /* record */[
