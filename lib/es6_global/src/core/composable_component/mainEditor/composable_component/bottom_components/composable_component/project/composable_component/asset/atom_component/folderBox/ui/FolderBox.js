...
function render(param, param$1, param$2, param$3) {
  ...
  var checkNodeRelation = param$2[1];
...
function make(uiState, dispatchFunc, dragImg, effectAllowd, imgSrc, folderId, name, isSelected, widget, debounceTime, onDrop, isWidget, checkNodeRelation, _children) {
  return /* record */[
