...
function _handleImageType(param, param$1, param$2) {
...
function _handleAssetWDBType(param, param$1, param$2) {
  ...
  var editorState = param$2[0];
  var parentFolderNodeId = param$1[1];
  var baseName = FileNameService$WonderEditor.getBaseName(param[0]);
  return AssetWDBUtils$WonderEditor.importAssetWDB(/* tuple */[
                IterateAssetTreeAssetEditorService$WonderEditor.getUniqueTreeNodeName(baseName, /* WDB */2, parentFolderNodeId, /* tuple */[
                      editorState,
                      engineState
                    ]),
                param[1]
                ...
                var match$2 = ExtractAndRelateAssetsUtils$WonderEditor.extractAndRelateAssets(allGameObjects, match$1[1], /* tuple */[
                      match[0],
                      match[1]
                    ]);
                ...
                var engineState$1 = DirectorEngineService$WonderEditor.loopBody(0, ArrayService$WonderCommonlib.reduceOneParam((function (engineState, gameObject) {
                            return GameObjectEngineService$WonderEditor.initGameObject(gameObject, RelateGameObjectAndAssetUtils$WonderEditor.replaceWDBAssetGameObjectGeometryComponentToDefaultGeometryComponent(gameObject, defaultGeometryData, engineState));
                          }), engineState, allGameObjects));
                var match$5 = ExtractAndRelateAssetsUtils$WonderEditor.addNodeToAssetTree(match$4[0], match$4[1], /* tuple */[
                      editorState,
                      engineState$1
                    ]);
