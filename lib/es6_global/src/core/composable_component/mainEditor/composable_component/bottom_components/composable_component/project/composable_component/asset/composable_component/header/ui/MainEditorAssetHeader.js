...
function render(param, param$1) {
  ...
  var store = param[0];
  var match = param$1[/* state */1][/* isSelectNav */0];
  var match$1 = StateLogicService$WonderEditor.getEditorState(isCurrentNodeIdEqualRootId);
                      ...
                      className: "item-canBeClick"
                        ...
                        className: "item-content"
                            ...
                            onClick: (function () {
                                ...
                                className: "section-header"
                              }, DomHelper$WonderEditor.textEl("Material")))) : null), React.createElement("div", {
                  className: "asset-header-item",
                  onClick: (function () {
