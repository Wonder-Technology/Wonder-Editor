...
function _renderSelectNav(uiState, dispatchFunc, param) {
...
function _renderRemoveItem(uiState, dispatchFunc, param) {
              ...
              className: "wonder-asset-header"
                  ...
                  onClick: (function (_e) {
                      ...
                      className: "item-canBeClick"
                        ...
                        })), match ? _renderSelectNav(uiState, dispatchFunc, self) : null), _renderRemoveItem(uiState, dispatchFunc, self), React.createElement("div", {
                  className: "asset-header-item"
                }, React.createElement("div", {
                      className: "item-canBeClick",
                      title: "load asset"
