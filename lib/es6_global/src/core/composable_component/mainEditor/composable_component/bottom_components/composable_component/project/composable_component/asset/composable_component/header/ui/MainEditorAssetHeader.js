...
import * as AssetHeaderAddScriptAttributeEventHandler$WonderEditor from "../eventHandler/AssetHeaderAddScriptAttributeEventHandler.js";
import * as AssetHeaderAddScriptEventFunctionEventHandler$WonderEditor from "../eventHandler/AssetHeaderAddScriptEventFunctionEventHandler.js";
...
var addScriptEventFunction = AssetHeaderAddScriptEventFunctionEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0];

var addScriptAttribute = AssetHeaderAddScriptAttributeEventHandler$WonderEditor.MakeEventHandler[/* pushUndoStackWithNoCopyEngineState */0];
  ...
  return React.createElement("div", {
              className: "item-content"
                  ...
                  onClick: (function (_e) {
                      ...
                      className: "section-header"
                    }, DomHelper$WonderEditor.textEl("Script Event Function"))), React.createElement("div", {
                  className: "content-section",
                  onClick: (function (_e) {
                      ...
                      className: "section-header"
                    }, DomHelper$WonderEditor.textEl("Script Attribute"))));
}
...
function _renderRemoveItem(uiState, dispatchFunc, languageType, param) {
  ...
  return React.createElement("div", {
              ...
              onClick: (function (_e) {
                  var match = StateLogicService$WonderEditor.getEditorState(CurrentNodeIdAssetEditorService$WonderEditor.couldRemoveCurrentNode);
                  if (match) {
                    Curry._3(removeAssetNode, /* tuple */[
                          uiState,
                          dispatchFunc
                        ], /* () */0, /* () */0);
                    return /* () */0;
