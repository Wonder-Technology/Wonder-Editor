...
function setUndoValueToCopiedEngineState(param, arcballCameraController, minDistance) {
  return ArcballCameraEngineService$WonderEditor.setArcballCameraControllerMinDistance(minDistance, arcballCameraController, StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
