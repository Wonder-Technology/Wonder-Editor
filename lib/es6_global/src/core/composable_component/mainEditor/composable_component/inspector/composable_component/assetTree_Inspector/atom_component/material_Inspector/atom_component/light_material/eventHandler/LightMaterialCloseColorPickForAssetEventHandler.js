...
function setUndoValueToCopiedEngineState(param, param$1, value) {
  return LightMaterialEngineService$WonderEditor.setLightMaterialDiffuseColor(Color$WonderEditor.convert16HexToRGBArr(value), param$1[0], StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
