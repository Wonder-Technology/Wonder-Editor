...
function _changeScriptAttributeFieldDefaultValue(script, attributeName, fieldName, attribute, defaultValue) {
...
function _renderScriptAttributeFieldDefaultValue(param, languageType, script, attributeName, fieldName, type_, attribute) {
  ...
  if (type_) {
    return ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(undefined, (function (value) {
                      ...
                      return _changeScriptAttributeFieldDefaultValue(script, attributeName, fieldName, attribute, value);
                    }), (function (value) {
                      return _blurScriptAttributeFieldDefaultValue(/* tuple */[
                                  uiState,
                                  dispatchFunc
...
function _renderScriptAttributeFields(param, languageType, script, attributeName, attribute) {
  var dispatchFunc = param[1];
  var uiState = param[0];
                ...
                return React.createElement("div", {
                            ...
                            className: "wonder-script-attribute"
                                ...
                                className: "scriptAttribute-fields"
                                    ...
                                    uiState,
                                    dispatchFunc
                                  ], languageType, currentScript, name, param[1])));
              }));
}
