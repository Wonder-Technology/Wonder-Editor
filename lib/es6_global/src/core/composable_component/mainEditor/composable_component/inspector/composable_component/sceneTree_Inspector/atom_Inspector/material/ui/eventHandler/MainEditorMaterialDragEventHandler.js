...
function onMarkRedoUndoByStackLastReturnStore(param, materialComponent, dragedId) {
  var param$1 = SparseMapService$WonderCommonlib.unsafeGet(dragedId, TextureNodeMapAssetService$WonderEditor.unsafeGetTextureNodeMap(StateAssetService$WonderEditor.getState(/* () */0)));
  ...
  if (match) {
    _handleBoxGeometryAddMap(gameObject, materialComponent, param$1[/* textureId */0], engineStateToGetData);
  }
