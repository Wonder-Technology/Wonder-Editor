...
function addComponentByType(type_, currentSceneTreeNode, engineState) {
  switch (type_) {
    ...
    case "BasicCameraView" : 
        ...
        return GameObjectComponentEngineService$WonderEditor.addBasicCameraViewComponent(currentSceneTreeNode, match$1[1], match$1[0]);
    case "Light" : 
        var match$2 = DirectionLightEngineService$WonderEditor.create(engineState);
        return GameObjectComponentEngineService$WonderEditor.addDirectionLightComponent(currentSceneTreeNode, match$2[1], match$2[0]);
    case "Material" : 
        var match$3 = LightMaterialEngineService$WonderEditor.create(engineState);
        return GameObjectComponentEngineService$WonderEditor.addLightMaterialComponent(currentSceneTreeNode, match$3[1], match$3[0]);
    case "MeshRenderer" : 
        var match$4 = MeshRendererEngineService$WonderEditor.create(engineState);
        return GameObjectComponentEngineService$WonderEditor.addMeshRendererComponent(currentSceneTreeNode, match$4[1], match$4[0]);
    case "PerspectiveCameraProjection" : 
        var match$5 = CameraEngineService$WonderEditor.createPerspectiveCamera(engineState);
        return GameObjectComponentEngineService$WonderEditor.addPerspectiveCameraProjectionComponent(currentSceneTreeNode, match$5[1], match$5[0]);
    default:
