...
function showFolderInfo(param, nodeResult, nodeId, param$1) {
  ...
  switch (match) {
    ...
    case 3 : 
        return ReasonReact.element(/* None */0, /* None */0, TextureInspector$WonderEditor.make(param[0], param[1], state[/* inputValue */0], nodeId, Caml_format.caml_int_of_string(OptionService$WonderEditor.unsafeGet(nodeResult[/* result */2])), /* array */[]));
