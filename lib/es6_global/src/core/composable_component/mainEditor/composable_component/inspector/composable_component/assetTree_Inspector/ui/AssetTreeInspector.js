...
function buildFolderComponent(state, send, nodeId) {
  return React.createElement("div", {
              className: ""
                  ...
                  disabled: AssetUtils$WonderEditor.isIdEqual(StateLogicService$WonderEditor.getAssetState(AssetTreeRootAssetService$WonderEditor.getRootTreeNodeId), nodeId),
                  type: "text",
        ...
        if (value === "") {
          ...
          return ReasonReactUtils$WonderEditor.updateWithSideEffects(/* record */[
                      ...
                      /* postfix */state[/* postfix */2]
                        ...
                        return StateLogicService$WonderEditor.getAssetState((function (param) {
...
function make(store, dispatchFunc, nodeId, nodeResult, _) {
  return /* record */[
          ...
          /* initialState */(function () {
              var match = FileNameUtils$WonderEditor.getBaseNameAndExtName(nodeResult[/* name */0]);
