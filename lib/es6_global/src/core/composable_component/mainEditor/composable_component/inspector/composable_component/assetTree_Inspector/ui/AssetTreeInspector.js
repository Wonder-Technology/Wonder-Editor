...
function buildTextureComponent(param, param$1, state, textureNodeMap) {
  ...
  return ReasonReact.element(/* None */0, /* None */0, TextureInspector$WonderEditor.make(param[0], dispatchFunc, state[/* inputValue */0], textureId, (function (param) {
                    return AssetTreeInspectorUtils$WonderEditor.renameAssetTreeNode(dispatchFunc, textureId, nodeType, param);
                  }), /* array */[]));
}

function showFolderInfo(reduxTuple, currentNodeId, nodeType, param) {
