...
function buildTextureComponent(param, state, currentNodeId, param$1) {
  ...
  var store = param[0];
  return ReasonReact.element(undefined, undefined, TextureInspector$WonderEditor.make(store, dispatchFunc, state[/* inputValue */0], param$1[/* textureComponent */0], Curry._2(renameAssetTreeNode, /* tuple */[
                      store,
                      dispatchFunc
                    ], currentNodeId), /* array */[]));
}
...
function buildMaterialComponent(param, state, currentNodeId, param$1) {
  var dispatchFunc = param[1];
  var store = param[0];
  return ReasonReact.element(undefined, undefined, MaterialInspector$WonderEditor.make(store, dispatchFunc, currentNodeId, state[/* inputValue */0], param$1[/* type_ */0], param$1[/* materialComponent */1], Curry._2(renameAssetTreeNode, /* tuple */[
                      store,
                      dispatchFunc
                    ], currentNodeId), /* array */[]));
}
...
function make(store, dispatchFunc, currentNode, _) {
