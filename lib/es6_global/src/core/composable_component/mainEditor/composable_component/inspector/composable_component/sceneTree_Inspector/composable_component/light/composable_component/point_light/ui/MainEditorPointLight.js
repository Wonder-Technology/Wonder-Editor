...
function buildColorPickComponent(param, lightComponent) {
  return ReasonReact.element(undefined, undefined, PickColorComponent$WonderEditor.make("Color", (function (param) {
                    return Color$WonderEditor.getHexString(StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                                      return PointLightEngineService$WonderEditor.getPointLightColor(lightComponent, param);
                                    })));
                  }), (function (param) {
...
function buildIntensityComponent(param, lightComponent) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make("Intensity", (function (param) {
...
function buildConstantComponent(param, lightComponent) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make("Constant", (function (param) {
...
function buildLinearComponent(param, lightComponent) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make("Linear", (function (param) {
...
function buildQuadraticComponent(param, lightComponent) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make("Quadratic", (function (param) {
...
function buildRangeComponent(param, lightComponent) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make("Range", (function (param) {
...
function make(store, dispatchFunc, lightComponent, _children) {
  return /* record */[
