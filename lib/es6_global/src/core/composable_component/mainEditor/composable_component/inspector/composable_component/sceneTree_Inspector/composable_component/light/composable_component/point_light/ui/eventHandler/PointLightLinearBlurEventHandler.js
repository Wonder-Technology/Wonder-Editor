...
function setUndoValueToCopiedEngineState(param, lightComponent, linear) {
  return PointLightEngineService$WonderEditor.setPointLightLinear(linear, lightComponent, StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
