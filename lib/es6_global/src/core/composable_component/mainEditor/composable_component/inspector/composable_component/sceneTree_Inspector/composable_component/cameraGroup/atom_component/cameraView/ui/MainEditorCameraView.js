...
function render(param, _) {
  ...
  var currentGameObjectBasicCameraViewComponent = GameObjectComponentEngineService$WonderEditor.getBasicCameraViewComponent(StateLogicService$WonderEditor.getEditorState(SceneEditorService$WonderEditor.unsafeGetCurrentSceneTreeNode), engineState);
  var isCurrentCamera = BasicCameraViewEngineService$WonderEditor.isActiveBasicCameraView(currentGameObjectBasicCameraViewComponent, engineState);
  ...
  return React.createElement("article", {
              ...
              className: "wonder-camera-view"
                  ...
                  className: ""
                      ...
                      className: ""
                    }, DomHelper$WonderEditor.textEl("currentCamera : ")), React.createElement("input", {
