...
function render(param, _) {
  ...
  var currentGameObjectBasicCameraViewComponent = GameObjectComponentEngineService$WonderEditor.unsafeGetBasicCameraViewComponent(StateLogicService$WonderEditor.getEditorState(SceneTreeEditorService$WonderEditor.unsafeGetCurrentSceneTreeNode), engineState);
