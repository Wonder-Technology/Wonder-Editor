...
function changeIntensity(lightComponent, value) {
  return StateLogicService$WonderEditor.getAndRefreshEngineStateWithFunc((function (param) {
                return PointLightEngineService$WonderEditor.setPointLightIntensity(value, lightComponent, param);
              }));
}
...
function changeConstant(lightComponent, value) {
  return StateLogicService$WonderEditor.getAndRefreshEngineStateWithFunc((function (param) {
                return PointLightEngineService$WonderEditor.setPointLightConstant(value, lightComponent, param);
              }));
}
...
function changeLinear(lightComponent, value) {
  return StateLogicService$WonderEditor.getAndRefreshEngineStateWithFunc((function (param) {
                return PointLightEngineService$WonderEditor.setPointLightLinear(value, lightComponent, param);
              }));
}
...
function changeQuadratic(lightComponent, value) {
  return StateLogicService$WonderEditor.getAndRefreshEngineStateWithFunc((function (param) {
                return PointLightEngineService$WonderEditor.setPointLightQuadratic(value, lightComponent, param);
              }));
}
...
function changeRange(lightComponent, value) {
  return StateLogicService$WonderEditor.getAndRefreshEngineStateWithFunc((function (param) {
                return PointLightEngineService$WonderEditor.setPointLightRange(value, lightComponent, param);
              }));
}
