...
function render(param, _) {
  ...
  var currentGameObjectPerspectiveCamera = GameObjectComponentEngineService$WonderEditor.unsafeGetPerspectiveCameraProjectionComponent(StateLogicService$WonderEditor.getEditorState(SceneEditorService$WonderEditor.unsafeGetCurrentSceneTreeNode), engineState);
