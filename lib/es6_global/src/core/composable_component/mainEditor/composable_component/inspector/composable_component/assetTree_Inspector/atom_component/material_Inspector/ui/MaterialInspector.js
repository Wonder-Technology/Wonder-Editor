...
function render(param, param$1, renameFunc, param$2) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-material-inspector"
                      ...
                      }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("material-type-describe", languageType), /* array */[])), match ? ReasonReact.element(undefined, undefined, MainEditorLightMaterial$WonderEditor.make(uiState, dispatchFunc, materialComponent, /* array */[])) : ReasonReact.element(undefined, undefined, MainEditorBasicMaterial$WonderEditor.make(uiState, dispatchFunc, materialComponent, /* array */[])));
}
