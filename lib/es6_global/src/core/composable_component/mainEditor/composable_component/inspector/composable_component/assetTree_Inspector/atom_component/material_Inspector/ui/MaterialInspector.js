...
function render(param, param$1, renameFunc, param$2) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-material-inspector"
                      ...
                      }), /* array */[])), match ? ReasonReact.element(undefined, undefined, MainEditorLightMaterial$WonderEditor.make(store, dispatchFunc, materialComponent, /* array */[])) : ReasonReact.element(undefined, undefined, MainEditorBasicMaterial$WonderEditor.make(store, dispatchFunc, materialComponent, /* array */[])));
}

function make(store, dispatchFunc, currentNodeId, name, type_, materialComponent, renameFunc, _children) {
