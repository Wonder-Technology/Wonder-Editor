...
function _renderDragableImage(store, materialComponent, getMapFunc, param) {
...
function make(store, dispatchFunc, materialComponent, label, getMapFunc, onDropFunc, removeTextureFunc, _children) {
