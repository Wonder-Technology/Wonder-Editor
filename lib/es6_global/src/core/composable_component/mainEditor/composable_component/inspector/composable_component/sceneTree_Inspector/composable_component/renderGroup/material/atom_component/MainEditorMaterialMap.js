...
function handleSetTextureToEngine(isWidgetFunc, isTypeValidFunc, $$event) {
  var startNodeId = DragUtils$WonderEditor.getDragedId($$event);
  EventHelper$WonderEditor.preventDefault($$event);
  var match = _isTriggerAction(isWidgetFunc, isTypeValidFunc);
  if (match) {
    return /* DragDrop */Block.__(0, [startNodeId]);
  } else {
    return /* DragLeave */2;
  }
}
...
function _buildTextureUIComponent(param, send, engineState) {
  ...
  return React.createElement("div", {
              ...
              className: param[0],
              onClick: (function () {
                  return Curry._1(send, /* SetTextureToEngine */Block.__(1, [
                                nodeId,
                                textureComponent
                              ]));
                })
...
var Method = /* module */[
  ...
  /* handleSetTextureToEngine */handleSetTextureToEngine,
...
function reducer(param, param$1, action, state) {
  ...
  if (typeof action === "number") {
    ...
    var textureComponent = action[1];
    var textureNodeId = action[0];
...
function _renderDragableImage(_, param) {
  ...
  return React.createElement("div", {
              ...
              onClick: (function () {
                  ...
                  onDrop: (function (_e) {
                      return Curry._1(send, handleSetTextureToEngine(isWidget, isTypeValid, _e));
                    })
...
function render(param, param$1, param$2, self) {
  ...
  return React.createElement("article", {
              className: "inspector-item"
                ...
                }, _renderDragableImage(store, self), React.createElement("button", {
...
function make(store, dispatchFunc, materialComponent, label, getMapFunc, onDropFunc, removeTextureFunc, isShowTextureGroup, _) {
