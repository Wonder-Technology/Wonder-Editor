...
function addComponentByTypeForRunEngineState(type_, currentSceneTreeNode, param) {
  ...
  switch (type_) {
    ...
    case 3 : 
        var match$1 = ArcballCameraEngineService$WonderEditor.create(engineState);
        var param$1 = GameObjectLogicService$WonderEditor.addArcballCameraControllerForRunEngineState(currentSceneTreeNode, match$1[1], /* tuple */[
              editorState,
              match$1[0]
            ]);
        return /* tuple */[
                param$1[0],
                OperateComponentUtils$WonderEditor.handleAddArcballCameraControllerIfInRunMode(currentSceneTreeNode, param$1[1])
              ];
    case 4 : 
        var match$2 = CameraEngineService$WonderEditor.createCameraGroup(engineState);
        var param$2 = GameObjectLogicService$WonderEditor.addCameraGroupForRunEngineState(currentSceneTreeNode, match$2[1], /* tuple */[
              editorState,
              match$2[0]
            ]);
        var engineState$1 = param$2[1];
        return /* tuple */[
                param$2[0],
    ...
    case 5 : 
        ...
        if (match$3) {
          ...
          var match$4 = DirectionLightEngineService$WonderEditor.create(engineState);
          var param$3 = GameObjectLogicService$WonderEditor.addDirectionLightForRunEngineState(currentSceneTreeNode, match$4[1], /* tuple */[
                editorState,
                match$4[0]
              ]);
          return /* tuple */[
                  param$3[0],
                  OperateLightMaterialLogicService$WonderEditor.reInitAllMaterials(param$3[1])
                ];
        }
    case 0 : 
    case 2 : 
