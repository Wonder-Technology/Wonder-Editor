...
function _addArcballCameraController(currentSceneTreeNode, param) {
  ...
  var engineState$1;
  if (match$1) {
    var match$2 = GameObjectComponentEngineService$WonderEditor.hasBasicCameraViewComponent(currentSceneTreeNode, engineState);
    if (match$2) {
      var __x = GameObjectComponentEngineService$WonderEditor.unsafeGetBasicCameraViewComponent(currentSceneTreeNode, engineState);
      var match$3 = BasicCameraViewEngineService$WonderEditor.isActiveBasicCameraView(__x, engineState);
      engineState$1 = match$3 ? ArcballCameraEngineService$WonderEditor.bindArcballCameraControllerEventForGameView(cameraController, engineState) : engineState;
    } else {
