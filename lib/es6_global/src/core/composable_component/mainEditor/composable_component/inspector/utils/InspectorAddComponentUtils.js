...
import * as AssetGeometryNodeMapEditorService$WonderEditor from "../../../../../../service/state/editor/asset/AssetGeometryNodeMapEditorService.js";
...
function addComponentByTypeForEditEngineState(type_, currentSceneTreeNode, engineState) {
  ...
  switch (type_) {
    ...
    case 2 : 
        ...
        var param = AssetGeometryDataEditorService$WonderEditor.getGeometryData(editorState);
        var editCubeGeometry = StateLogicService$WonderEditor.getEditEngineComponent(/* Geometry */2, SparseMapService$WonderCommonlib.unsafeGet(param[/* cubeGeometryAssetId */0], AssetGeometryNodeMapEditorService$WonderEditor.getGeometryNodeMap(editorState)));
...
function addComponentByTypeForRunEngineState(type_, currentSceneTreeNode, param) {
  ...
  switch (type_) {
    ...
    case 2 : 
        ...
        var runCubeGeometry = SparseMapService$WonderCommonlib.unsafeGet(param$1[/* cubeGeometryAssetId */0], AssetGeometryNodeMapEditorService$WonderEditor.getGeometryNodeMap(editorState$1));
