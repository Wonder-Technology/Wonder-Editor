...
function removeTexture(param, _, materialComponent) {
  var match = StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
          return BasicMaterialEngineService$WonderEditor.getBasicMaterialMap(materialComponent, param);
        }));
  if (match !== undefined) {
  ...
  return React.createElement("article", {
              className: "wonder-basic-material"
                        ...
                        return changeColor(materialComponent, param);
                          ...
                          store,
                          dispatchFunc
                        ], materialComponent), /* array */[])), ReasonReact.element(undefined, undefined, MainEditorMaterialMap$WonderEditor.make(store, dispatchFunc, materialComponent, "map : ", BasicMaterialEngineService$WonderEditor.getBasicMaterialMap, onDrop, removeTexture, /* array */[])));
}
