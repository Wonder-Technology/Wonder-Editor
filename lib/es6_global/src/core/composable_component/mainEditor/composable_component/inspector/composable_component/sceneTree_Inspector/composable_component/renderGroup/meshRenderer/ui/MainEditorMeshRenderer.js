...
function make(store, dispatchFunc, _) {
  ...
  return /* record */[
          ...
          /* initialState */(function () {
              ...
              var meshRenderer = GameObjectComponentEngineService$WonderEditor.unsafeGetMeshRendererComponent(SceneEditorService$WonderEditor.unsafeGetCurrentSceneTreeNode(StateEditorService$WonderEditor.getState(/* () */0)), engineState);
              return /* record */[
