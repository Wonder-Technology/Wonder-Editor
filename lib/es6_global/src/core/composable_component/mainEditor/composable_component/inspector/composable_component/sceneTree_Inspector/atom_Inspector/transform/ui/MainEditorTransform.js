...
function render(_, transformComponent, param) {
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(/* None */0, /* None */0, FloatInput$WonderEditor.make(/* Some */[StringService$WonderEditor.floatToString(state[/* x */0])], /* Some */["X"], /* Some */[(function (param) {
                          return changeX(transformComponent, param);
                        })], /* Some */[(function (value) {
                          return Curry._1(send, /* TransformBlurX */Block.__(0, [value]));
                        })], /* array */[])), ReasonReact.element(/* None */0, /* None */0, FloatInput$WonderEditor.make(/* Some */[StringService$WonderEditor.floatToString(state[/* y */1])], /* Some */["Y"], /* Some */[(function (param) {
                          return changeY(transformComponent, param);
                        })], /* Some */[(function (value) {
                          return Curry._1(send, /* TransformBlurY */Block.__(1, [value]));
                        })], /* array */[])), ReasonReact.element(/* None */0, /* None */0, FloatInput$WonderEditor.make(/* Some */[StringService$WonderEditor.floatToString(state[/* z */2])], /* Some */["Z"], /* Some */[(function (param) {
