...
function _operateSpecificComponent(gameObject, componentName, engineState) {
  switch (componentName) {
    case "arcballCameraController" : 
        return _getComponent(gameObject, GameObjectComponentEngineService$WonderEditor.hasArcballCameraControllerComponent, GameObjectComponentEngineService$WonderEditor.getArcballCameraControllerComponent, engineState);
    ...
    case "geometry" : 
    case "light" : 
        return _getComponent(gameObject, LightEngineService$WonderEditor.hasLightComponent, LightEngineService$WonderEditor.getLightComponent, engineState);
    case "material" : 
        return _getComponent(gameObject, MaterialEngineService$WonderEditor.hasMaterialComponent, MaterialEngineService$WonderEditor.getMaterialComponent, engineState);
