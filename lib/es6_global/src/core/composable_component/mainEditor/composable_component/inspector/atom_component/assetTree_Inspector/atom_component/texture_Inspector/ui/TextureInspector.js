...
function buildTextureComponent(state, send, _) {
  return React.createElement("div", {
              className: ""
                  ...
                  className: ""
                      ...
                      className: ""
                    }, DomHelper$WonderEditor.textEl("Wrap S Mode:")), React.createElement("input", {
                      className: "input-component float-input",
                      type: "text",
                      value: state[/* inputValue */0],
                      onBlur: (function () {
                  ...
                  className: ""
                      ...
                      className: ""
                    }, DomHelper$WonderEditor.textEl("Wrap T Mode:")), React.createElement("input", {
                      className: "input-component float-input",
                      type: "text",
                      value: state[/* inputValue */0],
                      onBlur: (function () {
                  ...
                  className: ""
                      ...
                      className: ""
                    }, DomHelper$WonderEditor.textEl("Filter Mag Mode:")), React.createElement("input", {
                      className: "input-component float-input",
                      type: "text",
                      value: state[/* inputValue */0],
                      onBlur: (function () {
                  ...
                  className: ""
                      ...
                      className: ""
                    }, DomHelper$WonderEditor.textEl("Filter Min Mode:")), React.createElement("input", {
                      className: "input-component float-input",
                      type: "text",
                      value: state[/* inputValue */0],
                      onBlur: (function () {
...
function showFolderInfo(nodeResult, nodeId, param) {
  ...
  switch (match) {
    ...
    case 3 : 
        return buildTextureComponent(state, send, Caml_format.caml_int_of_string(OptionService$WonderEditor.unsafeGet(nodeResult[/* result */2])));
