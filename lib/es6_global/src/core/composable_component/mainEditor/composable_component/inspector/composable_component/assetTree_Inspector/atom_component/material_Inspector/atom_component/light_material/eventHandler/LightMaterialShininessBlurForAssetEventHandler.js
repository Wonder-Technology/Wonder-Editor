...
function setUndoValueToCopiedEngineState(param, param$1, shininessValue) {
  return LightMaterialEngineService$WonderEditor.setLightMaterialShininess(shininessValue, param$1[0], StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
