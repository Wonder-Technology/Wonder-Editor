...
function handleSelfLogic(param, _, materialComponent) {
  ...
  StateEngineService$WonderEditor.setState(OperateTextureLogicService$WonderEditor.handleBasicMaterialComponentFromHasMapToNoMap(materialComponent, engineState));
  Curry._1(param[1], [
