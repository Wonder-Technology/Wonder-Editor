...
function setUndoValueToCopiedEngineState(param, arcballCameraController, target) {
  return ArcballCameraEngineService$WonderEditor.setArcballCameraControllerTarget(arcballCameraController, target, StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
