...
function render(param, arcballCameraController, _) {
  ...
  return React.createElement("article", {
              className: "wonder-inspector-arcballCameraController"
            }, ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                        return dragDropArcballCameraDistance(/* tuple */[
                                    uiState,
                                    dispatchFunc
                                  ], arcballCameraController, value);
                      ...
                      }), /* array */[])), ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                        blurArcballCameraMinDistance(/* tuple */[
                              uiState,
                              dispatchFunc
                            ], arcballCameraController, value);
                        return StateLogicService$WonderEditor.getAndSetState((function (param) {
                      ...
                      }), /* array */[])), ReasonReact.element(undefined, undefined, ThreeFloatInput$WonderEditor.make(uiState, dispatchFunc, "Target", arcballCameraController, changeTargetX, changeTargetY, changeTargetZ, ArcballCameraEngineService$WonderEditor.unsafeGetArcballCameraControllerTarget, blurArcballCameraTarget, (function (param, arcballCameraController, target) {
                        var dispatchFunc = param[1];
                      ...
                      }), true, /* array */[])), ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                        blurArcballCameraPhi(/* tuple */[
                              uiState,
                              dispatchFunc
                            ], arcballCameraController, value);
                        return StateLogicService$WonderEditor.getAndSetState((function (param) {
                        ...
                        return blurArcballCameraPhi(partial_arg$2, arcballCameraController, param);
                      }), /* array */[])), ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                        blurArcballCameraTheta(/* tuple */[
                              uiState,
                              dispatchFunc
                            ], arcballCameraController, value);
                        return StateLogicService$WonderEditor.getAndSetState((function (param) {
                        ...
                        return blurArcballCameraTheta(partial_arg$3, arcballCameraController, param);
                      }), /* array */[])));
}

function make(uiState, dispatchFunc, arcballCameraController, _) {
  return /* record */[
