...
function renderDistanceField(uiStoreDataTuple, arcballCameraController, languageType) {
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                  ...
                  }), "Distance", StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                  ...
                  }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("arcball-distance-describe", languageType), /* array */[]));
}

function renderMinDistanceField(uiStoreDataTuple, arcballCameraController, languageType) {
  ...
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                  ...
                  }), "Min Distance", StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                  ...
                  }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("arcball-min-distance-describe", languageType), /* array */[]));
}

function renderTargetField(param, arcballCameraController, languageType) {
  return ReasonReact.element(undefined, undefined, ThreeFloatInput$WonderEditor.make(param[0], param[1], "Target", arcballCameraController, changeTargetX, changeTargetY, changeTargetZ, ArcballCameraEngineService$WonderEditor.unsafeGetArcballCameraControllerTarget, blurArcballCameraTarget, (function (param, arcballCameraController, target) {
                  ...
                  }), true, LanguageUtils$WonderEditor.getInspectorLanguageDataByType("arcball-target-describe", languageType), /* array */[]));
}

function renderPhiField(uiStoreDataTuple, arcballCameraController, languageType) {
  var dispatchFunc = uiStoreDataTuple[1];
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                  ...
                  }), "Phi", StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                  ...
                  }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("arcball-phi-describe", languageType), /* array */[]));
}

function renderThetaField(uiStoreDataTuple, arcballCameraController, languageType) {
  var dispatchFunc = uiStoreDataTuple[1];
  return ReasonReact.element(undefined, undefined, MainEditorFloatInputBaseComponent$WonderEditor.make((function (value) {
                  ...
                  }), "Theta", StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                  ...
                  }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("arcball-theta-describe", languageType), /* array */[]));
}
...
function render(uiStoreDataTuple, arcballCameraController, _self) {
  ...
  return React.createElement("article", {
            ...
            }, renderDistanceField(uiStoreDataTuple, arcballCameraController, languageType), renderMinDistanceField(uiStoreDataTuple, arcballCameraController, languageType), renderTargetField(uiStoreDataTuple, arcballCameraController, languageType), renderPhiField(uiStoreDataTuple, arcballCameraController, languageType), renderThetaField(uiStoreDataTuple, arcballCameraController, languageType));
}
