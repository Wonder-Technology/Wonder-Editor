...
function render(label, changeComponentValueFunc, param) {
  ...
  return ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(undefined, StringService$WonderEditor.floatToString(param[/* state */1][/* componentValueForUndo */0]), label, changeComponentValueFunc, (function (value) {
