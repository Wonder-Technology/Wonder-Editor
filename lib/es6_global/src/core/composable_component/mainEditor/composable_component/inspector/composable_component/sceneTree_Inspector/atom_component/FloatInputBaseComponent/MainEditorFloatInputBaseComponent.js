...
function render(label, changeComponentValueFunc, param) {
  ...
  return ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(StringService$WonderEditor.floatToString(param[/* state */1][/* componentValueForUndo */0]), label, changeComponentValueFunc, (function (value) {
                    return Curry._1(send, /* TriggerBlur */[value]);
                  }), undefined, /* array */[]));
}

function make(label, getComponentValueFunc, changeComponentValueFunc, blurValueFunc, _children) {
  return /* record */[
