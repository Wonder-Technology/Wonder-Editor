...
function make($staropt$star, label, getComponentValueFunc, changeComponentValueFunc, blurValueFunc, _) {
  var dragDropFunc = $staropt$star !== undefined ? $staropt$star : (function () {
        return /* () */0;
      });
