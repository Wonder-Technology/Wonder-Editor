...
function handleTypeValid(startId, assetState) {
  if (startId) {
    var param = SparseMapService$WonderCommonlib.unsafeGet(startId[0], NodeMapAssetService$WonderEditor.unsafeGetNodeMap(assetState));
...
var onDrop = MainEditorMaterialDragEventHandler$WonderEditor.MakeEventHandler[/* onDrop */1];

var removeTexture = MainEditorSceneTreeClickEventHandler$WonderEditor.MakeEventHandler[/* onClick */2];
  ...
  return React.createElement("article", {
              className: "wonder-inspector-material"
                  ...
                  className: "material-texture"
                      ...
                      onClick: (function () {
                          return Curry._3(removeTexture, /* tuple */[
                                      store,
                                      dispatchFunc
                                    ], /* () */0, materialComponent);
                        })
