...
function _handleSetMap(gameObject, materialComponent, engienStateToGetData) {
  BasicMaterialEngineService$WonderEditor.getColor(materialComponent, engienStateToGetData);
  return StateLogicService$WonderEditor.getAndSetEngineStateWithDiff(/* array */[
              /* record */[
            ...
            ], GameObjectEngineService$WonderEditor.disposeGameObjectBasicMaterialComponent);
}
...
function handleBoxGeometryAddMap(gameObject, _, engineStateToGetData) {
...
function handleCustomGeometryAddMap(gameObject, _, engineStateToGetData) {
...
function onDrop(dispatchFunc, startId, materialComponent) {
  ...
  SparseMapService$WonderCommonlib.unsafeGet(startId, AssetNodeMapEditorService$WonderEditor.unsafeGetNodeMap(editorState));
  ...
  if (match) {
    handleBoxGeometryAddMap(gameObject, materialComponent, engineStateToGetData);
  } else {
    handleCustomGeometryAddMap(gameObject, materialComponent, engineStateToGetData);
  }
