...
function onDrop(dispatchFunc, startId, materialComponent) {
  ...
  StateLogicService$WonderEditor.getAndRefreshEngineStateWithDiffTest(/* array */[
        /* record */[
          /* arguments : array */[Caml_format.caml_int_of_string(OptionService$WonderEditor.unsafeGet(param[/* result */2]))],
          /* type_ : Texture */3
        ],
        /* record */[
      ...
      ], BasicMaterialEngineService$WonderEditor.setMap);
