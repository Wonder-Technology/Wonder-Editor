...
var _handleTextureNode = OperateTextureLogicService$WonderEditor.setTextureNameToEngine;
...
function renameAssetTreeNode(dispatchFunc, nodeId, nodeType, value) {
  ...
  AssetNodeUtils$WonderEditor.handleSpeficFuncByAssetNodeType(nodeType, /* tuple */[
        ...
        (function () {
            return OperateTextureLogicService$WonderEditor.setTextureNameToEngine(nodeId, value);
          })
      ]);
