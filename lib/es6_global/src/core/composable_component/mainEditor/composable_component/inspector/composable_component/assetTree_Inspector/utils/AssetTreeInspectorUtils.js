...
function _handleTextureNode(textureId, name, _) {
  return OperateTextureLogicService$WonderEditor.renameTextureToEngine(textureId, name);
}
...
function renameAssetTreeNode(dispatchFunc, nodeId, nodeType, value) {
  ...
  AssetNodeUtils$WonderEditor.handleSpeficFuncByAssetNodeType(nodeType, /* tuple */[
        (function (param) {
            return _handleFolderNode(nodeId, value, assetState, param);
          }),
        (function (param) {
            return _handleJsonNode(nodeId, value, assetState, param);
          }),
        (function () {
