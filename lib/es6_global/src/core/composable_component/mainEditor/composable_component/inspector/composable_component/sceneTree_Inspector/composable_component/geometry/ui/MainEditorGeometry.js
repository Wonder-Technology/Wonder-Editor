...
function render(_, currentSceneTreeNode, param) {
                  ...
                  className: "inspector-item"
                    ...
                    className: "select-component-content"
                        ...
                        className: "select-component-item"
                            ...
                            className: "item-header"
                          }, DomHelper$WonderEditor.textEl("Geometry")), showGeometryAssets(send, currentSceneTreeNode, state[/* currentGeometry */1])), React.createElement("div", {
...
function make(store, dispatchFunc, currentSceneTreeNode, geometryComponent, isShowGeometryGroup, _) {
