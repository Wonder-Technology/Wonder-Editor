...
function _sortByName(allGeometryAssets, engineState) {
...
function _getAllGeometryAssetsAndDefaultGeometrys(editorState, engineState) {
  return ArrayService$WonderEditor.fastConcat(_sortByName(GeometryAssetLogicService$WonderEditor.getGeometryAssets(editorState, engineState), engineState), GeometryDataAssetEditorService$WonderEditor.unsafeGetDefaultGeometryComponents(editorState));
}
...
function showGeometryAssets(send, currentSceneTreeNode, currentGeometry) {
  ...
  return allGeometrys.map((function (geometry) {
                ...
                var className = match ? "item-content item-active" : "item-content";
...
function _renderGeometryGroup(store, currentSceneTreeNode, param) {
  ...
  return React.createElement("div", {
              className: "select-component-content"
                  ...
                  className: "select-component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("Geometry")), showGeometryAssets(send, currentSceneTreeNode, param[/* state */1][/* currentGeometry */1])), React.createElement("div", {
...
function make(store, dispatchFunc, currentSceneTreeNode, geometryComponent, isShowGeometryGroup, _children) {
