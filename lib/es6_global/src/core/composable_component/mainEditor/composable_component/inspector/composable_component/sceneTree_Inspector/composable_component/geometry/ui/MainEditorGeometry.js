...
function _renderGeometryGroup(uiState, currentSceneTreeNode, param) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-inspector-geometry"
                  ...
                  className: "inspector-item"
                      ...
                      title: LanguageUtils$WonderEditor.getInspectorLanguageDataByType("geometry-geometry-describe", languageType)
                    }, DomHelper$WonderEditor.textEl("Geometry")), React.createElement("div", {
