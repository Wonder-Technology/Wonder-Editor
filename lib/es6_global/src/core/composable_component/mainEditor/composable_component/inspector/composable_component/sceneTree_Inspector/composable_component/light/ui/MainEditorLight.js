...
function render(param, param$1) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-inspector-light"
                      ...
                      }), LanguageUtils$WonderEditor.getInspectorLanguageDataByType("light-type-describe", languageType), /* array */[])), MainEditorLightUtils$WonderEditor.handleSpecificFuncByLightType(state[/* lightType */0], /* tuple */[
                  (function (param) {
