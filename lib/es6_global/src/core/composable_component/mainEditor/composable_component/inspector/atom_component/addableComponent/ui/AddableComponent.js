...
function buildGameObjectAddableComponent(store, dispatch, currentSceneTreeNode, componentList) {
...
function render(reduxTuple, currentSceneTreeNode, addableComponentList, param) {
  ...
  return React.createElement("article", {
              className: "addable-component"
                ...
                }, DomHelper$WonderEditor.textEl("add component")), match !== 0 ? buildGameObjectAddableComponent(reduxTuple[0], reduxTuple[1], currentSceneTreeNode, addableComponentList) : null);
}
