...
function buildGameObjectAddableComponent(store, dispatchFunc, currentSceneTreeNode, componentList) {
...
function render(reduxTuple, currentSceneTreeNode, addableComponentList, param) {
  ...
  return React.createElement("article", {
              className: "addable-component"
                ...
                }, DomHelper$WonderEditor.textEl("add component")), match ? buildGameObjectAddableComponent(reduxTuple[0], reduxTuple[1], currentSceneTreeNode, addableComponentList) : null);
}
          ...
          /* initialState */(function () {
              ...
              if (match !== 0) {
                return /* record */[
                        ...
                        /* isListEmpty */Js.false_
                      ];
              } else {
                return /* record */[
                        /* isShowAddableComponent */false,
                        /* isListEmpty */Js.true_
                      ];
              }
            }),
