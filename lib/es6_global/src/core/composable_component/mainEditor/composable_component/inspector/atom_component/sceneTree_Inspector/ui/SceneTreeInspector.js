...
function _buildComponentBox(param, param$1, isClosable, buildComponentFunc) {
  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, ComponentBox$WonderEditor.make(param[0], isClosable, Curry._3(buildComponentFunc, param$1[0], param$1[1], param[1]), /* array */[]));
}

function _buildTransform(store, dispatchFunc, component) {
  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, MainEditorTransform$WonderEditor.make(store, dispatchFunc, component, /* array */[]));
}

function _buildBasicMaterial(store, dispatchFunc, component) {
  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, MainEditorBasicMaterial$WonderEditor.make(store, dispatchFunc, component, /* array */[]));
}
...
function _buildGameObjectAllShowComponent(componentList, store, dispatchFunc) {
...
function buildCurrentSceneTreeNodeComponent(store, dispatchFunc, allShowComponentConfig, currentSceneTreeNode) {
  if (currentSceneTreeNode) {
    ...
    return ArrayService$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, AddableComponent$WonderEditor.make(/* tuple */[
                        store,
                        dispatchFunc
                      ], gameObject, match[1], /* array */[])), _buildGameObjectAllShowComponent(match[0], store, dispatchFunc));
  } else {
    return /* array */[];
  }
}
...
function render(store, dispatchFunc, allShowComponentConfig, currentSceneTreeNode, _) {
  return React.createElement("article", {
              key: "SceneTreeInspector",
              className: "inspector-component"
            }, buildCurrentSceneTreeNodeComponent(store, dispatchFunc, allShowComponentConfig, currentSceneTreeNode));
}
...
function make(store, dispatchFunc, allShowComponentConfig, currentSceneTreeNode, _) {
  return /* record */[
          ...
          /* render */(function (self) {
              return render(store, dispatchFunc, allShowComponentConfig, currentSceneTreeNode, self);
            }),
