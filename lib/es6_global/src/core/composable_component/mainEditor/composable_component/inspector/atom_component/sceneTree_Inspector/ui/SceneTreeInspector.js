...
function buildCurrentSceneTreeNodeComponent(store, dispatch, allShowComponentConfig, currentSceneTreeNode) {
...
function render(store, dispatch, allShowComponentConfig, currentSceneTreeNode, _) {
  return React.createElement("article", {
              key: "SceneTreeInspector",
              className: "inspector-component"
            }, buildCurrentSceneTreeNodeComponent(store, dispatch, allShowComponentConfig, currentSceneTreeNode));
}

function make(store, dispatch, allShowComponentConfig, currentSceneTreeNode, _) {
  var newrecord = component.slice();
  newrecord[/* render */9] = (function (self) {
      return render(store, dispatch, allShowComponentConfig, currentSceneTreeNode, self);
    });
  return newrecord;
}
