...
import * as MainEditorMaterialDragEventHandler$WonderEditor from "../ui/eventHandler/MainEditorMaterialDragEventHandler.js";
...
var component = ReasonReact.reducerComponentWithRetainedProps("MainEditorBasicMaterialTexture");
...
function render(param, materialComponent, param$1) {
  ...
  var dispatchFunc = param[1];
  var store = param[0];
  var match = param$1[/* retainedProps */2][/* map */0];
