...
function _handleGeometryAddMap(param, textureComponent, handleSetMapFunc, param$1) {
  ...
  if (geometryComponent !== undefined && !GeometryService$WonderEditor.hasTexCoords(GeometryEngineService$WonderEditor.unsafeGetGeometryTexCoords(geometryComponent, engineState))) {
