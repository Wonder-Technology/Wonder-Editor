...
function render(_, param, param$1, param$2) {
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(StringService$WonderEditor.floatToString(state[/* x */0]), "X", Curry._1(param$1[0], transformComponent), (function (value) {
                        return Curry._1(send, /* TransformBlurX */Block.__(0, [value]));
                      }), canBeZero, /* array */[])), ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(StringService$WonderEditor.floatToString(state[/* y */1]), "Y", Curry._1(param$1[1], transformComponent), (function (value) {
                        return Curry._1(send, /* TransformBlurY */Block.__(1, [value]));
                      }), canBeZero, /* array */[])), ReasonReact.element(undefined, undefined, FloatInput$WonderEditor.make(StringService$WonderEditor.floatToString(state[/* z */2]), "Z", Curry._1(param$1[2], transformComponent), (function (value) {
                        return Curry._1(send, /* TransformBlurZ */Block.__(2, [value]));
                      }), canBeZero, /* array */[])));
}

function make(store, dispatchFunc, transformComponent, changeXFunc, changeYFunc, changeZFunc, getDataFunc, blurEventFunc, canBeZero, _) {
