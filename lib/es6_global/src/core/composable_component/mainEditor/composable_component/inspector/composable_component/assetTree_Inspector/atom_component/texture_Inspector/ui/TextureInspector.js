...
function reducer(dispatchFunc, nodeId, textureId, action) {
  if (action) {
    var value = action[0];
        ...
        if (value === "") {
          ...
          return ReasonReactUtils$WonderEditor.updateWithSideEffects(/* record */[
                      ...
                      /* originalName */value
                        ...
                        return changeTextureName(dispatchFunc, nodeId, textureId, value);
                      }));
        }
      });
  }
...
function make(_, dispatchFunc, name, nodeId, textureId, _$1) {
  return /* record */[
          ...
          /* reducer */(function (param) {
              return reducer(dispatchFunc, nodeId, textureId, param);
            }),
