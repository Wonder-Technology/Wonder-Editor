...
function renderMagFilterSelect(textureIndex) {
  return ReasonReact.element(/* None */0, /* None */0, Select$WonderEditor.make(/* Some */["Mag Filter Mode"], TextureFilterUtils$WonderEditor.getFilterOptions(/* () */0), StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
...
function renderMinFilterSelect(textureIndex) {
  return ReasonReact.element(/* None */0, /* None */0, Select$WonderEditor.make(/* Some */["Min Filter Mode"], TextureFilterUtils$WonderEditor.getFilterOptions(/* () */0), StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
