...
function changeTextureName(dispatchFunc, nodeId, textureId, newName) {
  OperateTextureLogicService$WonderEditor.setTextureNameToEngineAndNodeMap(nodeId, textureId, newName);
...
function render(dispatchFunc, name, param, _) {
  var textureId = param[1];
  var nodeId = param[0];
  return React.createElement("article", {
              ...
              className: "wonder-texture-assetTree"
                  ...
                  className: ""
                      ...
                      className: ""
                    }, ReasonReact.element(/* None */0, /* None */0, StringInput$WonderEditor.make(/* Some */[name], /* Some */["name"], /* None */0, /* Some */[(function (param) {
                                  return changeTextureName(dispatchFunc, nodeId, textureId, param);
                                })], /* Some */[false], /* array */[]))), React.createElement("div", {
                      className: ""
...
function make(_, dispatchFunc, name, nodeId, textureId, _$1) {
  return /* record */[
          ...
          /* render */(function (self) {
              return render(dispatchFunc, name, /* tuple */[
                          nodeId,
                          textureId
                        ], self);
            }),
