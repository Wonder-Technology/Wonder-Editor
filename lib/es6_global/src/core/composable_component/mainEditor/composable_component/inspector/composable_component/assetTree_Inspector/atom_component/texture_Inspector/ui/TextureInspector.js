...
function render(param, name, textureIndex, _) {
  return React.createElement("article", {
            ...
            }, React.createElement("h1", undefined, DomHelper$WonderEditor.textEl("Texture")), React.createElement("hr", undefined), ReasonReact.element(undefined, undefined, StringInput$WonderEditor.make(name, "Name", undefined, param[1], false, /* array */[])), renderWrapSSelect(textureIndex), renderWrapTSelect(textureIndex), renderMagFilterSelect(textureIndex), renderMinFilterSelect(textureIndex));
}
