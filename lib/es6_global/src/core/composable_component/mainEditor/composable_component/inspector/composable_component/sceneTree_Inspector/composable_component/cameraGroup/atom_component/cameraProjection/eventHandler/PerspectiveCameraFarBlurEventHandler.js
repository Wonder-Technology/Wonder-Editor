...
function setUndoValueToCopiedEngineState(_, perspectiveComponent, value) {
  return PerspectiveCameraProjectionEngineService$WonderEditor.setPerspectiveCameraFar(value, perspectiveComponent, StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
