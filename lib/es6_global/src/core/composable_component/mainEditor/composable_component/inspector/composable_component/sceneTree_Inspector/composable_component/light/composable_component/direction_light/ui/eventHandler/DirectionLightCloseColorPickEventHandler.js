...
function setUndoValueToCopiedEngineState(param, lightComponent, value) {
  return DirectionLightEngineService$WonderEditor.setDirectionLightColor(Color$WonderEditor.convert16HexToRGBArr(value), lightComponent, StateEngineService$WonderEditor.deepCopyForRestore(StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
