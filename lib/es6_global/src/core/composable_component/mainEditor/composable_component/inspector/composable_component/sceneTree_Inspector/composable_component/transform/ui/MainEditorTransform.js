...
function render(param, param$1, _) {
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(undefined, undefined, ThreeFloatInput$WonderEditor.make(uiState, dispatchFunc, "Position", transformComponent, changePositionX, changePositionY, changePositionZ, TransformUtils$WonderEditor.getTransformPositionData, blurPositionEvent, blurPositionEvent, true, /* array */[])), ReasonReact.element(undefined, undefined, ThreeFloatInput$WonderEditor.make(uiState, dispatchFunc, "Rotation", transformComponent, changeRotationX, changeRotationY, changeRotationZ, TransformUtils$WonderEditor.getTransformRotationData, blurRotationEvent, blurRotationEvent, true, /* array */[])), ReasonReact.element(undefined, undefined, ThreeFloatInput$WonderEditor.make(uiState, dispatchFunc, "Scale", transformComponent, changeScaleX, changeScaleY, changeScaleZ, TransformUtils$WonderEditor.getTransformScaleData, blurScaleEvent, blurScaleEvent, true, /* array */[])), buildShadeComponent(param$1[1]));
}
