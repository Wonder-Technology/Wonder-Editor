  ...
  return React.createElement("article", {
              className: "wonder-inspector-transform"
                  ...
                  className: "inspector-item"
                    ...
                    }, ReasonReact.element(undefined, undefined, TransformTemplate$WonderEditor.make(uiState, dispatchFunc, transformComponent, changePositionX, changePositionY, changePositionZ, TransformUtils$WonderEditor.getTransformPositionData, blurPositionEvent, true, /* array */[])))), React.createElement("div", {
                  className: "inspector-item"
                }, React.createElement("div", {
                      className: "item-header"
                    }, DomHelper$WonderEditor.textEl("Rotation")), React.createElement("div", {
                      className: "item-content"
                    }, ReasonReact.element(undefined, undefined, TransformTemplate$WonderEditor.make(uiState, dispatchFunc, transformComponent, changeRotationX, changeRotationY, changeRotationZ, TransformUtils$WonderEditor.getTransformRotationData, blurRotationEvent, true, /* array */[])))), React.createElement("div", {
                  className: "inspector-item"
                }, React.createElement("div", {
                      className: "item-header"
                    }, DomHelper$WonderEditor.textEl("Scale")), React.createElement("div", {
                      className: "item-content"
                    }, ReasonReact.element(undefined, undefined, TransformTemplate$WonderEditor.make(uiState, dispatchFunc, transformComponent, changeScaleX, changeScaleY, changeScaleZ, TransformUtils$WonderEditor.getTransformScaleData, blurScaleEvent, false, /* array */[])))), buildShadeComponent(param$1[1]));
}

function make(uiState, dispatchFunc, transformComponent, gameObject, _) {
  return /* record */[
