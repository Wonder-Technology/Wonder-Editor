  ...
  return React.createElement("article", {
              className: "wonder-inspector-transform"
                  ...
                  className: "inspector-item"
                      ...
                      className: "item-content"
                    }, ReasonReact.element(undefined, undefined, TransformTemplate$WonderEditor.make(store, dispatchFunc, transformComponent, changeScaleX, changeScaleY, changeScaleZ, TransformUtils$WonderEditor.getTransformScaleData, blurScaleEvent, false, /* array */[])))), buildShadeComponent(param$1[1]));
}
