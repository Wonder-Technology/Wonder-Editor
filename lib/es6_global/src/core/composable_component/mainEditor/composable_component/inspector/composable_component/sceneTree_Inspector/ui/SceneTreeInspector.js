...
function _buildNameFunc(param, gameObject, languageType) {
  ...
  return React.createElement("div", {
              ...
              className: "sceneTree-name"
                            ...
                            return GameObjectEngineService$WonderEditor.unsafeGetGameObjectName(gameObject, param);
                          })), "Name", LanguageUtils$WonderEditor.getInspectorLanguageDataByType("name-describe", languageType), undefined, (function (param) {
                        return reNameGameObjectBlurEvent(partial_arg, gameObject, param);
                      }), true, /* array */[])));
}

function _buildGameObjectAllShowComponent(param, gameObject, languageType, componentTypeArr) {
  ...
  return componentTypeArr.map((function (componentType) {
                return InspectorGameObjectUtils$WonderEditor.buildComponentUIComponent(/* tuple */[
                            uiState,
                            dispatchFunc
                          ], componentType, gameObject, languageType);
              }));
}

function buildCurrentSceneTreeNodeComponent(param, addableComponentConfig, currentSceneTreeNode, languageType) {
  if (currentSceneTreeNode !== undefined) {
    ...
    return ArrayService$WonderEditor.push(ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, AddableComponent$WonderEditor.make(/* tuple */[
                        ...
                        uiState,
                        dispatchFunc
                      ], gameObject, languageType)].concat(_buildGameObjectAllShowComponent(/* tuple */[
                        uiState,
                        dispatchFunc
                      ], gameObject, languageType, ImmutableSparseMapService$WonderCommonlib.unsafeGet(gameObject, InspectorEditorService$WonderEditor.getComponentTypeMap(StateEditorService$WonderEditor.getState(/* () */0))))));
  } else {
    return /* array */[];
  }
}
...
function render(param, addableComponentConfig, currentSceneTreeNode, _self) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-inspector-sceneTree"
                  ...
                  param[0],
                  param[1]
                ], addableComponentConfig, currentSceneTreeNode, languageType));
}
