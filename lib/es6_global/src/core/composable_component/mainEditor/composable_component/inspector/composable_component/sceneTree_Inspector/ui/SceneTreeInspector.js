...
function buildCurrentSceneTreeNodeComponent(param, addableComponentConfig, currentSceneTreeNode) {
  if (currentSceneTreeNode !== undefined) {
    ...
    var dispatchFunc = param[1];
    var uiState = param[0];
    if (StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
...
function render(param, addableComponentConfig, currentSceneTreeNode, _) {
...
function make(uiState, dispatchFunc, addableComponentConfig, currentSceneTreeNode, _) {
  return /* record */[
