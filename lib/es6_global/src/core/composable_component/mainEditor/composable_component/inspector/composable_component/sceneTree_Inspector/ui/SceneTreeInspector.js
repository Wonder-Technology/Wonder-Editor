...
import * as SceneTreeNodeMarkRedoUndoEventHandlder$WonderEditor from "./eventHandler/SceneTreeNodeMarkRedoUndoEventHandlder.js";
...
var reNameGameObjectBlurEvent = SceneTreeNodeMarkRedoUndoEventHandlder$WonderEditor.MakeEventHandler[/* onMarkRedoUndoByStackLastReturnStore */4];
...
function _buildNameFunc(param, gameObject) {
  return React.createElement("div", {
              key: DomHelper$WonderEditor.getRandomKey(/* () */0)
                            ...
                            }))], /* None */0, /* None */0, /* Some */[Curry._2(reNameGameObjectBlurEvent, /* tuple */[
                            param[0],
                            param[1]
                          ], gameObject)], /* Some */[false], /* array */[])));
}
...
function buildCurrentSceneTreeNodeComponent(param, allShowComponentConfig, currentSceneTreeNode) {
  if (currentSceneTreeNode) {
    ...
    return ArrayService$WonderEditor.unshift(_buildComponentBox(/* tuple */[
                    ...
                    store,
                    dispatchFunc
                  ], false, _buildNameFunc), ArrayService$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, AddableComponent$WonderEditor.make(/* tuple */[
                            store,
                            dispatchFunc
