...
function reNameGameObjectBlurEvent(store, dispatchFunc, gameObject, newName) {
  Log$WonderLog.print(gameObject);
  Log$WonderLog.print(newName);
  ...
  Curry._1(dispatchFunc, [
        ...
        /* SetSceneGraph */[/* Some */[SceneTreeUtils$WonderEditor.renameSceneGraphData(gameObject, newName, SceneTreeUtils$WonderEditor.unsafeGetSceneGraphDataFromStore(store))]]
      ]);
  return /* () */0;
}

function _buildName(param, gameObject) {
  var dispatchFunc = param[1];
  var store = param[0];
  return React.createElement("div", {
              key: DomHelper$WonderEditor.getRandomKey(/* () */0)
            }, ReasonReact.element(/* None */0, /* None */0, StringInput$WonderEditor.make(/* Some */[StateLogicService$WonderEditor.getEngineStateToGetData((function (param) {
                              return GameObjectEngineService$WonderEditor.unsafeGetGameObjectName(gameObject, param);
                            }))], /* None */0, /* None */0, /* Some */[(function (param) {
                          return reNameGameObjectBlurEvent(store, dispatchFunc, gameObject, param);
                        })], /* array */[])));
}
...
function buildCurrentSceneTreeNodeComponent(param, allShowComponentConfig, currentSceneTreeNode) {
  if (currentSceneTreeNode) {
    ...
    return ArrayService$WonderEditor.unshift(_buildComponentBox(/* tuple */[
                    ...
                    store,
                    dispatchFunc
                  ], false, _buildName), ArrayService$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, AddableComponent$WonderEditor.make(/* tuple */[
                            store,
                            dispatchFunc
