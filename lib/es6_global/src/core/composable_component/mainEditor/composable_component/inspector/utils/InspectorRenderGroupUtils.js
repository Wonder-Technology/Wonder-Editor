...
function replaceRenderGroupByMaterialType(sourceMateralType, targetMaterialType) {
  ...
  StateLogicService$WonderEditor.setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, match$5[1]));
  return StateLogicService$WonderEditor.setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, match$5[0]));
}
