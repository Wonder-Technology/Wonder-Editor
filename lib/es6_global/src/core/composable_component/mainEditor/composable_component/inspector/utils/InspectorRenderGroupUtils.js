...
function _getOperateSourceRenderGroupData$1(meshRenderer, material, materialType, _) {
  if (materialType) {
    return /* tuple */[
...
function replaceGameObjectsMaterialsOfTheMaterial(param, engineState) {
  var match = param[1];
...
var Dispose = /* module */[
  ...
  /* replaceGameObjectsMaterialsOfTheMaterial */replaceGameObjectsMaterialsOfTheMaterial
];
