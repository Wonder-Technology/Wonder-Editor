...
function triggerBlur(dispatchFunc, value, nodeId) {
  ...
  StateEditorService$WonderEditor.setState(AssetNodeMapEditorService$WonderEditor.setResult(nodeId, AssetTreeNodeUtils$WonderEditor.renameNodeResult(value, SparseMapService$WonderCommonlib.unsafeGet(nodeId, AssetNodeMapEditorService$WonderEditor.unsafeGetNodeMap(editorState))), editorState));
    ...
    case 0 : 
        ...
        return React.createElement("div", {
                    className: ""
                        ...
                        disabled: match$1 ? Js.true_ : Js.false_,
                        type: "text",
...
function reducer(dispatchFunc, nodeId, action, state) {
  if (action) {
    return /* Update */Block.__(0, [/* record */[
                /* inputField */state[/* inputField */0],
                /* inputValue */action[0],
                /* originalName */state[/* originalName */2],
    ...
    if (value === "") {
      return /* Update */Block.__(0, [/* record */[
                  /* inputField */state[/* inputField */0],
                  /* inputValue */state[/* originalName */2],
                  /* originalName */state[/* originalName */2],
                  /* postfix */state[/* postfix */3]
                ]]);
    } else {
      return /* UpdateWithSideEffects */Block.__(2, [
                ...
                (function () {
                    return triggerBlur(dispatchFunc, value + state[/* postfix */3], nodeId);
                  })
              ]);
    }
  }
...
function make(_, dispatchFunc, nodeId, nodeResult, _$1) {
  return /* record */[
          ...
          /* reducer */(function (param, param$1) {
              return reducer(dispatchFunc, nodeId, param, param$1);
            }),
