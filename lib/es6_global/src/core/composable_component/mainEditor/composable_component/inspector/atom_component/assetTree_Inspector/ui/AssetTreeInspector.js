...
function triggerBlur(dispatch, value, nodeId) {
  ...
  AssetNodeMapEditorService$WonderEditor.setResult(nodeId, AssetTreeNodeUtils$WonderEditor.renameNodeResult(value, SparseMapService$WonderCommonlib.unsafeGet(nodeId, AssetNodeMapEditorService$WonderEditor.unsafeGetNodeMap(editorState))), editorState);
...
function make(_, dispatch, nodeId, nodeResult, _$1) {
  ...
  newrecord[/* initialState */10] = (function () {
      return /* record */[
              ...
              /* originalName */nodeResult[/* name */0],
              /* isAssetTreeRootNode */AssetUtils$WonderEditor.isIdEqual(StateLogicService$WonderEditor.getEditorState(AssetTreeRootEditorService$WonderEditor.getRootTreeNodeId), nodeId)
            ];
    });
