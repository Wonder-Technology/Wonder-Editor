...
function _renderSelectMaterial(param) {
...
function render(param, currentSceneTreeNode, self) {
  ...
  return React.createElement("article", {
            ...
            }, _renderSelectMaterial(self), match ? _renderMaterialGroup(currentSceneTreeNode, self) : null, React.createElement("div", {
...
function make(store, dispatchFunc, currentSceneTreeNode, $staropt$star, _children) {
