...
function render(param, allShowComponentConfig, self) {
  return React.createElement("article", {
              ...
              className: "wonder-inspector-component"
                  ...
                  self[/* retainedProps */2][/* currentNodeData */5]
                ]));
}
...
function make(store, dispatchFunc, allShowComponentConfig, _) {
  ...
  if (currentSceneTreeNode) {
    ...
    tmp = match ? /* None */0 : /* Some */[Log$WonderLog.print(TransformUtils$WonderEditor.getCurrentTransformData(GameObjectComponentEngineService$WonderEditor.getTransformComponent(gameObject, engineStateToGetData)))];
  } else {
    tmp = /* None */0;
  }
  var tmp$1;
