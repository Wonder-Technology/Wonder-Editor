...
function render(param, addableComponentConfig, _) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-inspector-component"
                  ...
                  StateLogicService$WonderEditor.getEditorState(AssetCurrentNodeDataEditorService$WonderEditor.getCurrentNodeData)
                ]));
}

function shouldUpdate(param) {
  return StoreUtils$WonderEditor.shouldComponentUpdate(/* Inspector */1, param[/* newSelf */1][/* retainedProps */2][/* updateTypeArr */0]);
}

function make(store, dispatchFunc, addableComponentConfig, _) {
  return /* record */[
