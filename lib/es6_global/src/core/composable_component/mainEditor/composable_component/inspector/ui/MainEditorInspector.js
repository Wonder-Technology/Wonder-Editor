...
function render(param, allShowComponentConfig, _) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-inspector-component"
                  ...
                  StateLogicService$WonderEditor.getAssetState(CurrentNodeDataAssetService$WonderEditor.getCurrentNodeData)
                ]));
}
