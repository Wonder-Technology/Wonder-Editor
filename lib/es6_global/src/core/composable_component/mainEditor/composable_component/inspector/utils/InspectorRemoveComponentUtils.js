...
function removeComponentByTypeForEditEngineState(type_, currentSceneTreeNode, engineState) {
  ...
  switch (type_) {
    ...
    case 2 : 
        var __x = GameObjectComponentEngineService$WonderEditor.unsafeGetGeometryComponent(currentSceneTreeNode, engineState);
        return GameObjectLogicService$WonderEditor.disposeGeometryForEditEngineState(currentSceneTreeNode, __x, engineState);
    case 3 : 
...
function removeComponentByTypeForRunEngineState(type_, currentSceneTreeNode, param) {
  ...
  switch (type_) {
    ...
    case 2 : 
        return GameObjectLogicService$WonderEditor.disposeGeometryForRunEngineState(currentSceneTreeNode, GameObjectComponentEngineService$WonderEditor.unsafeGetGeometryComponent(currentSceneTreeNode, engineState), /* tuple */[
                    editorState,
                    engineState
                  ]);
    case 3 : 
