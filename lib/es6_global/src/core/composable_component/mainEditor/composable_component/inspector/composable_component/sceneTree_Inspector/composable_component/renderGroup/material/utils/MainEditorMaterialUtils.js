...
function getNewMaterilaName() {
  return "New Material";
}

function getNoNameMaterialName() {
  return "NoName Material";
}

function getName(material, type_, engineState) {
  if (type_) {
    var match = LightMaterialEngineService$WonderEditor.getLightMaterialName(material, engineState);
    if (match !== undefined) {
      return match;
    } else {
      return "NoName Material";
    ...
    var match$1 = BasicMaterialEngineService$WonderEditor.getBasicMaterialName(material, engineState);
