...
function handleSelfLogic(param, _, param$1) {
  ...
  Curry._1(dispatchFunc, [
        ...
        /* SetSceneGraph */[SceneTreeUtils$WonderEditor.getDragedSceneGraphData(targetUid, dragedUid, StoreUtils$WonderEditor.unsafeGetSceneGraphDataFromStore(param[0]))]
      ]);
  Curry._1(dispatchFunc, [
