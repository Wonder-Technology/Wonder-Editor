...
var component = ReasonReact.statefulComponentWithRetainedProps("MainEditorSceneTree");
...
function render(store, dispatch, self) {
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, DragTree$WonderEditor.make(buildSceneTreeArray(self[/* state */4][/* dragImg */0], Curry._2(onSelect, /* tuple */[
                              store,
                              dispatch
...
function make(store, dispatch, _) {
  ...
  newrecord[/* initialState */10] = (function () {
      return /* record */[/* dragImg */document.createElement("img")];
    });
