...
function _isCurrentSceneTreeNode(uid, currentSceneTreeNode) {
...
function buildSceneTreeArray(onSelect, onDrop, currentSceneTreeNode, sceneGraphData) {
  return $$Array.map((function (param) {
                ...
                if (match !== 0) {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  uid,
                                  name,
                                  _isCurrentSceneTreeNode(uid, currentSceneTreeNode)
                                ], /* tuple */[
                                  onSelect,
                                  onDrop,
                                  handleSign,
                                  SceneTreeUtils$WonderEditor.isGameObjectRelationError
                                ], SceneTreeUIUtils$WonderEditor.getSign(/* () */0), /* None */0, /* None */0, /* Some */[buildSceneTreeArray(onSelect, onDrop, currentSceneTreeNode, children)], /* array */[]));
                } else {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  uid,
                                  name,
...
var Method = /* module */[
  ...
  /* _isCurrentSceneTreeNode */_isCurrentSceneTreeNode,
...
function render(store, dispatch, self) {
  ...
  return React.createElement("article", {
              ...
              className: "sceneTree-component"
                              ...
                              store,
                              dispatch
                            ], /* () */0), self[/* retainedProps */5][/* currentSceneTreeNode */1], ArrayService$WonderEditor.getFirst(sceneGraphData)[/* children */2]), StateLogicService$WonderEditor.getEditorState(SceneEditorService$WonderEditor.unsafeGetScene), Curry._2(onDrop, /* tuple */[
                          store,
                          dispatch
