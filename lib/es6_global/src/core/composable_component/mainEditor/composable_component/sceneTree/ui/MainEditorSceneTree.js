...
function handleFlag(startFlag) {
  return startFlag === SceneTreeUIUtils$WonderEditor.getFlag(/* () */0);
}
...
function buildSceneTreeArray(dragImg, onSelect, onDrop, currentSceneTreeNode, sceneGraphData) {
  return sceneGraphData.map((function (param) {
                ...
                return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                ...
                                true,
                                dragImg,
                                SceneTreeUIUtils$WonderEditor.getFlag(/* () */0),
                                /* None */0,
                                /* None */0
                              ], /* tuple */[
                                onSelect,
...
function render(store, dispatchFunc, self) {
  ...
  return React.createElement("article", {
              ...
              className: "sceneTree-component"
                          ...
                          store,
                          dispatchFunc
                        ], /* () */0), handleFlag, SceneTreeUtils$WonderEditor.isGameObjectRelationError, /* array */[])));
}
