...
function buildSceneTreeArray(dragImg, currentSceneTreeNode, param, sceneGraphArr) {
  ...
  return sceneGraphArr.map((function (param) {
                var uid = param[/* uid */1];
                return ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, TreeNode$WonderEditor.make(uid, param[/* name */0], _isSelected(uid, currentSceneTreeNode), true, dragImg, SceneTreeUtils$WonderEditor.getWidge(/* () */0), undefined, undefined, onSelectFunc, onDropFunc, SceneTreeUtils$WonderEditor.isWidge, SceneTreeUtils$WonderEditor.isGameObjectRelationError, buildSceneTreeArray(dragImg, currentSceneTreeNode, /* tuple */[
                                    onSelectFunc,
                                    onDropFunc
...
function render(store, dispatchFunc, _) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-sceneTree-component"
                        ...
                        ], ArrayService$WonderEditor.getFirst(StoreUtils$WonderEditor.unsafeGetSceneGraphDataFromStore(store))[/* children */2]), StateLogicService$WonderEditor.getEngineStateToGetData(SceneEngineService$WonderEditor.getSceneGameObject), Curry._2(onDrop, /* tuple */[
                          store,
                          dispatchFunc
                        ], /* () */0), SceneTreeUtils$WonderEditor.isWidge, SceneTreeUtils$WonderEditor.isGameObjectRelationError, /* array */[])));
}

function shouldUpdate(param) {
  return StoreUtils$WonderEditor.shouldComponentUpdate(/* SceneTree */3, param[/* newSelf */1][/* retainedProps */2][/* updateTypeArr */0]);
}
