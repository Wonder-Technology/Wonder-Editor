...
function render(store, dispatchFunc, _) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-sceneTree-component"
                        ...
                        ], ArrayService$WonderEditor.getFirst(StoreUtils$WonderEditor.unsafeGetSceneGraphDataFromStore(store))[/* children */2]), StateLogicService$WonderEditor.getEngineStateToGetData(SceneEngineService$WonderEditor.getSceneGameObject), Curry._2(dragGameObjectIntoGameObject, /* tuple */[
                          store,
                          dispatchFunc
