...
function buildSceneTreeArray(onSelect, onDrop, sceneGraphData) {
  return $$Array.map((function (param) {
                ...
                if (match !== 0) {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  ...
                                  onDrop,
                                  handleSign
                                ], SceneTreeUIUtils$WonderEditor.getSign(/* () */0), /* None */0, /* None */0, /* Some */[buildSceneTreeArray(onSelect, onDrop, children)], /* array */[]));
                } else {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  uid,
                                  name,
