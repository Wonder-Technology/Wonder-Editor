...
function onSelect(param, _, uid) {
  ...
  if (match) {
    ...
    if (match$1) {
      Log$WonderLog.print("gameobject == uid");
      return /* () */0;
    } else {
...
function buildSceneTreeArray(dragImg, currentSceneTreeNode, param, sceneGraphArr) {
  ...
  return sceneGraphArr.map((function (param) {
                var uid = param[/* uid */1];
                return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(uid, param[/* name */0], _isSelected(uid, currentSceneTreeNode), true, dragImg, SceneTreeUtils$WonderEditor.getFlag(/* () */0), /* None */0, /* None */0, onSelectFunc, onDropFunc, SceneTreeUtils$WonderEditor.handleFlag, SceneTreeUtils$WonderEditor.isGameObjectRelationError, buildSceneTreeArray(dragImg, currentSceneTreeNode, /* tuple */[
                                    onSelectFunc,
                                    onDropFunc
