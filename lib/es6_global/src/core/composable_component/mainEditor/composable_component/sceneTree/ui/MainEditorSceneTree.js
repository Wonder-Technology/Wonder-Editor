...
function render(store, dispatchFunc, self) {
  ...
  return React.createElement("article", {
            ...
            }, ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, DragTree$WonderEditor.make(buildSceneTreeArray(document.createElement("img"), self[/* retainedProps */2][/* currentSceneTreeNode */1], /* tuple */[
                          (function (param) {
