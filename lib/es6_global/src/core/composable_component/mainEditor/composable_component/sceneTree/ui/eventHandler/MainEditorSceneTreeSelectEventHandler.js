...
function onSelect(param, _, uid) {
  StateLogicService$WonderEditor.getAndSetEditorState((function (editorState) {
          return AssetCurrentNodeIdEditorService$WonderEditor.clearCurrentNodeId(CurrentSourceEditorService$WonderEditor.setCurrentSource(/* SceneTree */0, SceneEditorService$WonderEditor.setCurrentSceneTreeNode(uid, editorState)));
        }));
