...
import '../../../../../../../../../src/core/composable_component/mainEditor/atom_component/componentBox/ui/css/componentBox.css';
...
function render(header, isClosable, gameObjectComponent, param) {
  ...
  return React.createElement("article", {
              className: "componentBox-component"
                  ...
                  className: "header"
                    ...
                    }, DomHelper$WonderEditor.textEl(header)), isClosable ? React.createElement("span", {
                        className: "header-close"
                      }, DomHelper$WonderEditor.textEl("x")) : null), match ? gameObjectComponent : null);
}

function make(header, isClosable, gameObjectComponent, _) {
  return /* record */[
          ...
          /* render */(function (self) {
              return render(header, isClosable, gameObjectComponent, self);
            }),
