...
function _handleEngineState(sceneGameObject, hasWDBIMGUIFunc, engineState) {
  ...
  StateEditorService$WonderEditor.setState(GameObjectComponentLogicService$WonderEditor.setGameObjectArrComponentTypeMap(GameObjectUtils$WonderEditor.getChildren(sceneGameObject, engineState$2), GameObjectComponentLogicService$WonderEditor.buildAllComponentArray(/* () */0), engineState$2, editorState$2));
