...
function _getTextureIndexFromMap(textureComponent, textureIndexMap) {
  if (textureComponent !== undefined) {
    return Caml_option.some(SparseMapService$WonderCommonlib.unsafeGet(textureComponent, textureIndexMap));
  }
...
function _buildWDBData(imageUint8ArrayMap, imageAlignedByteLength, imageBufferViewArr, param) {
  ...
  var match = SparseMapService$WonderEditor.reduceValid((function (param, param$1) {
          ...
          var match = HeaderExportAssetWDBUtils$WonderEditor.generate(param$1[/* wdbGameObject */2], imageUint8ArrayMap, param[0]);
          var wdbArrayBuffer = match[1];
