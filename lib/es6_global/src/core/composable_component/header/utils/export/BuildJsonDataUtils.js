...
function _buildImageData(editorState) {
  var match = SparseMapService$WonderEditor.reduceiValid((function (param, param$1, imageDataIndex) {
          ...
          return /* tuple */[
                  SparseMapService$WonderCommonlib.set(imageDataIndex, imageArr.length, param[0]),
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (param, node) {
                ...
                return /* tuple */[
                        ...
                        ArrayService$WonderEditor.push(/* record */[
                              ...
                              /* source */SparseMapService$WonderCommonlib.unsafeGet(match[/* imageDataIndex */1], imageIndexMap),
