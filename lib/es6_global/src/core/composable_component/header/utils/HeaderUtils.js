...
function handleSceneWdb(wdbResult) {
  return Most.flatMap((function () {
                return Most.map((function (param) {
                            ...
                            }), AssembleWDBEngineService$WonderEditor.assembleWDB(wdbResult[/* result */2], true, StateLogicService$WonderEditor.getRunEngineState(/* () */0)));
                  ...
                  }), AssembleWDBEngineService$WonderEditor.assembleWDB(wdbResult[/* result */2], true, StateLogicService$WonderEditor.getEditEngineState(/* () */0))));
}
