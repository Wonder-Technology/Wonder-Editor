...
function handleSceneWdb(wdbResult) {
  return Most.flatMap((function () {
                return Most.map((function (param) {
                              ...
                              StateEditorService$WonderEditor.setState(AssetTreeRootEditorService$WonderEditor.setAssetTreeRoot(match[0], GameObjectComponentLogicService$WonderEditor.getGameObjectComponentStoreInComponentTypeMap(gameObject, runEngineState, match[1])));
                    ...
                    var editEngineState = SceneEngineService$WonderEditor.setSceneGameObject(param[1], SceneEngineService$WonderEditor.disposeSceneAndChildren(param[0]));
                    ...
                    return Most.fromPromise(new Promise((function (resolve, _) {
                                      ...
                                      Curry._2(FileReader$WonderEditor.onload, reader, (function (result) {
                                              return resolve(/* record */[
                                                          /* name */wdbInfo[/* name */0],
                                                          /* type_ */AssetTreeNodeUtils$WonderEditor.getUploadFileType(wdbInfo[/* type_ */1]),
                                                          /* result */result
                                                        ]);
                                            }));
