...
import * as AssetWDBUtils$WonderEditor from "../../../mainEditor/composable_component/bottom_components/composable_component/project/composable_component/asset/utils/AssetWDBUtils.js";
...
function buildImageData(param, buffer, editorState) {
  ...
  return Most.reduce((function (param, param$1) {
                ...
                return /* tuple */[
                        ...
                        ImageNodeMapAssetEditorService$WonderEditor.setResult(assetNodeId, ImageNodeMapAssetEditorService$WonderEditor.buildImageNodeResult(undefined, Js_primitive.some(param$1[1]), param$1[3], param$1[4]), match[0])
                      ];
              }), /* tuple */[
...
function buildMaterialData(param, textureMap, param$1) {
  var match = ArrayService$WonderCommonlib.reduceOneParami((function (param, param$1, materialIndex) {
      ...
      ], param[/* basicMaterials */3]);
  var match$1 = match[1];
  var match$2 = ArrayService$WonderCommonlib.reduceOneParami((function (param, param$1, materialIndex) {
...
function buildWDBData(param, buffer, param$1) {
  ...
  var totalImageUint8ArrayDataMapRef = /* record */[/* contents */SparseMapService$WonderCommonlib.createEmpty(/* () */0)];
  return Most.drain(Most.concatMap((function (param) {
                      ...
                      return Most.fromPromise(AssetWDBUtils$WonderEditor.importAssetWDB(/* tuple */[
                                        param[/* name */0],
                                        arrayBuffer
                                      ], /* tuple */[
                                        match[1],
                                        ...
                                        totalImageUint8ArrayDataMapRef[0] = _mergeImageUint8ArrayDataMap(totalImageUint8ArrayDataMapRef[0], match$1[1]);
                ...
                return Promise.resolve(/* tuple */[
                            /* tuple */[
                              ...
                              totalImageUint8ArrayDataMapRef[0]
                            ],
                            /* tuple */[
                              editorState,
                              engineState
