...
function _disposeAssets() {
  return StateLogicService$WonderEditor.getAndSetStateToGetData(DisposeTreeAssetLogicService$WonderEditor.disposeTree);
}
...
function _checkMaterials(where, gameObjects) {
  return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("all " + (String(where) + "->materials should be material assets or default materials"), "not"), (function () {
                var editorState = StateEditorService$WonderEditor.getState(/* () */0);
                var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
...
function _checkSceneMaterials() {
  var __x = SceneEngineService$WonderEditor.getSceneGameObject(StateEngineService$WonderEditor.unsafeGetState(/* () */0));
  return _checkMaterials("scene gameObjects", GameObjectEngineService$WonderEditor.getAllGameObjects(__x, StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
...
function _checkTextures(where, gameObjects) {
  return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("all " + (String(where) + "->textures should be texture assets"), "not"), (function () {
...
function _checkSceneTextures() {
  var __x = SceneEngineService$WonderEditor.getSceneGameObject(StateEngineService$WonderEditor.unsafeGetState(/* () */0));
  return _checkTextures("scene gameObjects", GameObjectEngineService$WonderEditor.getAllGameObjects(__x, StateEngineService$WonderEditor.unsafeGetState(/* () */0)));
}
...
function _init(allWDBGameObjectArrRef) {
  ...
  return ArrayService$WonderCommonlib.reduceOneParam((function (engineState, gameObject) {
              ...
              }), engineState$2, ArrayService$WonderEditor.fastConcat(allWDBGameObjectArrRef[0], GameObjectEngineService$WonderEditor.getAllGameObjects(SceneEngineService$WonderEditor.getSceneGameObject(engineState$2), engineState$2)));
}

function _import(result) {
  StateLogicService$WonderEditor.getAndSetStateToGetData(DisposeTreeAssetLogicService$WonderEditor.disposeTree);
  ...
  var asbImageUint8ArrayDataMapRef = /* record */[/* contents */SparseMapService$WonderCommonlib.createEmpty(/* () */0)];
                    ...
                    return Contract$WonderLog.ensureCheck((function () {
                      ...
                      return Most.map((function (param) {
                                    ...
                                    Contract$WonderLog.requireCheck((function () {
                                            return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("sceneGameObjectImageUint8ArrayDataMap be empty", "not"), (function () {
                                                          return Contract$WonderLog.Operators[/* = */0](SparseMapService$WonderEditor.length(_sceneGameObjectImageUint8ArrayDataMap), 0);
                                                        }));
                                          }), StateEditorService$WonderEditor.getStateIsDebug(/* () */0));
                                    var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
                                    ImportPackageRelateGameObjectAndAssetUtils$WonderEditor.relateSceneWDBGameObjectsAndAssets(GameObjectEngineService$WonderEditor.getAllGameObjects(param[0], engineState), asbImageUint8ArrayDataMapRef[0], materialMapTupleRef[0], wdbAssetGameObjectGeometryAssetArrRef[0]);
                                    return /* () */0;
