...
function _setLightMaterialNotMapData(material, param, engineState) {
  return LightMaterialEngineService$WonderEditor.setLightMaterialShininess(param[2], material, LightMaterialEngineService$WonderEditor.setLightMaterialDiffuseColor(param[1], material, LightMaterialEngineService$WonderEditor.setLightMaterialName(param[0], material, engineState)));
}

function _setLightMaterialMapData(material, textureMap, diffuseMap, engineState) {
  var match = OptionService$WonderEditor.isJsonSerializedValueNone(diffuseMap);
  if (match) {
    return engineState;
  } else {
    var diffuseMap$1 = OptionService$WonderEditor.unsafeGetJsonSerializedValue(diffuseMap);
    return LightMaterialEngineService$WonderEditor.setLightMaterialDiffuseMap(ImmutableSparseMapService$WonderCommonlib.unsafeGet(diffuseMap$1, textureMap), material, engineState);
  }
}
...
function _buildLightMaterialData(lightMaterials, param, param$1) {
  ...
  return ArrayService$WonderCommonlib.reduceOneParami((function (param, param$1, materialIndex) {
                ...
                var material = match$1[1];
                var engineState = _setLightMaterialNotMapData(material, /* tuple */[
                      param$1[/* name */0],
                      param$1[/* diffuseColor */3],
                      param$1[/* shininess */5]
                    ], match$1[0]);
                var engineState$1 = _setLightMaterialMapData(material, textureMap, param$1[/* diffuseMap */4], engineState);
                var editorState = _addMaterialToAssetTree(/* tuple */[
                      material,
                      param$1[/* path */1],
                      /* LightMaterial */1
...
function _addScriptEventFunctionToAssetTree(path, param, engineState, editorState) {
  ...
  return ScriptEventFunctionNodeAssetEditorService$WonderEditor.addScriptEventFunctionNodeToAssetTree(match$1[1], ScriptEventFunctionNodeAssetService$WonderEditor.buildNode(match[1], param[1], param[0]), match$1[0]);
}
...
function buildScriptEventFunctionData(param, engineState, editorState) {
  return ArrayService$WonderCommonlib.reduceOneParami((function (param, param$1, scriptEventFunctionIndex) {
                ...
                var editorState = _addScriptEventFunctionToAssetTree(param$1[/* path */1], /* tuple */[
                      eventFunctionData,
                      name
                    ], engineState, param[1]);
                return /* tuple */[
...
function _addScriptAttributeToAssetTree(path, param, engineState, editorState) {
  var match = IdAssetEditorService$WonderEditor.generateNodeId(editorState);
  var match$1 = OperateTreeAssetLogicService$WonderEditor.addFolderNodesToTreeByPath(path, /* tuple */[
        match[0],
        engineState
      ]);
  return ScriptAttributeNodeAssetEditorService$WonderEditor.addScriptAttributeNodeToAssetTree(match$1[1], ScriptAttributeNodeAssetService$WonderEditor.buildNode(match[1], param[1], param[0]), match$1[0]);
}
...
function buildScriptAttributeData(param, engineState, editorState) {
  return ArrayService$WonderCommonlib.reduceOneParami((function (param, param$1, scriptAttributeIndex) {
                ...
                var editorState = _addScriptAttributeToAssetTree(param$1[/* path */1], /* tuple */[
                      attribute,
                      name
                    ], engineState, param[1]);
                return /* tuple */[
