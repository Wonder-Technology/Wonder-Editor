...
function _replaceGameObjectMaterialComponentToMaterialAsset(gameObject, param, isLightMaterialDataEqualFunc, engineState) {
  var match = RelateGameObjectAndAssetUtils$WonderEditor.getRelatedMaterialDataFromGameObject(gameObject, SparseMapService$WonderCommonlib.createEmpty(/* () */0), param[2], param[0], param[1], isLightMaterialDataEqualFunc, engineState);
