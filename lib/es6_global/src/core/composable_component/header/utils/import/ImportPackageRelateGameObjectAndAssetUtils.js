...
function _replaceWDBAssetGameObjectScriptComponentDataToScriptDataAsset(gameObject, param, engineState) {
  return RelateGameObjectAndScriptEventFunctionAssetUtils$WonderEditor.replaceToScriptEventFunctionAssetEventFunctionData(gameObject, param[0], engineState);
}
...
function _replaceSceneGameObjectScriptComponentDataToScriptDataAsset(gameObject, param, engineState) {
  return RelateGameObjectAndScriptEventFunctionAssetUtils$WonderEditor.replaceToScriptEventFunctionAssetEventFunctionData(gameObject, param[0], engineState);
}
...
function relateSceneWDBGameObjectsAndAssets(allWDBGameObjectsArr, imageUint8ArrayDataMap, param, wdbAssetGameObjectGeometryAssetArr, scriptDataMapTuple) {
  ...
  var engineState$1 = ArrayService$WonderCommonlib.reduceOneParam((function (engineState, gameObject) {
          return _replaceSceneGameObjectScriptComponentDataToScriptDataAsset(gameObject, scriptDataMapTuple, _replaceSceneGameObjectGeometryComponentToWDBAssetGeometryComponent(gameObject, /* tuple */[
                          defaultGeometryData,
...
function relateWDBAssetGameObjectsAndAssets(allWDBGameObjectsArr, param, param$1, imageUint8ArrayDataMap) {
  var scriptAttributeEntriesMap = param$1[1];
  var scriptEventFunctionEntriesMap = param$1[0];
  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
  var engineState = StateEngineService$WonderEditor.unsafeGetState(/* () */0);
  var basicMaterialDataMap = RelateGameObjectAndMaterialAssetUtils$WonderEditor.getBasicMaterialDataMap(param[0], engineState);
  var lightMaterialDataMap = RelateGameObjectAndMaterialAssetUtils$WonderEditor.getLightMaterialDataMap(param[1], /* tuple */[
  ...
  var defaultGeometryData = RelateGameObjectAndGeometryAssetUtils$WonderEditor.getDefaultGeometryData(editorState, engineState);
  var engineState$1 = ArrayService$WonderCommonlib.reduceOneParam((function (engineState, gameObject) {
          return _replaceWDBAssetGameObjectScriptComponentDataToScriptDataAsset(gameObject, /* tuple */[
                      scriptEventFunctionEntriesMap,
                      scriptAttributeEntriesMap
                    ], RelateGameObjectAndGeometryAssetUtils$WonderEditor.replaceWDBAssetGameObjectGeometryComponentToDefaultGeometryComponent(gameObject, defaultGeometryData, _replaceWDBAssetGameObjectMaterialComponentToMaterialAsset(gameObject, /* tuple */[
                              defaultMaterialData,
                              /* tuple */[
                                basicMaterialDataMap,
                                lightMaterialDataMap
