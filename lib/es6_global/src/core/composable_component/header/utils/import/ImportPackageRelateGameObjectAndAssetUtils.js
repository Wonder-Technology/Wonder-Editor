...
function _isImageUint8ArrayWhichHasLengthDataEqual(imageUint8ArrayWhichHasLengthData, uint8Array) {
  if (uint8Array !== undefined) {
    return Js_primitive.valFromOption(uint8Array).length === GenerateSceneGraphEngineService$WonderEditor.readUint32DataFromUint8Array(imageUint8ArrayWhichHasLengthData);
  } else {
    return true;
  }
}
...
function _isImageDataEqual(param, image2, texture2, imageUint8ArrayDataMap) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("gameObject->image to be nullable", "not"), (function () {
