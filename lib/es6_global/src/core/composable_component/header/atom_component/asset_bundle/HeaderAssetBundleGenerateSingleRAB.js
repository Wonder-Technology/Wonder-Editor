...
function _addResourceData(resources, value, convertValueToResourceDataFunc) {
  return ArrayService$WonderEditor.push(Curry._1(convertValueToResourceDataFunc, value), resources);
}
...
var Method = /* module */[
  ...
  /* _addResourceData */_addResourceData,
