...
function generateAllABZip(selectTreeForGenerateAllAB, param, createZipFunc, param$1) {
  var dependencyRelationInputValueStr = param[1];
  var zipBaseName = param[0];
              ...
              className: "wonder-generateAllAB-modal"
                  ...
                  className: "modal-item"
                      ...
                      className: "modal-item-footer"
                          ...
                          onClick: (function (_e) {
                              var partial_arg_000 = state[/* nameInputValue */1];
                              var partial_arg_001 = state[/* dependencyRelationInputValue */2];
                              var partial_arg = /* tuple */[
                                partial_arg_000,
                                partial_arg_001
                              ];
                              var partial_arg$1 = state[/* selectTreeForGenerateAllAB */0];
                              StateLogicService$WonderEditor.getStateToGetData((function (param) {
                                          return generateAllABZip(partial_arg$1, partial_arg, Zip$WonderBsJszip.create, param);
