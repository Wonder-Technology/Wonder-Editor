...
function buildFileComponentSelectNav(send, uiState, dispatchFunc) {
  ...
  return React.createElement("div", {
              className: "header-item"
                  ...
                  className: "component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("File"))), isFileNav ? buildFileComponentSelectNav(send, param$1[0], param$1[1]) : null, match ? ReasonReact.element(undefined, undefined, Modal$WonderEditor.make("Controls", buildControlModalContent(/* () */0), (function (param) {
