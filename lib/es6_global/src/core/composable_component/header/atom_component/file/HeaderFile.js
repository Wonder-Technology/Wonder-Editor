...
import * as HeaderFileNewSceneUtils$WonderEditor from "./utils/HeaderFileNewSceneUtils.js";
              ...
              className: "item-content"
                  ...
                  onClick: (function (_e) {
                      return StateLogicService$WonderEditor.getAndSetState((function (param) {
                                    return HeaderFileNewSceneUtils$WonderEditor.handleNewScene(dispatchFunc, param);
                                  }));
                    })
                }, React.createElement("span", {
                      className: "section-header"
                    }, DomHelper$WonderEditor.textEl(LanguageUtils$WonderEditor.getHeaderLanguageDataByType("file-new-scene", languageType)))), React.createElement("div", {
                  className: "content-section",
                  onClick: (function (_e) {
