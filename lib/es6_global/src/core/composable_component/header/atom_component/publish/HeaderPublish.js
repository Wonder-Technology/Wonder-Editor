...
function buildPublishComponentSelectNav(send) {
  ...
  return React.createElement("div", {
              className: "header-item"
                  ...
                  className: "component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("Publish"))), isPublishNav ? buildPublishComponentSelectNav(send) : null, match ? ReasonReact.element(undefined, undefined, PublishLocalModal$WonderEditor.make((function (param) {
