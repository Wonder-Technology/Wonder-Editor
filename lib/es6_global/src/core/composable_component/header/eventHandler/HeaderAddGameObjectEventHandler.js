...
function handleSelfLogic(param, type_, _) {
  ...
  if (type_) {
    ...
    var runCubeGeometry = SparseMapService$WonderCommonlib.unsafeGet(param$1[/* cubeGeometryAssetId */0], AssetGeometryNodeMapEditorService$WonderEditor.getGeometryNodeMap(editorState));
