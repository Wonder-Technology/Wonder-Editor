...
function _buildFileComponentSelectNav(_, uiState, dispatchFunc) {
  ...
  return React.createElement("div", {
              className: "header-item"
                  ...
                  className: "component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("File"))), match$1 ? _buildFileComponentSelectNav(send, uiState, dispatchFunc) : null);
}
