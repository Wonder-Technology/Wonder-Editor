                  ...
                  className: "component-item"
                    ...
                    className: "item-content"
                        ...
                        onClick: (function () {
                            ...
                            className: "section-header"
                          }, DomHelper$WonderEditor.textEl("Redo")))) : null);
}
                  ...
                  className: "component-item"
                    ...
                    className: "item-content item-edit"
                        ...
                        onClick: (function () {
                            ...
                            className: "section-header"
                          }, DomHelper$WonderEditor.textEl("Export Scene")))) : null, match$2 ? ReasonReact.element(undefined, undefined, SingleInputModal$WonderEditor.make((function () {
  ...
  return React.createElement("div", {
              className: "header-item"
                  ...
                  className: "component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("Publish"))), match$1 ? React.createElement("div", {
                    className: "item-content"
                  }, React.createElement("div", {
                        className: "content-section",
                        onClick: (function () {
                            ...
                            className: "section-header"
                          }, DomHelper$WonderEditor.textEl("Local")))) : null, match$2 ? ReasonReact.element(undefined, undefined, PublishLocalModal$WonderEditor.make((function () {
                          return Curry._1(send, /* HidePublishLocalModal */6);
                        }), "Local", (function (zipName, useWorker) {
                          HeaderPublishLocalUtils$WonderEditor.Publish[/* publishZip */0](/* tuple */[
                                zipName,
                                useWorker
  ...
  return React.createElement("div", {
              className: "header-item"
                  ...
                  className: "component-item"
                    ...
                    }, DomHelper$WonderEditor.textEl("Help"))), match$1 ? React.createElement("div", {
                    className: "item-content item-help"
                        ...
                        onClick: (function () {
                            ...
                            className: "section-header"
                          }, DomHelper$WonderEditor.textEl("Version")))) : null, match$2 ? ReasonReact.element(undefined, undefined, Modal$WonderEditor.make((function () {
