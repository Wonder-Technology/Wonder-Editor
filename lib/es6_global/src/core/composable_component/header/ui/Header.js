...
var component = ReasonReact.reducerComponentWithRetainedProps("Header");
...
function render(store, dispatchFunc, param) {
  Log$WonderLog.print("header update");
...
function shouldUpdate(param) {
  return StoreUtils$WonderEditor.shouldComponentUpdate(/* Header */1, param[/* newSelf */1][/* retainedProps */2][/* updateTypeArr */0]);
}
