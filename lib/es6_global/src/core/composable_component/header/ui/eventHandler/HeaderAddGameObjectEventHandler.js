...
import * as SceneTreeUIUtils$WonderEditor from "../../../mainEditor/composable_component/sceneTree/utils/SceneTreeUIUtils.js";
...
function onClick(param, type_, _) {
  ...
  var partial_arg = SceneTreeUIUtils$WonderEditor.unsafeGetSceneGraphDataFromStore(param[0]);
  Curry._1(param[1], [
