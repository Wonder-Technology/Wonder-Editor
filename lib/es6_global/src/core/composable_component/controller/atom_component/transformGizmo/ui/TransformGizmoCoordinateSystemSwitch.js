...
function reducer(action, _) {
  ...
  return ReasonReactUtils$WonderEditor.updateWithSideEffects(/* record */[/* selectedCoordinateSystem */coordinateSystem], (function () {
...
function make(defaultCoordinateSystem, isDisable, onChange, _) {
  return /* record */[
