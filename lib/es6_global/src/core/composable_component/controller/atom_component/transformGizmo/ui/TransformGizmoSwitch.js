...
function _getTitle(type_, languageType) {
  switch (type_) {
    case 0 : 
        return LanguageUtils$WonderEditor.getControllerLanguageDataByType("translation-gizmo-describe", languageType);
    case 1 : 
        return LanguageUtils$WonderEditor.getControllerLanguageDataByType("rotation-gizmo-describe", languageType);
    case 2 : 
        return LanguageUtils$WonderEditor.getControllerLanguageDataByType("scale-gizmo-describe", languageType);
    
  }
}

function renderContent(param, languageType, data) {
  var send = param[1];
  var state = param[0];
