...
function changeLanguage(languageType) {
  if (languageType) {
    LocalStorage$WonderEditor.setValue("language", "ZH");
    return DomHelper$WonderEditor.locationReload();
  } else {
    LocalStorage$WonderEditor.setValue("language", "EN");
    return DomHelper$WonderEditor.locationReload();
  }
}
...
function buildAmbientLightComponent(uiState, dispatchFunc, languageType) {
  return React.createElement("div", {
              className: "header-item"
            }, React.createElement("div", {
                  className: "component-item"
                }, ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, PickColorComponent$WonderEditor.make(LanguageUtils$WonderEditor.getControllerLanguageDataByType("controller-ambient", languageType), LanguageUtils$WonderEditor.getControllerLanguageDataByType("ambient-describe", languageType), getColor, changeColor, Curry._2(closeColorPick, /* tuple */[
                              uiState,
                              dispatchFunc
                            ], /* () */0), /* array */[]))));
}
...
function buildTransformComponent(uiState, dispatchFunc, languageType) {
  return React.createElement("div", {
              className: "header-item"
            }, React.createElement("div", {
                  className: "component-item"
...
function renderRunAndStop(uiState, dispatchFunc, languageType) {
  var match = StateEditorService$WonderEditor.getIsRun(/* () */0);
  return React.createElement("div", {
              className: "controller-runAndStop",
              title: LanguageUtils$WonderEditor.getControllerLanguageDataByType("run-describe", languageType),
              onClick: (function (_e) {
                  var match = StateEditorService$WonderEditor.getIsRun(/* () */0);
                  if (match) {
  ...
  return React.createElement("article", {
              ...
              className: "wonder-controller-component"
                  ...
                  className: "header-controller"
                    ...
                    }, buildAmbientLightComponent(uiState, dispatchFunc, languageType)), React.createElement("div", {
                      className: "controller-transform"
                    }, buildTransformComponent(uiState, dispatchFunc, languageType)), renderRunAndStop(uiState, dispatchFunc, languageType), React.createElement("div", {
                      className: "controller-other"
                    }, React.createElement("div", {
                          className: "other-language",
                          onClick: (function (_e) {
                              return changeLanguage(languageType);
                            })
                        }, languageType ? DomHelper$WonderEditor.textEl("中文") : DomHelper$WonderEditor.textEl("English")))));
}
