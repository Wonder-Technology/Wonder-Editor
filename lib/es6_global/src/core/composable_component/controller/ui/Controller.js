...
function _handleChangeCurrentTransformGizmoType(dispatchFunc, type_) {
...
function _getCurrentTransformGizmoType() {
...
function _getCurrentTransformGizmoCoordinateSystem() {
...
function _isTransformGizmoCoordinateSystemSwitchDisable() {
...
function buildTransformComponent(_, dispatchFunc) {
  return React.createElement("div", {
              className: "header-item"
            }, React.createElement("div", {
                  className: "component-item"
                          ...
                          /* record */[
                            ...
                            /* onChangeFunc */(function (param) {
                                return _handleChangeCurrentTransformGizmoType(dispatchFunc, param);
                              })
                          ],
                          /* record */[
                            /* type_ : Rotation */1,
...
var Method = /* module */[
  ...
  /* _handleChangeCurrentTransformGizmoType */_handleChangeCurrentTransformGizmoType,
  ...
  return React.createElement("article", {
              ...
              className: "wonder-controller-component"
                  ...
                  className: "header-controller"
                    ...
                    }, buildTransformComponent(uiState, dispatchFunc)), React.createElement("div", {
