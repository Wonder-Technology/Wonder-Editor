...
function buildAmbientLightComponent(uiState, dispatchFunc) {
  return React.createElement("div", {
              className: "header-item"
                ...
                }, ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, PickColorComponent$WonderEditor.make("Ambient Color : ", "ambient color", getColor, changeColor, Curry._2(closeColorPick, /* tuple */[
                              uiState,
                              dispatchFunc
                            ], /* () */0), /* array */[]))));
}
