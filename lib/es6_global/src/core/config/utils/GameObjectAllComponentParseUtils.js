...
function convertDataToRecordTest(jsonData) {
  return Json_decode$WonderBsJson.array((function (json) {
                return /* record */[
                        /* type_ */Json_decode$WonderBsJson.field("type", Json_decode$WonderBsJson.string, json),
...
function getGameObjectAllComponentConfigTest() {
  return convertDataToRecordTest(GameObject_all_component$WonderEditor.gameObject_all_component_test);
}
...
export {
  ...
  getGameObjectAllComponentConfigTest ,
