...
var inspector_language_array = /* array */[
  /* record */[
    /* title */"name-describe",
    /* language : record */[
      /* zh */"GameObject的名字",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"Render Group，决定GameObject是否以及怎样被渲染",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"使用的material，来自默认的material和material资产",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"使用的geometry，来自默认的geometry和模型的geometry",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"Camera Group，设置GameObject的相机组件",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"设置为当前使用的相机。场景中只能有一个使用的相机。设置后，会取消其它使用的相机。",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"相机到目标的最小距离。如果距离小于该值，距离会被自动设置为该值。",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"定义当一个纹理单元（texel）覆盖多个像素点时纹理如何��样",
  ...
  /* record */[
    ...
    /* language : record */[
      /* zh */"定义当一个纹理单元（texel）不足以覆盖单个像素点时纹理如何采样",
