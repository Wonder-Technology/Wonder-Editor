...
function stop(dispatchFunc, _) {
  ...
  return ControllerHistoryUtils$WonderEditor.restoreHistoryStack(dispatchFunc, StateLogicService$WonderEditor.getEditEngineState(/* () */0), StateLogicService$WonderEditor.getRunEngineState(/* () */0), AllStateData$WonderEditor.getHistoryState(/* () */0));
}
