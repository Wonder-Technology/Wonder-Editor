...
function runForTest(store) {
  EngineStateDataEditorService$WonderEditor.setIsRun(/* true */1);
  return ControllerHistoryUtils$WonderEditor.copyHistoryStack(store, StateLogicService$WonderEditor.getStateForHistory(/* () */0), AllStateData$WonderEditor.getHistoryState(/* () */0));
}
