...
function handleSelfLogic(param, _, param$1) {
  ...
  var editorState$1 = SceneTreeEditorService$WonderEditor.setIsShowChildren(targetGameObjectUid, true, editorState);
  var match = DragWDBUtils$WonderEditor.dragWDB(param$1[1], targetGameObjectUid, param$1[2], /* tuple */[
        editorState$1,
        engineState
      ]);
  var match$1 = match[1];
