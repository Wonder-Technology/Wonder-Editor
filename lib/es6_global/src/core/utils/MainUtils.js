...
function init(editorState) {
  return Most.forEach((function () {
                ...
                var scene = match[1];
                StateLogicService$WonderEditor.setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, DirectorEngineService$WonderEditor.init(DefaultSceneUtils$WonderEditor.createDefaultSceneForEdit(scene, DefaultSceneUtils$WonderEditor.computeDiffValue(editorState, DefaultSceneUtils$WonderEditor.prepareSpecificGameObjectsForEditEngineState(scene, match[0]))))));
                var editorState$1 = StateEditorService$WonderEditor.getState(/* () */0);
                var engineState$1 = StateLogicService$WonderEditor.getRunEngineState(/* () */0);
                var match$1 = GameObjectEngineService$WonderEditor.create(engineState$1);
                var scene$1 = match$1[1];
                StateLogicService$WonderEditor.setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, DirectorEngineService$WonderEditor.init(DefaultSceneUtils$WonderEditor.createDefaultSceneForRun(scene$1, match$1[0]))));
