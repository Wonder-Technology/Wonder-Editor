  ...
  switch (type_) {
    case "edit" : 
        return AssetEngineService$WonderEditor.loadToData(/* array */[
                    "./src/service/state/data/engine/editSetting.json",
                    engineDataDir
...
function init(editorState) {
  return Most.drain(Most.map((function (editEngineState) {
                        ...
                        StateLogicService$WonderEditor.setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, DirectorEngineService$WonderEditor.init(GameObjectUtils$WonderEditor.setParentKeepOrder(match$3[1], match$1[1], match$3[0]))));
                        ...
                        return /* () */0;
                          ...
                          StateLogicService$WonderEditor.setRunEngineState(DirectorEngineService$WonderEditor.loopBody(0, DirectorEngineService$WonderEditor.init(match$1[0])));
