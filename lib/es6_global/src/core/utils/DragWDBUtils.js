...
function dragWDB(wdbGameObjectUid, targetGameObjectUid, dragPosition, param) {
  var editorState = param[0];
  ...
  if (match[1]) {
    var match$1 = GameObjectEngineService$WonderEditor.cloneGameObject(wdbGameObjectUid, 1, true, engineState);
    ...
    console.log(clonedWDBGameObject);
    var engineState$2;
    switch (dragPosition) {
      case 0 : 
          throw [
      ...
      case 1 : 
          engineState$2 = GameObjectEngineService$WonderEditor.changeGameObjectChildOrder(wdbGameObjectUid, targetGameObjectUid, /* Before */0, GameObjectUtils$WonderEditor.addChild(OptionService$WonderEditor.unsafeGet(GameObjectUtils$WonderEditor.getParent(targetGameObjectUid, engineState$1)), clonedWDBGameObject, engineState$1));
          break;
      case 2 : 
          engineState$2 = GameObjectUtils$WonderEditor.addChild(targetGameObjectUid, clonedWDBGameObject, engineState$1);
          break;
      case 3 : 
          engineState$2 = GameObjectEngineService$WonderEditor.changeGameObjectChildOrder(wdbGameObjectUid, targetGameObjectUid, /* After */1, GameObjectUtils$WonderEditor.addChild(OptionService$WonderEditor.unsafeGet(GameObjectUtils$WonderEditor.getParent(targetGameObjectUid, engineState$1)), clonedWDBGameObject, engineState$1));
          break;
