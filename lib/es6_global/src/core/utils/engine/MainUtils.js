...
function _handleEngineState(engineState) {
  var engineState$1 = JobEngineService$WonderEditor.registerNoWorkerLoopJob("restore", RestoreJobUtils$WonderEditor.restoreJob, JobEngineService$WonderEditor.registerNoWorkerLoopJob("prepare_render_game_view", PrepareRenderViewJobUtils$WonderEditor.prepareRenderGameViewJob, JobEngineService$WonderEditor.registerNoWorkerLoopJob("prepare_render_scene_view", PrepareRenderViewJobUtils$WonderEditor.prepareRenderSceneViewJob, JobEngineService$WonderEditor.registerNoWorkerLoopJob("reallocate_cpu_memory", ReallocateCPUMemoryJobUtils$WonderEditor.reallocateJob, JobEngineService$WonderEditor.registerNoWorkerInitJob("init_event_for_editor", InitEventJobUtils$WonderEditor.initEventForEditorJob, JobEngineService$WonderEditor.registerNoWorkerInitJob("init_editor", InitEditorJobUtils$WonderEditor.initEditorJob, engineState))))));
...
function _hideLoading (loadingDomId){
