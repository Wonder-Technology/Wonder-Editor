...
function _setEditCameraIsActive(editCamera, editEngineState) {
  return BasicCameraViewEngineService$WonderEditor.activeBasicCameraView(GameObjectComponentEngineService$WonderEditor.getBasicCameraViewComponent(editCamera, editEngineState), editEngineState);
}
...
function init(editorState) {
  return Most.drain(Most.map((function (editEngineState) {
                        ...
                        StateLogicService$WonderEditor.setEditEngineState(DirectorEngineService$WonderEditor.loopBody(0, DirectorEngineService$WonderEditor.init(GameObjectEngineService$WonderEditor.setGameObjectName("scene", scene, SetIMGUIFuncUtils$WonderEditor.setIMGUIFunc(_setEditEnginestateUnsafeGetStateFuncAndSetStateFuncForEvent(_setEditCameraIsActive(match[1], match$1[1])))))));
