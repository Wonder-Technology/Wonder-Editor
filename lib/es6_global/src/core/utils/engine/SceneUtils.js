...
function addGameObjectToScene(gameObject, engineState) {
  return DirectorEngineService$WonderEditor.loopBody(0, SceneEngineService$WonderEditor.addSceneChild(gameObject, GameObjectEngineService$WonderEditor.initGameObject(gameObject, engineState)));
}
...
function addGameObject(createGameObjectFunc) {
  ...
  var engineState = addGameObjectToScene(gameObject, match[1]);
