...
function _bindDomEventToTriggerPointEvent(param, param$1, engineState) {
  ...
  return Curry._4(param$1[0], param[0], (function (mouseEvent, engineState) {
                ...
                if (match) {
                  ...
                  var match$1 = ManageEventEngineService$WonderEditor.triggerCustomGlobalEvent(CreateCustomEventEngineService$WonderEditor.create(customEventName, Js_primitive.some(Curry._2(convertDomEventToPointEventFunc, pointEventName, mouseEvent))), engineState$1);
