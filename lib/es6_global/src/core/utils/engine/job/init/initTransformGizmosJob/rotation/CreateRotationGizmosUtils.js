...
function _createCircleGeometry(engineState) {
  ...
  var _generate = function (_param, _param$1, _i) {
    while(true) {
      var param = _param$1;
      var param$1 = _param;
      var i = _i;
  ...
  var engineState$1 = GeometryEngineService$WonderEditor.setGeometryIndices16(geometry, new Uint16Array(match[1]), GeometryEngineService$WonderEditor.setGeometryVertices(geometry, new Float32Array(match[0]), match$1[0]));
  return /* tuple */[
          engineState$1,
          geometry
        ];
