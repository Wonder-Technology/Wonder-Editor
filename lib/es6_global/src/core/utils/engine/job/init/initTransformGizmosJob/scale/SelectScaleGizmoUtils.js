...
function _isSelectScaleCenterBoxGizmo(scaleCenterBoxGizmo, ray, engineState, editorState) {
...
function _handleSelectCenterBoxGizmo(param, handleSelectAxisGizmoFunc, param$1) {
  ...
  if (match) {
    ...
    return _selectCenterBoxGizmo(param[0], (function (param, param$1) {
                  return CurrentTransformGizmosUtils$WonderEditor.setCurrentGizmoColor(partial_arg, param, param$1);
                }), /* tuple */[
                editorState,
                engineState
...
function selectScaleGizmo($$event, engineState, editorState) {
  ...
  return _handleSelectCenterBoxGizmo(/* tuple */[
              $$event,
              ray
            ], _handleSelectAxisGizmo, /* tuple */[
              editorState,
              engineState
            ]);
}
