...
function moveTranslationPlaneGizmo(editorState, engineState) {
  ...
  var planeLocalPositionData = _isInPXPYPZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
      /* tuple */[
        1,
        1,
        0
      ...
      _isInNXPYPZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
          /* tuple */[
            -1,
            1,
            0
          ...
          _isInPXNYPZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
              /* tuple */[
                1,
                -1,
                0
              ...
              _isInPXPYNZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
                  /* tuple */[
                    1,
                    1,
                    0
                  ...
                  _isInNXNYPZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
                      /* tuple */[
                        -1,
                        -1,
                        0
                      ...
                      _isInNXPYNZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
                          /* tuple */[
                            -1,
                            1,
                            0
                          ...
                          _isInPXNYNZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
                              /* tuple */[
                                1,
                                -1,
                                0
                              ...
                              _isInNXNYNZ(cameraPosInWholeGizmoLocalCoordSystem) ? /* tuple */[
                                  /* tuple */[
                                    -1,
                                    -1,
                                    0
                                ...
                                ] : (Log$WonderLog.error(Log$WonderLog.buildErrorMessage("moveTranslationPlaneGizmo", "cameraPosInWholeGizmoLocalCoordSystem: " + (String(cameraPosInWholeGizmoLocalCoordSystem) + " is error"), "", "", "")), /* tuple */[
                                    /* tuple */[
                                      0,
                                      0,
                                      0
  ...
  return _updatePlaneGizmoLocalPosition(planeLocalPositionData, editorState, engineState);
}
