...
function calcMaxDistanceOfPointsToCenter(center, vertices) {
...
function setFromPoints(vertices) {
  ...
  return /* record */[
          /* radius */Math.sqrt(calcMaxDistanceOfPointsToCenter(center, vertices)),
          /* center */center
        ];
}
...
export {
  _forEachVertices ,
  calcMaxDistanceOfPointsToCenter ,
  setFromPoints ,
  applyMatrix4 ,
