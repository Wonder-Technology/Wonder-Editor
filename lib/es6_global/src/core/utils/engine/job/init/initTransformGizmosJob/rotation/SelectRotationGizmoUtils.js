...
function _isIntersectWithCircle(intersectPoint, editorState, engineState) {
...
function _isSelectCircle(intersectXYPlanePoint, editorState, engineState) {
  if (intersectXYPlanePoint !== undefined) {
    ...
    if (match) {
      ...
      return _isIntersectWithCircle(intersectPoint, editorState, engineState);
    }
  } else {
    return false;
  }
...
function selectRotationGizmo($$event, editorState, engineState) {
  ...
  var intersectXYPlanePoint = RayIntersectUtils$WonderEditor.checkIntersectPlane(CircleRotationGizmosUtils$WonderEditor.buildXYPlane(editorState, engineState), ray);
  ...
  if (match) {
    ...
    var intersectXZPlanePoint = RayIntersectUtils$WonderEditor.checkIntersectPlane(CircleRotationGizmosUtils$WonderEditor.buildXZPlane(editorState, engineState), ray);
    ...
    if (match$1) {
      ...
      var intersectYZPlanePoint = RayIntersectUtils$WonderEditor.checkIntersectPlane(CircleRotationGizmosUtils$WonderEditor.buildYZPlane(editorState, engineState), ray);
