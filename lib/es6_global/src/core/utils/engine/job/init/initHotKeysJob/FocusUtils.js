...
function setEditorCameraFocusTargetGameObject(editCamera, targetGameObject, _, engineState) {
  Contract$WonderLog.requireCheck((function () {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("the editor camera should has arcballCameraController component", "not"), (function () {
