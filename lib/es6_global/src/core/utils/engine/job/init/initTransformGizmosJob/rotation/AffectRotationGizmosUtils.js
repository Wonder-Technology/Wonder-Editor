...
function _affectGizmo(ray, param, computeTotalAngleFunc, editorState, engineState) {
  var match = RayUtils$WonderEditor.checkIntersectPlane(param[0], ray);
  var match$1;
  if (match !== undefined) {
...
function affectRotationGizmo($$event, param) {
  ...
  if (match) {
    return _affectGizmo(ray, /* tuple */[
              ...
              ], _computeXYPlaneTotalAngle, editorState, engineState);
  } else {
    ...
    if (match$1) {
      return _affectGizmo(ray, /* tuple */[
                ...
                ], _computeXZPlaneTotalAngle, editorState, engineState);
    } else {
      ...
      if (match$2) {
        return _affectGizmo(ray, /* tuple */[
                  ...
                  ], _computeYZPlaneTotalAngle, editorState, engineState);
      } else {
        return /* tuple */[
                editorState,
                engineState
