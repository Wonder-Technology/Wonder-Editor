...
function _getReplacedZeroFactor(param) {
  return 0.001;
}
...
function _avoidVectorFactorZero(scale) {
  ...
  Contract$WonderLog.requireCheck((function (param) {
          return Contract$WonderLog.test(Log$WonderLog.buildAssertMessage("scaleX,scaleY,scaleZ should be nearly zero together", "not"), (function (param) {
