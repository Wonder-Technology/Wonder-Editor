...
function _convertPosition(param, param$1, editCamera, engineState) {
  var match = CoordinateEngineService$WonderEditor.convertWorldToScreen(GameObjectComponentEngineService$WonderEditor.unsafeGetBasicCameraViewComponent(editCamera, engineState), GameObjectComponentEngineService$WonderEditor.unsafeGetPerspectiveCameraProjectionComponent(editCamera, engineState), /* tuple */[
        param[0],
        param[1],
        param[2],
        param[3],
