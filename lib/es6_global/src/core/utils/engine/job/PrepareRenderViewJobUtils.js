...
function prepareRenderSceneViewJob(param, engineState) {
  var editorState = StateEditorService$WonderEditor.getState(/* () */0);
...
function prepareRenderGameViewJob(param, engineState) {
  ...
  var param$1 = _markIsRenderSceneViewGameObjects(false, editorState, _prepareRenderViewJob(OptionService$WonderEditor.unsafeGet(gameViewRect), _activeGameViewCamera, engineState));
