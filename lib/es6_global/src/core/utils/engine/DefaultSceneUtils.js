...
function prepareSpecificGameObjectsForEditEngineState(scene, engineStateForEdit) {
  ...
  var engineState$1 = SceneEngineService$WonderEditor.setCurrentCameraGameObject(camera, GameObjectUtils$WonderEditor.addChild(scene, box, GameObjectUtils$WonderEditor.addChild(scene, camera, LightMaterialEngineService$WonderEditor.setLightMaterialDiffuseColor(/* array */[
                    1,
                    0.1,
                    0.1
...
function computeDiffValue(editorState, engineState) {
  var diffMap = HashMapService$WonderCommonlib.set("texture", 0, HashMapService$WonderCommonlib.set("directionLight", 0, HashMapService$WonderCommonlib.set("lightMaterial", 1, HashMapService$WonderCommonlib.set("basicMaterial", 0, HashMapService$WonderCommonlib.set("meshRenderer", 2, HashMapService$WonderCommonlib.set("transform", 2, HashMapService$WonderCommonlib.set("gameObject", 2, HashMapService$WonderCommonlib.createEmpty(/* () */0))))))));
  return /* tuple */[
