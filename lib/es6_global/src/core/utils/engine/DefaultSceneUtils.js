...
function prepareDefaultComponent(editorState, engineState) {
  var match = PrepareDefaultComponentUtils$WonderEditor.buildDefaultCubeGeometryComponent(editorState, engineState);
  var match$1 = PrepareDefaultComponentUtils$WonderEditor.buildDefaultSphereGeometryComponent(match[0], match[1]);
  var match$2 = PrepareDefaultComponentUtils$WonderEditor.buildDefaultMaterialComponents(match$1[0], match$1[1]);
  return /* tuple */[
          match$2[0],
          match$2[1],
          match[2]
...
function createDefaultScene(cubeGeometry, editorState, engineState) {
  ...
  var match = SceneEngineService$WonderEditor.createDefaultSceneGameObjects(/* tuple */[
        cubeGeometry,
