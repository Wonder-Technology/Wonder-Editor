...
function prepareDefaultComponentForEditEngineState(engineState) {
  var match = PrepareDefaultComponentUtils$WonderEditor.buildCubeGeometryDefaultComponent(engineState);
  var match$1 = PrepareDefaultComponentUtils$WonderEditor.buildSphereGeometryDefaultComponent(match[0]);
  return /* tuple */[
          match$1[0],
          match[1]
        ];
...
function prepareDefaultComponentForRunEngineState(editorState, engineState) {
  var match = PrepareDefaultComponentUtils$WonderEditor.buildCubeGeometryDefaultComponentForRunEngineState(editorState, engineState);
  var match$1 = PrepareDefaultComponentUtils$WonderEditor.buildSphereGeometryDefaultComponentForRunEngineState(match[0], match[1]);
  return /* tuple */[
          match$1[0],
          match$1[1],
          match[2]
...
function prepareSpecificGameObjectsForEditEngineState(editEngineState) {
...
function computeDiffValue(editorState) {
  var diffMap = HashMapService$WonderCommonlib.set("texture", 0, HashMapService$WonderCommonlib.set("arcballCameraController", 1, HashMapService$WonderCommonlib.set("perspectiveCamera", 1, HashMapService$WonderCommonlib.set("basicCameraView", 1, HashMapService$WonderCommonlib.set("pointLight", 0, HashMapService$WonderCommonlib.set("directionLight", 0, HashMapService$WonderCommonlib.set("lightMaterial", 0, HashMapService$WonderCommonlib.set("basicMaterial", 1, HashMapService$WonderCommonlib.set("meshRenderer", 1, HashMapService$WonderCommonlib.set("geometry", 1, HashMapService$WonderCommonlib.set("transform", 2, HashMapService$WonderCommonlib.set("gameObject", 2, HashMapService$WonderCommonlib.createEmpty(/* () */0)))))))))))));
  return SceneEditorService$WonderEditor.setDiffMap(diffMap, editorState);
}
...
function createDefaultSceneForEditEngineState(cubeGeometry, engineState) {
  var match = SceneEngineService$WonderEditor.createDefaultSceneGameObjectsForEditEngineState(cubeGeometry, engineState);
...
function createDefaultSceneForRunEngineState(cubeGeometry, editorState, engineState) {
  var match = SceneEngineService$WonderEditor.createDefaultSceneGameObjectsForRunEngineState(cubeGeometry, editorState, engineState);
  return /* tuple */[
          match[0],
...
export {
  prepareDefaultComponentForEditEngineState ,
  prepareDefaultComponentForRunEngineState ,
