...
function prepareSpecificGameObjectsForEditEngineState(engineStateForEdit) {
  ...
  var engineState$1 = SceneEngineService$WonderEditor.setCurrentCameraGameObject(camera, SceneEngineService$WonderEditor.addSceneChild(box, SceneEngineService$WonderEditor.addSceneChild(camera, GameObjectComponentEngineService$WonderEditor.addArcballCameraControllerComponent(camera, match$2[1], LightMaterialEngineService$WonderEditor.setLightMaterialDiffuseColor(/* array */[
                        1,
                        0.1,
                        0.1
