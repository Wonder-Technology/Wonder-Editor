...
function _prepareEngineState(camera, directionLight, box1, box2, engineState) {
  return SceneEngineService$WonderEditor.addSceneChild(directionLight, SceneEngineService$WonderEditor.addSceneChild(box2, SceneEngineService$WonderEditor.addSceneChild(box1, SceneEngineService$WonderEditor.addSceneChild(camera, TransformEngineService$WonderEditor.setTransformLocalEulerAngles(/* tuple */[
                              45,
                              0,
                              0
...
function createDefaultSceneForEditEngineState(engineState) {
  ...
  return _prepareEngineState(match[1], match[4], match[2], match[3], match[0]);
}
...
function createDefaultSceneForRunEngineState(editorState, engineState) {
  ...
  return /* tuple */[
          match[0],
          _prepareEngineState(match[2], match[5], match[3], match[4], match[1])
        ];
}
