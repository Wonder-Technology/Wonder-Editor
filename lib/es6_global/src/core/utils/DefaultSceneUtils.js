...
function prepareSpecificGameObjectsForEditEngineState(scene, engineStateForEdit) {
  ...
  var engineState$1 = SceneEngineService$WonderEditor.setCurrentCameraGameObject(camera, GameObjectUtils$WonderEditor.addChild(scene, box, GameObjectUtils$WonderEditor.addChild(scene, camera, BasicMaterialEngineService$WonderEditor.setColor(/* float array */[
                    1,
                    0.1,
                    0.1
...
function createDefaultSceneForEdit(scene, box, engineState) {
  ...
  return GameObjectUtils$WonderEditor.addChild(scene, match[3], GameObjectUtils$WonderEditor.addChild(scene, match[2], GameObjectUtils$WonderEditor.addChild(scene, camera, TransformEngineService$WonderEditor.setLocalPosition(/* tuple */[
                          ...
                          0,
                          40
                        ], GameObjectComponentEngineService$WonderEditor.getTransformComponent(camera, engineState$1), GameObjectUtils$WonderEditor.setParentKeepOrder(camera, box, engineState$1)))));
}
