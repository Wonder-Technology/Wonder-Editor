  ...
  return (function (component, _) {
      return /* record */[
              ...
              /* render */(function (param) {
                  ...
                  if (match !== undefined) {
                    return ReasonReact.element(undefined, undefined, Curry._3(component, Js_primitive.valFromOption(match), (function (param) {
              ...
              /* initialState */(function () {
                  return /* record */[
                          /* reductiveState */Js_primitive.some(store[/* state */0]),
