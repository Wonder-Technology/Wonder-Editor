...
function buildOperateHistoryComponent(store, dispatch) {
  return React.createElement("div", undefined, React.createElement("div", {
                  className: "component-item"
                      ...
                      onClick: (function () {
                          return StateLogicService$WonderEditor.getAndSetState((function (param) {
                                        return HistoryLogicService$WonderEditor.undoHistoryState(store, dispatch, param);
                                      }));
                        })
                  ...
                  className: "component-item"
                      ...
                      onClick: (function () {
                          return StateLogicService$WonderEditor.getAndSetState((function (param) {
                                        return HistoryLogicService$WonderEditor.redoHistoryState(store, dispatch, param);
                                      }));
                        })
