...
import * as CurrentGameObjectLogicService$WonderEditor  from "../../../../../service/stateTuple/CurrentGameObjectLogicService.js";
...
function onClick(param, _, _$1) {
  ...
  Curry._1(param[1], [
        ...
        /* SetSceneGraph */[/* Some */[StateLogicService$WonderEditor.getState(MainEditorSceneTreeView$WonderEditor.getSceneGraphDataFromEngine)]]
      ]);
  return /* () */0;
}
