...
import * as MainEditorSceneTreeStore$WonderEditor from "../../composable_component/mainEditor/composable_component/left_components/composable_component/sceneTree/ui/store/MainEditorSceneTreeStore.js";
...
var state_004 = /* updateState : record */[/* componentTypeArr : array */[/* All */1]];

var state_005 = /* inspectorState : record */[/* showComponentMap */SparseMapService$WonderCommonlib.createEmpty(/* () */0)];

var state_006 = /* showComponentState : record */[/* currentComponentType : Project */0];
...
function appReducter(state, action) {
  if (action === IsDidMounted) {
    return /* record */[
            ...
            /* showComponentState */state[/* showComponentState */6]
          ];
    ...
    return /* record */[
            ...
            /* updateState */state[/* updateState */4],
            /* inspectorState */state[/* inspectorState */5],
            /* showComponentState */BottomShowComponentStore$WonderEditor.showComponentReducer(state[/* showComponentState */6], action[1])
          ];
