...
import * as OperateHistoryLogicService$WonderEditor from "../../../service/stateTuple/OperateHistoryLogicService.js";

function undo(historyState, currentState) {
  return OperateHistoryLogicService$WonderEditor.operateHistory(currentState, historyState[/* uiUndoStack */2], (function () {
                return /* record */[
...
function redo(historyState, currentState) {
  return OperateHistoryLogicService$WonderEditor.operateHistory(currentState, historyState[/* uiRedoStack */1], (function () {
                return /* record */[
                        /* markRedoUndoStack */historyState[/* markRedoUndoStack */0],
