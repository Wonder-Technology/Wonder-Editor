...
function copyRedoUndoStack(store, param, historyState) {
...
function restoreController(dispatch, engineStateForEdit, engineStateForRun, historyState) {
  ...
  if (exit === 1) {
    throw [
          ...
          [
            "/home/arvin/yangHao/Wonder-Editor/src/core/ui/eventHandler/utils/ControllerRedoUndoEventHandlerUtils.re",
            26,
            2
          ]
        ];
