...
function MakeEventHandler(EventItem) {
  var onSelect = function (reduxTuple, prepareTuple, dataTuple) {
    MarkRedoUndoEventHandlerUtils$WonderEditor.markRedoUndoChangeUI(reduxTuple[0], StateLogicService$WonderEditor.getStateForHistory(/* () */0));
  ...
  var onMarkRedoUndoByFirstStack = function (reduxTuple, prepareTuple, dataTuple) {
    MarkRedoUndoEventHandlerUtils$WonderEditor.markRedoUndoChangeNothing(AllStateData$WonderEditor.getHistoryState(/* () */0), reduxTuple[0], StateLogicService$WonderEditor.getStateForHistory(/* () */0));
  ...
  var onMarkRedoUndoByLastStack = function (reduxTuple, prepareTuple, dataTuple) {
    ...
    return MarkRedoUndoEventHandlerUtils$WonderEditor.markRedoUndoChangeNothing(AllStateData$WonderEditor.getHistoryState(/* () */0), reduxTuple[0], StateLogicService$WonderEditor.getStateForHistory(/* () */0));
  };
  return /* module */[
          /* onSelect */onSelect,
          /* onDrop */onDrop,
