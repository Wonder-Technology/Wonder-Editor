...
function showComponent(store, dispatchFunc) {
  ...
  return React.createElement("article", {
            ...
            }, value !== undefined ? ExtensionParseUtils$WonderEditor.extensionPanelComponent("App", value, store) : null, match ? ReasonReact.element(undefined, undefined, Header$WonderEditor.make(store, dispatchFunc, /* array */[])) : null, match$1 ? ReasonReact.element(undefined, undefined, Controller$WonderEditor.make(store, dispatchFunc, /* array */[])) : null, ReasonReact.element(undefined, undefined, MainEditor$WonderEditor.make(store, dispatchFunc, /* array */[])));
}
...
function make(store, dispatch, _children) {
  return /* record */[
