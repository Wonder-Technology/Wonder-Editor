...
function showComponent(store, dispatchFunc) {
  ...
  return React.createElement("article", {
            ...
            }, value ? ExtensionParseUtils$WonderEditor.extensionPanelComponent("App", value[0], store) : null, match ? ReasonReact.element(/* None */0, /* None */0, Header$WonderEditor.make(store, dispatchFunc, /* array */[])) : null, ReasonReact.element(/* None */0, /* None */0, MainEditor$WonderEditor.make(store, dispatchFunc, /* array */[])));
}
