...
function extensionPanelComponent(componentName, extensionText, store) {
  ...
  if (len !== 0) {
    return panelArray.map((function (panelObj) {
                  ...
                  return ReasonReact.element(DomHelper$WonderEditor.getRandomKey(/* () */0), undefined, PanelExtension$WonderEditor.make(record, _getExtensionName(extensionRecord), store, /* array */[]));
                }));
  } else {
    return /* array */[];
  }
