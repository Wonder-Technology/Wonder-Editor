...
function _getExtensionName(extensionRecord) {
  ...
  return OptionService$WonderEditor.unsafeGet(Js_primitive.nullable_to_opt(extensionRecord[/* name */2]));
}
...
function _getExtensionMethods(extensionRecord) {
  ...
  return OptionService$WonderEditor.unsafeGet(Js_primitive.nullable_to_opt(extensionRecord[/* methodExtension */1]));
}
...
function _getExtensionPanels(extensionRecord) {
  ...
  return OptionService$WonderEditor.unsafeGet(Js_primitive.nullable_to_opt(extensionRecord[/* panelExtension */0]));
}
