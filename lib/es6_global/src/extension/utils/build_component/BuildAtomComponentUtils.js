...
function buildComponentByName(componentName, argumentArray) {
  switch (componentName) {
    ...
    default:
      Log$WonderLog.error(LogUtils$WonderEditor.buildErrorMessage("the specific component: " + (String(componentName) + " is not find"), "", "check extension->panelExtension->render->name->" + (String(componentName) + " should correct"), "componentName: " + (String(componentName) + "")));
      return null;
  }
}
