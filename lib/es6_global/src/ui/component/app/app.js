  ...
  newrecord[/* render */9] = (function () {
      return React.createElement("div", {
                  className: "app"
                              ...
                              console.log("hehe");
                              return /* () */0;
                            })], /* Some */["primary"], /* array */[UiTool$WonderEditor.textEl("xne")])), ReasonReact.element(/* None */0, /* None */0, NumberInput$WonderEditor.make(/* None */0, /* Some */["X"], /* array */[])), ReasonReact.element(/* None */0, /* None */0, MainEditor$WonderEditor.make(state[/* stringState */0], dispatch, /* array */[])), React.createElement("button", {
                      onClick: (function () {
