  ...
  return React.createElement("article", {
              ...
              className: "header-component"
                  ...
                  className: "component-item"
                      ...
                      onClick: (function () {
                          return OperateStateUtils$WonderEditor.operateStateWithReduxData(StateHistoryView$WonderEditor.undoHistoryState, store, dispatch);
                        })
                    }, DomHelper$WonderEditor.textEl("undo"))), React.createElement("div", {
                  className: "component-item"
                }, React.createElement("button", {
                      onClick: (function () {
                          return OperateStateUtils$WonderEditor.operateStateWithReduxData(StateHistoryView$WonderEditor.redoHistoryState, store, dispatch);
                        })
                    }, DomHelper$WonderEditor.textEl("redo"))), React.createElement("div", {
                  className: "component-item"
                }, React.createElement("button", {
                      onClick: (function () {
                          return OperateStateUtils$WonderEditor.operateStateWithReduxData(addBox, store, dispatch);
                        })
                    }, DomHelper$WonderEditor.textEl("add box"))), React.createElement("div", {
                  className: "component-item"
                }, React.createElement("button", {
                      onClick: (function () {
                          return OperateStateUtils$WonderEditor.operateStateWithReduxData(disposeCurrentGameObject, store, dispatch);
                        })
