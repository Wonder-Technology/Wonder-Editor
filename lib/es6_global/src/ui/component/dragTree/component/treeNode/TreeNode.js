...
function make(uid, name, onSelect, onDropFinish, treeChildren, _) {
  var newrecord = ReasonReact.reducerComponent("TreeNode").slice();
  ...
  newrecord[/* reducer */12] = (function (action, state) {
      switch (action) {
        case 0 : 
            var style = ReactUtils$WonderEditor.addStyleProp("border", "2px dashed blue", state[/* currentStyle */0]);
            return /* Update */Block.__(0, [/* record */[/* currentStyle */style]]);
        case 1 : 
            var style$1 = ReactUtils$WonderEditor.addStyleProp("border", "0", state[/* currentStyle */0]);
            return /* Update */Block.__(0, [/* record */[/* currentStyle */style$1]]);
        case 2 : 
            var style$2 = ReactUtils$WonderEditor.addStyleProp("opacity", "0.2", state[/* currentStyle */0]);
            return /* Update */Block.__(0, [/* record */[/* currentStyle */style$2]]);
