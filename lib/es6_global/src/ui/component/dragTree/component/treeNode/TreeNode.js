...
function handleDragStart(uid, $$event) {
  ...
  DragUtils$WonderEditor.setEffectTransferToMove($$event);
...
function reducer(action, state) {
  switch (action) {
    ...
    case 1 : 
        return /* Update */Block.__(0, [/* record */[/* style */ReactUtils$WonderEditor.addStyleProp("border", "0", state[/* style */0])]]);
    case 2 : 
        console.log("end");
...
function render(attributeTuple, eventHandleTuple, treeChildren, param) {
  ...
  return React.createElement("ul", {
              ...
              draggable: true,
              onDragEnd: Curry._1(reduce, handleDragEnd),
...
function make(attributeTuple, eventHandleTuple, treeChildren, _) {
  ...
  newrecord[/* render */9] = (function (_self) {
      return render(attributeTuple, eventHandleTuple, treeChildren, _self);
    });
