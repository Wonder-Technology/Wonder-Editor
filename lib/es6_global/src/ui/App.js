...
function render(store, dispatch, _) {
  ...
  if (match !== 0) {
    ...
    return React.createElement("article", {
              ...
              }, value ? ExtensionParseSystem$WonderEditor.extensionPanelComponent("App", value[0], store) : null, ReasonReact.element(/* None */0, /* None */0, Header$WonderEditor.make(store, dispatch, /* array */[])), ReasonReact.element(/* None */0, /* None */0, MainEditor$WonderEditor.make(store, dispatch, /* array */[])));
  } else {
    return React.createElement("article", {
                key: "app",
