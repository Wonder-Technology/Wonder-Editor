...
function _findUniquePropArrayByAtomName(atomName, propsArray) {
  return Contract$WonderEditor.ensureCheck((function (r) {
                return Contract$WonderEditor.test("atomComponent length is <= 1", (function () {
                              return Contract$WonderEditor.Operators[/* <= */10](r.length, 1);
                            }));
              }), propsArray.filter((function (props) {
...
function _getUniqueMapByComponentName(state, uiComponentName) {
  ...
  if (match) {
    ...
    return ExcepetionHandleSystem$WonderEditor.throwMessage("componentsMap:the mapState is empty");
  }
}
