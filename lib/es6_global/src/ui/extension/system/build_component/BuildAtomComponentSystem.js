...
function buildComponentByName(componentName, argumentArray) {
  switch (componentName) {
    ...
    default:
      Log$WonderLog.error(Log$WonderLog.buildErrorMessage("buildComponentByName", "the specific component: " + (String(componentName) + " is not find"), "", "check extension->panelExtension->render->name->" + (String(componentName) + " should correct"), "button text: null"));
      return null;
  }
}
