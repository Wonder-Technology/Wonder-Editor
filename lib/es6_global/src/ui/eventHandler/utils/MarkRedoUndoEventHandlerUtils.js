...
function _clearMarkRedoUndoStack(allState) {
  return AllStateData$WonderEditor.setAllState(/* record */[
...
function markRedoUndoChangeUI(store) {
  _clearMarkRedoUndoStack(AllStateData$WonderEditor.getAllState(/* () */0));
  var match = MainEditorStateView$WonderEditor.prepareState(/* () */0);
...
function markRedoUndoChangeNothing(allState, uiState) {
