...
function unsafeGetCurrentGameObject(editorState) {
  Contract$Wonderjs.requireCheck((function () {
          return Contract$Wonderjs.test("current gameObject should exist", (function () {
                        return Contract$Wonderjs.assertExist(editorState[/* sceneData */0][/* currentGameObject */1]);
                      }));
        }));
