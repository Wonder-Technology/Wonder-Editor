...
import * as MainEditorGameObjectView$WonderEditor from "../component/inspector/component/logic/view/MainEditorGameObjectView.js";
  ...
  return React.createElement("article", {
              ...
              className: "wonder-mainEditor-component"
                  ...
                  className: "vertical-component"
                    ...
                    }, ReasonReact.element(/* None */0, /* None */0, MainEditorInspector$WonderEditor.make(store, dispatch, MainEditorGameObjectView$WonderEditor.getGameObjectAllShowInspectorComponent(/* () */0), /* array */[]))), React.createElement("div", {
