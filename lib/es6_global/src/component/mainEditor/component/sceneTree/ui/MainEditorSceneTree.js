...
function make(store, dispatch, _) {
  ...
  newrecord[/* shouldUpdate */8] = (function (param) {
      ...
      var match = Caml_obj.caml_equal(oldSelf[/* retainedProps */5][/* sceneGraph */0], newSelf[/* retainedProps */5][/* sceneGraph */0]);
      var match$1 = Caml_obj.caml_equal(oldSelf[/* retainedProps */5][/* currentGameObject */1], newSelf[/* retainedProps */5][/* currentGameObject */1]);
