...
function _setGameObjectParent(targetUid, dragedUid) {
  return MainEditorStateView$WonderEditor.finishState(MainEditorSceneTreeView$WonderEditor.setParent(targetUid, dragedUid, MainEditorStateView$WonderEditor.prepareState(/* () */0)));
}
