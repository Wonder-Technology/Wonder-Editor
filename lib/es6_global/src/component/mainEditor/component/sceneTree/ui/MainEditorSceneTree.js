...
function render(store, dispatch, _) {
  Log$WonderLog.print("scenetree update");
...
function make(store, dispatch, _) {
  ...
  newrecord[/* shouldUpdate */8] = (function (param) {
      ...
      var match = +(oldSelf[/* retainedProps */5][/* sceneGraph */0] === newSelf[/* retainedProps */5][/* sceneGraph */0]);
      var match$1 = +(oldSelf[/* retainedProps */5][/* currentGameObject */1] === newSelf[/* retainedProps */5][/* currentGameObject */1]);
