...
var MakeMainEditorSceneTreeSelectEventHandler = EventHandler$WonderEditor.MakeEventHandler([
      onSelect,
      onDrag,
      onChange
    ]);
...
export {
  SelectEventHandler                        ,
  MakeMainEditorSceneTreeSelectEventHandler ,
  
}
/* MakeMainEditorSceneTreeSelectEventHandler Not a pure module */
