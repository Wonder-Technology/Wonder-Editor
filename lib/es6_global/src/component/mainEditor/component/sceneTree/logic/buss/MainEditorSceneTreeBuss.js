...
function isExistSpecificGameObject(gameObjectArray) {
...
function _iterateDragedObject(targetGameObject, dragedGameObject, engineState) {
  ...
  if (match !== 0) {
    return isExistSpecificGameObject(MainEditorGameObjectOper$WonderEditor.getChildren(dragedGameObject, engineState).filter((function (child) {
...
function _insertRemovedTreeNodeToTargetTreeNode(targetId, param) {
    ...
    return sceneGraphArray.map((function (treeNode) {
                  ...
                  if (match !== 0) {
                    return /* record */[
                            /* name */treeNode[/* name */0],
                            /* uid */treeNode[/* uid */1],
                            /* children */OperateArrayUtils$WonderEditor.push(dragedTreeNode, children.slice())
                          ];
                  } else {
                    return /* record */[
                            /* name */treeNode[/* name */0],
  ...
  return _iterateSceneGraph(targetId, param[1], param[0]);
}
