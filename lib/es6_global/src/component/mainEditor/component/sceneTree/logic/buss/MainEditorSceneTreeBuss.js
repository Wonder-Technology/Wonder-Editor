...
function _isDragedGameObjectEqualTargetGameObject(targetGameObject, dragedGameObject) {
  return +(targetGameObject === dragedGameObject);
}
...
export {
  _isDragedGameObjectEqualTargetGameObject    ,
