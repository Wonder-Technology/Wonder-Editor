...
import '../../../../../../../../../src/component/mainEditor/component/sceneTree/component/dragTree/css/dragTree.css';
  ...
  return $$Array.map((function (param) {
                ...
                if (match !== 0) {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  ...
                                  onSelect,
                                  onDropFinish
                                ], /* Some */[renderSceneGraph(onSelect, onDropFinish, children)], /* array */[]));
                } else {
                  return ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, TreeNode$WonderEditor.make(/* tuple */[
                                  uid,
                                  name
...
function reducer(action, state) {
  if (action !== 0) {
    return /* Update */Block.__(0, [/* record */[/* currentStyle */ReactUtils$WonderEditor.addStyleProp("backgroundColor", "#c0c0c0", state[/* currentStyle */0])]]);
  } else {
    return /* Update */Block.__(0, [/* record */[/* currentStyle */ReactUtils$WonderEditor.addStyleProp("backgroundColor", "rgba(1,1,1,0.7)", state[/* currentStyle */0])]]);
  }
}

function render(eventHandleTuple, sceneGraphData, param) {
  ...
  return React.createElement("article", {
            ...
            }, renderSceneGraph(eventHandleTuple[0], onDropFinish, sceneGraphData), React.createElement("div", {
...
function make(eventHandleTuple, sceneGraphData, _) {
  var newrecord = component.slice();
  newrecord[/* render */9] = (function (param) {
      return render(eventHandleTuple, sceneGraphData, param);
    });
