...
function make(eventHandleTuple, sceneGraphData, _) {
  ...
  newrecord[/* render */9] = (function (param) {
      var eventHandleTuple$1 = eventHandleTuple;
      var sceneGraphData$1 = sceneGraphData;
      var param$1 = param;
      var onDropFinish = eventHandleTuple$1[1];
      var reduce = param$1[/* reduce */3];
      ...
      return React.createElement("article", {
                ...
                }, renderSceneGraph(eventHandleTuple$1[0], onDropFinish, sceneGraphData$1), React.createElement("div", {
                      className: "wonder-disable-drag",
                      style: param$1[/* state */4][/* currentStyle */0],
