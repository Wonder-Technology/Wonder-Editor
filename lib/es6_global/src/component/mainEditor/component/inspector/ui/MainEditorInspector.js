...
function render(store, dispatch, allShowComponentsConfig, _) {
  Log$WonderLog.print("inspectpr update");
...
function make(store, dispatch, allShowComponentsConfig, _) {
  ...
  newrecord[/* shouldUpdate */8] = (function (param) {
      var match = Caml_obj.caml_equal(param[/* oldSelf */0][/* retainedProps */5][/* currentGameObject */0], param[/* newSelf */1][/* retainedProps */5][/* currentGameObject */0]);
      if (match !== 0) {
        return /* false */0;
      } else {
        return /* true */1;
  ...
  newrecord[/* retainedProps */11] = /* record */[/* currentGameObject */MainEditorSceneView$WonderEditor.getCurrentGameObject(MainEditorStateView$WonderEditor.prepareState(/* () */0))];
  return newrecord;
}
