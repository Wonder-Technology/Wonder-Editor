...
function _getCurrentGameObject() {
  return MainEditorSceneView$WonderEditor.getCurrentGameObject(MainEditorStateView$WonderEditor.prepareState(/* () */0));
}
...
function buildCurrentGameObjectComponent(store, dispatch, allShowComponentConfig) {
  ...
  if (match) {
    ...
    var match$1 = MainEditorGameObjectView$WonderEditor.buildCurrentGameObjectShowComponentList(gameObject, allShowComponentConfig, MainEditorStateView$WonderEditor.prepareState(/* () */0));
...
var Method = /* module */[
  /* _getCurrentGameObject */_getCurrentGameObject,
