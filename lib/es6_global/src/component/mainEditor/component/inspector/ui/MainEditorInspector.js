...
import * as MainEditorMaterial$WonderEditor       from "../component/material/MainEditorMaterial.js";
...
function _buildComponentUIComponent(param, param$1, componentArray) {
  ...
  switch (type_) {
    case "material" : 
        return OperateArrayUtils$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, MainEditorMaterial$WonderEditor.make(store, dispatch, component, /* array */[])), componentArray);
    case "transform" : 
