...
function _buildComponentUIComponent(type_, _, store, dispatch, componentArray) {
  switch (type_) {
    case "cameraController" : 
    case "material" : 
        return componentArray;
    case "transform" : 
        return OperateArrayUtils$WonderEditor.push(ReasonReact.element(/* Some */[DomHelper$WonderEditor.getRandomKey(/* () */0)], /* None */0, MainEditorTransform$WonderEditor.make(store, dispatch, /* array */[])), componentArray);
    default:
