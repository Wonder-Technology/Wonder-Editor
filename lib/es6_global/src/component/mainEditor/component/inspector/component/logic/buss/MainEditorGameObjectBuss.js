...
function addSourceInstanceComponent(gameObject, param) {
  var engineState = param[1];
  return (function (param) {
      return MainEditorGameObjectOper$WonderEditor.addGameObjectSourceInstanceComponent(gameObject, engineState, param);
    });
}
