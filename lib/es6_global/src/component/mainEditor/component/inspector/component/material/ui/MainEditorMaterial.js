...
function _setCurrentGameObjectColor(materialComponent) {
...
function onBlur(materialComponent, value) {
  ...
  return _setCurrentGameObjectColor(materialComponent);
}

var Method = /* module */[
  /* getCurrentGameObjectColor */getCurrentGameObjectColor,
  /* _setCurrentGameObjectColor */_setCurrentGameObjectColor,
  /* onBlur */onBlur
];
