...
function render(store, dispatch, currentGameObject, addableComponentList, param) {
  ...
  return React.createElement("article", {
              className: "addable-component"
                ...
                }, DomHelper$WonderEditor.textEl("add component")), match !== 0 ? buildGameObjectAddableComponent(store, dispatch, currentGameObject, addableComponentList) : null);
}
