...
function addSpecificComponent(type_, currentGameObject, dispatch, _) {
  MainEditorStateView$WonderEditor.finishState(MainEditorComponentView$WonderEditor.addComponentByType(type_, currentGameObject, MainEditorStateView$WonderEditor.prepareState(/* () */0)));
