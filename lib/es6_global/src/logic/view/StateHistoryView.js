...
function storeAllState(uiState, editorState, engineState, allState) {
  return EngineStateView$WonderEditor.storeEngineState(engineState, EditorStateView$WonderEditor.storeEditorState(editorState, UIStateHistory$WonderEditor.storeUIState(uiState, allState)));
}
