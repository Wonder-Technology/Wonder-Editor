(function (global, factory) {
	...
	*/
	...
	function concatArray(streamArr) {
	  ...
	  if (match !== 0) {
	    return reduceOneParam$1((function (stream1, stream2) {
	...
	function concatStreamFuncArray(stateData$$1, streamFuncArr) {
	  ...
	  return reduceOneParam$1((function (stream1, streamFunc2) {
	...
	var unsafeFindFirst$1 = unsafeFindFirst;


	/* Log-WonderLog Not a pure module */

	function _getExecutableWorkerJob(jobs, jobItemName) {
	  return unsafeFindFirst$1(jobs, jobItemName, (function (param) {
	...
	function _buildWorkerStreamFuncArr(param, getJobHandleFunc) {
	  ...
	  return reduceOneParam$1((function (streamArr, job) {
	...
	function getRenderWorkerJobStreamArr$1(param, jobHandleMap, stateData$$1, getJobHandleFunc) {
	  ...
	  return reduceOneParam$1((function (streamArr, pipelineSubJobs) {
	...
	function reduceiValid$1(func, initValue, map) {
	...
	function unsafeGetBitmap(record) {
	  return unsafeGet$5(getBitmap(record));
	}
	...
	function createCustomTextures(gl, customImageArr, customTextureMap) {
	  ...
	  return reduceOneParam$1((function (customTextureMap, data) {
	                var format;
	                switch (data[2]) {
	                  case 0 : 
	                      format = rgb;
	...
	function bufferAllData(gl, groupedDrawDataArr, record) {
	  ...
	  var match$1 = reduceOneParam$1((function (param, param$1) {
	...
	function _getGroupPosition(record) {
	  ...
	  if (match) {
	    ...
	    var match$1 = reduceOneParam$1((function (param, index) {
	            var match = param[1];
	...
	function _getMGlyph(fntData) {
	  ...
	  return reduceOneParam$1((function (glyph, m_width) {
	                if (glyph !== undefined) {
	                  return glyph;
	                } else {
	...
	function _getFirstGlyph(fntData) {
	  return getValidValues(fntData[/* fontDefDictionary */4])[0];
	}
	...
	function getLayoutData(text, param, fntData, record) {
	  ...
	  var maxLineWidth = reduceOneParam$1((function (width$1, param) {
	...
	function draw$1(param, str, align, record) {
	  ...
	  if (match$1 !== undefined) {
	    ...
	    var match$3 = reduceOneParam$1((function (param, layoutData) {
	...
	function _draw(gl, drawElementsDataArr, record) {
	  ...
	  forEach((function (param) {
	          var texture = param[/* drawType */0] ? unsafeGet$5(param[/* customTexture */1]) : fontTexture;
	...
	function _restoreGlState(gl, record) {
	  var match = unsafeGet$5(unsafeGetWebglData(record)[/* lastWebglData */9]);
	...
	function _buildGroupedDrawDataArr(record) {
	  ...
	  var match = reduceOneParam$1((function (param, drawData) {
	...
	function _clearData(record) {
	  return /* record */[
	          ...
	          /* controlData : record */[
	            ...
	            /* checkboxData : record */[
	              /* index */0,
	              /* isSelectedMap */createEmpty$3(/* () */0)
	            ],
	            /* sliderData : record */[
	              /* index */0,
	              /* valueMap */createEmpty$3(/* () */0)
	            ]
	          ],
	          /* ioData */record[/* ioData */7],
	          /* layoutData : record */[/* groupData : record */[
	...
	function _exec(apiJsObj, getRecordFunc, data) {
	  ...
	  if (match !== undefined) {
	    return valFromOption(match)(unsafeGet$5(record[/* imguiFuncData */5][/* customDataForIMGUIFunc */1]), apiJsObj, data);
	  } else {
	    return data;
	  }
	}
	...
	function getRecord$2(param) {
	  return unsafeGet$2(param[/* browserDetectRecord */26]);
	}
	...
	function _disposeVboBuffer(needDisposeVboBufferArr, param, vboBufferRecord) {
	  ...
	  return reduceOneParam$1((function (vboBufferRecord, component) {
	...
	function initTexturesWithIndexArray(gl, indexInTypeArrayRange, glTextureMap) {
	  return reduceOneParam$1((function (glTextureMap, textureInTypeArray) {
	...
	function unsafeGetBasicSourceTextureCount(param) {
	  return unsafeGet$2(param[/* basicSourceTextureCount */3]);
	}

	function unsafeGetArrayBufferViewSourceTextureCount(param) {
	  return unsafeGet$2(param[/* arrayBufferViewSourceTextureCount */4]);
	}

	function unsafeGetPointLightCount(param) {
	  return unsafeGet$2(param[/* pointLightCount */6]);
	}
	...
	function getRecord$7(param) {
	  return unsafeGet$2(param[/* basicSourceTextureRecord */15]);
	}
	...
	function _getFlipYFunc(texture, state) {
	  var match = getRecord$7(state);
	  return isFlipY(texture, unsafeGet$2(match[/* flipYs */7]));
	}
	...
	function getRecord$8(param) {
	  return unsafeGet$2(param[/* arrayBufferViewSourceTextureRecord */16]);
	}
	...
	function addSourceArray(sourceArray, state) {
	  var record = getRecord$8(state);
	  var sourceMap = unsafeGet$2(record[/* sourceMap */10]);
	  reduceOneParam$1((function (sourceMap, param) {
	...
	function getIndices16(index, param) {
	  ...
	  return getUint16PointData(getInfoIndex(index), geometryRecord[/* indices16 */3], geometryRecord[/* indicesInfos */8]);
	}
	...
	function getIndicesLength$1(indices) {
	  return indices.length;
	}

	function unsafeGetIndex(index, indices) {
	...
	function computeVertexNormals$1(vertices, indices) {
	  var _compute = function (indicesLen, _index, _normals) {
	    while(true) {
	      ...
	      if (match) {
	        ...
	        var va = imul(unsafeGetIndex(index, indices), 3);
	        var vb = imul(unsafeGetIndex(index + 1 | 0, indices), 3);
	        var vc = imul(unsafeGetIndex(index + 2 | 0, indices), 3);
	  ...
	  return _normalizeNormals(_compute(getIndicesLength$1(indices), 0, new Float32Array(vertices.length)));
	}
	...
	function computeVertexNormals(index, state) {
	  ...
	  if (match) {
	    return computeVertexNormals$1(getVertices(index, state), getIndices32(index, state));
	  } else {
	    return computeVertexNormals$1(getVertices(index, state), getIndices16(index, state));
	  }
	}
	...
	function addUniformSendDataByType(param, param$1, getDataFunc) {
	  return /* record */[
	          /* renderObjectSendModelDataArr */push(/* record */[
	                /* pos */param[0],
	...
	function addUniformSendDataByType$1(param, param$1, getDataFunc) {
	  return /* record */[
	          ...
	          /* renderObjectSendMaterialDataArr */push(/* record */[
	...
	function createState(state) {
	  return /* record */[
	          ...
	          /* jobDataRecord : record */[/* outlineData : record */[/* outlineColor */getOutlineColor(state[/* jobDataRecord */22])]]
	        ];
	}
	...
	function _getOrCreateBuffer(buffer, param, param$1, state) {
	  ...
	  if (exit === 1) {
	    return fatal(buildFatalMessage("_getOrCreateBuffer", "unknown buffer: " + (String(buffer) + ""), "", "", ""));
	  }
	...
	function _directlySendAttributeData(gl, param, sendRenderDataSubState, state) {
	  ...
	  forEach((function (param) {
	        ...
	        }), unsafeGetAttributeSendData(param[0], state[/* glslSenderRecord */3]));
	  return state;
	}
	...
	function sendUniformRenderObjectModelData(gl, param, param$1) {
	  ...
	  forEach((function (param) {
	        ...
	        }), unsafeGetUniformSendData(param[0], param$1[1][/* glslSenderRecord */3]));
	  return /* () */0;
	}
	...
	function sendUniformRenderObjectMaterialData(gl, param, getRenderDataSubState, state) {
	  ...
	  forEach((function (param) {
	        ...
	        }), unsafeGetUniformSendData$2(param[0], state[/* glslSenderRecord */3]));
	  return state;
	}
	...
	function render$3(gl, param, bindAndUpdateFunc, state) {
	  ...
	  var materialIndex = param[1];
	  var state$1 = useByShaderIndex(gl, shaderIndex, state);
	  var sendRenderDataSubState = createState$1(state$1);
	  var state$2 = sendAttributeData(gl, /* tuple */[
	        shaderIndex,
	        param[4]
	      ], sendRenderDataSubState, state$1);
	  var getRenderDataSubState = createState(state$2);
	  ...
	  if (exit === 1) {
	    ...
	    var getRenderDataSubState$1 = createState(state$2);
	...
	function getIsDepthTestsOffset(basicMaterialCount, textureCountPerMaterial) {
	  return getMapUnitsOffset(basicMaterialCount, textureCountPerMaterial) + imul((basicMaterialCount << 0), Uint8Array.BYTES_PER_ELEMENT) | 0;
	}
	...
	function getAlphasOffset(basicMaterialCount, textureCountPerMaterial) {
	  return getIsDepthTestsOffset(basicMaterialCount, textureCountPerMaterial) + imul((basicMaterialCount << 0), Uint8Array.BYTES_PER_ELEMENT) | 0;
	}
	...
	function getIsDepthTest(index, typeArr) {
	  return getUint8_1(getIsDepthTestIndex(index), typeArr) === 0;
	}

	function getAlpha(index, typeArr) {
	  return getFloat1(getAlphaIndex(index), typeArr);
	}
	...
	var setRenderObjectGlState = setDepthTest;
	...
	var unsafeGetIsSourceInstance = unsafeGet$3;


	/* GPUDetectService-Wonderjs Not a pure module */

	function isSupportInstance(state) {
	  return isSupportInstance$1(unsafeGetGPU$1(state[/* settingRecord */19])[/* useHardwareInstance */0], state[/* gpuDetectRecord */16]);
	}
	...
	var getObjectInstanceTransformIndex = unsafeGet$3;
	...
	function forEachObjectInstanceTransformCollection(param, func) {
	  ...
	  var match = _getStartIndexAndEndIndex(param[0], param[1], param[2], objectInstanceTransformCollections);
	  for(var i = match[0] ,i_finish = match[1]; i <= i_finish; ++i){
	    func(getUint32_1(i, objectInstanceTransformCollections));
	  }
	  return /* () */0;
	}
	...
	function build(sourceInstance, state) {
	  ...
	  return /* tuple */[
	          ...
	          /* tuple */[
	            sourceInstance,
	            unsafeGetObjectInstanceCountPerSourceInstance(state[/* settingRecord */19]),
	            objectInstanceTransformIndex,
	...
	function render$7(gl, indexTuple, renderFunc, state) {
	  ...
	  var getRenderDataSubState = createState(state$1);
	  forEachObjectInstanceTransformCollection(match[1], (function (objectInstanceTransform) {
	          forEach((function (param) {
	                  var pos = param[/* pos */0];
	                  var match = isUniformLocationExist(pos);
	                  if (match) {
	...
	function _fillObjectInstanceData(objectInstanceTransformDataTuple, matricesArrayForInstance, fillMatrixTypeArrFunc, getRenderDataSubState, offset) {
	  reduceObjectInstanceTransformCollection(objectInstanceTransformDataTuple, offset, (function (offset, objectInstanceTransform) {
	...
	function _sendTransformMatrixDataBuffer(param, param$1, sendRenderDataSubState) {
	  ...
	  enableVertexAttribArray(gl, pos, sendRenderDataSubState[/* vertexAttribHistoryArray */0]);
	...
	function _sendTransformMatrixDataBufferData(glDataTuple, shaderIndex, stride, param) {
	  ...
	  forEachi((function (sendData, index) {
	...
	function _sendTransformMatrixData(param, param$1, fillMatrixTypeArrFunc, state) {
	  ...
	  var getRenderDataSubState = createState(state);
	...
	function _sendStaticTransformMatrixData(componentTuple, dataTuple, fillMatrixTypeArrFunc, state) {
	  ...
	  if (match$3) {
	    ...
	    var sendRenderDataSubState = createState$1(state);
	...
	function fillMatrixTypeArr(transformIndex, matricesArrayForInstance, state, offset) {
	  return fillFloat32ArrayWithFloat32Array(/* tuple */[
	              ...
	              getLocalToWorldMatrixTypeArray$2(transformIndex, state),
	              0
	            ], 16);
	}
	...
	function _fillMatrixTypeArr(transform, matricesArrayForInstance, state, offset) {
	  fillMatrixTypeArr(transform, matricesArrayForInstance, state, offset);
	  return offset + 16 | 0;
	}
	...
	function _setRenderObjectGlState(gl, materialIndex, state) {
	  setRenderObjectGlState(gl, getIsDepthTest(materialIndex, state[/* basicMaterialRecord */7][/* isDepthTests */4]), state[/* deviceManagerRecord */18]);
	  return state;
	}
	...
	function render$2(gl, param, state) {
	  ...
	  return reduceOneParam$1((function (state, index) {
	                ...
	                if (hasSourceInstance(sourceInstance)) {
	                  ...
	                  draw$4(gl, meshRendererIndex, geometryIndex, state$2);
	                  return state$2;
	                }
	              }), state, param[0]);
	}
	...
	function getRecord$9(state) {
	  return unsafeGet$2(state[/* geometryRecord */18]);
	}
	...
	function getRecord$10(param) {
	  return unsafeGet$2(param[/* transformRecord */17]);
	}
	...
	function getRecord$11(param) {
	  return unsafeGet$2(param[/* pointLightRecord */20]);
	}
	...
	function getPositionMap(record) {
	  return unsafeGet$2(record[/* positionMap */1]);
	}

	function getRenderLightArr(record) {
	  return unsafeGet$2(record[/* renderLightArr */2]);
	}
	...
	function getRecord$12(param) {
	  return unsafeGet$2(param[/* meshRendererRecord */14]);
	}
	...
	function getRecord$13(param) {
	  return unsafeGet$2(param[/* workerDetectRecord */25]);
	}
	...
	function getRecord$14(param) {
	  return unsafeGet$2(param[/* basicMaterialRecord */12]);
	}

	function unsafeGetShaderIndices(state) {
	  return unsafeGet$2(getRecord$14(state)[/* shaderIndices */0]);
	}

	function unsafeGetMapUnits(state) {
	  return unsafeGet$2(getRecord$14(state)[/* mapUnits */3]);
	}

	function unsafeGetIsDepthTests(state) {
	  return unsafeGet$2(getRecord$14(state)[/* isDepthTests */4]);
	}

	function unsafeGetAlphas(state) {
	  return unsafeGet$2(getRecord$14(state)[/* alphas */5]);
	}
	...
	function getRecord$15(param) {
	  return unsafeGet$2(param[/* lightMaterialRecord */13]);
	}

	function unsafeGetShaderIndices$1(state) {
	  return unsafeGet$2(getRecord$15(state)[/* shaderIndices */0]);
	}

	function unsafeGetDiffuseMapUnits(state) {
	  return unsafeGet$2(getRecord$15(state)[/* diffuseMapUnits */5]);
	}

	function unsafeGetSpecularMapUnits(state) {
	  return unsafeGet$2(getRecord$15(state)[/* specularMapUnits */6]);
	}
	...
	function getRecord$16(param) {
	  return unsafeGet$2(param[/* directionLightRecord */19]);
	}
	...
	function getDirectionMap(record) {
	  return unsafeGet$2(record[/* directionMap */1]);
	}
	...
	function create$10(param) {
	  return /* record */[
	          ...
	          /* matrixInstanceBufferCapacityMap */createEmpty$3(/* () */0),
	          /* matrixFloat32ArrayMap */createEmpty$3(/* () */0),
	          /* isSendTransformMatrixDataMap */createEmpty$3(/* () */0)
	        ];
	}

	function unsafeGetObjectInstanceTransformIndexMap(record) {
	  return unsafeGet$2(record[/* objectInstanceTransformIndexMap */0]);
	}

	function unsafeGetObjectInstanceTransformCollections(record) {
	  return unsafeGet$2(record[/* objectInstanceTransformCollections */1]);
	}

	function unsafeGetIsTransformStaticMap(record) {
	  return unsafeGet$2(record[/* isTransformStatics */2]);
	}
	...
	function createRenderState(state) {
	  ...
	  return /* record */[
	          ...
	          /* basicMaterialRecord : record */[
	            ...
	            /* colors */unsafeGet$2(basicMaterialRecord[/* colors */1]),
	            /* textureIndices */unsafeGet$2(basicMaterialRecord[/* textureIndices */2]),
	            /* mapUnits */unsafeGetMapUnits(state),
	            /* isDepthTests */unsafeGetIsDepthTests(state),
	            /* alphas */unsafeGetAlphas(state)
	          ],
	          /* lightMaterialRecord : record */[
	            /* shaderIndices */unsafeGetShaderIndices$1(state),
	            /* diffuseColors */unsafeGet$2(lightMaterialRecord[/* diffuseColors */1]),
	            /* specularColors */unsafeGet$2(lightMaterialRecord[/* specularColors */2]),
	            /* shininess */unsafeGet$2(lightMaterialRecord[/* shininess */3]),
	            /* textureIndices */unsafeGet$2(lightMaterialRecord[/* textureIndices */4]),
	          ...
	          /* basicSourceTextureRecord : record */[
	            /* wrapSs */unsafeGet$2(basicSourceTextureRecord[/* wrapSs */0]),
	            /* wrapTs */unsafeGet$2(basicSourceTextureRecord[/* wrapTs */1]),
	            /* magFilters */unsafeGet$2(basicSourceTextureRecord[/* magFilters */2]),
	            /* minFilters */unsafeGet$2(basicSourceTextureRecord[/* minFilters */3]),
	            /* formats */unsafeGet$2(basicSourceTextureRecord[/* formats */4]),
	            /* types */unsafeGet$2(basicSourceTextureRecord[/* types */5]),
	            /* isNeedUpdates */unsafeGet$2(basicSourceTextureRecord[/* isNeedUpdates */6]),
	            /* flipYs */unsafeGet$2(basicSourceTextureRecord[/* flipYs */7]),
	            /* sourceMap */basicSourceTextureRecord[/* sourceMap */8],
	          ...
	          /* arrayBufferViewSourceTextureRecord : record */[
	            /* wrapSs */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* wrapSs */0]),
	            /* wrapTs */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* wrapTs */1]),
	            /* magFilters */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* magFilters */2]),
	            /* minFilters */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* minFilters */3]),
	            /* formats */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* formats */4]),
	            /* types */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* types */5]),
	            /* isNeedUpdates */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* isNeedUpdates */6]),
	            /* flipYs */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* flipYs */7]),
	            /* widths */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* widths */8]),
	            /* heights */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* heights */9]),
	            /* sourceMap */unsafeGet$2(arrayBufferViewSourceTextureRecord[/* sourceMap */10]),
	...
	function createTypeArrays$8(buffer, basicMaterialCount, textureCountPerMaterial) {
	  return /* tuple */[
	          ...
	          new Uint8Array(buffer, getIsDepthTestsOffset(basicMaterialCount, textureCountPerMaterial), getIsDepthTestsLength(basicMaterialCount)),
	          new Float32Array(buffer, getAlphasOffset(basicMaterialCount, textureCountPerMaterial), getAlphasLength(basicMaterialCount))
	        ];
	}
	...
	function _createTypeArrays$3(buffer, count, state) {
	  ...
	  state[/* transformRecord */17] = /* record */[
	    ...
	    /* localScales */match[3],
	    /* localToWorldMatrixCacheMap */createEmpty$3(/* () */0),
	    /* normalMatrixCacheMap */createEmpty$3(/* () */0)
	  ];
	  return state;
	}
	                                                        ...
	                                                        "\n\n"
	                                                            ...
	                                                            "\n\n"
	                                                                ...
	                                                                "\n\n"
	                                                                    ...
	                                                                    "\n\n",
	                                                                    "\n\n"
	                                                                  ], "\ngl_Position = u_pMatrix * u_vMatrix * mMatrix * vec4(a_position, 1.0);\n"), set("webgl1_rotation_gizmo_circle_for_editor_fragment", _buildChunk(/* tuple */[
	                                                                        "\n\n",
	                                                                        "\n\n"
	                                                                                                                                                                    ...
	                                                                                                                                                                    "\n\n"
	                                                                                                                                                                        ...
	                                                                                                                                                                        "\nfloat getBlinnShininess(float shininess, vec3 normal, vec3 lightDir, vec3 viewDir, float dotResultBetweenNormAndLight){\n        vec3 halfAngle = normalize(lightDir + viewDir);\n\n        float blinnTerm = dot(normal, halfAngle);\n\n        blinnTerm = clamp(blinnTerm, 0.0, 1.0);\n        blinnTerm = dotResultBetweenNormAndLight != 0.0 ? blinnTerm : 0.0;\n        blinnTerm = pow(blinnTerm, shininess);\n\n        return blinnTerm;\n}\n\n// float getPhongShininess(float shininess, vec3 normal, vec3 lightDir, vec3 viewDir, float dotResultBetweenNormAndLight){\n//         vec3 reflectDir = reflect(-lightDir, normal);\n//         float phongTerm = dot(viewDir, reflectDir);\n\n//         phongTerm = clamp(phongTerm, 0.0, 1.0);\n//         phongTerm = dotResultBetweenNormAndLight != 0.0 ? phongTerm : 0.0;\n//         phongTerm = pow(phongTerm, shininess);\n\n//         return phongTerm;\n// }\n\nvec3 calcAmbientColor(vec3 materialDiffuse){\n        vec3 materialLight = getMaterialLight();\n\n        return (u_ambient + materialLight) * materialDiffuse;\n}\n\nvec3 calcLight(vec3 lightDir, vec3 color, float intensity, float attenuation, vec3 normal, vec3 viewDir, vec3 materialDiffuse)\n{\n        vec3 materialSpecular = u_specular;\n        vec3 materialEmission = getMaterialEmission();\n\n        float specularStrength = getSpecularStrength();\n\n        float dotResultBetweenNormAndLight = dot(normal, lightDir);\n        float diff = max(dotResultBetweenNormAndLight, 0.0);\n\n        vec3 emissionColor = materialEmission;\n\n        vec3 ambientColor = calcAmbientColor(materialDiffuse);\n\n\n        // if(u_lightModel == 3){\n        //     return emissionColor + ambientColor;\n        // }\n\n        vec3 diffuseColor = color * materialDiffuse.rgb * diff * intensity;\n\n        float spec = 0.0;\n\n        // if(u_lightModel == 2){\n        //         spec = getPhongShininess(u_shininess, normal, lightDir, viewDir, diff);\n        // }\n        // else if(u_lightModel == 1){\n        //         spec = getBlinnShininess(u_shininess, normal, lightDir, viewDir, diff);\n        // }\n\n        spec = getBlinnShininess(u_shininess, normal, lightDir, viewDir, diff);\n\n\n        vec3 specularColor = spec * materialSpecular * specularStrength * intensity;\n\n       return vec3(emissionColor + ambientColor + attenuation * (diffuseColor.rgb + specularColor));\n}\n\n\n\n\n#if POINT_LIGHTS_COUNT > 0\n        vec3 calcPointLight(vec3 lightDir, PointLight light, vec3 normal, vec3 viewDir, vec3 materialDiffuse)\n{\n        //lightDir is not normalize computing distance\n        float distance = length(lightDir);\n\n        float attenuation = 0.0;\n\n        if(distance < light.range)\n        {\n            attenuation = 1.0 / (light.constant + light.linear * distance + light.quadratic * (distance * distance));\n        }\n\n        lightDir = normalize(lightDir);\n\n        return calcLight(lightDir, light.color, light.intensity, attenuation, normal, viewDir, materialDiffuse);\n}\n#endif\n\n\n\n#if DIRECTION_LIGHTS_COUNT > 0\n        vec3 calcDirectionLight(vec3 lightDir, DirectionLight light, vec3 normal, vec3 viewDir, vec3 materialDiffuse)\n{\n        float attenuation = 1.0;\n\n        // lightDir = normalize(lightDir);\n\n        return calcLight(lightDir, light.color, light.intensity, attenuation, normal, viewDir, materialDiffuse);\n}\n#endif\n\n\n\nvec4 calcTotalLight(vec3 norm, vec3 viewDir){\n    vec3 totalLight = vec3(0.0, 0.0, 0.0);\n\n    vec4 materialDiffuse = getMaterialDiffuse();\n\n    float alpha = materialDiffuse.a;\n    vec3 materialDiffuseRGB = materialDiffuse.rgb;\n\n\n    #if (DIRECTION_LIGHTS_COUNT == 0 && POINT_LIGHTS_COUNT == 0 )\n        return vec4(calcAmbientColor(materialDiffuseRGB), alpha);\n    #endif\n\n\n    #if POINT_LIGHTS_COUNT > 0\n                for(int i = 0; i < POINT_LIGHTS_COUNT; i++){\n                totalLight += calcPointLight(getPointLightDir(i), u_pointLights[i], norm, viewDir, materialDiffuseRGB);\n        }\n    #endif\n\n    #if DIRECTION_LIGHTS_COUNT > 0\n                for(int i = 0; i < DIRECTION_LIGHTS_COUNT; i++){\n                totalLight += calcDirectionLight(getDirectionLightDir(i), u_directionLights[i], norm, viewDir, materialDiffuseRGB);\n        }\n    #endif\n\n        return vec4(totalLight, alpha);\n}\n"
	                                                                                                                                                                            ...
	                                                                                                                                                                            "\n\n"
	                                                                                                                                                                                ...
	                                                                                                                                                                                "\n\n",
	                                                                                                                                                                                "\n\n"
	                                                                                                                                                                              ], "\ngl_Position = u_pMatrix * u_vMatrix * vec4(v_worldPosition, 1.0);\n"), set("webgl1_outline_expand_fragment", _buildChunk(/* tuple */[
	                                                                                                                                                                                    "\n\n",
	                                                                                                                                                                                    "\n\n"
	                                                                                                                                                                                  ], "\n\n", /* tuple */[
	                                                                                                                                                                                    "\n\n",
	                                                                                                                                                                                    "\n\n"
	                                                                                                                                                                                  ], "\ngl_FragColor = vec4(u_outlineColor, 1.0);\n"), set("webgl1_outline_expand_vertex", _buildChunk(/* tuple */[
	                                                                                                                                                                                        "\n\n",
	                                                                                                                                                                                        "\n\n"
	                                                                                                                                                                                      ], "\n\n", /* tuple */[
	                                                                                                                                                                                        "\n\n",
	                                                                                                                                                                                        "\n\n"
	                                                                                                                                                                                      ], "\nvec3 position = a_position.xyz + a_normal.xyz * 0.08;\n\ngl_Position = u_pMatrix * u_vMatrix * mMatrix * vec4(position, 1.0);\n"), set("webgl1_outline_origin_fragment", _buildChunk(/* tuple */[
	                                                                                                                                                                                            "\n\n",
	                                                                                                                                                                                            "\n\n"
	                                                                                                                                                                                          ], "\n\n", /* tuple */[
	                                                                                                                                                                                            "\n\n",
	                                                                                                                                                                                            "\n\n"
	                                                                                                                                                                                          ], "\ngl_FragColor = vec4(1.0);\n"), set("webgl1_outline_origin_vertex", _buildChunk(/* tuple */[
	                                                                                                                                                                                                "\n\n",
	                                                                                                                                                                                                "\n\n"
	                                                                                                                                                                                              ], "\n\n", /* tuple */[
	                                                                                                                                                                                                "\n\n",
	...
	function _fillMatrixTypeArr$1(transform, matricesArrayForInstance, state, offset) {
	  fillMatrixTypeArr(transform, matricesArrayForInstance, state, offset);
	...
	function init$6(gl, param, initMaterialFunc, param$1) {
	  ...
	  return reduceOneParam$1((function (state, materialIndex) {
	...
	function addUniformSendDataByType$2(param, param$1, getDataFunc) {
	  return /* record */[
	          ...
	          /* renderObjectSendMaterialDataArr */param$1[/* renderObjectSendMaterialDataArr */1],
	          /* shaderSendNoCachableDataArr */param$1[/* shaderSendNoCachableDataArr */2],
	          /* shaderSendCachableDataArr */push(/* record */[
	                /* shaderCacheMap */param[0],
	                /* name */param[1],
	                /* pos */param[2],
	                /* getDataFunc */getDataFunc,
	...
	function reduceiValidShaderSendCachableData(glslSenderRecord, func, initValue) {
	  return reduceiValid(func, initValue, glslSenderRecord[/* uniformShaderSendCachableDataMap */6]);
	}
	...
	function addUniformSendDataByType$3(param, param$1, getDataFunc) {
	  return /* record */[
	          /* renderObjectSendModelDataArr */param$1[/* renderObjectSendModelDataArr */0],
	          /* renderObjectSendMaterialDataArr */param$1[/* renderObjectSendMaterialDataArr */1],
	          /* shaderSendNoCachableDataArr */push(/* record */[
	                /* pos */param[1],
	                /* getDataFunc */getDataFunc,
	...
	function reduceiValidShaderSendNoCachableData(glslSenderRecord, func, initValue) {
	  return reduceiValid(func, initValue, glslSenderRecord[/* uniformShaderSendNoCachableDataMap */5]);
	}


	/* ArrayService-Wonderjs Not a pure module */

	function addUniformSendDataByType$4(param, param$1, sendDataFunc) {
	  return /* record */[
	          /* renderObjectSendModelDataArr */param$1[/* renderObjectSendModelDataArr */0],
	          /* renderObjectSendMaterialDataArr */param$1[/* renderObjectSendMaterialDataArr */1],
	          /* shaderSendNoCachableDataArr */param$1[/* shaderSendNoCachableDataArr */2],
	          /* shaderSendCachableDataArr */param$1[/* shaderSendCachableDataArr */3],
	          /* shaderSendCachableFunctionDataArr */push(/* record */[
	                /* program */param[0],
	...
	function setToUniformSendMap$4(shaderIndex, uniformShaderSendCachableFunctionDataMap, shaderSendCachableFunctionDataArr) {
	...
	function reduceiValidShaderSendCachableFunctionData(glslSenderRecord, func, initValue) {
	  return reduceiValid(func, initValue, glslSenderRecord[/* uniformShaderSendCachableFunctionDataMap */7]);
	}
	...
	function getShaderIndex$4(key, param) {
	  ...
	  return get(key, shaderLibShaderIndexMap);
	}

	function setShaderIndex$1(key, shaderIndex, param) {
	  var shaderLibShaderIndexMap = param[/* shaderLibShaderIndexMap */2];
	  return set(key, shaderIndex, shaderLibShaderIndexMap);
	}
	...
	function _initNewShader(param, param$1, param$2, param$3) {
	  ...
	  setShaderIndex$1(param[1], shaderIndex, param$3[0]);
	...
	function addUniformSendDataByType$5(pos, param, param$1) {
	  return /* record */[
	          ...
	          /* instanceSendNoCachableDataArr */push(/* record */[
	                /* pos */pos,
	...
	function setToUniformSendMap$5(shaderIndex, uniformInstanceSendNoCachableDataMap, instanceSendNoCachableDataArr) {
	...
	function addModelSendData(param, sendDataArrTuple) {
	  ...
	  switch (field) {
	    case "instance_mMatrix" : 
	        return addUniformSendDataByType$5(pos, sendDataArrTuple, /* tuple */[
	    ...
	    default:
	      return fatal(buildFatalMessage("addModelSendData", "unknow field:" + (String(field) + ""), "", "", ""));
	  }
	}
	...
	function getCameraVMatrixData(state) {
	  return unsafeGet$2(state[/* cameraRecord */0])[/* vMatrix */0];
	}

	function getCameraPMatrixData(state) {
	  return unsafeGet$2(state[/* cameraRecord */0])[/* pMatrix */1];
	}

	function getCameraPositionData(state) {
	  return unsafeGet$2(state[/* cameraRecord */0])[/* position */2];
	}
	...
	function getColor$3(material, param) {
	  return getColor(material, param[/* basicMaterialRecord */1][/* colors */1]);
	}

	function getAlpha$1(material, param) {
	  return getAlpha(material, param[/* basicMaterialRecord */1][/* alphas */5]);
	}

	function getMapUnit$1(material, param) {
	  return getMapUnit(material, param[/* basicMaterialRecord */1][/* mapUnits */3]);
	}
	...
	function getDiffuseColor$1(material, param) {
	  return getDiffuseColor(material, param[/* lightMaterialRecord */2][/* diffuseColors */1]);
	}

	function getSpecularColor$1(material, param) {
	  return getSpecularColor(material, param[/* lightMaterialRecord */2][/* specularColors */2]);
	}

	function getShininess$1(material, param) {
	  return getShininess(material, param[/* lightMaterialRecord */2][/* shininess */3]);
	}

	function getDiffuseMapUnit$1(material, param) {
	  return getDiffuseMapUnit(material, param[/* lightMaterialRecord */2][/* diffuseMapUnits */5]);
	}

	function getSpecularMapUnit$1(material, param) {
	  return getSpecularMapUnit(material, param[/* lightMaterialRecord */2][/* specularMapUnits */6]);
	}
	...
	function setToUniformSendMap$6(shaderIndex, uniformSendDataMap, sendDataArr) {
	  set$1(shaderIndex, sendDataArr, uniformSendDataMap);
	  return /* () */0;
	}
	...
	function _setToUniformSendMap(shaderIndex, param, param$1) {
	  ...
	  setToUniformSendMap(shaderIndex, param[/* uniformRenderObjectSendModelDataMap */3], param$1[/* renderObjectSendModelDataArr */0]);
	  setToUniformSendMap$1(shaderIndex, param[/* uniformRenderObjectSendMaterialDataMap */4], param$1[/* renderObjectSendMaterialDataArr */1]);
	  setToUniformSendMap$3(shaderIndex, param[/* uniformShaderSendNoCachableDataMap */5], param$1[/* shaderSendNoCachableDataArr */2]);
	  setToUniformSendMap$2(shaderIndex, param[/* uniformShaderSendCachableDataMap */6], param$1[/* shaderSendCachableDataArr */3]);
	  setToUniformSendMap$4(shaderIndex, param[/* uniformShaderSendCachableFunctionDataMap */7], param$1[/* shaderSendCachableFunctionDataArr */4]);
	  setToUniformSendMap$5(shaderIndex, uniformInstanceSendNoCachableDataMap, instanceSendNoCachableDataArr);
	  setToUniformSendMap$5(shaderIndex, uniformInstanceSendNoCachableDataMap, instanceSendNoCachableDataArr);
	  setToUniformSendMap$6(shaderIndex, param[/* uniformNoMaterialShaderSendCachableDataMap */9], param$1[/* noMaterialShaderSendCachableDataArr */6]);
	  return /* () */0;
	}
	...
	function readUniformSendData(shaderLibDataArr, param, readUniformsFunc, param$1) {
	  ...
	  var program = param[1];
	  var gl = param[0];
	  return reduceOneParam$1((function (sendDataArrTuple, param) {
	                  ...
	                  switch (from) {
	                    case "basicMaterial" : 
	                        return addBasicMaterialSendData(/* tuple */[
	                                    field,
	                                    getUniformLocationAndCache(program, name, uniformLocationMap, gl),
	                                    name,
	                                    type_,
	                                    uniformCacheMap
	                                  ], sendDataArrTuple);
	...
	function sendBuffer(gl, param, buffer, state) {
	  ...
	  if (match) {
	    ...
	    enableVertexAttribArray(gl, pos, state[/* vertexAttribHistoryArray */0]);
	    return /* () */0;
	  } else {
	    return /* () */0;
	  }
	...
	function addModelMatrixInstanceArrayBufferSendData(param, param$1) {
	  return /* tuple */[
	          param$1[0],
	          push(/* record */[
	                /* pos */getAttribLocationAndCache(param[1], param[2], param[3], param[0]),
	                /* size */4,
	...
	function addOtherArrayBufferSendData(param, param$1) {
	  return /* tuple */[
	          push(/* record */[
	                /* pos */getAttribLocationAndCache(param[1], param[2], param[5], param[0]),
	...
	function _buildVsAndFs(param, shaderLibDataArr, execHandleFunc, glslChunkRecord) {
	  return reduceOneParam$1((function (glslTuple, param) {
	                var glsls = param[/* glsls */1];
	                var match = isJsonSerializedValueNone(glsls);
	                if (match) {
	                  return glslTuple;
	                } else {
	                  return reduceOneParam$1((function (sourceTuple, param) {
	...
	function getMaterialShaderLibDataArrByStaticBranchInstance(param, param$1, resultDataArr) {
	  var value = param$1[1];
	  return push(_findFirstShaderData(param[0] ? (
	...
	function getMaterialShaderLibDataArrByDynamicBranch(param, param$1, isPassFunc, resultDataArr) {
	  var name = param[1];
	  var dynamicBranchData = unsafeFindFirst$1(param$1[0], name, (function (item) {
	  ...
	  if (match$1) {
	    ...
	    return push(_findFirstShaderData(unsafeGetJsonSerializedValue(dynamicBranchShaderLibNameOption), param$1[1]), resultDataArr);
	  }
	}
	...
	function getMaterialShaderLibDataArr$1(param, param$1, param$2, state) {
	  ...
	  var materialIndex = param[0];
	  return reduceOneParam$1((function (resultDataArr, param) {
	                var name = param[/* name */1];
	                var type_ = param[/* type_ */0];
	                var match = isJsonSerializedValueNone(type_);
	                if (match) {
	                  return push(_findFirstShaderData(name, shaderLibs), resultDataArr);
	                } else {
	...
	function unsafeGetMemory$1(param) {
	  return unsafeGet$2(param[/* memory */7]);
	}
	...
	function getRecord$31(state) {
	  return unsafeGet$2(state[/* renderConfigRecord */2]);
	}
	...
	function execJob$49(param, e, stateData) {
	  return callFunc((function (param) {
	                ...
	                setState$1(stateData, initMaterials(/* tuple */[
	                          ...
	                          init$5
	                        ], getRecord$14(state)[/* isSourceInstanceMap */8], _createTypeArrays$5(basicMaterialData.buffer, basicMaterialCount, textureCountPerMaterial, state)));
	                return e;
	              }));
	}
	...
	function getLightCount$2(renderLightArr) {
	...
	function getLightCount$1(renderLightArr, bufferMaxCount) {
	  var __x = getLightCount$2(renderLightArr);
	...
	function getLightCount(param) {
	  return getLightCount$1(param[/* renderLightArr */1], getBufferMaxCount(/* () */0));
	}
	...
	function getLightCount$3(param) {
	  return getLightCount$1(param[/* renderLightArr */1], getBufferMaxCount$1(/* () */0));
	}
	...
	function _sendAttenuation(light, param, param$1, pointLightRecord) {
	  ...
	  sendFloat(gl, uniformCacheMap, /* tuple */[
	        constant,
	        getUniformLocationAndCache(program, constant, uniformLocationMap, gl)
	      ], getConstant$1(light, pointLightRecord));
	  sendFloat(gl, uniformCacheMap, /* tuple */[
	        linear,
	        getUniformLocationAndCache(program, linear, uniformLocationMap, gl)
	      ], getLiear(light, pointLightRecord));
	  sendFloat(gl, uniformCacheMap, /* tuple */[
	        quadratic,
	        getUniformLocationAndCache(program, quadratic, uniformLocationMap, gl)
	      ], getQuadratic$1(light, pointLightRecord));
	  sendFloat(gl, uniformCacheMap, /* tuple */[
	        range$$1,
	        getUniformLocationAndCache(program, range$$1, uniformLocationMap, gl)
	...
	function send(gl, param, param$1) {
	  ...
	  reduceOneParami((function (pointLightRecord, light, index) {
	          ...
	          sendVec3(gl, uniformCacheMap, /* tuple */[
	                position,
	                getUniformLocationAndCache(program, position, uniformLocationMap, gl)
	              ], getPosition$2(light, positionMap));
	          sendFloat3(gl, uniformCacheMap, /* tuple */[
	                color,
	                getUniformLocationAndCache(program, color, uniformLocationMap, gl)
	              ], getColor$5(light, pointLightRecord));
	          sendFloat(gl, uniformCacheMap, /* tuple */[
	                intensity,
	                getUniformLocationAndCache(program, intensity, uniformLocationMap, gl)
	...
	function send$1(gl, param, param$1) {
	  ...
	  return sendFloat3(gl, param[1], /* tuple */[
	              name,
	              getUniformLocationAndCache(param[0], name, param[2], gl)
	            ], getColor$6(param$1[/* sceneRecord */1]));
	}
	...
	function send$2(gl, param, param$1) {
	  ...
	  reduceOneParami((function (directionLightRecord, light, index) {
	          ...
	          sendVec3(gl, uniformCacheMap, /* tuple */[
	                direction,
	                getUniformLocationAndCache(program, direction, uniformLocationMap, gl)
	...
	function execJob$63(flags, e, stateData) {
	  return callFunc((function (param) {
	                ...
	                var typeArrayPoolRecord = state[/* typeArrayPoolRecord */22];
	                var data = getRecord$1(e);
	                var match = reduceOneParam$1((function (param, sourceInstance) {
	                        return /* tuple */[
	...
	function _initBasicMaterials(gl, basicMaterialData, isSupportInstance, state) {
	  getRecord$14(state);
	  reduceOneParam$1((function (initBasicMaterialState, param) {
	...
	function _initLightMaterials(gl, lightMaterialData, isSupportInstance, state) {
	  getRecord$15(state);
	  reduceOneParam$1((function (initLightMaterialState, param) {
	...
	function _sendNoCachableData(gl, renderState) {
	  return reduceiValidShaderSendNoCachableData(renderState[/* glslSenderRecord */3], (function (renderState, dataArr, shaderIndex) {
	                var renderState$1 = useByShaderIndex(gl, shaderIndex, renderState);
	                reduceOneParam$1((function (getRenderDataSubState, param) {
	                        var pos = param[/* pos */0];
	                        var match = isUniformLocationExist(pos);
	                        if (match) {
	                      ...
	                      }), createState(renderState$1), dataArr);
	                return renderState$1;
	              }), renderState);
	}

	function _sendCachableData(gl, renderState) {
	  return reduceiValidShaderSendCachableData(renderState[/* glslSenderRecord */3], (function (renderState, dataArr, shaderIndex) {
	                var renderState$1 = useByShaderIndex(gl, shaderIndex, renderState);
	                reduceOneParam$1((function (getRenderDataSubState, param) {
	...
	function _sendCachableFunctionData(gl, renderState) {
	  return reduceiValidShaderSendCachableFunctionData(renderState[/* glslSenderRecord */3], (function (renderState, dataArr, shaderIndex) {
	                var renderState$1 = useByShaderIndex(gl, shaderIndex, renderState);
	                reduceOneParam$1((function (sendRenderDataSubState, param) {
	                        ...
	                        return sendRenderDataSubState;
	                      }), createState$1(renderState$1), dataArr);
	                return renderState$1;
	              }), renderState);
	}
	...
	function create$29(param) {
	  return /* record */[
	          ...
	          /* shaderLibShaderIndexMap */createEmpty(/* () */0),
	          /* materialsMap */createEmpty$3(/* () */0)
	        ];
	}
	...
	function create$30(param) {
	  return /* record */[/* outlineData : record */[
	            ...
	            /* gameObjectsNeedDrawOutline : array */[]
	          ]];
	}
	...
	function create$32(param) {
	  return /* record */[
	          ...
	          /* geometryNormalBufferMap */createEmpty$3(/* () */0),
	          /* geometryElementArrayBufferMap */createEmpty$3(/* () */0),
	          /* matrixInstanceBufferMap */createEmpty$3(/* () */0),
	          /* vertexArrayBufferPool */createEmpty$2(/* () */0),
	          /* elementArrayBufferPool */createEmpty$2(/* () */0),
	          /* matrixInstanceBufferPool */createEmpty$2(/* () */0)
	        ];
	}
	...
	function create$36(param) {
	  return /* record */[
	          ...
	          /* uniformCacheMap */createEmpty$3(/* () */0),
	          /* uniformRenderObjectSendModelDataMap */createEmpty$3(/* () */0),
	          /* uniformRenderObjectSendMaterialDataMap */createEmpty$3(/* () */0),
	          /* uniformShaderSendNoCachableDataMap */createEmpty$3(/* () */0),
	          /* uniformShaderSendCachableDataMap */createEmpty$3(/* () */0),
	          /* uniformShaderSendCachableFunctionDataMap */createEmpty$3(/* () */0),
